...
namespace CSLSite
{
    public partial class revisiontecnica : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    if (dptipocarga.Items.FindByValue("000") != null)
                    {
                        dptipocarga.Items.FindByValue("000").Selected = true;
                    }
                ...
                if (dptiposervicios.Items.Count > 0)
                {
                    ...
                    /*
                        ...
                        IMO	Etiquetado - Desetiquetado Unidades --estet
                        LA	Late Arrival -
                        RES	Reestiba
                        BAS	Repesaje
                     ...
                     */
                    if (dptiposervicios.Items.FindByValue("RTR") != null)
                    {
                        dptiposervicios.Items.FindByValue("RTR").Selected = true;
        ...
        public void llenarGridView()
        {
            ...
            var pase = System.Configuration.ConfigurationManager.AppSettings["STORE_PROC"];
            ...
            { 
               //nuevo metodo de RTR -- buscar
                table = unidadN4.consultaPortal(tipoTrafico,booking, msr, msn, hsn, txtcontenedor.Text.Trim().ToUpper(), sUser.ruc, sUser.codigoempresa, "RTR");
        ...
        public void envioCorreoSolicitud(int idSolicitud, usuario sUser, string descripcionServicio, string codigoSolicitud)
        {
            ...
            switch (descripcionServicio)
            {
                ...
                case "Revisión Técnica Refrigerada":
                    ...
                    correoBackUp = cfgs.Where(a => a.config_name.Contains("correoBackUp")).FirstOrDefault();
            ...
            else
            {
                ...
                Utility.mostrarMensajeRedireccionando(this.Page, "Se genero el código " + codigoSolicitud + "  para su solicitud del servicio de " + descripcionServicio + ", revise su correo en unos minutos para mayor información.", "../cuenta/menu.aspx");
            }
        }
