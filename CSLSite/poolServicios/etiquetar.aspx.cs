...
namespace CSLSite
{
    public partial class etiquetar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (dptiposervicios.Items.Count > 0)
                {
                     ...
                     */
                    if (dptiposervicios.Items.FindByValue("IMO") != null)
                    {
                        dptiposervicios.Items.FindByValue("IMO").Selected = true;
        ...
        public void llenarGridView()
        {
            ...
            if (descripcionServicio.Equals("Verificación de Sellos") || descripcionServicio.Equals("Repesaje") ||  descripcionServicio.Equals("Revisión Técnica Refrigerada"))
            {
