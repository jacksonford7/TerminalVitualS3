...
{
    public partial class lookup_empresas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                var lookup = MantenimientoEmpresa.Buscador_Empresas(txtfinder.Text, linea_naviera, out v_mensaje);
                try
                {
                ...
                catch (Exception ex)
                {
                    ...
                    this.sinresultado.InnerText = string.Format("Se produjo un error durante la búsqueda, por favor repórtelo con el siguiente codigo [E00-{0}] ", csl_log.log_csl.save_log<Exception>(ex, "lookup_empresas", "find_Click", txtfinder.Text, u != null ? u.loginname : "userNull"));
                    sinresultado.Visible = true;
                }
