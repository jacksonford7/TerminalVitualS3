...
namespace CSLSite
{
    ...
    public partial class facturacion_sav_listado : System.Web.UI.Page
    {
        ...
        private void Cargar_PasesPendientes()
        {
            try
            {
                ...
                if (Response.IsClientConnected)
                {
                    ...
                    List<SAV_Detalle_Factura> ListPases = SAV_Detalle_Factura.Detalle_Pases_Facturados_Por_Cgsa(fechadesde, fechahasta,  out cMensajes);
