...
namespace CSLSite
{
    ...
    public partial class facturacion_sav_cliente : System.Web.UI.Page
    {
        ...
        private void Cargar_PasesPendientes()
        {
            try
            {
                ...
                if (Response.IsClientConnected)
                {
                    ...
                    List<SAV_Detalle_Factura> ListPases = SAV_Detalle_Factura.Detalle_Pases_Por_Clientes(fechadesde, fechahasta, ClsUsuario.ruc, out cMensajes);
