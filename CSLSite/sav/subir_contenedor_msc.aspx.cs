...
namespace CSLSite
{
    ...
    public partial class subir_contenedor_msc : System.Web.UI.Page
    {
        ...
        protected void BtnNuevo_Click(Object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/sav/subir_contenedor_msc.aspx", true);
        }
                ...
                try
                {
                    ...
                    if (FileUpload1.HasFile && Path.GetExtension(FileUpload1.FileName) == ".xlsx")
                    {
                        using (var Excel = new ExcelPackage(FileUpload1.PostedFile.InputStream))
                        {
                            ...
                            {
                                string unidad = tbl.Rows[i][0].ToString();
                                //string fecha = tbl.Rows[i][1].ToString();
                                ...
                                //if (!DateTime.TryParseExact(fecha, "dd/MM/yyyy", enUS, DateTimeStyles.AdjustToUniversal, out Fecha_Retiro))
                                //{
                                ...
                                det.fecha_despacho = System.DateTime.Now;
                                det.estado = true;
        ...
        protected void BtnGrabar_Click(Object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var nProceso = objCabMsc.SaveTransaction(out cMensajes);
