<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="facturacion_sav_listado.aspx.cs" Inherits="CSLSite.facturacion_sav_listado" %>
...
<script type="text/javascript">
    ...
    function exportar()
    {
        ...
        console.log(json);
            ...
            xhr.open('POST', 'facturacion_sav_listado.aspx/ExportarExcel', true);
