            ...
            <div class="form-row" >
                ...
                <div class="form-group   col-md-6"> 
                    <label for="inputAddress">1: Seleccione Depósito:<span style="color: #FF0000; font-weight: bold;"></span></label>
                     ...
                     <asp:UpdatePanel ID="UPDEPOSITO" runat="server"  UpdateMode="Conditional">
                             <ContentTemplate>
                        <asp:DropDownList ClientIDMode="Static" ID="cmbDeposito" class="form-control"  AutoPostBack="true" runat="server" onchange="valdpme(this,0,valcbo);"   OnSelectedIndexChanged="cmbDeposito_SelectedIndexChanged"></asp:DropDownList>
                     </ContentTemplate>
                         </asp:UpdatePanel>
                </div>
                ...
                <div class="form-group   col-md-6"> 
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server"  UpdateMode="Conditional">
                             <ContentTemplate>
                    <div class="d-flex">
                        <asp:DropDownList ClientIDMode="Static" ID="dplinea" class="form-control" runat="server" onchange="valdpme(this,0,valopera);"  AutoPostBack="true"  OnSelectedIndexChanged="dplinea_SelectedIndexChanged">
                        </asp:DropDownList>
