...
{
    public partial class turnosSavZAL : System.Web.UI.Page
    {
        ...
        public void LlenaComboDepositos()
        {
            try
            {
                cmbDeposito.DataSource = man_pro_expo.consultaDepositosFiltrado("3"); //ds.Tables[0].DefaultView;
                cmbDeposito.DataValueField = "ID";
                cmbDeposito.DataTextField = "DESCRIPCION";
                cmbDeposito.DataBind();
                cmbDeposito.Enabled = true;

                cmbDepositoList.DataSource = man_pro_expo.consultaDepositosFiltrado("4"); //ds.Tables[0].DefaultView;
