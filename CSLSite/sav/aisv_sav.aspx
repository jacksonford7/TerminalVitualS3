<%@ Page Title="Nuevo Turno" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="aisv_sav.aspx.cs" Inherits="CSLSite.aisv_sav" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Servicio de Administración de Vacíos</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Nuevo turno para recepción</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        ...
        <div >
             ...
             <div class="alert alert-warning" runat="server" id="Div1" >
                <span>Estimados Clientes.</span><br />
                 <span>Les recordamos que los contenedores deben ser entregados: Limpios, sin desechos, no deben tener etiquetas IMO y pueden ser 20 pies y/o 40 pies; caso contrario no serán recibidos después de la inspección.</span>
            </div>
            ...
            <div class="form-row" >
                ...
                <div class="form-group col-md-6"> 
                    <label for="inputAddress">1: Seleccione Depósito:<span style="color: #FF0000; font-weight: bold;"></span></label>
                          ...
                          <asp:DropDownList ClientIDMode="Static" ID="cmbDeposito" AutoPostBack="true" class="form-control" runat="server" 
                            onchange="valdpme(this,0,valcbo);"
                ...
                <div class="form-group   col-md-6"> 
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server"  UpdateMode="Conditional">
                             <ContentTemplate>
                                  <div class="d-flex">
                        <asp:DropDownList ClientIDMode="Static" ID="dplinea" class="form-control" AutoPostBack="true" runat="server" 
                             OnSelectedIndexChanged="dplinea_SelectedIndexChanged"
                            onchange="valdpme(this,0,valopera);">
                ...
                <div class="form-group   col-md-6"> 
                    ...
                    <div class="d-flex">
                        <asp:TextBox class="form-control" runat="server" ID="fecsalida" AutoPostBack="false" MaxLength="10"  OnTextChanged="fecsalida_TextChanged"
                ...
                <div class="form-group   col-md-6"> 
                    ...
                    <div class="d-flex">
                        <asp:DropDownList ClientIDMode="Static" ID="dptamano"  class="form-control" runat="server" onchange="valdpme(this,0,valsize);"  >
                            ...
                            <asp:ListItem Value="50">40 FLAT RACK</asp:ListItem>
                            <asp:ListItem Value="55">20 FLAT RACK</asp:ListItem>
                            <asp:ListItem Value="60">40 OPEN TOP</asp:ListItem>
                            <asp:ListItem Value="65">20 OPEN TOP</asp:ListItem>
                ...
                <div class="form-group   col-md-6"> 
                    ...
                    <div class="d-flex">
                        <asp:TextBox style="text-transform:uppercase;" ID="txtplaca" runat="server" MaxLength="10"  class="form-control" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789')" onBlur="validarPlaca(this,'valplaca');buble_warning();" placeholder="AAA0000" ClientIDMode="Static"></asp:TextBox>
                                        ...
                                        <div class="bokindetalle" style=" width:100%; overflow:auto">
                                            <fieldset>
                                                ...
                                                <table class="table table-bordered invoice" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr><td  class='border-none text-right text-info font-weight-bold' style="color:blue;"><strong>IVA:</strong></td><td class="estotal"><span id='stiva' style="color:blue;" runat="server" clientidmode="Static" ><strong>$0000.00</strong></span></td></tr>
