<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="solicitudpasebrbk.aspx.cs" Inherits="CSLSite.solicitudpasebrbk" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">TURNOS ESPECIALES/CARGA BREAK BULK (BRBK)</li>
          </ol>
        </nav>
      </div>
...
<div class="dashboard-container p-4" id="cuerpo" runat="server"> 
   ...
   <%--  <h4 class="mb">COMPAÑÍA DE TRANSPORTE</h4>    --%>
     <div class="form-row"> 
       ...
       <h4 class="mb">DETALLE DE TURNOS A SOLICITAR</h4>
     <div class="form-row"> 
                        ...
                        <ItemTemplate>
                            <tr class="gradeC"> 
                               ...
                               <td class="center hidden-phone">  
                                <asp:Button ID="BtnActualizar" CommandArgument= '<%#Eval("LLAVE")%>' runat="server" Text="QUITAR" class="btn btn-primary" ToolTip="Quitar Pase" CommandName="Eliminar" />
                                </td> 
                ...
                <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-12 d-flex justify-content-center">
                        ...
                        <asp:Button ID="BtnGrabar" runat="server"  class="btn btn-primary"  Text="Enviar solicitud"   OnClientClick="return confirmacion()"  OnClick="BtnGrabar_Click" />
                         &nbsp;&nbsp;
                            <asp:Button ID="BtnVisualizar" runat="server" class="btn btn-primary" Text="Imprimir Solicitud"    OnClick="BtnVisualizar_Click" />
                  </div>
                </div>
            </ContentTemplate>
             </asp:UpdatePanel>   
     ...
     $(function () {
        $('[id*=Txtempresa]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("solicitudpasebrbk.aspx/GetEmpresas") %>',
                    data: "{ 'prefix': '" + request + "'}",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
