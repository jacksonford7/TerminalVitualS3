...
namespace CSLSite
{
    ...
    public partial class aprobarsolicitudbrbk : System.Web.UI.Page
    {
        ...
        private void Cargar_Solicitud_Pendientes()
        {
            ...
            {
                var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                var Tabla = brbk_solicitud_pendiente.Solicitud_Pendientes_Aprobar(out cMensajes);
                if (Tabla == null)
                {
                    this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>No existe información que mostrar, de solicitudes pendientes de aprobar. {0}", cMensajes));
                    return;
                }
                if (Tabla.Count <= 0)
                {
                    ...
                    this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>No existe información que mostrar, de solicitudes pendientes de aprobar."));
                    return;
                }
                ...
                try
                {
                    ...
                    if (e.CommandName == "Ver")
                    {
                        ...
                        else
                        {
                            ...
                            this.Titulo.InnerText = string.Format("SOLICITUD PENDIENTE DE APROBAR # {0}", ID_SOL);
