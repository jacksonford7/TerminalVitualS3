...
namespace CSLSite
{
    ...
    public partial class actualizacion_transportepasebrbk : System.Web.UI.Page
    {
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                    var Carga = PasePuerta.Pase_BRBK.ObtenerListaEditable_Transportista(this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim(), ClsUsuario.ruc, ClsUsuario.loginname, null);
                    if (Carga.Exitoso)
                    {
                ...
                try
                {
                    ...
                    **********************************************************************************************************************************************/
                    foreach (var Det in objPaseBRBK.Detalle)
                    {
                        ...
                        {
                            this.Mostrar_Mensaje(1, string.Format("<b>Informativo! No se ha ingresado la empresa de transporte para poder actualizar los pase de puerta de la carga: {0} </b>", Det.CARGA));
                    ...
                    **********************************************************************************************************************************************/
                    ...
                    foreach (var Det in LinqQuery)
                    {
                        ...
                        var Resultado = pase.Actualizar_Transportista(ClsUsuario.loginname, Det.MRN, Det.MSN, Det.HSN);
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (Estado.Text.Equals("EXPIRADO") || estado_transaccion == false || LblCambioturno.Text.Equals("SI"))
                {
                   ...
                   // Btn.Attributes["disabled"] = "disabled";
                    ...
                    //if (!LblIdSolicitud.Text.Equals("0") && !Estado.Text.Equals("EXPIRADO"))
                    //{
                    //    Chk.Enabled = true;
                    //    BtnEvento.Visible = true;
                    //}
