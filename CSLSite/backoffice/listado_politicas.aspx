<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="listado_politicas.aspx.cs" Inherits="CSLSite.listado_politicas" %>
...
<asp:ToolkitScriptManager ID="tkscata" runat="server"></asp:ToolkitScriptManager>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">POLÍTICAS</a></li>
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE DE ACEPTACIÓN DE POLÍTICAS</li>
          </ol>
        </nav>
      </div>
         ...
         <div class="form-group col-md-6"> 
              <label for="inputAddress">TIPO:<span style="color: #FF0000; font-weight: bold;">*</span></label>  
                <asp:DropDownList ClientIDMode="Static" ID="CboTipo" class="form-control" runat="server" >
                            <asp:ListItem Value="AC" Selected="True">Aceptados</asp:ListItem>
                            <asp:ListItem Value="NO">Historial No Aceptados</asp:ListItem>
                 </asp:DropDownList>
           </div>
     </div> 
              ...
              <div class="bokindetalle" style=" width:100%; overflow:auto">  
                      <asp:Repeater ID="grilla" runat="server"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                <td class="center hidden-phone"> <%#Eval("usuario")%></td>
                                <td class="center hidden-phone"> <%#Eval("descripcion")%></td>
                                <td class="center hidden-phone"> <%#Eval("empresa")%></td>
