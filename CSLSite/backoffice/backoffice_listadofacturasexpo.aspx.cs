...
{
    public partial class backoffice_listadofacturasexpo : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaFactura = _obj.BackOffice_Entidad_Listado_Facturas_Expo(fechadesde, fechahasta,  out cMensajes);
