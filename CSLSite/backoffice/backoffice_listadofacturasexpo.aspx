<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="backoffice_listadofacturasexpo.aspx.cs" Inherits="CSLSite.backoffice.backoffice_listadofacturasexpo" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE FACTURAS EMITIDAS DE EXPORTACION</li>
          </ol>
        </nav>
      </div>
    ...
    <asp:AsyncPostBackTrigger ControlID="BtnBuscar" />
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
       <ContentTemplate>
             ...
             <h3>DETALLE DE FACTURAS DE EXPORTACION</h3>
                      ...
                      <asp:Repeater ID="grilla" runat="server"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                          ...
                          <tr>
                            ...
                            <th class="center hidden-phone">BUQUE</th>
                            <th class="center hidden-phone">CLIENTE</th>
                            <th class="center hidden-phone">TIPO FACTURA</th>
                            <th class="center hidden-phone">SUBTOTAL</th>
                            <th class="center hidden-phone">IVA</th>
                            <th class="center hidden-phone">TOTAL</th>
                            <th class="center hidden-phone">USUARIO</th>
                            <th class="center hidden-phone">PRINT</th>
                          </tr>
                        </thead>
                        <tbody>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone"> <%#Eval("IV_GLOSA")%></td>
                                ...
                                <td class="center hidden-phone">
                                    <a href="../reportesexpo/factura_preview.aspx?id_comprobante=<%#securetext(Eval("IV_ID")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> </button></a>
