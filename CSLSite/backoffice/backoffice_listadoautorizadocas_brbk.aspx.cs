...
namespace CSLSite
{
    public partial class backoffice_listadoautorizadocas_brbk : System.Web.UI.Page
    {
        #region "Clases"
        ...
        private void Crear_Sesion()
        {
            ...
            Session["ConsultaAutBRBK" + this.hf_BrowserWindowName.Value] = Lista;
        }
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaAutorizacion = Cls_Bil_CasManual.Listado_Autorizaciones_Brbk(fechadesde, fechahasta,  out cMensajes);
