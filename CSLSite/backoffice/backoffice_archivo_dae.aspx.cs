...
namespace CSLSite
{
    public partial class backoffice_archivo_dae : System.Web.UI.Page
    {
        private usuario u;
        ...
        private void New_ExportFileUpload()
        {
            ...
            if (fsuploadarchivo.HasFile)
            {
                ...
                var p = CSLSite.app_start.CredencialesHelper.UploadFile_Dae(Server.MapPath(fsuploadarchivo.FileName), fsuploadarchivo.PostedFile.InputStream, out finalname);
                if (!p)
                {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    this.sinresultado.InnerText = string.Format("Se produjo un error durante la búsqueda, por favor repórtelo con el siguiente codigo [E00-{0}] ", csl_log.log_csl.save_log<Exception>(ex, "backoffice_archivo_dae", "find_Click", "", u != null ? u.loginname : "userNull"));
                    sinresultado.Visible = true;
                }
        ...
        protected void find_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                this.sinresultado.InnerText = string.Format("Se produjo un error durante la carga de archivo, por favor repórtelo con el siguiente codigo [E00-{0}] ", csl_log.log_csl.save_log<Exception>(ex, "backoffice_archivo_dae", "find_Click", "", u != null ? u.loginname : "userNull"));
                sinresultado.Visible = true;
            }
        }
    }
