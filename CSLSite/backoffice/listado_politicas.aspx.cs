...
namespace CSLSite
{
    public partial class listado_politicas : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    {
                        this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Sólo puede consultar las transacciones de hasta un mes."));
                        return;
                    }


                    var TablaFactura = Cls_Politicas_Datos.Listado_Politicas(fechadesde, fechahasta, this.CboTipo.SelectedValue.ToString() ,out cMensajes);
                    ...
                    grilla.DataSource = TablaFactura;
                    grilla.DataBind();
