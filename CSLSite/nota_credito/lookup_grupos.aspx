<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_grupos.aspx.cs" Inherits="CSLSite.lookup_grupos"  Title="Buscar Grupos de Usuarios" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Catálogo de Grupos de Usuarios de Notas de Créditos</title>
   ...
   <script type="text/javascript" >
       ...
       function setGrupos(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_grupos = {
                  sel_g_id_group: celColect[0].textContent,
                  sel_g_group_name: celColect[1].textContent,
                  sel_g_estado: celColect[2].textContent,
                  sel_g_create_user: celColect[3].textContent,
                  sel_g_usuarios: celColect[4].textContent
              };
           if (window.opener != null) {

               window.opener.popupCallback_Nivel(lookup_get_grupos);
           }
