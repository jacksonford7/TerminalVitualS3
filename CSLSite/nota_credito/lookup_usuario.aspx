<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_usuario.aspx.cs" Inherits="CSLSite.lookup_usuario"  Title="Buscar Usuarios" %>
   ...
   <script type="text/javascript" >
       ...
       function setUsuario(row)
       {
           ...
           if (window.opener != null) {
               ...
               window.opener.popupCallback2(lookup_usuario);
           }
