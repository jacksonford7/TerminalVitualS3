...
<%@ Page Title="Usuarios" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
    CodeBehind="consultausuarioadministrador.aspx.cs" Inherits="CSLSite.consultausuarioadministrador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <input id="zonaid" type="hidden" value="902" />
    <noscript>
                ...
                <div class="accion">
                    <table class="controles" cellspacing="0" cellpadding="1">
                        ...
                        <tr>
                            ...
                            <td class="bt-bottom bt-right" colspan="3">
                                <asp:TextBox ID="txtUsuario" runat="server"  
                                    MaxLength="20" placeholder="USUARIO" Width="200px" onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890_',true)"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="bt-bottom bt-right" colspan="3">
                                <asp:TextBox ID="txtNombreEmpresa" runat="server"  onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890',true)"
                                                ...
                                                <asp:Repeater ID="tablePagination" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="point"  id="trUsuario">
                                                            ...
                                                            <td>
                                                                <div class="tcomand">
                                                                    <input type="button" id="btVerUsusario" value="Asignar roles hijos" tooltip="Carga la información del usuario para modificarla"
    ...
    <script type="text/javascript">
        ...
        function setUser(user) {
            ...
            location.href = "../seguridad/grupooperador";
        }
