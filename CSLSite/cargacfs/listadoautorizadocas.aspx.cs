...
namespace CSLSite
{
    public partial class listadoautorizadocas : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaAutorizacion = Cls_Bil_CasManual.Listado_Autorizaciones_desconsolidadora(fechadesde, fechahasta, IdDesConsolidadora, out cMensajes);
