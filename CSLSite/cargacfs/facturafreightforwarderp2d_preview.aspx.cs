...
namespace CSLSite
{
    public partial class facturafreightforwarderp2d_preview : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
        ...
        protected void BtnFacturar_Click(object sender, EventArgs e)
        {
            ...
            this.Mostrar_Mensaje(string.Format("<b>GENERANDO FACTURA CARGA SUELTA (FREIGHT FORWARDER)! </b>....POR FAVOR ESPERE, SE ESTA GENERANDO LA FACTURA......."));
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        **********************************************************************************************************************************************/
                        ...
                        if (objFactura == null)
                        {
                            this.Mostrar_Mensaje(string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible..no existen datos para facturar carga suelta (Port To Door).."));
                            return;
                        }
                        ...
                        if (SinServicios)
                        {
                            this.Mostrar_Mensaje(string.Format("<i class='fa fa-warning'></i><b> Informativo! No existen servicios pendientes para facturar carga suelta (Port To Door).</br> {0} ", cMensajeActualizados));
                            return;
                        ...
                        if (Finalizar != null)
                        {
                            if (Finalizar.status_id.Equals("OK"))
                            {
                                ...
                                new System.Xml.Linq.XElement("FACT_CABECERA",
                                                                        ...
                                                                        new System.Xml.Linq.XAttribute("IV_TIPO_CLIENTE", objFactura.IV_TIPO_CLIENTE == null ? "" : objFactura.IV_TIPO_CLIENTE),
                                ...
                                this.Mostrar_Mensaje(string.Format("<b>Se procedió a generar la factura de carga suelta por servicio Port To Door # {0}  {1} ...{2} ", FacturaFinal, ",Puede proceder a imprimir su comprobante.", cMensajeActualizados));
                                ...
                                var nProceso = objProcesar.SaveTransaction_cfs_p2d(out cMensajes);
                                ...
                                if (!nProceso.HasValue || nProceso.Value <= 0)
                                {
                                    ...
                                    this.Mostrar_Mensaje(string.Format("<b>Error! No se pudo grabar datos de la factura de carga suelta por servicio Port To Door..{0}</b>", cMensajes));
                                    ...
                                    * **********************************************************************************************************************************/
                                    ...
                                    this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación CFS (Port To Door)", "Error al grabar", cMensajes, out MensajeCasos);
                            ...
                            else
                            {
                                ...
                                * **********************************************************************************************************************************/
                                ...
                                this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación CFS (Port To Door)", "Error al grabar", Finalizar.messages.ToString(), out MensajeCasos);
                        ...
                        else
                        {
                            ...
                            * **********************************************************************************************************************************/
                            ...
                            this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación CFS (Port To Door)", "Error al grabar", string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Problemas al finalizar el DRAFT # {0}", draftNumber), out MensajeCasos);
