...
namespace CSLSite
{
    ...
    public partial class facturacioncfsadicional : System.Web.UI.Page
    {
        ...
        private List<Cls_Bil_PasePuertaCFS_Carga> List_Cargas { set; get; }
        #endregion
            ...
            * **********************************************************************************************************************************/
            ...
            try
            {
                ...
                else
                {
                    if (bloqueo)
                    {
                        Mensaje = string.Format("se envió una notificación a nuestro personal de Tesorería  para que realicen las respectivas revisiones del problema {0} ...Casilla de atención: tesoreia@cgsa.com.ec,  Teléfonos (04) 6006300 – 3901700 opción 3,  Horario lunes a viernes 8h30 a 17h30 sábados y domingos 8h00 a 15h00.", rt.MensajeProblema);
       ...
       #region "Eventos de la grilla"
                   ...
                   /*para almacenar clientes que asumen factura*/
                    ...
                    if (EcuaContenedores.Exitoso)
                    {
                        ...
                        if (ListaContenedores.Exitoso)
                        {
                            ...
                            /*cargas con pases expirados y con nuevos eventos para facturar*/
                            List_Cargas = new List<Cls_Bil_PasePuertaCFS_Carga>();
                            List_Cargas.Clear();
                            var EventosPases = PasePuerta.Pase_CFS.ObtenerListaEditable(this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim(), ClsUsuario.ruc, ClsUsuario.loginname, true, null);
                            if (EventosPases.Exitoso)
                            {
                                var LinqQueryEventos = (from p in EventosPases.Resultado.AsEnumerable()
                                                        where (p.Field<bool>("SERVICIO")==true)
                                                        select new
                                                        {
                                                            CARGA = string.Format("{0}-{1}-{2}",p.Field<string>("MRN"),p.Field<string>("MSN"), p.Field<string>("HSN").Trim()),
                                                        }).Distinct();

                                foreach (var Det in LinqQueryEventos)
                                {
                                    List_Cargas.Add(new Cls_Bil_PasePuertaCFS_Carga { CARGA = Det.CARGA });
                                }
                            }

                           // List_Cargas.Add(new Cls_Bil_PasePuertaCFS_Carga { CARGA = "CEC2018SMLU0085-0053-0001" });
                            var LinqNewEventos = (from Tbl in List_Cargas.ToList()
                                                  select new { CARGA = Tbl.CARGA });
                            ...
                            var LinqQuery = (from Tbl in LinqPartidadN4
                                                join Eventos in LinqNewEventos on Tbl.CARGA equals Eventos.CARGA
        ...
        protected void BtnNuevo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/cargacfs/facturacioncfsadicional.aspx", false);
                ...
                try
                {
                    ...
                    **********************************************************************************************************************************************/
                    ...
                    else
                    {
                        ...
                        Response.Redirect("~/cargacfs/proformacfs_preview_adicional.aspx?id_proforma=" + cId.Trim() + "", false);
                    ...
                    **********************************************************************************************************************************************/
                    ...
                    else
                    {
                        ...
                        **********************************************************************************************************************************************/
                        ...
                        Response.Redirect("~/cargacfs/facturacfs_preview_adicional.aspx?id=" + cId.Trim() + "", false);
