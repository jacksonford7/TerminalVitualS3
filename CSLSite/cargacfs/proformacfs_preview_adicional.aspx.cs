...
namespace CSLSite
{
    public partial class proformacfs_preview_adicional : System.Web.UI.Page
    {
        usuario ClsUsuario;
        ...
        protected void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/cargacfs/facturacioncfsadicional.aspx?ID_CARGA=" + securetext(ID_CARGA), false);
        }
