<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="reportecajas_agencia.aspx.cs" Inherits="CSLSite.reportecajas_agencia" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADOS DE CAJAS - AGENCIAS</li>
          </ol>
        </nav>
      </div>
<div class="dashboard-container p-4" id="cuerpo" runat="server">
           ...
           <h4 id="LabelTotal" runat="server" class="mb">BODEGA FRIA/SECA</h4>
            ...
            <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  DataKeyNames="Fila" OnPageIndexChanging="tablePagination_PageIndexChanging" OnPreRender="tablePagination_PreRender"   OnRowDataBound="tablePagination_RowDataBound" 
                    ...
                    <alternatingrowstyle  BackColor="#FFFFFF" />
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="REFERENCIA" HeaderText="REFERENCIA" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"/>
                                        ...
                                        <asp:BoundField DataField="LINEA" HeaderText="LINEA"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:GridView ID="tableMuelle" runat="server" AutoGenerateColumns="False"  DataKeyNames="Fila" OnPageIndexChanging="tableMuelle_PageIndexChanging" OnPreRender="tableMuelle_PreRender"   OnRowDataBound="tableMuelle_RowDataBound" 
                    ...
                    <alternatingrowstyle  BackColor="#FFFFFF" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="referencia" HeaderText="REFERENCIA"  HeaderStyle-HorizontalAlign="Center" />
                                       <asp:BoundField DataField="linea" HeaderText="LINEA"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="ruc" HeaderText="RUC"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="Exportador" HeaderText="EXPORTADOR"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
    ...
    <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
             <ContentTemplate>
               ...
               <div class="row">
                <div class="col-md-12 d-flex justify-content-center">
                         <div class="alert alert-danger" id="banmsg_det" runat="server" clientidmode="Static"><b>Error!</b>......</div>
                </div>
              </div>
              <br/>
            ...
            <br/>
             ...
             <div class="col-md-12 d-flex justify-content-center">
                   ...
                   <asp:Button ID="BtnExportar" runat="server" class="btn btn-primary mr-4" Text="EXPORTAR A EXCEL" OnClientClick="exportar();" Visible="true"/>
   ...
   <script type="text/javascript" src="../lib/advanced-form-components.js"></script>
    ...
    <script type="text/javascript">
        ...
        function exportar()
        {
            ...
            xhr.open('POST', 'reportecajas_agencia.aspx/ExportarExcel', true);
