<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="facturacionexportador.aspx.cs" Inherits="CSLSite.facturacionexportador" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">FACTURACIÓN POR OTROS SERVICIOS - EXPORTADOR</li>
          </ol>
        </nav>
      </div>
                                 ...
                                 <div class="form-group col-md-12">
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="tablePaginationRubros">
                                      ...
                                      <tr>
                                        ...
                                        <th class="center hidden-phone">COMENTARIO</th>
                                           <th class="center hidden-phone">COSTO</th>
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeC"> 
                                            ...
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("numero_factura")%>' ID="Label2" runat="server"  /> </td>
                                            ...
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("comentario")%>' ID="Label7" runat="server"  /></td>
                                             <td class="center hidden-phone"><asp:Label Text='<%#Eval("valor")%>' ID="Label8" runat="server"  /></td>
                                             <td class="center hidden-phone"><asp:Label Text='<%#Eval("total")%>' ID="Label9" runat="server"  /></td>
                                         </tr>    
                                   </ItemTemplate>
                                   <FooterTemplate>
                                    </tbody>
