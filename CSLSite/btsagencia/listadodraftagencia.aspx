<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="listadodraftagencia.aspx.cs" Inherits="CSLSite.listadodraftagencia" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE DRAFT DE AGENCIA</li>
          </ol>
        </nav>
      </div>
        ...
        <ContentTemplate>
            <div class="row">
                <div class="col-md-12 d-flex justify-content-center">
                        <asp:Button ID="BtnBuscar" runat="server" class="btn btn-primary"   Text="BUSCAR"  OnClientClick="return mostrarloader()" OnClick="BtnBuscar_Click" />                             
             ...
             <script type="text/javascript">
              ...
              <div class="form-title">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                    ...
                    <th class="th-sm">GENERAR FACTURA</th>
                    </tr>
                </thead>
                <tbody>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr class="gradeC">
                        ...
                        <td class="center hidden-phone"> <%#Eval("DESC_FACTURADO")%></td>
                        ...
                        <td class="center hidden-phone">
                            <a href="../btsagencia/facturaagencia_print_preview.aspx?id_comprobante=<%#securetext(Eval("ID")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</button></a>
                               
                        </td> 
                         <td class="center hidden-phone">  
                             <asp:Button ID="BtnAnular" CommandArgument= '<%#Eval("ID")%>' runat="server" Text="ANULAR" class="btn btn-primary" ToolTip="Anular borrador de factura" CommandName="Rechazar" 
                                OnClientClick="return confirm('Esta seguro que desea anular el borrador de la factura?');" 
                               />   
                         </td> 
                        <td class="center hidden-phone">  
                             <asp:Button ID="BtnAprobar" CommandArgument= '<%#Eval("ID")%>' runat="server" Text="GENERAR FACTURA" class="btn btn-primary" ToolTip="generar la factura del draf" CommandName="Grabar" 
...
<script type="text/javascript">
    ...
    {
        var mensaje;
        var opcion = confirm("Esta seguro que desea generar la factura del draf?");
        if (opcion == true)
        {
            mostrarloader();
            return true;
...
<script type="text/javascript">
    ...
    {
        var mensaje;
        var opcion = confirm("Esta seguro que desea anular el borrador de la factura?");
        if (opcion == true)
        {
            mostrarloader();
            return true;
