...
namespace CSLSite
{
    public partial class listadofacturasexportador : System.Web.UI.Page
    {
        #region "Clases"
        ...
        private void GenerarConsulta()
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    List<BTS_Listado_Facturas_Exportador> ListFactura = BTS_Listado_Facturas_Exportador.Datos_Facturas(fechadesde, fechahasta, ClsUsuario.loginname, ClsUsuario.ruc, out cMensajes);
