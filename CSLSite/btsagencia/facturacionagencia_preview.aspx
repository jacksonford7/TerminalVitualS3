<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="facturacionagencia_preview.aspx.cs" Inherits="CSLSite.facturacionagencia_preview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
  ...
  <div id="div_BrowserWindowName" style="visibility:hidden;">
    ...
    <asp:HiddenField ID="manualHide" runat="server" />
     <asp:UpdatePanel ID="TITULOS" runat="server"  UpdateMode="Conditional" >
       <ContentTemplate>
     <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Bodega BTS</a></li>
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">PREVISUALIZACIÓN DE FACTURA DE AGENCIA</li>
          </ol>
        </nav>
    </div>
        </ContentTemplate>
            ...
            <div class="col-lg-12 col-lg-offset-1"> <!--col-lg-10 col-lg-offset-1-->
             <asp:UpdatePanel ID="UPDETALLE" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
                ...
                <div class="row">
                  ...
                  <strong><span id="carga" runat="server">.... </span></strong><br/><br/>
                  <strong><span id="cajas_bodega" runat="server">.... </span></strong><br/>
                  <strong><span id="cajas_muelle" runat="server">.... </span></strong><br/>
                ...
                <br/>
                 ...
                 <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-right no-border"><strong>Iva 15%</strong></td>
                  ...
                  <div class="white-panel mt" runat="server" id="cargar" clientidmode="Static">
                    ...
                    <div class="d-flex justify-content-end mt-4">                      
                            <asp:Button ID="BtnFacturar" runat="server" class="btn btn-primary"  Text="GRABAR BORRADOR"   
                                  onclick="BtnFacturar_Click"  OnClientClick="return confirmacion()"    />
                        &nbsp;&nbsp;
                            <asp:Button ID="BtnVisualizar" runat="server" class="btn btn-primary" Text="IMPRIMIR BORRADOR"    OnClick="BtnVisualizar_Click" />
