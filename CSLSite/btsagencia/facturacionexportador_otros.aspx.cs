...
namespace CSLSite
{
    ...
    public partial class facturacionexportador_otros : System.Web.UI.Page
    {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    if (e.CommandName == "Detalle")
                    {
                        ...
                        if (Detalle != null)
                        {
                            var rubros = BTS_OTROS_Detalle_Rubros.Carga_DetalleRubros_Otros( out v_mensaje);
                            ...
                            {
                                this.Mostrar_Mensaje(4, string.Format("<i class='fa fa-warning'></i><b> Informativo! Debe generar la consulta, para poder consultar los rubros del exportador </b>"));
                                return;
                            }

                            objCabeceraBTS_OTROS.Detalle_Rubros_Adicionales.Clear();

                            int nRow = 1;
                            foreach (var Det in rubros)
                            {
                                objDetalleExportadorRubros = new BTS_OTROS_Detalle_Rubros();
                                objDetalleExportadorRubros.Fila = nRow;
                                objDetalleExportadorRubros.linea = Detalle.linea;
                                objDetalleExportadorRubros.referencia = Detalle.referencia;
                                objDetalleExportadorRubros.booking = Detalle.booking;
                                objDetalleExportadorRubros.ruc = Detalle.ruc;
                                objDetalleExportadorRubros.exportador = Detalle.exportador;
                                objDetalleExportadorRubros.cantidad = Detalle.cantidad;
                                objDetalleExportadorRubros.ruc_asume = Detalle.ruc_asume;
                                ...
                                objDetalleExportadorRubros.valor = Det.valor;
                                nRow++;
                                objCabeceraBTS_OTROS.Detalle_Rubros_Adicionales.Add(objDetalleExportadorRubros);
                            }

                            tablePaginationRubros.DataSource = objCabeceraBTS_OTROS.Detalle_Rubros_Adicionales;
                    ...
                    if (e.CommandName == "Grabar")
                    {
                        ...
                        if (Detalle != null)
                        {
                            ...
                            **********************************************************************************************************************************************/
                            ...
                            {
                                list.Add(Tuple.Create(item.codigoN4, string.Format("{0},{1},{2}", item.value_tarifa_N4, Detalle.cantidad.ToString().Replace(".00",""), item.comentario)));
                            }
                            ...
                            objCabeceraBTS_OTROS.REFERENCIA = Detalle.referencia;
                            objCabeceraBTS_OTROS.TOTAL_CAJA = Detalle.cantidad;
                            objCabeceraBTS_OTROS.LINEA = Detalle.linea;
                            objCabeceraBTS_OTROS.BOOKING = Detalle.booking;
                            objCabeceraBTS_OTROS.RUC_USUARIO = ClsUsuario.ruc;
                            objCabeceraBTS_OTROS.DESC_USUARIO = ClsUsuario.nombres;
                            objCabeceraBTS_OTROS.BOOKING = Detalle.booking;
                            ...
                            foreach (var Det in objCabeceraBTS_OTROS.Detalle_Exportador.Where(f => f.Fila == (string.IsNullOrEmpty(this.TxtFila.Text) ? 0 : int.Parse(this.TxtFila.Text))))
                            {
                                ...
                                objDetalleExportadorUnico.linea = Det.linea;
                                ...
                                objDetalleExportadorUnico.booking = Det.booking;
                                objDetalleExportadorUnico.referencia = Det.referencia;
                            ...
                            var LinqInvoiceType = (from Tbl in rubros.Where(Tbl => Tbl.valor != 0)
                                               select new
                                               {
                            ...
                            **********************************************************************************************************************************************/
                            ...
                            new System.Xml.Linq.XElement("FACT_CABECERA",
                                                                    ...
                                                                    new System.Xml.Linq.XAttribute("LINEA", objCabeceraBTS_OTROS.LINEA == null ? "" : objCabeceraBTS_OTROS.LINEA),
                                                                    new System.Xml.Linq.XAttribute("NAVE", objCabeceraBTS_OTROS.BOOKING == null ? "" : objCabeceraBTS_OTROS.BOOKING),
                                                                    new System.Xml.Linq.XAttribute("BOOKING", objCabeceraBTS_OTROS.BOOKING == null ? "" : objCabeceraBTS_OTROS.BOOKING),
                           ...
                           new System.Xml.Linq.XElement("FACT_SERVICIOS", from p in objCabeceraBTS_OTROS.Detalle_Rubros_Factura.AsEnumerable().AsParallel()
                            ...
                            System.Xml.Linq.XDocument XMLExportador = new System.Xml.Linq.XDocument(new System.Xml.Linq.XDeclaration("1.0", "UTF-8", "yes"),
                             new System.Xml.Linq.XElement("FACT_EXPORTADOR", from p in objCabeceraBTS_OTROS.Detalle_Exportador_Unico.AsEnumerable().AsParallel()
                                                                         select new System.Xml.Linq.XElement("DETALLE",
                                                                            ...
                                                                            new System.Xml.Linq.XAttribute("referencia", p.referencia == null ? "" : p.referencia.ToString().Trim()),
                            ...
                            new System.Xml.Linq.XElement("FACT_RUBROS", from p in objCabeceraBTS_OTROS.Detalle_Rubros.AsEnumerable().AsParallel()
                                                                            select new System.Xml.Linq.XElement("DETALLE",
                                                                                ...
                                                                                new System.Xml.Linq.XAttribute("cantidad", p.cantidad),
                                                                                new System.Xml.Linq.XAttribute("ruc_asume", p.ruc_asume == null ? "" : p.ruc_asume.ToString().Trim()),
                                                                                new System.Xml.Linq.XAttribute("codigoN4", p.codigoN4 == null ? "" : p.codigoN4.ToString().Trim()),
                                                                                new System.Xml.Linq.XAttribute("nombre", p.nombre == null ? "" : p.nombre.ToString().Trim()),
                            ...
                            var nProceso = objProcesaFactura.SaveTransaction_BTS_Exportador_Otros(out cMensajes);
                            ...
                            if (!nProceso.HasValue || nProceso.Value <= 0)
                            {
                                ...
                                * **********************************************************************************************************************************/
                                ...
                                this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación BODEGA BTS OTROS SERVICIOS", "Error al grabar", cMensajes, objCabeceraBTS_OTROS.REFERENCIA, objCabeceraBTS_OTROS.DESC_FACTURADO, objCabeceraBTS_OTROS.NUMERO_FACTURA, out MensajeCasos);
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    List<BTS_Detalle_Bodegas> ListExportadores = BTS_Detalle_Bodegas.Carga_DetalleBodegas_Exportadores(this.TXTMRN.Text.Trim() , out cMensajes);
                    if (!String.IsNullOrEmpty(cMensajes))
                    {
                    ...
                    /*detalle de exportadores*/
                    List<BTS_Detalle_Muelle> MuelleExportadores = BTS_Detalle_Muelle.Carga_DetalleMuelle_Exportadores(this.TXTMRN.Text.Trim(), out cMensajes);
                    if (!String.IsNullOrEmpty(cMensajes))
                    {
                    ...
                    else
                    {
                        ...
                        foreach (var Detalle in objCabeceraBTS_OTROS.Detalle_Exportador.Where(p => string.IsNullOrEmpty(p.numero_factura)))
                        {
                           ...
                           **********************************************************************************************************************************************/
                            ...
                            if (rubros.Count == 0)
                            {
                                this.Mostrar_Mensaje(4, string.Format("<i class='fa fa-warning'></i><b> Informativo! No existen rubros asociados al exportador para poder generar la facturar por otros servicios.....</b>"));
                                this.Actualiza_Paneles();
                                return;
                            }
                            ...
                            objDetalleExportadorUnico.linea = Detalle.linea;
                            ...
                            objDetalleExportadorUnico.booking = Detalle.booking;
                            objDetalleExportadorUnico.referencia = Detalle.referencia;
                           ...
                           **********************************************************************************************************************************************/
                            ...
                            else
                            {
                                ...
                                this.Mostrar_Mensaje(4, string.Format("<i class='fa fa-warning'></i><b> Error! No se logró realizar la facturación en N4...{0} del exportador {1}-{2} </b>", resp.MensajeProblema, objCabeceraBTS_OTROS.ID_CLIENTE, objCabeceraBTS_OTROS.DESC_CLIENTE));
                                return;
