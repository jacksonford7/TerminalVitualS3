<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inspeccion_naves.aspx.cs" Inherits="CSLSite.inspeccion_naves" %>
		   ...
		   <div class="col-md-12"> 
             ...
             <div class="alert  alert-warning" id="alerta" >
                 Confirme que los datos ingresados sean correctos.  En caso de error, por favor notifíquelo a las casilla ec.sac@contecon.com.ec o comuníquese a los teléfonos (04) 6006300 – 3901700 opción 4	
                  ...
                  <div class=" form-title">Naves</div>
       ...
       function setNave(row) {
            var celColect = row.getElementsByTagName('td');
              var nave = {
                  ...
                  rol: celColect[3].textContent,
                  bandera: celColect[4].textContent,
                  id_line: celColect[5].textContent,
                  line: celColect[6].textContent
              };
