...
namespace CSLSite
{
    public partial class inspeccion_naves : System.Web.UI.Page
    {
        ...
        {
            var table = new Catalogos.sp_referencias_list_inspDataTable();
            var ta = new CatalogosTableAdapters.sp_referencias_list_inspTableAdapter();
