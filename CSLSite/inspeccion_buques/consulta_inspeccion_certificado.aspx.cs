...
namespace CSLSite
{
    public partial class consulta_inspeccion_certificado : System.Web.UI.Page
    {
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    sinresultado.InnerText = string.Format("Ha ocurrido un problema durante la búsqueda, por favor repórtelo con este código E00-{0}, gracias por entender.", csl_log.log_csl.save_log<Exception>(ex, "consulta_inspeccion_certificado", "btbuscar_Click", "Hubo un error al buscar", t.loginname));
        ...
        private void populate()
       {
           ...
           catch (Exception ex)
           {
               ...
               sinresultado.Attributes["class"] = string.Empty;
               sinresultado.Attributes["class"] = "msg-critico";
               sinresultado.InnerText = string.Format("Ha ocurrido un problema durante la carga de datos, por favor repórtelo con este código E00-{0}, gracias por entender.", csl_log.log_csl.save_log<Exception>(ex, "consulta_inspeccion_certificado", "populate", "Hubo un error al buscar", t.loginname));
               sinresultado.Visible = true;
           }
           finally
           {
