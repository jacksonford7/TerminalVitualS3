<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="archivo_inspeccion.aspx.cs" Inherits="CSLSite.archivo_inspeccion"  Title="Buscar Archivo a Cargar" %>
...
<body >
  ...
  <asp:ToolkitScriptManager ID="tkscata" runat="server"></asp:ToolkitScriptManager>
     <div class="dashboard-container p-4" id="cuerpo" runat="server">
       ...
       <div class="form-title">Cargar archivo (Informe de Inspección de Buques)</div>
