...
namespace CSLSite
{
    ...
    public partial class imprimirpasecfs : System.Web.UI.Page
    {
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                    var CargaSuelta = PasePuerta.Pase_WebCFS.ObtenerListaPase(this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim(), ClsUsuario.ruc);
                    ...
                    if (CargaSuelta.Exitoso)
                    {
                        ...
                        if (LinqQuery != null && LinqQuery.Count() > 0)
                        {
                            ...
                            objPaseCFS.MSN = this.TXTMSN.Text;
                            objPaseCFS.HSN = this.TXTHSN.Text;
