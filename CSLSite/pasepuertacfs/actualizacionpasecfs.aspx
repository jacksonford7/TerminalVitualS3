...
<%-- <link href="../css/calendario_ajax.css" rel="stylesheet"/>--%>
 ...
 <script type="text/javascript" src='https://maps.google.com/maps/api/js?key=AIzaSyA0f3IQRMX1fmn-35UxyLJSDvKv3BbKBhI&sensor=false&libraries=places'></script>
   <script src="../maps/locationpicker.jquery.js"></script>
                       ...
                       <div class="form-group col-md-2">   
                         ...
                         <div class="form-group col-md-1">
                            <label for="inputEmail4"> &nbsp;<span style="color: #FF0000; font-weight: bold;"> &nbsp;</span></label>
                                  <label class="checkbox-container" runat="server" id="LblExpress" visible="false"  disabled>
                                   <label class="form-check-label" for="inlineCheckbox1" runat="server" id="Label1" disabled>P2D Xpress </label>  
                                  </label> 
                            </div>
                          <div class="form-group col-md-2">
                            <label for="inputEmail4"> &nbsp;<span style="color: #FF0000; font-weight: bold;"> &nbsp;</span></label>
                                  <label class="checkbox-container" runat="server" id="LblApilable" visible="false"  disabled>
                                   <label class="form-check-label" for="inlineCheckbox1" runat="server" id="Label3" disabled>CARGA APILABLE </label>  
                                  </label> 
                            </div>
