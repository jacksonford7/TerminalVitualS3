...
namespace CSLSite
{
    public partial class listadopasescfs : System.Web.UI.Page
    {
        #region "Clases"
        ...
        private void Crear_Sesion()
        {
            ...
            Session["ConsultaPaseCFS" + this.hf_BrowserWindowName.Value] = Lista;
        }
        ...
        protected void ChkTodos_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                var TablaPase = Cls_Bil_PasePuertaCFS_Detalle.Listado_Pases(fechadesde, fechahasta, ClsUsuario.ruc, valor, out cMensajes);
                if (TablaPase != null)
                {
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                    var TablaPase = Cls_Bil_PasePuertaCFS_Detalle.Listado_Pases(fechadesde, fechahasta, ClsUsuario.ruc,0, out cMensajes);
                    if (TablaPase == null)
                    {
