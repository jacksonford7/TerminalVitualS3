...
{
    public partial class facturacioncarganoexportadavisualiza : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
       // private Cls_Bil_Proforma_Consulta objProforma = new Cls_Bil_Proforma_Consulta();
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.Mostrar_Mensaje( string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible..no existen datos para facturar"));
                    Response.Redirect("~/facturacioncarganoexportada.aspx", false);
                    return;
                }
                        ...
                        **********************************************************************************************************************************************/
                        ...
                        if (LinqFechasContainer.Count != 0)
                        {
                         ...
                         new System.Xml.Linq.XElement("FACT_CONTENEDOR", from p in objFactura.Detalle.AsEnumerable().AsParallel()
                            ...
                            if (SinServicios)
                            {
                                this.Mostrar_Mensaje(string.Format("<i class='fa fa-warning'></i><b> Informativo! No existen servicios pendientes para facturar.</br>"));
                                return;
                            }
                            ...
                            if (Finalizar != null)
                            {
                                if (Finalizar.status_id.Equals("OK"))
                                {
                                    ...
                                    new System.Xml.Linq.XElement("FACT_CABECERA",
                                                                           ...
                                                                           new System.Xml.Linq.XAttribute("IV_NUMERO_CARGA", objFactura.IV_NUMERO_CARGA == null ? "" : string.Format("{0}-{1}-{2}",objFactura.IV_NUMERO_CARGA,"0000","0000")),
