<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="facturacionbooking.aspx.cs" Inherits="CSLSite.contenedorexpo.facturacionbooking" %>
                ...
                <div >
                    <div class="form-row" >
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class ="d-flex">
                                &nbsp;
                                <label for="inputZip">INVOICE TYPE<span style="color: #FF0000; font-weight: bold;"></span></label>
                            </div>
                            <div class ="d-flex">
                                &nbsp;
        ...
        $(function () {
            $('[id*=Txtempresa]').typeahead({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("facturacionbooking.aspx/GetEmpresas") %>',
                    data: "{ 'prefix': '" + request + "'}",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
