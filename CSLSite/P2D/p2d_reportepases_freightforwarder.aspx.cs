...
namespace CSLSite
{
    public partial class p2d_reportepases_freightforwarder : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                    var TablaPase = Cls_Bil_PasePuertaCFS_Detalle.Listado_Pases_Freightforwarder(fechadesde, fechahasta, ClsUsuario.ruc, out cMensajes);
                    if (TablaPase == null)
                    {
