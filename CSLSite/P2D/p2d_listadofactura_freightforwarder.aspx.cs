...
namespace CSLSite
{
    public partial class p2d_listadofactura_freightforwarder : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaFactura = P2D_MULTI_Imprimir.Listado_Facturas(fechadesde, fechahasta, out cMensajes);
