...
namespace CSLSite
{
    ...
    public partial class p2d_imprimirpase_freightforwarder : System.Web.UI.Page
    {
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
                    var CargaSuelta = PasePuerta.Pase_WebCFS.ObtenerListaPase_MultiDespachoTransporte(this.TXTMRN.Text.Trim(), ClsUsuario.ruc);
