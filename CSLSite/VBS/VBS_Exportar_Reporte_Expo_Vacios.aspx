<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_Exportar_Reporte_Expo_Vacios.aspx.cs" Inherits="CSLSite.VBS_Exportar_Reporte_Expo_Vacios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Reporte de citas Expo. Vacíos</a></li>
    ...
    <script type="text/javascript">
        ...
        function exportar() {
           ...
           <%-- var cboTipoCarga = document.getElementById("<%= cboTipoCarga.ClientID %>");
            ...
            xhr.open('POST', 'VBS_Exportar_Reporte_Expo_Vacios.aspx/ExportarExcel', true);
