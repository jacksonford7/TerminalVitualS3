...
namespace CSLSite
{
    ...
    public partial class VBS_Exportar_Reporte_Import_Ant : System.Web.UI.Page
    {
        ...
        private void Carga_CboBloques()
        {
            try
            {
                ...
                VBS_ConsultarTipoBloques todos = new VBS_ConsultarTipoBloques()
                {
                    IdBloque = 0,
                    Codigo = "TODOS"
                };
        ...
        public static byte[] CreateExcelBytesFromStoredProcedure(string fechaDesde, string cboBloqueId)
        {
            ...
            var idTipoBloque= Convert.ToInt32(cboBloqueId);
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                var cabeceraReport = objCab.CabeceraImportReporte(fechaConvertida, idTipoBloque);// Consulta de la cabecera
                ...
                using (SqlCommand command = new SqlCommand("VBS_DETALLE_REPORTE_IMPORT", connection))
                {
                    ...
                    command.Parameters.AddWithValue("@idBloque", idTipoBloque);
                    ...
                    using (ExcelPackage excelPackage = new ExcelPackage())
                    {
                        ...
                        worksheet.Cells["G3:G3"].Value = "Total Citas Importación: Planeados";
                        ...
                        worksheet.Cells["I3:I3"].Value = "Total Citas Importación: Reservados";
                        ...
                        worksheet.Cells["K3:K3"].Value = "Total Citas Importación: Disponible";
                        ...
                        worksheet.Cells[6, 6].Value = "Bloque";
                            ...
                            if (inicio > lastHour)
                            {
                                ...
                                foreach (DataRow horaRow in sortedTable.Rows)
                                {
                                    ...
                                    if (horaInicio == inicio && horaFin == fin)
                                    {
                                        ...
                                        string tipoCarga = horaRow["CodigoBloque"].ToString();
                                        ...
                                        worksheet.Cells[6, columnIndex + 3].Value = "CodigoBloque";
                                        ...
                                        worksheet.Cells["A5:AA5"].Value = "Disponibilidad de citas Importación";
        ...
        [WebMethod]
        public static void ExportarExcelImport(string fechaDesde, string cboBloqueId)
        {
            try
            {
                byte[] excelBytes = CreateExcelBytesFromStoredProcedure(fechaDesde, cboBloqueId);
