...
namespace CSLSite
{
    public partial class VBS_Consulta_Turnos_Lineas : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (ClsUsuario != null)
                {
                    ...
                    this.TxtLinea.Text = string.Format("{0}", ClsUsuario.ruc);
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var consultaTurnosDetalle = objCab.GetListaReporteTurnosLineasPorFechas(ClsUsuario.ruc, fechadesde, fechahasta);

                    //RN_Bill_Invoice_Listado _obj = new RN_Bill_Invoice_Listado();
                    //var TablaFactura = _obj.Entidad_Listado_Facturas_Impo_Brbk(fechadesde, fechahasta, ClsUsuario.loginname, ClsUsuario.ruc, out cMensajes);
                    ...
                    if (consultaTurnosDetalle.Resultado.Count <= 0)
                    {
                    ...
                    grilla.DataSource = consultaTurnosDetalle.Resultado;
                    grilla.DataBind();
