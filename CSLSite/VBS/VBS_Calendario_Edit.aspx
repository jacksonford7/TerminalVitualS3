...
<asp:Content ID="Content1" ContentPlaceHolderID="placehead" runat="server">
    ...
    <script type="text/javascript">
            ...
            $('#calendar').fullCalendar(
            {
                ...
                dayClick: function (date, jsEvent, view)
                {
                    ...
                    if (events.length > 0) {
                        ...
                        $.ajax({
                            url: 'VBS_Calendario_Edit.aspx/ConsultarTablaExpoPorDia',
                            type: 'POST',
                        ...
                        dayClick: function (date, jsEvent, view)
                        {
                           ...
                           // $('#tbodyDetallesIMPORT').empty();//nuevo
                            ...
                            if (events.length > 0) {
                                ...
                                $.ajax({
                                    url: 'VBS_Calendario_Edit.aspx/ConsultarTablaImportPorDia',
                                    type: 'POST',
                                    data: JSON.stringify({ start: start }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
                ...
                else if (selectedValue === "4")//turnos de exportacion por lineas
                {
                    ...
                    $('#calendarlineas').fullCalendar({
                        ...
                        events: function (start, end, timezone, callback)
                        {
                            ...
                            function fetchEvents() {
                                $.ajax({
                                    url: 'VBS_Calendario_Edit.aspx/GetCalendarEventsExpoLineas',
                                    type: 'POST',
                                    data: JSON.stringify({ year: year, month: month, inicial: initialLoad, pageIndex: pageIndex, pageSize: pageSize }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
                        ...
                        dayClick: function (date, jsEvent, view)
                        {
                            ...
                            if (events.length > 0) {
                                ...
                                $.ajax({
                                    url: 'VBS_Calendario_Edit.aspx/ConsultarTablaLineasPorDia',
                                    type: 'POST',
                                    data: JSON.stringify({ start: start }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
                        ...
                        eventClick: function (calEvent, jsEvent, view)
                        {
                            ...
                            $.ajax({
                                url: 'VBS_Calendario_Edit.aspx/ConsultarEventosLineas',
                                type: 'POST',
                        ...
                        viewRender: function (view, element)
                        {
                            ...
                            if (view.name === 'agendaDay') {
                                ...
                                // Realizar la consulta específica cuando se cambie a la vista de agenda por día
                                $.ajax({
                                    url: 'VBS_Calendario_Edit.aspx/ConsultarEventosPorDiaLineas',
                                    type: 'POST',
                                    data: JSON.stringify({ start: selectedDate }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
        ...
        $(document).on("click", ".detalleVaciosBtn", function ()
        {
            ...
            $.ajax({
                url: 'VBS_Calendario_Edit.aspx/GetDetalleVacios',
                type: 'POST',
        ...
        function enviarDatosAlServidorLineas()
        {
            ...
            mostrarConfirmacion('¿Está seguro de generar las Citas para Líneas Navieras?',
                function () {
                    $('#loader').show();
                    $.ajax({
                        url: "VBS_Calendario_Edit.aspx/GuardarDatosTablaLineas",
                        type: 'POST',
                        data: JSON.stringify({
                            vigenciaInicial: vigenciaInicial,
                            vigenciaFinal: vigenciaFinal,
        ...
        function guardarCambiosTablaVacios() {
            ...
            mostrarConfirmacion("¿Deseas guardar los cambios en la tabla?", function () {
                $.ajax({
                    type: "POST",
                    url: "VBS_Calendario_Edit.aspx/GuardarDatosVacios",
                    data: JSON.stringify({ datosTabla: eventos }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        function guardarCambiosTablaLineas() {
            ...
            mostrarConfirmacion("¿Deseas guardar los cambios en la tabla?", function ()
            {
                $.ajax({
                    type: "POST",
                    url: "VBS_Calendario_Edit.aspx/GuardarDatosPorlineas",
                    data: JSON.stringify({ datosTabla: eventos }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <div class="modal-dialog modal-lg" role="document">
     ...
     <div class="modal fade" id="modaltExpoLinea" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-event-label">Creación de Citas Expo. Vacíos</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
