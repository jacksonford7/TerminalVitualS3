<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_Exportar_Reporte_Expo_Ant.aspx.cs" Inherits="CSLSite.VBS_Exportar_Reporte_Expo_Ant" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <asp:DropDownList runat="server" ID="cboTipoCarga" AutoPostBack="false" class="form-control">
                </asp:DropDownList>
    ...
    <script type="text/javascript">
        function exportar() {
            ...
            xhr.send(JSON.stringify({ fechaDesde: fechaDesde, tipoCargaId: tipoCargaId }));
        }
    </script>
