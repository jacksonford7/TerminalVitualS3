<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_Cancelacion_Turnos_Expo_Vacios.aspx.cs" Inherits="CSLSite.VBS_Cancelacion_Turnos_Expo_Vacios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Cancelacion de citas Expo. vacíos</a></li>
    ...
    <script type="text/javascript">
        function InactivarHorasExpo() {
            ...
            mostrarConfirmacion(mensaje,
                ...
                {
                    $.ajax({
                        url: "VBS_Cancelacion_Turnos_Expo_Vacios.aspx/InactivarHorasExpoVacios",
