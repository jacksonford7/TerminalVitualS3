...
namespace CSLSite
{
    ...
    public partial class VBS_Bloque_Mantenimiento : System.Web.UI.Page
    {
        ...
        public static string GetListaBloque()
        {
            VBS_CabeceraPlantilla objCab = new VBS_CabeceraPlantilla();
            var listBloque = objCab.GetListaBloque();
        ...
        [WebMethod]
        public static string CrearBloque(VBS_BLOQUE obj)
        {
            
            VBS_CabeceraPlantilla objCab = new VBS_CabeceraPlantilla();
            var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());
            obj.Estado = "A";
            var revisarSiexiste = objCab.GetBloqueValida(obj.Codigo);
            ...
            else
            {
                ...
                var crearNuevoParametro = objCab.GuardarBloque(obj);
            }
        ...
        [WebMethod]
        public static string EditBloque(VBS_BLOQUE obj)
        {
            VBS_CabeceraPlantilla objCab = new VBS_CabeceraPlantilla();
            var ClsUsuario = usuario.Deserialize(HttpContext.Current.Session["control"].ToString());

               obj.UsuarioRegistro = ClsUsuario.nombres + "-" + ClsUsuario.apellidos;
               var crearNuevoParametro = objCab.EditarBloque(obj);
