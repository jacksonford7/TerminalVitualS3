...
namespace CSLSite
{
    ...
    public partial class VBS_Exportar_Reporte_Expo_Vacios : System.Web.UI.Page
    {
        ...
        public static byte[] CreateExcelBytesFromStoredProcedure(string fechaDesde, string fechaHasta)
        {
           ...
           // var idTipoCarga = Convert.ToInt32(tipoCargaId);
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("VBS_DETALLE_REPORTE_EXPO_LINEAS", connection))
                {
