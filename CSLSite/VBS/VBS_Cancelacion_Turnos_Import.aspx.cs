...
namespace CSLSite
{
    ...
    public partial class VBS_Cancelacion_Turnos_Import : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string InactivarHorasImport(string fechaDesde, string fechaHasta,string cboBloqueId)
        {
            try
            {
                ...
                var editar = objCab.EditarHorasImport(fechaSoloDesde, horaDesde, fechaSoloHasta, horaHasta,idTipoBloque);
