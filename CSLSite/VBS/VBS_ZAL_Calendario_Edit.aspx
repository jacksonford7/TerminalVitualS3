 <%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_ZAL_Calendario_Edit.aspx.cs" Inherits="CSLSite.VBS_ZAL_Calendario_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="placehead" runat="server">
    ...
    <link href="../css/all.min.css" rel="stylesheet" /> <%--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>--%>
    ...
    <script type="text/javascript">
            ...
            $('#calendarImpo').fullCalendar({
                ...
                events: function (start, end, timezone, callback) {
                    ...
                    function fetchEvents() {
                        $.ajax({
                            url: 'VBS_ZAL_Calendario_Edit.aspx/GetCalendarEventsImport',
                            type: 'POST',
                ...
                dayClick: function (date, jsEvent, view) {
                    ...
                    if (events.length > 0) {
                        ...
                        $.ajax({
                            url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarTablaImportPorDia',
                            type: 'POST',
                    ...
                    document.getElementById('<%=txtVigenciaInicial.ClientID %>').value = start;
                        ...
                        eventClick: function (calEvent, jsEvent, view) {
                            ...
                            $.ajax({
                                url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarEventosImport',
                                type: 'POST',
                        ...
                        viewRender: function (view, element) {
                            ...
                            if (view.name === 'agendaDay') {
                                ...
                                $.ajax({
                                    url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarEventosPorDiaImport',
                                    type: 'POST',
            ...
            $('#calendar').fullCalendar(
                {
                    ...
                    events: function (start, end, timezone, callback) {
                        ...
                        $.ajax({
                            url: 'VBS_ZAL_Calendario_Edit.aspx/GetCalendarEvents',
                            type: 'POST',
                            data: JSON.stringify({ year: year, month: month, inicial: initialLoad }),
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'json',
                    ...
                    dayClick: function (date, jsEvent, view) {
                        ...
                        if (events.length > 0) {
                            ...
                            $.ajax({
                                url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarTablaExpoPorDia',
                                type: 'POST',
                                data: JSON.stringify({ start: start }),
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'json',
                                success: function (data) {
                                    ...
                                    for (var i = 0; i < jsonArray.length; i++) {
                                        ...
                                        fila.innerHTML = `
                                    <td class="center hidden-phone">${secuencia}</td>
                                    <td class="center hidden-phone">${evento.tipoCarga}</td>
                                    <td class="center hidden-phone">${evento.tipoContenedor}</td>
                                    ...
                                    <button class="btn btn-primary" onclick="eliminarDetalle(this)" disabled>QUITAR</button>
                                       ...
                                       `;
                                        ...
                                        // Agregar los datos del detalle como atributos personalizados a la fila
                                        fila.setAttribute('data-tipo-contenedor-id', evento.tipoContenedorId);
                                        fila.setAttribute('data-tipo-carga-id', evento.tipoCargaId);
                    ...
                    document.getElementById('<%=txtFechaActu.ClientID %>').readOnly = true;
                        ...
                        $.ajax({
                            url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarEventos',
                            type: 'POST',
                            data: JSON.stringify({ idDetalle: calEvent.idDetalle, start: calEvent.start.format(), end: calEvent.end.format() }),
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'json',
                    ...
                    viewRender: function (view, element) {
                        ...
                        if (view.name === 'agendaDay') {
                            ...
                            // Realizar la consulta específica cuando se cambie a la vista de agenda por día
                            $.ajax({
                                url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarEventosPorDia',
                                type: 'POST',
                                data: JSON.stringify({ start: selectedDate }),
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'json',
        ...
        window.onload = function () {
            ...
            document.getElementById("DropDownList1").addEventListener("change", function () {
                ...
                else if (selectedValue === "4")//turnos de exportacion por lineas
                {
                    $('#calendarlineas').show();
                    ...
                    $('#calendarlineas').fullCalendar({
                        ...
                        events: function (start, end, timezone, callback) {
                            ...
                            function fetchEvents() {
                                $.ajax({
                                    url: 'VBS_ZAL_Calendario_Edit.aspx/GetCalendarEventsExpoLineas',
                                    type: 'POST',
                                    data: JSON.stringify({ year: year, month: month, inicial: initialLoad, pageIndex: pageIndex, pageSize: pageSize }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
                        ...
                        dayClick: function (date, jsEvent, view) {
                            ...
                            if (events.length > 0) {
                                ...
                                $.ajax({
                                    url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarTablaLineasPorDia',
                                    type: 'POST',
                                    data: JSON.stringify({ start: start }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
                                    success: function (data) {
                                        ...
                                        for (var i = 0; i < jsonArray.length; i++) {
                                            ...
                                            fila.innerHTML = `
                                    <td class="center hidden-phone">${secuencia}</td>
                                    <td class="center hidden-phone">${evento.descLinea}</td>
                                    <td class="center hidden-phone">${evento.cantidad}</td>
                                    <td class="center hidden-phone">
                                    <button class="btn btn-primary" onclick="eliminarDetalle(this)" disabled>QUITAR</button>
                                    </td>
                                       `;
                                            // Agregar los datos del detalle como atributos personalizados a la fila
                                            fila.setAttribute('data-tipo-linea-id', evento.IdLinea);
                        ...
                        eventClick: function (calEvent, jsEvent, view) {
                            ...
                            $.ajax({
                                url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarEventosLineas',
                                type: 'POST',
                                data: JSON.stringify({ IdLinea: calEvent.IdLinea, start: calEvent.start.format(), end: calEvent.end.format() }),
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'json',
                                success: function (data) {
                                    var eventos = JSON.parse(data.d);
                        ...
                        viewRender: function (view, element) {
                            ...
                            if (view.name === 'agendaDay') {
                                ...
                                // Realizar la consulta específica cuando se cambie a la vista de agenda por día
                                $.ajax({
                                    url: 'VBS_ZAL_Calendario_Edit.aspx/ConsultarEventosPorDiaLineas',
                                    type: 'POST',
                                    data: JSON.stringify({ start: selectedDate }),
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'json',
                ...
                else if (selectedValue === "3")//turnos de consolidacióm/Acopio
                {
                    $('#calendarBanano').show();
                    $('#calendarBanano').fullCalendar('refetchEvents');
                    $('#calendar').hide();
                    $('#calendarlineas').hide();
                    $('#calendarImpo').hide();
        ...
        $(document).on("click", ".detalleVaciosBtn", function ()
        {
            // Guarda los datos del modal "modalActu" en variables temporales aquí
            // ...
            var clickedRow = $(this).closest("tr");
            var idTurno = clickedRow[0].dataset.idturno;
      
            // Find the "HORARIO" cell in the row and get its text
            var horarioValue = clickedRow.find(".center.hidden-phone:eq(1)").text();
            // Cierra el modal "modalActu" si está abierto
            $('#modalActu').modal('hide');

            $.ajax({
                url: 'VBS_ZAL_Calendario_Edit.aspx/GetDetalleVacios',
                type: 'POST',
                data: JSON.stringify({ idTurno: idTurno }),
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (data) {
                  
                    // Agregar los nuevos eventos al FullCalendar
                    $('#modalVacios').modal('show');
                    document.getElementById('<%=txtVaciosHora.ClientID %>').value = horarioValue;
                    document.getElementById('<%=txtVaciosTipoCarga.ClientID %>').value = tipoCargaVacios;

                    var jsonArray = JSON.parse(data.d);
                    var cuerpoTablaVacios = $("#cuerpoTablaVacios");

                    // Limpiar el contenido previo de la tabla
                    cuerpoTablaVacios.empty();

                    $.each(jsonArray, function (index, detalle) {
                        var fila = $("<tr>");
                        fila.attr("data-idTurno", detalle.IdDetalle);
                        fila.append($("<td>").text(detalle.Descripcion));

                        var cantidadInput = $(`<input type="text" class="form-control cantidad-editable" value="${detalle.Cantidad}">`);

                        // Agregar el valor "Asignado" como atributo data
                        cantidadInput.attr("data-asignado", detalle.Asignados);

                        fila.append($("<td>").append(cantidadInput));
                        fila.append($("<td>").text(detalle.Asignados));
                        cuerpoTablaVacios.append(fila);
            ...
            // Abre el modal de "Detalle Vacios"
        ...
        function enviarDatosAlServidor()
        {
            ...
            mostrarConfirmacion('¿Está seguro de generar las Citas?',
                function () {
                    $('#loader').show();
                    $.ajax({
                        url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatosTabla1",
                        type: 'POST',
                        data: JSON.stringify({
        ...
        function enviarDatosAlServidorImpor() {
            ...
            mostrarConfirmacion('¿Está seguro de generar los Citas?',
                function () {
                    $('#loader').show();
                    $.ajax({
                        url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatosTablaImport",
                        type: 'POST',
                        data: JSON.stringify({
                            vigenciaInicial: vigenciaInicial,
                            vigenciaFinal: vigenciaFinal,
        ...
        function enviarDatosAlServidorLineas()
        {
            ...
            mostrarConfirmacion('¿Está seguro de generar las Citas para Líneas Navieras?',
                function () {
                    $('#loader').show();
                    $.ajax({
                        url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatosTablaLineas",
                        type: 'POST',
                        data: JSON.stringify({
                            vigenciaInicial: vigenciaInicial,
                            vigenciaFinal: vigenciaFinal,
        ...
        function LlenarTablaExpoLineas(eventos)
        {
            ...
            $.each(eventos, function (index, evento)
            {
                ...
                document.getElementById('<%=TxtLineaDefault.ClientID %>').value = evento.descLinea;
        ...
        function guardarCambiosTabla() {
            ...
            mostrarConfirmacion("¿Deseas guardar los cambios en la tabla?", function () {
                $.ajax({
                    type: "POST",
                    url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatos",
        ...
        function guardarCambiosTablaImport() {
            ...
            mostrarConfirmacion("¿Deseas guardar los cambios en la tabla?", function () {
                $.ajax({
                    type: "POST",
                    url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatosImport",
                    data: JSON.stringify({ datosTabla: eventos }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        function guardarCambiosTablaVacios() {
            ...
            mostrarConfirmacion("¿Deseas guardar los cambios en la tabla?", function () {
                $.ajax({
                    type: "POST",
                    url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatosVacios",
                    data: JSON.stringify({ datosTabla: eventos }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        function guardarCambiosTablaLineas() {
            ...
            mostrarConfirmacion("¿Deseas guardar los cambios en la tabla?", function ()
            {
                $.ajax({
                    type: "POST",
                    url: "VBS_ZAL_Calendario_Edit.aspx/GuardarDatosPorlineas",
                    data: JSON.stringify({ datosTabla: eventos }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        function cboTipoCargaChanged() {
            ...
            xhr.open("GET", "VBS_ZAL_Calendario_Edit.aspx?tipoCargaId=" + tipoCargaId, true);
        ...
        function buscarBooking()
        {
            ...
            $.ajax({
                url: "VBS_ZAL_Calendario_Edit.aspx/ConsultarBookingCalendario",
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
        ...
        <div class="mt-4">
            <nav class="mt-4" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li style="text-align:center; width:250px" class="breadcrumb-item active" aria-current="page" id="LiDropDownList1" runat="server">
                        ...
                        <asp:DropDownList  runat="server" ID="DropDownList1" AutoPostBack="false" class="form-control" ClientIDMode="Static">
                            ...
                            <asp:ListItem Text="Exportación" Value="2"></asp:ListItem>
                            <%--<asp:ListItem Text="-- Seleccione --" Value="8"></asp:ListItem>--%>
                            <%--<asp:ListItem Text="Expo. Vacíos" Value="4"></asp:ListItem>
                            <asp:ListItem Text="Consolidación/Acopio" Value="3"></asp:ListItem>
                            <asp:ListItem Text="Consolidación CFS" Value="5"></asp:ListItem>
                            <asp:ListItem Text="Carga Exportación BRBK" Value="6"></asp:ListItem>--%>
                        </asp:DropDownList>
                    </li>
                </ol>
            </nav>
    ...
    <!-- Modal para mostrar Actualizar turnos -->
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-Actu-label">Actualización de Citas creadas Expo.</h5>
        ...
        <div class="modal fade" id="modalVacios" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-xs" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-event-label2">Detalle Vacios</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                            <div class="form-row">
                                    ...
                                    <label for="inputZip">Tipo de Cargas</label>
                                    <asp:TextBox ID="txtVaciosTipoCarga" runat="server" class="form-control" MaxLength="2" onkeypress="return soloLetras(event,'0123456789')" Style="text-align: left"
                                        placeholder="" ReadOnly="true" >
                                    </asp:TextBox>
                                </div>
                                    <div class="form-group col-md-3">
                                                                    <label for="inputZip">Horario</label>
                                    <asp:TextBox ID="txtVaciosHora" runat="server" class="form-control" MaxLength="2" onkeypress="return soloLetras(event,'0123456789')" Style="text-align: left"
                                        placeholder="" ReadOnly="true" >
                                    </asp:TextBox>
                                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody id="cuerpoTablaVacios">
                      
                            </tbody>
                        </table>
                
                        <!-- Botón de actualización (sin lógica por ahora) -->
                        <button  id="btnModalVaciosActu" class="btn btn-primary" type="button">Actualizar</button>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" >Cerrar</button>
                    </div>
        ...
        <div class="modal fade" id="modalActuImport" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-Actu-label-Import">Actualización de Citas creadas Impo.</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="modalActuExpoLineas" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-Actu-label">Actualización de Citas creadas Expo. Vacíos.</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
      ...
      <!-- expo-->
        <div class="modal fade" id="modalt" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-event-label">Creación de Citas Expo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="modaltImport" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-event-label-Import">Creación de Citas Impo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="modaltExpoLinea" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-event-label1">Creación de Citas Expo. Vacíos</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="inputZip">LÍNEAS NAVIERAS</label>
                            ...
                            <div class="form-group col-md-12">
                                <table id="tablaDetallesLineas" class="table table-bordered invoice">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="center hidden-phone">#</th>
                                            <th class="center hidden-phone">LÍNEAS NAVIERAS</th>
                                            <th class="center hidden-phone">CAPACIDAD</th>
                                            <th class="center hidden-phone">QUITAR</th>
                                        </tr>
                                    </thead>
        ...
        <div class="modal fade" id="modalConsolidacionAcopio" tabindex="-1" role="dialog" aria-labelledby="modal-event-label" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-event-labelCA">Creación de Citas Consolidación/Acopio.</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="inputZip">FECHA DESDE</label>
                                <asp:TextBox ID="txtCAFechaDesde" runat="server" class="form-control" MaxLength="2" onkeypress="return soloLetras(event,'0123456789')" Style="text-align: left" placeholder=""></asp:TextBox>
                            </div> 
                            <div class="form-group col-md-6">
                                <label for="inputZip">FECHA HASTA</label>
                                <asp:TextBox ID="txtCAFechaHasta" runat="server" class="form-control" MaxLength="2" onkeypress="return soloLetras(event,'0123456789')" Style="text-align: left" placeholder=""></asp:TextBox>
                            </div>
                        
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="inputZip">BODEGAS</label>
                                <asp:DropDownList runat="server" ID="cmbCAbodegas" AutoPostBack="false" class="form-control"  ClientIDMode="Static"></asp:DropDownList>
                            </div>
                       
                            <div class="form-group col-md-4">
                                <label for="inputZip">CAPACIDAD</label>
                                <asp:TextBox ID="txtCACapacidad" runat="server" class="form-control" MaxLength="2"  onkeypress="return soloLetras(event,'1234567890')"  Style="text-align: left" placeholder=""></asp:TextBox>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputZip">&nbsp;</label>
                                <div class="d-flex">
                                    <button class="btn btn-primary" onclick="agregarDetalleXLineas()" type="button">AGREGAR</button>
                                    &nbsp;&nbsp;
                                    <img alt="loading.." src="../lib/file-uploader/img/loading.gif" height="32px" width="32px" id="ImgCargaCABodegas" class="nover" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <table id="tablaDetallesBodegaCA" class="table table-bordered invoice">
                                    <!-- Cabecera de la tabla -->
                                    <thead>
                                        <tr>
                                            <th class="center hidden-phone">#</th>
                                    ...
                                    <!-- Cuerpo de la tabla -->
                                    <tbody id="tbodyDetallesBodegasCA">
                                    </tbody>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                            ...
                            <asp:TextBox type="hidden"  ID="TextBox5" runat="server" class="form-control" MaxLength="2" onkeypress="return soloLetras(event,'0123456789')" Style="text-align: left" placeholder=""></asp:TextBox>
