...
namespace CSLSite
{
    ...
    public partial class VBS_Duplicar_Turnos_Import : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string DuplicarHorasImport(string fechaDesde, string fechaHasta,string cboBloqueId )
        {
            try
            {
                ...
                var editar = objCab.DuplicarHorasImport(fechaSoloDesde, horaDesde, fechaSoloHasta, horaHasta,idTipoBloque, pUsuario);
