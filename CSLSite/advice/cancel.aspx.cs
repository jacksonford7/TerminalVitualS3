...
namespace CSLSite
{
    public partial class cancel : System.Web.UI.Page
    {
        ...
        protected string getOklist(List<unidadAdvice> listado, ref List<unidadAdvice> listaok)
        {
            ...
            t.Append("<p>A cancelar</p><table id=\"tablasort\" cellpadding=\"1\" cellspacing=\"0\"  class=\"table table-bordered table-sm table-contecon\"   ><thead><tr><th>Container</th></tr></thead><tbody>");
        ...
        protected string getBadlist(List<unidadAdvice> listado)
        {
            var t = new StringBuilder();
            var i = 0;
            t.Append("<p>No Cancelable</p><table id=\"tablasort1\" cellpadding=\"1\" cellspacing=\"0\" class=\"table table-bordered table-sm table-contecon\" ><thead><tr><th>Container</th><th>Error</th></tr></thead><tbody>");
            foreach (var item in listado)
            {
                if (item.status == "1")
                {
            ...
            if (Response.IsClientConnected)
            {
                ...
                try
                {
                   ...
                   str = Regex.Replace(str, @"'|!|<|>|-|_|""|#|", string.Empty);
                    ...
                    sinresultado.InnerHtml = string.Format("<span><strong>Contenedores para cancelar su previso:</strong> [{0}]</span>/<span><strong>Contenedores con errores:</strong> [{1}]</span>/<span><strong>Total de contenedores en archivo:</strong> [{2}]</span>", ok, xresultado.Count - ok, xresultado.Count);
