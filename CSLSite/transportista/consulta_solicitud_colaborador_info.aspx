<%@ Page  Language="C#" AutoEventWireup="true" Title="Registra Huella y Foto/Creaciòn de Permiso"
         CodeBehind="consulta_solicitud_colaborador_info.aspx.cs" Inherits="CSLSite.consulta_solicitud_colaborador_info" %>
  ...
  <div class="seccion">
     ...
     <div class="colapser colapsa"></div>
      ...
      <asp:Repeater id="rpDetalle" runat="server">
                 <HeaderTemplate>
                 <table id="tabla" cellspacing="1" cellpadding="1" class="tabRepeat" style=" width:2000px">
                 <thead>
                 <tr>
                 <th>Tipo</th>
                 <th>Estado Actual</th>
                 ...
                 <ItemTemplate>
                 <tr class="point" >
                 <td style=" width:50px"><asp:Label runat="server" ID="lblTipo" Text='<%#Eval("TIPO")%>'></asp:Label></td>
