...
namespace CSLSite
{
    public partial class consulta_solicitud_colaborador_existente : System.Web.UI.Page
    {
        ...
        private void RegistraColaboradoresOnlyControl(string tipocredencial, out bool validacolaboradores)
        {
            ...
            dtAprobados = dtAprobados = dtAprobados.Select("CREA_PERMISO IN (0,1)").CopyToDataTable(); //dtAprobados.Select("CREA_PERMISO = 1").Count() == 0 ? new DataTable() : dtAprobados.Select("CREA_PERMISO = 1").CopyToDataTable();
