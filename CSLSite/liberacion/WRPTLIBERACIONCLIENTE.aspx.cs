...
{
    public partial class WRPTLIBERACIONCLIENTE : System.Web.UI.Page
    {
        ...
        private DataTable p_drCliente
        {
            get
            {
                return (DataTable)Session["drClienteLibRpt"];
            }
            set
            {
                Session["drClienteLibRpt"] = value;
            }
        ...
        private DataTable p_result
        {
            get
            {
                return (DataTable)Session["dvResultllibrpt"];
            }
            set
            {
                Session["dvResultllibrpt"] = value;
            }
        ...
        {
            //this.Master.Titulo = "Reporte Liberación de  CLIENTE";
            //this.Master.FavName = "Reporte Liberación CLIENTE";
            if (IsPostBack != true)
            {
        ...
        public void LoadReport(){
              String Reporte="RptLibCliente.rdlc";
              ReportDataSource wdatasourc ;
              ReportParameter wrparameter= new ReportParameter();

              Reporte = this.Server.MapPath(@"..\liberacion\" + Reporte);
              ...
              {
                  wdatasourc = new ReportDataSource("dsLibReporte", p_result);
        ...
        ReportParameter wrparameter = new ReportParameter();
        String wuser = Session["puser"].ToString(); 
       if ( System.IO.File.Exists(Reporte) != true){
        ...
        public static string[] GetClienteList(String prefixText, int count)
        {
            ...
            DTRESULT = (DataTable)HttpContext.Current.Session["drClienteLibRpt"];
