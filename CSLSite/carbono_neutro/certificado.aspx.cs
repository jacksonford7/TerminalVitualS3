...
namespace CSLSite.carbono_neutro
{
    public partial class certificado_carbono : System.Web.UI.Page
    {
        string sid;
        string lg;
            ...
            if (Response.IsClientConnected)
            {
...

                {
                    ...
                    try
                    {
                        ...
                        this.aisv_producto.InnerText = (fila.Isaisv_productoNull() || string.IsNullOrEmpty(fila.aisv_producto) )? "No declarado" : fila.aisv_producto;
