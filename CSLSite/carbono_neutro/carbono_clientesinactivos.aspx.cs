...
namespace CSLSite
{
    public partial class carbono_clientesinactivos : System.Web.UI.Page
    {
        ...
        private void Carga_Paquetes_Clientes()
        {
            try
            {
                ...
                List<Cls_ImpoContenedor> Listado = Cls_ImpoContenedor.Listado_Paquetes_Clientes_Inactivos(pdesde, phasta, criterio,out OError);
                if (Listado != null)
                {
        ...
        {
            Session["usuarioId"] = null;
            Response.Redirect("../carbono_neutro/inactivar_carbono.aspx");
        }
