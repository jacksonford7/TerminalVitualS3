<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="brbk_mantenimiento_turnos.aspx.cs" Inherits="CSLSite.brbk_mantenimiento_turnos" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">MANTENIMIENTO DE TURNOS APROBADOS</li>
          </ol>
        </nav>
      </div>
      ...
      <ContentTemplate>
        ...
        <div class="form-row">
              <div class="form-group col-md-2"> 
                    <label for="inputEmail4">FECHA:<span style="color: #FF0000; font-weight: bold;">*</span></label>
                     <div class="d-flex">
                          <asp:TextBox ID="TxtFechaDesde" runat="server"  class="datepicker form-control"  MaxLength="10"  placeholder="dd/MM/yyyy"  onkeypress="return soloLetras(event,'1234567890/')"></asp:TextBox>
                     </div> 
              </div> 
             <div class="form-group col-md-2">
          ...
          <div class="form-group col-md-2">
                ...
                <div class="d-flex">
               <asp:Button ID="BtnBuscar" runat="server" class="btn btn-primary"  Text="BUSCAR TURNOS"  OnClientClick="return mostrarloader('1')" OnClick="BtnBuscar_Click" />  
                   &nbsp;&nbsp;
       ...
       <div class="form-row">
         ...
         <div class="form-group col-md-2">   
                   <label for="inputZip">COMENTARIO<span style="color: #FF0000; font-weight: bold;"></span></label>
        ...
        <div class="form-group col-md-2">
                <label for="inputZip"> &nbsp;</label>
             <div class="d-flex">
                 <asp:Button ID="BtnActualizar" runat="server"  class="btn btn-primary"  Text="ACTUALIZAR CAPACIDAD"     OnClick="BtnActualizar_Click" />      
            </div>
        </div> 
                ...
                <div class="col-md-12 d-flex justify-content-center">
                   <asp:Button ID="BtnNuevo" runat="server"  class="btn btn-primary"  Text="NUEVA CONSULTA"  OnClick="BtnNuevo_Click" />      
                    ...
                    <asp:Button ID="BtnExcel" runat="server"  class="btn btn-primary"  Text="EXPORTAR EXCEL"  OnClick="BtnExcel_Click" />      
                        &nbsp;&nbsp; &nbsp;      
                    <asp:Button ID="BtnGrabar" runat="server"  class="btn btn-primary"  Text="ACTUALIZAR TURNOS"   OnClientClick="return confirmacion()"  OnClick="BtnGrabar_Click" />      
              </div>
        </div>
     </ContentTemplate>
        <Triggers>
            ...
            <ContentTemplate>
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="hidden-table-info">
                          ...
                          <tr >
                            ...
                            <th class="center hidden-phone">UTILIZADOS</th>
                            <th class="center hidden-phone">DISPONIBLE</th>
                            <th class="center hidden-phone">+/-</th>
                            <th class="center hidden-phone">NUEVA CAPACIDAD</th>
                        ...
                        <ItemTemplate>
                            <tr >
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("SECUENCIA")%>' ID="SECUENCIA" runat="server"  style="align-content:center"/>
                                    <asp:Label Text='<%#Eval("IDX_ROW")%>' ID="IDX_ROW" runat="server"  style="align-content:center" Visible="false"   /></td>
                               ...
                               <td class="center hidden-phone"><asp:Label Text='<%#Eval("PASES")%>' ID="PASES" runat="server"  style="text-align:center"  /></td> 
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("CAPACIDAD")%>' ID="CAPACIDAD" runat="server"  style="text-align:center"  /></td> 
                               
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("USADOS")%>' ID="USADOS" runat="server"  style="text-align:center"  /></td> 
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("SALDO")%>' ID="SALDO" runat="server"  style="text-align:center"  /></td> 
                                <td class="center hidden-phone">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="true">
                                     <ContentTemplate>
                                       <asp:TextBox ID="TxtNewCantidad"   OnTextChanged="TxtNewCantidad_TextChanged" style="text-align:center" Width="100px" 
                                           onkeypress="return soloLetras(event,'1234567890-')" AutoPostBack="true"  class="form-control" Text='<%#Eval("NUEVA_CAPACIDAD")%>'  MaxLength="2" runat="server"></asp:TextBox>
                                         <asp:Label Text='<%#Eval("MENSAJE")%>' ID="MENSAJE" runat="server"  style="text-align:center" ForeColor="Red"  />
                                          </ContentTemplate>
                                        <Triggers>
                               ...
                               <td class="center hidden-phone"><asp:Label Text='<%#Eval("SALDO_CAPACIDAD")%>' ID="SALDO_CAPACIDAD" runat="server"  style="text-align:center"  /></td> 
                                <td class="nover"><asp:Label Text='<%#Eval("FINSEMANA")%>' ID="FINSEMANA" runat="server"   /></td> 
                            
                               
                                 <td class="center hidden-phone"> 
                                     <asp:UpdatePanel ID="UPCHKMARCAR" runat="server" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                      <label class="checkbox-container">   
                                     <asp:CheckBox ID="CHKMARCAR"  runat="server" Checked='<%# Bind("CHECK") %>'  OnCheckedChanged="CHKMARCAR_CheckedChanged"  AutoPostBack="True"  />
                                      <span class="checkmark"></span> 
                                   </label>
                                    </ContentTemplate>
                                            <Triggers>
...
<script type="text/javascript">
    ...
    {
        var mensaje;
        var opcion = confirm("Estimado usuario, está seguro que desea actualizar la capacidad de los Turnos seleccionados. ?");
        if (opcion == true)
        {
            loader();
            return true;
