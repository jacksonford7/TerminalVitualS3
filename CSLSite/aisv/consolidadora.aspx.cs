...
namespace CSLSite
{
    public partial class consolidadora : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                csl_log.log_csl.save_log<ApplicationException>(new ApplicationException("No autenticado"), "consolidadora", "Page_Init", "No autenticado", "No disponible");
            ...
            this.ruc_dae.Value = string.IsNullOrEmpty(user.ruc) ? user.codigoempresa : user.ruc;
        ...
        public static string ValidateJSON(jAisvContainer objeto)
        {
            try
            {
                ...
                {
                    csl_log.log_csl.save_log<ApplicationException>(new ApplicationException("No autenticado"), "consolidadora", "ValidateJSON", "No autenticado", "No disponible");
                ...
                if (token == null || !csl_log.log_csl.validateToken(token.Value))
                {
                    ...
                    csl_log.log_csl.save_log<ApplicationException>(new ApplicationException("Token expirado"), "container", "ValidateJSON", "Sin Token", "No tokenID");
                ...
                user.clase = "consolidadora"; user.metodo = "ValidateJSON";
                user.transaccion = "AISV Multiple"; user.usuario = sUser.loginname;
                ...
                if (!jmsg.resultado)
                {
                    ...
                    {
                        jmsg.fluir = true;
                        jmsg.data = "window.open('../portal/proforma.aspx','Proformas','width=1000,height=800,scrollbars=yes');";
                ...
                if (!objeto.add(out mensaje))
                {
                    ...
                    {
                        csl_log.log_csl.save_log<Exception>(ex, "consolidadora", "cancelAdvice", objeto.secuencia, "sistema");
                    }
                    return Newtonsoft.Json.JsonConvert.SerializeObject(jmsg);
                }
