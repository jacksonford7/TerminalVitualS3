...
<div id="hoja" class="agua-cgsa">
     ...
     <div class="seccion">
     <div class="accion">
 <div class="membrete" style="margin-bottom: 10px;">
    <table cellpadding="0" cellspacing="0">
        <tr>
            <td class="bt-top" rowspan="4"><span id="servicio">Servicio #</span></td>
            ...
            <td class="bt-top bt-right"><span runat="server" id="full" class="equis">(&nbsp;&nbsp;&nbsp;)</span></td>
        </tr>
        <tr>
            <td class="fondo bt-top">Carga suelta</td>
            <td class="bt-right"><span runat="server" id="csuelta" class="equis">( &nbsp;&nbsp;&nbsp;)</span></td>
        </tr>
        <tr>
            <td class="fondo bt-top">Carga a consolidar</td>
            <td class="bt-right"><span runat="server" id="consolidado" class="equis">( &nbsp;&nbsp;&nbsp;)</span></td>
        </tr>
        <tr>
            <td class="fondo bt-top">Contenedor lleno (Multiple)</td>
            <td class="bt-right"><span runat="server" id="multiple" class="equis">( &nbsp;&nbsp;&nbsp;)</span></td>
        </tr>
    </table>
</div>
<div class="accion">
    <table class="xcontroles" cellspacing="0" cellpadding="0" style="margin-top: -10px; border-top: 1px solid #ccc;">
        <tr>
            <td class="bt-bottom bt-right bt-left">Fecha LLEGADA:</td>
            <td class="bt-bottom">
                <span id="FechLlegaTurno" runat="server" class="labelprint">07/06/2023</span>
            </td>
           
            <td class="bt-bottom bt-right bt-left">Usted puede ingresar a la terminal desde las:</td>
            <td class="bt-bottom">
                <span id="horaLlegadAntes" runat="server" class="labelprint">09:15 AM</span>
            </td>
             <td class="bt-bottom bt-right bt-left">Su hora máxima de llegada es:</td>
            <td class="bt-bottom">
                <span id="horaLlegadaDespues" runat="server" class="labelprint">10:45 AM</span>
            </td>
        </tr>
    </table>
</div>
     ...
     <div class="accion">
        ...
        <tr><th colspan="3" class="bt-bottom bt-right  bt-left" > DATOS DEL CONTENEDOR / CARGAS</th></tr> 
         ...
         <td rowspan="9" style="background-color:transparent!important; border-left-color:transparent!important";>
         ...
         <td class="bt-bottom">
            <span id="tecacert" runat="server"  class="labelprint">certificado teca</span>
             ...
             <td class="bt-bottom bt-right validacion ">
              ...
              <tr>
              <td class="bt-bottom bt-right">Tipo de Carga</td>
             <td class="bt-bottom bt-right validacion ">
              <span id="tipocarga" runat="server"  class="labelprint"></span>
             </td>
            </tr>
              <tr>
              <td class="bt-bottom bt-right">Número de BL</td>
             <td class="bt-bottom bt-right validacion ">
              <span id="numero_bl" runat="server"  class="labelprint"></span>
             </td>
            </tr>
         <tr>
