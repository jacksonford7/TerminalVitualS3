...
<asp:Content ID="Content1" ContentPlaceHolderID="placehead" runat="server">
   ...
   <script type="text/javascript">
       var modalOpen = false; // Variable para controlar si el modal ya está abierto
       var calendar = null; // Variable global para almacenar la instancia del calendario
       function openModal() {
           var fecha = document.getElementById("fechllegadaCalenda").value;
           var dateParts = fecha.split('/');
           var formattedDate = dateParts[2] + '-' + dateParts[1] + '-' + dateParts[0];

           var linea = document.getElementById("lineaCI").value;
           var numbook = document.getElementById("numbook").textContent;
           var dateParts = fecha.split('/');
           ...
           if (fecha == '') {
               mostrarAdvertencia("No ha elegido una fecha de llegada");
           } else if (linea == '' || numbook == '...') {
               mostrarAdvertencia("Debe seleccionar Datos del booking");
           } else if (selectedDate < currentDate) {
               mostrarAdvertencia("No puede elegir una fecha anterior a la actual");
           } else {
               var Iso = document.getElementById("tipo").innerText;
               var firstLoad = true;
               ...
               $('#calendar').fullCalendar({
                   ...
                   events: function (start, end, timezone, callback) {
                       ...
                       $.ajax({
                           url: 'container.aspx/ConsultarEventosPorDiaAISV',
                           type: 'POST',
                           data: JSON.stringify({ start: formattedDate, ISO: Iso }),
                           ...
                           success: function (data)
                           {
                               ...
                               if (jsonArray !== null)
                               {
                                   for (var i = 0; i < jsonArray.length; i++)
                                   {
                                       ...
                                       var startDateTime = moment(formattedDate + ' ' + evento.horario, 'YYYY-MM-DD HH:mm:ss');
                               ...
                               else 
                               {
                                   ...
                                   mostrarConfirmacion('No tenemos Citas Disponibles para la fecha seleccionada, ¿Desea buscar nuevos datos?', function ()
                                   {
                                       $.ajax({
                                           url: 'container.aspx/ConsultarEventosPorDiaAISV',
                                           type: 'POST',
                                           data: JSON.stringify({ start: formattedDate, ISO: 'TODOS' }),
                                           contentType: 'application/json; charset=utf-8',
                                           dataType: 'json',
                                           success: function (data)
                                           {
                   ...
                   eventClick: function (calEvent, jsEvent, view) {
                       ...
                       if (turnoDisponible == 0) {
                           ...
                           mostrarConfirmacion('¿Está de acuerdo con seleccionar la hora ' + horaSeleccionada + '?', function () {
                               $('#horallegad').val(horaSeleccionada);
       ...
       function validacionDate(input, showWarning, valfecfum) {
           ...
           var selectedDate = new Date(dateParts[2], dateParts[1] - 1, dateParts[0]);
           document.getElementById("horallegad").value = "";
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        <div class="form-row">
            <div class="form-group col-md-12">
                <div class="alert alert-warning">
                    ...
                    <br />
                    Para este tipo de AISV, en el campo “Documento de Aduana”, 
        ...
        <div class="show" id="colbook">
            <div class="alert alert-info">Confirme que los datos sean correctos. En caso de error, favor comuníquese con el Departamento de Planificación a los teléfonos: +593 (04) 6006300, 3901700 (Con el Dpto. De Operaciones opción # 4, o con el Dpto. De Servicio Al Cliente opción # 1).</div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <asp:TextBox ID="consignee" runat="server" class="form-control"
                        onblur="cadenareqerida(this,8,250,'valconsig');"></asp:TextBox>
                    <span class="validacion" id="valconsig"></span>
                </div>

                 <div class="form-group col-md-6">
                    <label for="inputEmail4">21.1 Tipo de Carga  <span style="color: #FF0000; font-weight: bold;"><span style="color: #FF0000; font-weight: bold;">*</span></span></label>
                    <div class="d-flex">
                        <asp:DropDownList ID="CboTipoCarga" runat="server" class="form-control" >
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <asp:TextBox ID="txtcontenedor" runat="server" MaxLength="11" class="form-control"
                        ...
                        onBlur="checkDC(this,'valcont',true);"></asp:TextBox>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <asp:TextBox ID="txtpay" runat="server" class="form-control"
                        ...
                        onBlur="valrange(this,1,31,'valpayload',true);"
                        onkeypress="return soloLetras(event,'1234567890.')">00.00</asp:TextBox>
                    <span id="valpayload"
                ...
                <div class="form-group col-md-6">
                    ...
                    <asp:TextBox ID="txtpeso" runat="server" class="form-control"
                        ...
                        onBlur="valrange(this, 1, txtpay.value, 'valpes',true);">00.00</asp:TextBox>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="d-flex">
                        <input type="text"
                            ...
                            onkeypress="return soloLetras(event,'1234567890/:')"
                            onblur="valDate(this,true,fechax);" /><span id="fechax" class="validacion"></span>
        ...
        <div class="form-row" id="myDiv" runat="server">
            <div class="form-group col-md-6">
                <label for="inputAddress">28.1 Fecha de cita <span style="color: #FF0000; font-weight: bold;">*</span></label>
                <div class="d-flex">

                    <input  type="text"  id="fechllegadaCalenda" maxlength="10" class="datetimepickerAlt form-control"
                        onkeypress="return soloLetras(event,'1234567890/',true)" 
                        onblur="validacionDate(this,true,valfecfum);"
                        data-toggle="tooltip" data-placement="top" title="Fecha de llegada." />

                    <a class="btn btn-outline-primary mr-4" target="popup" onclick="openModal()" >
                        <span class='fa fa-search' style='font-size: 24px'></span></a>
            ...
            <div class="form-group col-md-6">
                <label for="inputEmail4">28.2 Hora de Cita<span style="color: #FF0000; font-weight: bold;">*</span></label>
                <div class="d-flex">
                    <asp:TextBox ID="horallegad" runat="server" MaxLength="10" class="form-control"
                        disabled="disabled"
            ...
            <div class="form-group col-md-12" style="display: none;">
                <div class="d-flex">
                    <asp:TextBox ID="txtIdTurno" runat="server" MaxLength="10" class="form-control"
                        ClientIDMode="Static"></asp:TextBox>
                </div>
            </div>
        </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txttemp" runat="server" MaxLength="5" class="form-control"
                            ...
                            disabled
                            data-toggle="tooltip" data-placement="top" title=" Asegúrese que esta temperatura coincida con la carta de temperatura.">0.0</asp:TextBox>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="tseal1" runat="server" class="form-control"
                            ...
                            MaxLength="14" onpaste="return true;"
                            onblur="cadenareqerida(this,1,20,'valsel1');"></asp:TextBox>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="tseal2" runat="server" class="form-control" ClientIDMode="Static" disabled
                            onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890',true)"
                            MaxLength="14" onpaste="return true;"></asp:TextBox>
                ...
                <div class="form-group col-md-8">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="tsresponsable" runat="server" class="form-control"
                            ...
                            data-toggle="tooltip" data-placement="top" title="Nombres y apellidos de la persona que estuvo a cargo del llenado y posterior cierre de la unidad, incluyendo la colocación de sellos."></asp:TextBox>
        ...
        <div class="form-title barra_colapser barra_cerrar" data-toggle="collapse" data-target="#coldim" aria-controls="coldim" role="button" aria-expanded="true">
            Detalle del exceso de dimensiones del contenedor
        </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txtexfro" runat="server" MaxLength="4" class="form-control xact" disabled
                            onkeypress="return soloLetras(event,'1234567890')"
                            onBlur="valrange(this,0,0,'xfro',true);">0</asp:TextBox>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txtexatra" runat="server" MaxLength="4" class="form-control xact" disabled
                            onkeypress="return soloLetras(event,'1234567890')"
                            onBlur="valrange(this,0,0,'xatr',true);">0</asp:TextBox>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txtexenc" runat="server" MaxLength="4" class="form-control xact" disabled
                            onkeypress="return soloLetras(event,'1234567890')"
                            onBlur="valrange(this,0,0,'xsup',true);">0</asp:TextBox>
        ...
        <div class="show" id="coltax">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txtSalida" runat="server" MaxLength="16" CssClass="datetimepicker form-control"
                            onkeypress="return soloLetras(event,'1234567890/:')"
                            onBlur="valDate(this,  true,valdatem);"></asp:TextBox>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txthoras" runat="server" MaxLength="3" class="form-control"
                            onkeypress="return soloLetras(event,'1234567890',true)"
                            onBlur="valrange(this,1,2000,'valestima',true);"></asp:TextBox>
            ...
            <div class="form-row">
                 <div class="form-group col-md-9">
                        ...
                        <div class="d-flex">
                            <asp:TextBox ID="tcompania" runat="server" MaxLength="100" class="form-control" Text="..."
                                onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyzñ')"
                                onBlur="cadenareqerida(this,1,200,'valtc');"
                                data-toggle="tooltip" data-placement="top" title="Nombre de la compañía transportista que realiza la entrega de la unidad de carga en CGSA." disabled></asp:TextBox>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="d-flex">
                            ...
                            <asp:TextBox ID="truc" runat="server" MaxLength="15" class="form-control" Text=""
                                onkeypress="return soloLetras(event,'0123456789',true)"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="txtplaca" runat="server" MaxLength="10" class="form-control"
                            ...
                            onBlur="validarPlaca(this,'valplaca');buble_warning();" ClientIDMode="Static"></asp:TextBox>
                        <span class="validacion" id="valplaca"></span>
                           <input id="IdTxtPlaca" type="hidden" runat="server" clientidmode="Static" enableviewstate="False" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <asp:TextBox ID="certespecial" runat="server" MaxLength="8" class="form-control"
                        onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789',true)"></asp:TextBox>
                </div>
    ...
    <script type="text/javascript">
        ...
        function prepareObject() {
            ...
            //2023 =>LCriollo Modifico datos de turnos calendario 
            
            var fechllegadaCalenda = document.getElementById('fechllegadaCalenda');
            var holallegadacalenda = document.getElementById('horallegad');

            if (fechllegadaCalenda && fechllegadaCalenda.value ) {

                this.jAisv.fechCalendarLlega = this.document.getElementById('fechllegadaCalenda').value;
                this.jAisv.horaCalendarLlega = this.document.getElementById('horallegad').value;
                this.jAisv.idTurno = this.document.getElementById('txtIdTurno').value;
              
            } else {
                this.jAisv.fechCalendarLlega = "";
                this.jAisv.horaCalendarLlega = "";
                this.jAisv.idTurno = 0;
            }
            if (holallegadacalenda && holallegadacalenda.value) {
            ...
            //tipo de carga
            this.jAisv.id_tipocarga = this.document.getElementById('<%= CboTipoCarga.ClientID %>').value; //id de tipo de carga
    ...
    $(function () {
        $('[id*=txtplaca]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("container.aspx/GetPlaca") %>',
