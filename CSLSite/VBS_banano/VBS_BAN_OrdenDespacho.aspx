...
<%@ Page Title="Orden de Despacho" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_OrdenDespacho.aspx.cs" Inherits="CSLSite.VBS_BAN_OrdenDespacho" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="placehead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function BindFunctions1() {
            $(document).ready(function () {
                $('#tablePaginationDetalle').DataTable(
                    {
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">ORDEN DE DESPACHO </li>
            </ol>
        </nav>
    </div>
            ...
            <ContentTemplate> 
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-1">
                        ...
                        <label for="inputZip">Cantidad Pallets</label>
                        <div class="d-flex"> 
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <label for="inputZip">Fila Desde</label>
                        <div class="d-flex"> 
                            <asp:DropDownList  ID="cmbFilaDesde" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="cmbFilaDesde_SelectedIndexChanged" runat="server" Font-Size="Medium" Font-Bold="true">
                            </asp:DropDownList>
                        </div>
		            </div>
                    <div class="form-group col-md-2">
                        ...
                        <label for="inputZip">Fila Hasta</label>
                        <div class="d-flex"> 
                            <asp:DropDownList  ID="cmbFilaHasta" class="form-control"  runat="server" Font-Size="Medium" Font-Bold="true">
                            </asp:DropDownList>
                        </div>
		            </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="d-flex"> 
                            <asp:DropDownList  ID="cmbAltura" class="form-control"  runat="server" Font-Size="Medium" Font-Bold="true">
                            </asp:DropDownList>
                        </div>
		            </div>
                ...
                <div class="form-group col-md-12"> 
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            ...
                            <asp:Button ID="btnGrabar" runat="server" class="btn btn-primary" Text="Generar Orden" OnClientClick="return mostrarloader('2')" OnClick="btnGrabar_Click"   />
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        ...
        <asp:UpdatePanel ID="UPCAB" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                ...
                <div class="form-row">
                    <div class="form-group   col-md-2"> 
                        <label for="inputAddress">Fecha Desde<span style="color: #FF0000; font-weight: bold;">*</span><span style="color: #FF0000; font-weight: bold;"></span></label>

                        <div class="d-flex">
                            <asp:TextBox ID="txtFechaDesde" AutoPostBack="true" runat="server"  class="datetimepickerAlt form-control"  MaxLength="10"  placeholder="MM/dd/yyyy" OnTextChanged="txtFechaProceso_TextChanged" onkeypress="return soloLetras(event,'1234567890/:')"></asp:TextBox>
                        </div>
                    </div>

                    <div class="form-group   col-md-2"> 
                        <label for="inputAddress">Fecha Hasta<span style="color: #FF0000; font-weight: bold;">*</span><span style="color: #FF0000; font-weight: bold;"></span></label>

                        <div class="d-flex">
                            <asp:TextBox ID="txtFechaHasta" AutoPostBack="true" runat="server"  class="datetimepickerAlt form-control"  MaxLength="10"  placeholder="MM/dd/yyyy" OnTextChanged="txtFechaProceso_TextChanged" onkeypress="return soloLetras(event,'1234567890/:')"></asp:TextBox>
                        </div>
                    </div>

                    <div class="form-group col-md-2">
                        <label for="inputZip">No Orden Despacho<span style="color: #FF0000; font-weight: bold;">*</span></label>
                        <asp:TextBox ID="txtNumeroOrden"  runat="server" class="form-control" MaxLength="16"  onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')" placeholder="ORDEN DE DESPACHO"></asp:TextBox>
                    </div>
        ...
        <asp:UpdatePanel ID="UPDETALLE" runat="server"  UpdateMode="Conditional"  >  
            <ContentTemplate>
                <script type="text/javascript">
                 ...
                 <div class="form-group col-md-12"> 
                    <div class="form-title">LISTA DE ORDENES DE DESPACHO</div>
                </div>
                ...
                <section class="wrapper2">
                                    ...
                                    <asp:Repeater ID="tablePagination" runat="server" onitemcommand ="tablePagination_ItemCommand" OnItemDataBound="tablePagination_ItemDataBound">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="tablePagination" width="100%">
                                            <thead style="background: #B4B4B4; color: white">
                                                <tr>
                                                    ...
                                                    <th class="th-sm">PALLETS</th>
                                                    <th class="th-sm">ARRSTRE</th>
                                                    <th class="th-sm">PENDIENTE</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="center hidden-phone"><asp:Label Text='<%# Eval("id", "{0:D9}") %>' ID="lblId" runat="server" /></td>
                                                ...
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("bloque")%>' ID="lblbloque" runat="server"  /></td>   
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("box")%>' ID="lblbox" runat="server"  /></td>             
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("pallets")%>' ID="lblpallets" runat="server"  /></td>           
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("arrastre")%>' ID="lblarrastre" runat="server"  /></td>   
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("pendiente")%>' ID="lblpendiente" runat="server"  /></td>            
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("usuarioCrea")%>' ID="lbluser" runat="server"  /></td>           
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("estado")%>' ID="lblestado" runat="server"  /></td>   
                                                <td class="center hidden-phone">  
                                                    <asp:Button runat="server" ID="btnEditar" Height="30px" CommandName="Editar" Text="Ver"  CommandArgument='<%# Bind("id") %>' class="btn btn-outline-primary mr-2"  data-toggle="modal" data-target="#myModal3"  />
                                                </td>
                                                <td class="nover"> 
                    ...
                    <div id="sinresultado" runat="server" class="alert alert-info">
                        No se encontraron resultados de ordenes de despacho
                    </div>
            ...
            <div class="modal-dialog" role="document" style="max-width: 1000px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">ORDEN DE DESPACHO</h5>
                        ...
                        <asp:UpdatePanel ID="UPEDIT" runat="server" UpdateMode="Conditional" >  
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="Panel2" runat="server">         
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <label for="inputZip">No Orden</label>
                                            <div class="d-flex"> 
                                                <asp:TextBox class="form-control"  ID="txtDetNumeroOrden" runat="server" disabled MaxLength="10" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890/')"></asp:TextBox>
                                            </div>
		                                </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="d-flex"> 
                                                <asp:TextBox class="form-control"  ID="txtDetReferencia" runat="server" disabled MaxLength="50" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890/')"></asp:TextBox>
                                            </div>
		                                </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div class="d-flex"> 
                                                <asp:TextBox class="form-control"  ID="txtDetBooking" runat="server" disabled MaxLength="50" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890/')"></asp:TextBox>
                                            </div>
		                                </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <label for="inputZip">Exportador</label>
                                            <div class="d-flex"> 
                                                <asp:DropDownList  ID="cmbDetExportador" class="form-control" disabled runat="server" Font-Size="Medium" Font-Bold="true">
                                                </asp:DropDownList>
                                            </div>
		                                </div>
                                        ...
                                        <div class="form-group col-md-4"> 
                                            <label for="inputAddress">Bodega :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                            <div class="d-flex">
                                                <asp:DropDownList ID="cmbDetBodega"  class="form-control" disabled runat="server" Font-Size="Medium" AutoPostBack="true" Font-Bold="true" OnSelectedIndexChanged="cmbDetBodega_SelectedIndexChanged" >
                                                </asp:DropDownList>
                                                <a class="tooltip" ><span class="classic" >Nombre de Bodega</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
                                            </div>
                                        </div>
                                            ...
                                            <label for="inputAddress">Bloque :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                            <div class="d-flex">
                                                <asp:DropDownList ID="cmbDetBloque" class="form-control" disabled  runat="server" Font-Size="Medium" AutoPostBack="false" Font-Bold="true" >
                                                </asp:DropDownList>
                                                <a class="tooltip" ><span class="classic" >Nombre de Bloque</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <label for="inputZip">Pallets</label>
                                            <div class="d-flex"> 
                                                <asp:TextBox ID="txtDetCantidad" runat="server" MaxLength="9" disabled class="form-control" onkeypress="return soloLetras(event,'1234567890',true)" placeholder="CANTIDAD"></asp:TextBox>
                                            </div>
		                                </div>
                                            ...
                                            <div class="d-flex"> 
                                                <asp:DropDownList  ID="cmbDetEstado" class="form-control" disabled runat="server" Font-Size="Medium" Font-Bold="true">
                                                </asp:DropDownList>
                                            </div>
		                                </div>
                                ...
                                <section class="wrapper2">
                                        ...
                                        <div class="findresult" >
                                            <div class="booking" >                                
                                                ...
                                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                                    ...
                                                    <asp:Repeater ID="tablePaginationDetalle" runat="server" OnItemDataBound="tablePaginationDetalle_ItemDataBound">
                                                        <HeaderTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="tablePaginationDetalle" width="100%">
                                                            <thead style="background: #B4B4B4; color: white">
                                                                <tr>
                                                                    <th class="th-sm"></th>
                                                                    <th class="nover">ID MOV </th>
                                                                    <th class="nover">ID UBICACIÓN</th>
                                                                    <th class="nover">No ORDEN</th>
                                                                    <th class="th-sm">BARCODE</th>
                                                                    <th class="th-sm">BODEGA</th>
                                                                    <th class="th-sm">FILA</th>
                                                                    <th class="th-sm">ALTURA</th>
                                                                    <th class="th-sm">SLOT</th>
                                                                    <th class="th-sm">BOX</th>
                                                                    <th class="th-sm">CREADOR</th>
                                                                    <th class="th-sm">ATENDIDO</th>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="nover"> <%#Eval("idUbicacion")%></td> 
                                                                <td class="nover"><asp:Label Text='<%#Eval("idOrden")%>' ID="lblbloque" runat="server"  /></td>   
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("barcodes")%>' ID="lblbooking" runat="server"  /></td>            
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("bodega")%>' ID="lblbodega" runat="server"  /></td>   
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("fila")%>' ID="lblexportador" runat="server"  /></td>      
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("altura")%>' ID="Label1" runat="server"  /></td>      
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("slot")%>' ID="lblarrastre" runat="server"  /></td>   
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("box")%>' ID="lblbox" runat="server"  /></td>             
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("usuarioCrea")%>' ID="lbluser" runat="server"  /></td>           
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("usuarioPreDespacho")%>' ID="lblpallets" runat="server"  /></td>           
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("usuarioDespacho")%>' ID="lblpendiente" runat="server"  /></td>            
                                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("estado")%>' ID="lblestado" runat="server"  /></td>   
                                                                <%--<td class="center hidden-phone">  
                                    ...
                                    <div id="sinresultadosDet" runat="server" class="alert alert-info">
                                        No se encontraron resultados de movimientos asociados a la orden de despacho
                                    </div>
                                ...
                                <section class="wrapper2">
                                    <%--<div class="row mb"> --%>
                                        <div class="content-panel" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-center">
                                                    <asp:Button ID="btnActualizar" runat="server" class="btn btn-primary"  Text="ACTUALIZAR"  OnClientClick="return mostrarloader('1')"   />
