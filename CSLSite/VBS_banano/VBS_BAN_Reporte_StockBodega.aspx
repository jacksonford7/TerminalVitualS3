<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_Reporte_StockBodega.aspx.cs" Inherits="CSLSite.VBS_BAN_Reporte_StockBodega" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">GENERACIÓN DE REPORTE DE STOCK POR BODEGA</li>
            </ol>
        </nav>
    </div>
    ...
    <script type="text/javascript">
        ...
        function exportar() {
            ...
            xhr.open('POST', 'VBS_BAN_Reporte_StockBodega.aspx/ExportarExcel', true);
            xhr.setRequestHeader('Content-Type', 'application/json; charset=utf-8');
            xhr.responseType = 'blob';

            xhr.onload = function () {
                var fileName = "Reporte_Stock_Bod_" + txtLinea +"_"+ tipoCargaId + ".xlsx";
                if (xhr.status === 200) {
