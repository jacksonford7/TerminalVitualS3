<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_Reporte_Ingresos.aspx.cs" Inherits="CSLSite.VBS_BAN_Reporte_Ingresos" %>
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">GENERACIÓN DE REPORTE DE INGRESOS DE BODEGA</li>
            </ol>
        </nav>
    </div>
    ...
    <script type="text/javascript">
        ...
        function exportar() {
           ...
           <%-- var cboTipoCarga = document.getElementById("<%= cboTipoCarga.ClientID %>");
            ...
            xhr.open('POST', 'VBS_BAN_Reporte_Ingresos.aspx/ExportarExcel', true);
