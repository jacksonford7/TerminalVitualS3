<%@ Page Title="Configuración de Consignatario" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_Consignatario.aspx.cs" Inherits="CSLSite.VBS_BAN_Consignatario" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="Li2" runat="server">CONSIGNEE [CCNE]</li>
          </ol>
        </nav>
      </div>
            ...
            <ContentTemplate>
                ...
                <script type="text/javascript">
                    ...
                    <section class="wrapper2">
                        <h4 class="mb">LISTA DE CONSIGNEE</h4>
                            <div class="row mb">
                                <div class="col-lg-12">
