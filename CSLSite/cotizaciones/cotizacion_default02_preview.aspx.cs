...
namespace CSLSite
{
    public partial class cotizacion_default02_preview : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.Mostrar_Mensaje(string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible..no existen datos para proformar carga suelta"));
                    Response.Redirect("~/cotizacion_default02.aspx", false);
                    return;
                }
        ...
        protected void BtnFacturar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "popup", "popOpen('../cotizaciones/print_proforma_preview.aspx?id_comprobante=" + cId + "');", true);
