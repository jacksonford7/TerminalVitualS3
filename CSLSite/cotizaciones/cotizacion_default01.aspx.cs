...
namespace CSLSite
{
    ...
    public partial class cotizacion_default01 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (row_fechasalida.HasValue)
                    {
                        ...
                        var Turnos = PasePuerta.TurnoVBS.ObtenerTurnos("CGSA", row_contenedor, row_gkey, row_fechasalida.Value);
                        if (Turnos.Exitoso)
                        {
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                   ...
                   /*para almacenar clientes que asumen factura*/
                    ...
                    var AgenteCod = N4.Entidades.Agente.ObtenerAgentePorRuc("CGSA", "0992506717001");
                    ...
                    var EcuaContenedores = Validacion.CargaPorManifiestoImpoPro("CGSA", this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim(), "0992506717001");//ecuapas contenedores
                    if (EcuaContenedores.Exitoso)
                    {
                        ...
                        if (Agente.Exitoso)
                        {
                            ...
                            if (ListaAgente != null)
                            {
                                ...
                                if (!this.hf_idcliente.Value.Trim().Equals("0992506717001"))
                                {
                                    //agrega importador
                        ...
                        else
                        {
                            ...
                            ***********************************************************************************************************************************/
                            ...
                            this.Enviar_Caso_Salesforce("CGSA", "0992506717001", "Cotización Contenedor", "No existe información del cliente, no registrado.", MensajesErrores.Trim(), string.Format("{0}-{1}-{2}", this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim()),
                        ...
                        var ListaContenedores = Contenedor.CargaPorKeys("CGSA", Gkey.Resultado);//resultado de entidad contenedor
                        if (ListaContenedores.Exitoso)
                        {
                            ...
                            if (LinqQuery != null && LinqQuery.Count() > 0)
                            {
                                ...
                                if (cancelado)
                                {
                                    ...
                                    ***********************************************************************************************************************************/
                                    ...
                                    this.Enviar_Caso_Salesforce("CGSA", "0992506717001", "Cotización Contenedor", "Unidad sin RIDT Aprobado", MensajesErrores.Trim(), string.Format("{0}-{1}-{2}",this.TXTMRN.Text.Trim(),this.TXTMSN.Text.Trim(),this.TXTHSN.Text.Trim()),
                                ...
                                else
                                {
                                    ...
                                    if (UnidadDesconectada)
                                    {
                                        ...
                                        ***********************************************************************************************************************************/
                                        ...
                                        this.Enviar_Caso_Salesforce("CGSA", "0992506717001", "Cotización Contenedor", "Unidades Reefer Desconectadas", MensajesErrores.Trim(), string.Format("{0}-{1}-{2}", this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim()),
                                            objCabecera.DESC_FACTURADO, objCabecera.DESC_AGENTE, out MensajeCasos);
                            ...
                            else
                            {
                                ...
                                this.Mostrar_Mensaje(1, string.Format("<i class='fa fa-warning'></i><b> Informativo! No existe información pendiente de proformar con el número de la carga ingresada..</b>"));
                                this.Actualiza_Panele_Detalle();
                                return;
                            }
                        }
                        ...
                        {
                            this.Mostrar_Mensaje(1, string.Format("<i class='fa fa-warning'></i><b> Informativo! No existe información pendiente de proformar con el número de la carga ingresada..{0}</b>", ListaContenedores.MensajeProblema));
                            this.Actualiza_Panele_Detalle();
                            return;
                        }
                    ...
                    {
                        this.Mostrar_Mensaje(1, string.Format("<i class='fa fa-warning'></i><b> Informativo! No existe información pendiente de proformar con el número de la carga ingresada..{0}</b>", EcuaContenedores.MensajeProblema));
                        this.Actualiza_Panele_Detalle();
                        return;
                    }
            ...
            try
            {
                ...
                **********************************************************************************************************************************************/
                ...
                else
                {
                    ...
                    Response.Redirect("~/cotizaciones/cotizacion_default01_preview.aspx?id_proforma=" + cId.Trim() + "", false);
