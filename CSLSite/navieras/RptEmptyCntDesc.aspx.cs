...
namespace CSLSite
{
    public partial class rpt_econt_desc : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                var number = log_csl.save_log<Exception>(ex, "descarga_vacio_report", "Page_Init", sid, Request.UserHostAddress);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    {
                        var ex = new ApplicationException(string.Format("IP:{0},URL:{1},METODO:{2}, Tabla de impresiones vacía", Request.UserHostAddress, Request.Url, Request.HttpMethod));
                        var number = log_csl.save_log<Exception>(ex, "descarga_vacio_report", "Page_Load", sid, Request.UserHostAddress);
                    ...
                    var t = repNavieras.GetRptEmptyCntDesc(arrglo[0], arrglo[1], "MTY");
