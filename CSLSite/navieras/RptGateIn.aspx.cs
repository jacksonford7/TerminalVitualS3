...
namespace CSLSite
{
    public partial class rpt_gate_in : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    //var t = repNavieras.GetRptGateIn(arrglo[0], arrglo[1], arrglo[2], arrglo[3], arrglo[4], true);
                    var t = repNavieras.GetRptGateIn_New(arrglo[0], arrglo[1], arrglo[2], arrglo[3], arrglo[4], true);
                ...
                {
                    var number = log_csl.save_log<Exception>(ex, "RptIngresoCont", "Page_Load", sid, Request.UserHostAddress);
                    this.PersonalResponse(string.Format("Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible, por favor reporte este código de servicio: A00-{0}", number), null);
                    return;
                }
                finally
