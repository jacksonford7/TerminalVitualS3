...
namespace CSLSite
{
    public partial class rpt_ref_cont : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    //var t = repNavieras.GetRptGateOut(arrglo[0], arrglo[1], arrglo[2], arrglo[3], arrglo[4]);
                    var t = repNavieras.GetRptRfCont(arrglo[0], arrglo[1], arrglo[2], arrglo[3], arrglo[4]);
