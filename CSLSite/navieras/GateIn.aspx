<%@ Page Title="Gate In" Language="C#" MasterPageFile="~/site.Master" 
         AutoEventWireup="true" CodeBehind="GateIn.aspx.cs" Inherits="CSLSite.gate_in" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="608" />
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Mis Naves</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Gate In Report</li>
            </ol>
        </nav>
    </div>
                                    ...
                                    <div class="booking" >
                                         <table>
                                             <tr>
                                                 ...
                                                 <td>
                                                    <input   class="btn btn-primary"  clientidmode="Static" id="dataexport" onclick="getTable('reportGateIn');" type="button" value="Exportar" runat="server" />
                                                 </td>
                                             </tr>
                                         </table>
                                        <br />
                                        ...
                                        <div class="form-group col-md-12"> 
                                            <div class="form-title">Gate In</div>
                                        </div>

                                         <div class="bokindetalle" style=" width:100%; overflow:auto">
                                         <%--<div style=" width : 1500px; overflow : auto; height : 300px ">--%>
                                                     ...
                                                     <HeaderTemplate>
                                                         <table id="tabla" cellspacing="1" cellpadding="1" class="table table-bordered invoice">
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <th style="width:400px">Exporter</th>
