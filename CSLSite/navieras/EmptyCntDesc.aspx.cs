...
namespace CSLSite
{
    public partial class econt_desc : System.Web.UI.Page
    {
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var tablix = repNavieras.GetRptEmptyCntDesc(this.agencia.Value, this.tbooking.Text, "MTY");
                    tablePagination.DataSource = tablix;
                    tablePagination.DataBind();
                    Session["reportDescEmp"] = tablix;
                    xfinder.Visible = true;
                    ...
                    this.aprint.HRef = string.Format("RptEmptyCntDesc.aspx?sid={0}", sid);
                }
                catch (Exception ex)
                {
