...
namespace CSLSite
{
    public partial class gate_in : System.Web.UI.Page
    {
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var tablix = repNavieras.GetRptGateIn_New(this.agencia.Value, this.tfechaini.Text, this.tfechafin.Text, this.tbooking.Text, this.contain.Text, true);
