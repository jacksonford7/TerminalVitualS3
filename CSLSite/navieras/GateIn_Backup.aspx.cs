...
namespace CSLSite
{
    public partial class GateIn_Backup : System.Web.UI.Page
    {
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var tablix = repNavieras.GetRptGateIn(this.agencia.Value, this.tfechaini.Text, this.tfechafin.Text, this.tbooking.Text, this.contain.Text, true);
                    tablePagination.DataSource = tablix;
                    tablePagination.DataBind();
                    Session["reportGateIn"] = tablix;
                    xfinder.Visible = true;
                    ...
                    var sid = QuerySegura.EncryptQueryString(string.Format("{0};{1};{2};{3};{4}", this.agencia.Value, this.tfechaini.Text, this.tfechafin.Text, this.tbooking.Text, this.contain.Text));
