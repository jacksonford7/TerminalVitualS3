...
namespace CSLSite
{
    public partial class econt_load : System.Web.UI.Page
    {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    */
                    ...
                    var tablix = repNavieras.GetRptEmptyCntLoad(this.agencia.Value, this.tbooking.Text, "MTY");
                    tablePagination.DataSource = tablix;
                    tablePagination.DataBind();
                    Session["reportCargEmp"] = tablix;
                    xfinder.Visible = true;
                    ...
                    this.aprint.HRef = string.Format("RptEmptyCntLoad.aspx?sid={0}", sid);
                }
                catch (Exception ex)
                {
