<%@ Page Title="Descarga de Vacíos" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
    CodeBehind="EmptyCntDesc.aspx.cs" Inherits="CSLSite.econt_desc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="604" />
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Mis Naves</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Empty Containers Discharge Report</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12"> 
                ...
                <div class="d-flex"> 
                    ...
                    <%--<asp:LinkButton runat="server" ID="btnBuscar" Text="<span class='fa fa-search' style='font-size:24px'></span>" class="btn btn-outline-primary mr-4"
                ...
                <div class="cataresult">
                    <asp:UpdatePanel ID="upresult" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div id="xfinder" runat="server" visible="false" title="">
                                ...
                                <div class="findresult">
                                    <div class="booking">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a href="#" class="btn btn-outline-primary mr-4" target="_blank" runat="server" id="aprint" clientidmode="Static" >Vista Preliminar / Imprimir</a>
                                                </td>
                                                <td>
                                                    <input class="btn btn-primary" clientidmode="Static" id="dataexport" onclick="getTable('reportDescEmp');" type="button" value="Exportar" runat="server" />
                                                </td>
                                            </tr>
                                        </table>
                                        <br />
