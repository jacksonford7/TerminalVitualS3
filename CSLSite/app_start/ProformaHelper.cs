...
namespace CSLSite.app_start
{
    public class ProformaHelper
    {
        ...
        public static Int32 BookingQty(string booking)
        {
            ...
            using (var con = new System.Data.SqlClient.SqlConnection())
            {
                ...
                comando.CommandType = System.Data.CommandType.Text;
                comando.Connection = con;
                comando.CommandText = "select [N5].[dbo].[fx_bk_qyt_bo](@bookingKey)";
                comando.Parameters.AddWithValue("@bookingKey", booking);
                try
                {
                    con.Open();
                    object sale = comando.ExecuteScalar();
                ...
                {
                    log_csl.save_log<Exception>(ex, "ProformaHelper", "BookingQty", booking.ToString(), "N4");
                    return 0;
                }
                finally
                {
        ...
        public static string crateServiceTable(Catalogos.ExportacionServicesDataTable tabla, int cantidad)
        {
            ...
            salida.AppendFormat("<tr><td colspan='6' class='filat'>IVA 15%(+)</td><td><span id='siva'>{0}</span></td></tr>", 2);
        ...
        //2017 nuevo ----->
        public static Int32 HorasFree(string line)
        {
            ...
            using (var con = new System.Data.SqlClient.SqlConnection())
            {
                ...
                comando.CommandType = System.Data.CommandType.Text;
                comando.Connection = con;
                comando.CommandText = "select [dbo].[fx_get_hora_free](@line)";
                comando.Parameters.AddWithValue("@line", line);
                try
                {
                    con.Open();
                    object sale = comando.ExecuteScalar();
                ...
                {
                    log_csl.save_log<Exception>(ex, "ProformaHelper", "HorasFree", line, "service");
                    return 0;
                }
                finally
                {
        ...
        public static Int32 LiquidacionPagada(string liquidacion)
        {
            ...
            using (var con = new System.Data.SqlClient.SqlConnection())
            {
                ...
                comando.CommandType = System.Data.CommandType.Text;
                comando.Connection = con;
                comando.CommandText = "select [dbo].[fx_liquidacion_pagada](@liquidacion)";
                ...
                {
                    log_csl.save_log<Exception>(ex, "ProformaHelper", "LiquidacionPagada", liquidacion, "Proforma");
                    return 0;
                }
                finally
                {
