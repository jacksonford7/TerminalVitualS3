...
namespace CSLSite.N4Object
{
    ...
    public partial class UnitAdvice
    {
        public UnitAdvice()
        {
           ...
           // this.specialstow = new HashSet<stow>();
            ...
            //nuevo 2018
            this.stows = new specialstows();
            //Modificamos la clase para aceptar varios stows
        ...
        */
        ...
        /*NUEVO 2018 STOWS TYPES*/
        [XmlElement(ElementName = "special-stows")]
        public specialstows stows { get; set; }
        /*fin lo nuevo 2018*/
    ...
    public class unitflex
    {
        ...
        //peso baplie ahora carbono neutro 1/2 /nada
        [XmlAttribute(AttributeName = "unit-flex-12")]
        public string flex12 { get; set; }

        //10-03-2022
        //captura del peso asiv (tara chiquita)
        [XmlAttribute(AttributeName = "unit-flex-13")]
        public string flex13 { get; set; }
    }

    /*Nuevo 2018*/
    [Serializable]
    public class specialstows
    {
        public specialstows()
        {
            this.stow1 = new stow();
        ...
        [XmlElement(ElementName = "special-stow-1")]
        public stow stow1 { get; set; }
        [XmlElement(ElementName = "special-stow-2")]
        public stow stow2 { get; set; }
        [XmlElement(ElementName = "special-stow-3")]
        public stow stow3 { get; set; }
        //[XmlElement(ElementName = "special-stow-4")]
        //public stow stow4 { get; set; }
    }
