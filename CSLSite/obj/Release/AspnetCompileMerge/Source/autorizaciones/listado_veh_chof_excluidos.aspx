<%@ Page  Title="Reporte de vehículos y Choferes Excluidos"  Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="listado_veh_chof_excluidos.aspx.cs" Inherits="CSLSite.autorizaciones.listado_veh_chof_excluidos" %>
 ...
 <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Reporte de Vehículos y Choferes Excluidos</li>
          </ol>
        </nav>
      </div>
            ...
            <div class="form-group col-md-6">
             ...
             <div class="form-group col-md-6">
                <label for="inputEmail4">Empresa de Transporte:</label> 
                 <asp:DropDownList runat="server" ID="CboEmpresas"    AutoPostBack="false"  class="form-control"  ></asp:DropDownList>
             </div>
           <div class="form-group col-md-6">
                <label for="inputEmail4">Tipo:</label>  
                 <asp:DropDownList runat="server" ID="CboTipo"   AutoPostBack="false"  class="form-control"  ></asp:DropDownList>
          </div>
    </div>
      <div class="row">
              ...
              <asp:UpdatePanel ID="UPVEHICULOS" runat="server" ChildrenAsTriggers="true">
                ...
                <div class="form-group col-md-12" runat="server" id="vehiculo" visible="true">
                            <rsweb:reportviewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                                ...
                                Visible="true"   >
                                <LocalReport ReportPath="autorizaciones\Rpt_Vehiculos_excluidos.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="SqlDataSource_Detalle" 
                                            Name="RVA_REPORTE_VEHICULOS_CHOFERES_EXCLUIDOS" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:reportviewer>
                                    <asp:SqlDataSource ID="SqlDataSource_Detalle" runat="server" ConnectionString="<%$ ConnectionStrings:midle %>" SelectCommand="RVA_REPORTE_VEHICULOS_CHOFERES_EXCLUIDOS" SelectCommandType="StoredProcedure">        
                                        <SelectParameters>  
                                        <asp:SessionParameter  Type="String"  Name="LINEA_NAVIERA"   SessionField="LINEA_NAVIERA" />
                                        <asp:SessionParameter  Type="String" Name="ID_EMPRESA"  SessionField="ID_EMPRESA" />
                ...
                <div class="form-group col-md-12" runat="server" id="choferes" visible="false">
                            <rsweb:reportviewer ID="ReportViewer2" runat="server" Font-Names="Verdana" 
                                ...
                                WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" 
                                Visible="true"  >
                                <LocalReport ReportPath="autorizaciones\Rpt_Choferes_excluidos.rdlc">
                                    <DataSources>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource_Detalle2" runat="server" ConnectionString="<%$ ConnectionStrings:midle %>" SelectCommand="RVA_REPORTE_VEHICULOS_CHOFERES_EXCLUIDOS" SelectCommandType="StoredProcedure">        
                                        <SelectParameters>  
                                        <asp:SessionParameter  Type="String"  Name="LINEA_NAVIERA"   SessionField="LINEA_NAVIERA" />
                                        <asp:SessionParameter  Type="String" Name="ID_EMPRESA"  SessionField="ID_EMPRESA" />
                                        <asp:SessionParameter  Name="TIPO" SessionField="TIPO" DbType="Int32"  />      
