<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pase_puerta_brbk_preview.aspx.cs" Inherits="CSLSite.pase_puerta_brbk_preview" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Imprimir Pases de Puerta de Carga Break Bulk (BRBK)</title>
     ...
     <div class="row">
         <div class="col-md-12 d-flex justify-content-center"> 
             <asp:UpdatePanel ID="UPPASEPUERTA" runat="server" UpdateMode="Conditional" >  
                        ...
                        <LocalReport EnableExternalImages="True" ReportPath="rptpasepuertabrbk.rdlc" >
                        </LocalReport>
                        </rsweb:ReportViewer>
