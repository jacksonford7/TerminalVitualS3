<%@ Page Title="Listado de Usuarios Inactivos" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="carbono_clientesinactivos.aspx.cs" Inherits="CSLSite.carbono_clientesinactivos" %>
            ...
            <div class="mt-4">         
                <nav class="mt-4" aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Carbono Neutro</a></li>
                        <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CLIENTES INACTIVOS</li>
                    </ol>
                </nav>
            </div>
