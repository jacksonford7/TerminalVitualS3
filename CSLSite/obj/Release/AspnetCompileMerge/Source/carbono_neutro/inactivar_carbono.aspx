<%@ Page Title="Inactivar Carbo Neutro" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="inactivar_carbono.aspx.cs" Inherits="CSLSite.inactivar_carbono" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
                                                            ...
                                                            <td>
                                                                <div class="tcomand">
                                                                      <asp:Button ID="BtnEvento" CommandArgument= '<%#Eval("Id")%>' runat="server" Text="Eliminar" 
                                                                            ...
                                                                            class="btn btn-primary" ToolTip="Inactivar certificado carbono" CommandName="Eliminar"
                                                                              />
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
            ...
            {
               try {
                    var w = window.open('../carbono_neutro/archivo_carbono.aspx', 'Archivos', 'width=850,height=400');
                     w.focus();     
               }
               catch (e) {
