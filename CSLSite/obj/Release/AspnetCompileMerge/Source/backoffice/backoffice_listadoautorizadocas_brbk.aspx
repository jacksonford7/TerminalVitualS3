<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="backoffice_listadoautorizadocas_brbk.aspx.cs" Inherits="CSLSite.backoffice_listadoautorizadocas_brbk" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE AUTORIZACIONES DE SALIDAS (BREAK BULK)</li>
          </ol>
        </nav>
      </div>
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
       <ContentTemplate>
            ...
            <section class="wrapper2">
             <h3>DETALLE DE CARGAS BREAK BULK</h3>
             <div class="row mb"> 
