<%@ Page Language="C#" Title="Calendario" AutoEventWireup="true" 
         CodeBehind="calendarioConsolidacion.aspx.cs" Inherits="CSLSite.calendarioConsolidacion" %>
            ...
            <div id="xfinder" runat="server" visible="false" >
             ...
             <div class="booking" >
                 ...
                 <tr class="point" onclick="setObject(this);">
                  <td class="nover"><%#Eval("item1")%></td>
                  <td style=" width:80PX"><%#Eval("item2")%></td>
                  <td class="nover"><%#Eval("item3")%></td>
                  <td>
