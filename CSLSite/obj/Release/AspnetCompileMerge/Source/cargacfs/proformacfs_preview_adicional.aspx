<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="proformacfs_preview_adicional.aspx.cs" Inherits="CSLSite.proformacfs_preview_adicional" %>
     ...
     <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">PROFORMA DE CARGA DE SUELTA (IMPORTACIÓN)</li>
          </ol>
        </nav>
    </div>
     ...
     <div class="form-row">
        ...
        <div class="form-group col-md-12"> <!--col-lg-12 mt-->
            ...
            <div class="col-lg-12 col-lg-offset-1"> <!--col-lg-10 col-lg-offset-1-->
                ...
                <%--<strong><span id="contenedor" runat="server">.... </span></strong><br/>--%>
                </address>
                  </div>
                  <!-- /col-md-9 -->
                  <div class="col-md-3">
