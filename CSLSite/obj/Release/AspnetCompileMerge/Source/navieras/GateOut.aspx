<%@ Page Title="Gate Out" Language="C#" MasterPageFile="~/site.Master" 
         AutoEventWireup="true" CodeBehind="GateOut.aspx.cs" Inherits="CSLSite.gate_out" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Mis Naves</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Gate Out Report</li>
            </ol>
        </nav>
    </div>
...
<%--            <table class="xcontroles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="3">Filtros para el reporte</th></tr>
         ...
         <tr>
         <td class="bt-bottom bt-left bt-right" style=" width:100px" >Referencia de Nave:</td>
         <td class="bt-bottom bt-right" >
         <table>
                            <tr>
                                <td>
                                ...
                                <div class="booking" >
                                     <table>
                                         <tr>
                                             ...
                                             <td>
                                                <input class="btn btn-primary" clientidmode="Static" id="dataexport" onclick="getTable('reportGateOut');" type="button" value="Exportar" runat="server" />
                                             </td>
                                         </tr>
                                    </table>
                                     <br />
                                    <div class="form-group col-md-12"> 
                                         <div class="form-title">Gate Out</div>
                                    </div>
                                    
                                     <div class="bokindetalle" style=" width:100%; overflow:auto">
                                     <%--<div style=" width : 1200px; overflow : auto; height : 300px ">--%>
