<%@ Page Title="" Language="C#"  MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="contenedorexportacion.aspx.cs" Inherits="CSLSite.contenedorexpo.contenedorexportacion" %>
        ...
        <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
            <ContentTemplate>
                ...
                <%--<section class="wrapper2">--%>
                    <%--<h3>DETALLE DE CONTENEDORES DE EXPORTACIÓN</h3>--%>
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="width:900px">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel2">DETALLE DE CONTENEDORES DE EXPORTACIÓN</h4>
                    </div>
                    <div class="modal-body" >
                        ...
                        <asp:UpdatePanel ID="UPMODAL" runat="server" UpdateMode="Conditional" >  
                            <ContentTemplate>
                                <asp:Panel ID="pnlEdit" runat="server">         
                                    <p>BOOKING:<asp:TextBox ID="txtID"  runat="server" class="form-control"   placeholder="" size="16"  Width="800px" Font-Bold="false" disabled></asp:TextBox></p>
                                </asp:Panel>
