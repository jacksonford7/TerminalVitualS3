<%@ Page Language="C#" AutoEventWireup="true" Title="Emisión Permiso Vehicular" CodeBehind="revisasolicitudvehiculo.aspx.cs" Inherits="CSLSite.revisasolicitudvehiculo" %>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3"> 
            ...
            <div class="d-flex">
                ...
                <a class="tooltip" ><span class="classic" >Lista de Tipos</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
            </div>
        </div>
    </div>
