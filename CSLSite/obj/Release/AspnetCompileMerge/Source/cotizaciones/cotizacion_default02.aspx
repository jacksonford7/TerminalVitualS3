<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cotizacion_default02.aspx.cs" Inherits="CSLSite.cotizacion_default02"  Title="Cotizaciones de Carga Suelta" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>


<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 <title>Cotizaciones de Carga Suelta</title>
...
<form id="cargasuelta" runat="server">
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">COTIZACIÓN DE CARGA SUELTA (CFS)</li>
          </ol>
        </nav>
      </div>
     ...
     <div class="form-row">  
        <div class="form-group col-md-4">
               ...
               <div class="d-flex">
                    ...
                    <ContentTemplate>
                    <asp:Button ID="BtnAgregar" runat="server" class="btn btn-primary"  Text="AGREGAR FECHA"  OnClick="BtnAgregar_Click" visible="false"/>      
                    </ContentTemplate> 
                        <Triggers>
            ...
            <h3 id="LabelTotal" runat="server">DETALLE DE ITEMS</h3>
             ...
             <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  DataKeyNames="CONTENEDOR"
                              ...
                              <Columns>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <ContentTemplate>
                                                                <label class="checkbox-container">
                                                                    <asp:CheckBox ID="CHKFA" runat="server" Checked='<%# Bind("VISTO") %>'  CssClass="center hidden-phone" />
                                                    ...
                                                    <asp:BoundField DataField="AUTORIZADO" HeaderText="AUTORIZADO POR ADUANA" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                                                    ...
                                                    <asp:BoundField DataField="NUMERO_PASE_N4" HeaderText="# PASE"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="false"/>
                                                </Columns>
                                            </asp:GridView>
