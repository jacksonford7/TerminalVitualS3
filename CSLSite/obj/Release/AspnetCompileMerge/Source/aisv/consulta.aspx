                 ...
                 <tr class="point" >
                  ...
                  <td scope="row">
                   ...
                   <td scope="row"> 
                       ...
                       <td scope="row"> 
                    <div class="col-md-2">
                          <asp:Button runat="server" ID="btnActualiza" class="btn btn-primary" Text="Actualiza Cita" OnClientClick="actualizarTurno(this)" />
        ...
        document.getElementById('<%=txtFechaNuevoTurno.ClientID %>').value = ''
            ...
            $.ajax({
                ...
                success: function (response) {
                    var responseData = JSON.parse(response.d);  // Parsear la respuesta JSON a un objeto JavaScript
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            for (var i = 0; i < jsonArray.length; i++) {
                                ...
                                var color = evento.  === 0 ? "#FF0000" : evento.color;
                                var event = {
                                    id: evento.idDetalle,
                        //            title: evento.title,
                                    start: startDateTime,
