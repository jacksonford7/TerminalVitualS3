...
<asp:Content ID="Content1" ContentPlaceHolderID="placehead" runat="server">
   ...
   <script type="text/javascript">
       ...
       function validacionDate(input, showWarning, valfecfum) {
           ...
           var selectedDate = new Date(input.value); // Obtiene la fecha seleccionada del campo de entrada

           if (selectedDate < currentDate && showWarning) {
               // Fecha menor a la actual: muestra advertencia y limpia el campo de entrada
               input.value = ""; // Limpia el valor del campo de entrada
               mostrarAdvertencia("No puede elegir una fecha anterior a la actual")
           }
       }
            ...
            <div class="form-group col-md-6">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" id="fechllegadaCalenda" maxlength="10" class="datetimepickerAlt form-control"
                        ...
                        data-toggle="tooltip" data-placement="top" <%--onchange="openModal(this.value)"--%> title="Fecha de llegada." />
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="d-flex">
                        <asp:TextBox ID="truc" runat="server" MaxLength="15" class="form-control"
                            ...
                            data-toggle="tooltip" data-placement="top" title="Número del Registro Único de Contribuyente de la compañia transportista registrada anteriormente."></asp:TextBox>
