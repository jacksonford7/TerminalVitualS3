<%@ Page Language="C#" MasterPageFile="~/site.Master" Title="Solicitud de Ingreso / Chofer" MaintainScrollPositionOnPostback="true"
         AutoEventWireup="true" CodeBehind="solicitud_entrada_chofer_tag.aspx.cs" Inherits="CSLSite.transportista.solicitud_entrada_chofer_tag" %>
...
<asp:Content ID="formcolaboradorciatrans" ContentPlaceHolderID="placebody" runat="server">
    <a name="MOVEHERE"></a>
...
<%--  <asp:ToolkitScriptManager ID="tkcal2" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>--%>
  ...
  <noscript><meta http-equiv="refresh" content="0; url=sinsoporte.htm" /> </noscript>
   <div>
         <i class="ico-titulo-1"></i><h2>Gates</h2><br />
         <i class="ico-titulo-2"></i><h1>Solicitud de Ingreso / Chofer</h1><br />
   </div>
    ...
    <div class="informativo">
      ...
      <tr><td rowspan="2" class="inum"> <div class="number">1</div></td><td class="level1" >
          Compañia de Transporte.</td></tr>
      <tr><td class="level2">Compañia de Transporte.</td></tr>
      </table>
     </div>
   ...
   <%--  <div class="bt-bottom  bt-right bt-left">--%>
     <table class="controles" cellspacing="0" cellpadding="1">
         <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:50px">Empresa:</td>
         <td class="bt-bottom" >
                   <span id="rucrazsocial" style=" width:450px" class="caja" clientidmode="Static" >...</span>
                   <input id="rucciatrans" type="hidden" value="" runat="server" clientidmode="Static"/>
          </td>
         <td class="validacion bt-bottom">
        <%--<a  class="topopup" target="popup" onclick="window.open('../catalogo/bookcon','name','width=1260,height=480')" >
          <i class="ico-find" ></i> Buscar </a>--%>
          <asp:Button ID="btnBuscarEmp" runat="server" Width="100px" Text="Buscar" OnClientClick="return openPopEmp()" />
         </td>
         
         <td class=" bt-bottom validacion bt-right "><span id="valciatransbuscar" class="validacion"> * obligatorio</span></td>
         </tr>
         </table>
     <table cellspacing="0" cellpadding="1" style=" width:100%; display:none">
           <tr>
     <td class="bt-bottom bt-left">
        <asp:TextBox ID="TxtGEmpresaAdd" onblur="checkcajalarge(this,'valsearchempresa',true);" onkeyup="searchCiaTrans(this)" placeholder="ESCRIBA EL RUC O LA RAZON SOCIAL" Width="400px"  runat="server"></asp:TextBox>
     </td>
       <td class="bt-bottom bt-right validacion "><span id="valsearchempresa" class="validacion"> * obligatorio</span></td>
     </tr>
     </table>
     <%--</div>--%>
    </div>
    ...
    <tr>
     ...
     <td class="validacion "><span id='valtipsol' class="validacion" > * obligatorio</span></td>
     <%--<td class="">
   ...
   <div class="seccion">
    ...
    <div class="colapser colapsa"></div>
      ...
      <tr>
        ...
        <tr>     <th class="bt-bottom bt-right bt-left" colspan="4"></th>
        </tr>
      </table>
      <table class="controles" cellspacing="0" cellpadding="1">
         <tr>
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
         ...
         <tr><td class="bt-bottom  bt-right bt-left" style=" width:155px">#TAG:</td>
         <td class="bt-bottom">
             <asp:TextBox 
             style="text-align: center"
             ID="txttag" runat="server" ClientIDMode="Static" width="200px" MaxLength="500"
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890')" 
             onblur="checkcaja(this,'valtag',true);"></asp:TextBox>
         </td>
         <td class="bt-bottom bt-right validacion"><span id="valtag" class="validacion"> * obligatorio</span></td>
         </tr>
         <tr><td class="bt-bottom  bt-right bt-left" style=" width:155px">Nota / Observación:</td>
         <td class="bt-bottom">
      ...
      <asp:UpdatePanel ID="upresult2" runat="server" style=" display:none">
      <ContentTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanelpb" UpdateMode="Conditional" runat="server">
        ...
        <ContentTemplate>
            ...
            <asp:Button ID="btsalvar" runat="server" Text="Registrar el Ingreso"  onclick="btsalvar_Click" ClientIDMode="Static"
                            OnClientClick="return prepareObject('¿Esta seguro de registrar el ingreso?');"
                            ToolTip="Confirma la información y genera el ingreso."/>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    </div>
   <asp:HiddenField runat="server" ID="emailsec2" />
     ...
     <asp:HiddenField ID="hfRazSocial" runat="server" />
     <asp:HiddenField ID="hfValRucCiaTrans" runat="server" />
     <asp:HiddenField ID="hfValHF" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function prepareObject(valor) {
            try {
                ...
                var vals = document.getElementById('rucciatrans').value;
                if (vals == 0) {
                    alert('Seleccione la Compañia de Transporte');
                    //document.getElementById('<%=TxtGEmpresaAdd.ClientID %>').focus();
                    //document.getElementById('<%=TxtGEmpresaAdd.ClientID %>').style.cssText = "background-color:#ffffc6;color:Red;width:400px;";
                ...
                var vals = document.getElementById('<%=txttag.ClientID %>').value;
                if (vals == '' || vals == null || vals == undefined) {
                    alert('* Escriba el TAG *');
                    document.getElementById('<%=txttag.ClientID %>').focus();
                    document.getElementById('<%=txttag.ClientID %>').style.cssText = "background-color:#ffffc6;color:Red;width:200px;";
                    document.getElementById("loader").className = 'nover';
                    return false;
                }
                ...
                //document.getElementById('<%=ddlTipoEmpresa.ClientID %>').focus();
                document.getElementById('<%=btnBuscarEmp.ClientID %>').focus();
                return true;
            } catch (e) {
                alert('Lamentamos comunicarle que ha ocurrido el siguiente problema:\n' + e.Message);
            }
        }
        function validateHF(rucrazsocial) {
            var validametodo = false;
            $.ajax({
                type: "POST",
                url: "solicitud_entrada_chofer_tag.aspx/IsAvailableTG",
                data: '{ruccipas: "' + rucrazsocial + '", cipas: "' + $("#<%=txtcipas.ClientID%>")[0].value + '" }',
        ...
        function ViewForm(id) {
            var rucrazsocial = document.getElementById('rucrazsocial').innerHTML;
            if (validateHF(rucrazsocial)) {
                var r = alert('En la pantalla a continuación, de click en el boton Crear Permiso(s) para registar el ingreso.');
                if (r == true) {
                    window.open('../transportista/consulta-solicitud-colaborador-tag-existente/?numsolicitud=' + id, '_blank', 'width=1500,height=480');
                    window.location = '../transportista/registra-solicitud-entrada-chofer-tag';
                }
                else {
                    window.open('../transportista/consulta-solicitud-colaborador-tag-existente/?numsolicitud=' + id, '_blank', 'width=1500,height=480');
                ...
                var r = alert('En la pantalla a continuación realice la toma de huella y foto del conductor,\ny luego de click en el boton Crear Permiso(s) para registar el ingreso.');
                if (r == true) {
                    window.open('../transportista/consulta-solicitud-colaborador-tag-nuevo/?numsolicitud=' + id, '_blank', 'width=1500,height=480');
                    window.location = '../transportista/registra-solicitud-entrada-chofer-tag';
                }
                else {
                    //window.location = '../cuenta/menu.aspx';
            ...
            /*
            if (vals = '0') {
                window.open('../transportista/consulta-solicitud-colaborador/?numsolicitud=' + id);
        ...
        function popupCallbackEmp(objeto, catalogo) {
            if (objeto == null || objeto == undefined) {
                alert('Hubo un problema al setaar un objeto de catalogo');
                return;
            }
            //alert(objeto.ruc + ' - ' + objeto.razonsocial);
            document.getElementById('valciatransbuscar').textContent = '';
            document.getElementById('rucciatrans').value = objeto.ruc;
            document.getElementById('rucrazsocial').innerHTML = objeto.ruc + ' - ' + objeto.razonsocial;
            document.getElementById('rucrazsocial').style = " width:525px"
            document.getElementById('<%=hfRazSocial.ClientID %>').value = objeto.ruc + ' - ' + objeto.razonsocial;
        }
        ...
        function fvalidaCriterios() {
            ...
            if (true/*renovacion*/) {
                ...
                */
                var vals = document.getElementById('<%=txtcipas.ClientID %>').value;
                if (vals == '' || vals == null || vals == undefined) {
                    document.getElementById('<%=txtcipas.ClientID %>').focus();
                    document.getElementById('<%=txtcipas.ClientID %>').style.cssText = "background-color:#ffffc6;color:Red;width:200px;";
                    /*if (cedula) {*/
                    alert('Escriba la Cedula o Pasaporte del Colaborador.');
                    return false;
                    /*}
                    if (nombres) {
...
//                document.getElementById('<%=txtfecexplic.ClientID %>').value = "";
        ...
        function openPopEmp() {
            window.open('../transportista/catalogo-cia-transporte', 'name', 'width=1260,height=480');
            return false;
        }
        function setValRazSocial() {
            document.getElementById('valciatransbuscar').textContent = '';
            document.getElementById('rucrazsocial').innerHTML = document.getElementById('<%=hfRazSocial.ClientID %>').value;
            document.getElementById('rucrazsocial').style = " width:525px";
        }
        function modalPanel() {
