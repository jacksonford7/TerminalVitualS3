...
//    window.open('../reportes/wbreporteproforma?id_comprobante='+opcion, 'name', 'width=700,height=700');
//    return true;
//}
...
function addrow() {
    ...
    if (xrowcounter > 50) {
        alert('El máximo de documentos que se pueden consolidar es 50 por contenedor, ha llegado al límite');
        return;
    }
...
function checkDC(control, validador, opcional) {
    try {
        control.style.cssText = "background-color:#999999;color:#000000;";
        var codigo;
        ...
        control.style.cssText = "background-color:none;color:none;"
