<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="listadoproformaimpo.aspx.cs" Inherits="CSLSite.listadoproformaimpo" %>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone">
                                    <a href="../reportes/proforma_preview.aspx?id_comprobante=<%#securetext(Eval("PF_ID")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</button></a>
