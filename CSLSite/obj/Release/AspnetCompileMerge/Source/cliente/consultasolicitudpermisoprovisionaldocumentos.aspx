...
CodeBehind="consultasolicitudpermisoprovisionaldocumentos.aspx.cs" Inherits="CSLSite.consultasolicitudpermisoprovisionaldocumentos" %>
       ...
       <%--<div class="separator">Revisar los documentos solicitados:</div>--%>
        <div class="informativo">
         <table id="tablerp" cellpadding="1" cellspacing="0">
            ...
            <td ><asp:CheckBox runat="server" id="chkRevisado"/></td>
            <td><asp:TextBox ID="tcomentario" runat="server" onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
            </tbody>
        ...
        <%--</div>--%>
              ...
              <div class="col-md-12 d-flex justify-content-rigth">
              <img alt="loading.." src="../shared/imgs/loader.gif" id="loader" class="nover"  />
                <asp:Button ID="btsalvar" runat="server" Text="Regresar" ToolTip="Regresa a la pantalla Solicitud de Sticker/Provisional Vehícular."
                               OnClientClick="return prepareObject();" onclick="btsalvar_Click" CssClass="btn btn-outline-primary mr-4"/>
            </div>      
        </div>
      </div>
      </div>
