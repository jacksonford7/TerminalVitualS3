<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="emisionpasebrbk.aspx.cs" Inherits="CSLSite.emisionpasebrbk" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">EMISIÓN E-PASS CARGA BREAK BULK (BRBK)</li>
          </ol>
        </nav>
      </div>
...
<div class="dashboard-container p-4" id="cuerpo" runat="server"> 
     ...
     <div class="form-row"> 
        ...
        <h4 class="mb">DETALLE DEL HORARIO</h4>
         ...
         <div class="form-row">
                   ...
                   <asp:UpdatePanel ID="UPCANTIDADRETIRAR" runat="server"  UpdateMode="Conditional" >
                               <ContentTemplate>
                                <asp:TextBox ID="TxtCantidadRetirar" runat="server" class="form-control"    onkeypress="return soloLetras(event,'0123456789')" MaxLength="4"
                                    placeholder=""  Font-Bold="true" style="text-align:center" ></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
             </div>
                 <div class="form-group col-md-1">
               ...
               <div class="form-group col-md-1">
                 <label for="inputZip">Actual:<span style="color: #FF0000; font-weight: bold;"></span></label>
                   <asp:UpdatePanel ID="UPACTUAL" runat="server"  UpdateMode="Conditional" >
                               <ContentTemplate>
                                <asp:TextBox ID="TxtActual" runat="server" class="form-control"    onkeypress="return soloLetras(event,'0123456789')" MaxLength="10"
                                    placeholder=""  Font-Bold="true" style="text-align:center" Enabled ></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
             </div>
             <div class="form-group col-md-1">
                 <label for="inputZip">Pendiente Actual:<span style="color: #FF0000; font-weight: bold;"></span></label>
                   <asp:UpdatePanel ID="UPSALDOFINAL" runat="server"  UpdateMode="Conditional" >
                               <ContentTemplate>
                                <asp:TextBox ID="TxtSaldoFinal" runat="server" class="form-control"    onkeypress="return soloLetras(event,'0123456789')" MaxLength="10"
                                    placeholder=""  Font-Bold="true" style="text-align:center" Enabled ></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
             </div>
   ...
   <%-- <h3>DETALLE DE PASES A EMITIR</h3>--%>
     ...
     <asp:UpdatePanel ID="UPTEXTO" runat="server"  UpdateMode="Conditional" >
      <ContentTemplate>
        <h4 class="mb" id="text_detalle" runat="server">DETALLE DE PASES A EMITIR</h4>
     </ContentTemplate>
     </asp:UpdatePanel>
     ...
     $(function () {
        $('[id*=Txtempresa]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("emisionpasebrbk.aspx/GetEmpresas") %>',
                    data: "{ 'prefix': '" + request + "'}",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
     ...
     $(function () {
        $('[id*=TxtChofer]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("emisionpasebrbk.aspx/GetChofer") %>',
     ...
     $(function () {
        $('[id*=TxtPlaca]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("emisionpasebrbk.aspx/GetPlaca") %>',
                    data: "{ 'prefix': '" + request + "', 'idempresa' : '" + $("#IdTxtempresa").val() + "' }",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
