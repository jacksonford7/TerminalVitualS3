<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="autorizarpasepuerta.aspx.cs" Inherits="CSLSite.autorizarpasepuerta" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">AUTORIZACIÓN PARA GENERAR PASE DE PUERTA </li>
          </ol>
        </nav>
      </div>
        ...
        <ContentTemplate>
            <div class="form-row">
                <div class="form-group col-md-4"> 
                        <label for="inputZip">TIPO DE CARGA<span style="color: #FF0000; font-weight: bold;">*</span></label>
                        <asp:UpdatePanel ID="UpTipoCarga" runat="server"  UpdateMode="Conditional"  >
                        <ContentTemplate>
                        <asp:DropDownList runat="server" Font-Size="Small" ID="CboTipoCarga" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="CboTipoCarga_SelectedIndexChanged">
                                        <asp:ListItem Value="0" Text="* Seleccione *" />
                                            <asp:ListItem Value="CNTR" Text="Contenedor" />
                                            <asp:ListItem Value="CFS" Text="Carga Suelta CFS" />
                                            <asp:ListItem Value="BRBK" Text="Carga Break Bulk" />
                                        </asp:DropDownList>
                        </ContentTemplate>
                        </asp:UpdatePanel> 
                 ...
                 <div class="form-group col-md-4"> 
                        <label for="inputZip">TIPO AUTORIZACIÓN<span style="color: #FF0000; font-weight: bold;">*</span></label>
                        <asp:UpdatePanel ID="UpTipoAutorizacion" runat="server"  UpdateMode="Conditional"  >
                        <ContentTemplate>
                        <asp:DropDownList runat="server" Font-Size="Small" ID="CboTipoAutorizacion" AutoPostBack="true" class="form-control"  OnSelectedIndexChanged="CboTipoAutorizacion_SelectedIndexChanged">
                                        <asp:ListItem Value="1" Text="Crédito" />
                                            <asp:ListItem Value="2" Text="Sin Factura" />
                                            <asp:ListItem Value="3" Text="Cambio de Fecha" />
                                        </asp:DropDownList>
                        </ContentTemplate>
                        </asp:UpdatePanel> 
            ...
            <div class="form-row">
                 <div class="form-group col-md-4">
                    <label for="inputZip">FACTURA<span style="color: #FF0000; font-weight: bold;"></span></label>
                    <asp:TextBox ID="TxtFactura" runat="server" class="form-control" MaxLength="30"  onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')"  
                                        placeholder="FACTURA"></asp:TextBox>

                 </div>
                <div class="form-group col-md-4">
                    <label for="inputZip">CONTENEDOR<span style="color: #FF0000; font-weight: bold;"></span></label>
                    <asp:TextBox ID="TxtContenedor" runat="server" class="form-control" MaxLength="30"  onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')"  
                                        placeholder="CONTENEDOR"></asp:TextBox>

                 </div>
                 <div class="form-group col-md-4">
                    <label for="inputZip">COMENTARIO<span style="color: #FF0000; font-weight: bold;"></span></label>
                    <asp:TextBox ID="TxtComentario" runat="server" class="form-control" MaxLength="50"  onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')"  
                                        placeholder="COMENTARIO"></asp:TextBox>
                 ...
                 <div class="form-group col-md-12">
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="hidden-table-info">
                          ...
                          <tr>
                            ...
                            <th class="center hidden-phone">AUTORIZAR</th>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                               ...
                               <%-- <asp:Button ID="BtnActualizar" CommandArgument= '<%#Eval("CONTENEDOR")%>' runat="server" Text="Seleccionar" class="btn btn-primary" ToolTip="Actualizar Datos" CommandName="Actualizar" />--%>
                                      <asp:Label Text='<%#Eval("TIPO_CONSULTA")%>' ID="LblTipoCarga" runat="server"  />
                           </td> 
                ...
                <div class="row">
                 ...
                 <div class="row">
                     <div class="col-md-12 d-flex justify-content-center">
                        ...
                        <asp:Button ID="BtnGrabar" runat="server"  class="btn btn-primary"  Text="AUTORIZAR"  OnClientClick="return mostrarloader('2')" OnClick="BtnGrabar_Click" />
