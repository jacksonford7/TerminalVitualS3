<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="emisionpasecontenedor.aspx.cs" Inherits="CSLSite.emisionpasecontenedor" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">EMISIÓN E-PASS CONTENEDOR</li>
          </ol>
        </nav>
      </div>
         ...
         <div class="form-row"> 
              <div class="form-group col-md-4">
                ...
                <asp:TextBox ID="TxtContenedorSeleccionado" runat="server" class="form-control"    
                    placeholder="" size="16" Font-Bold="false" ></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
              </div>
              <div class="form-group col-md-4"> 
              ...
              <div class="form-group col-md-4"> 
                ...
                <asp:TextBox ID="TxtFechaCas" runat="server" class="form-control"    
                    placeholder="" size="10" Font-Bold="false"  ></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
              </div>
        </div>
