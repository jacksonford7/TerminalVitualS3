<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="cas_manual_brbk.aspx.cs" Inherits="CSLSite.cas_manual_brbk" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CARTA DE AUTORIZACIÓN DE SALIDA (CAS) - BREAK BULK</li>
          </ol>
        </nav>
      </div>
<div class="dashboard-container p-4" id="cuerpo" runat="server">
    ...
    <h4 class="mb">AUTORIZAR LA SIGUIENTE CARGA</h4>   
    ...
    <asp:UpdatePanel ID="UPMENSAJE" runat="server"  UpdateMode="Conditional" >
        <ContentTemplate>
           ...
           <div class="row">
            <div class="col-md-12 d-flex justify-content-center">			
                <div class="alert alert-warning" id="banmsg" runat="server" clientidmode="Static" >.....</div>
           </div>
          </div>      
        </ContentTemplate>
        </asp:UpdatePanel>
       ...
       <h4 class="mb">AUTORIZACIÓN DE SALIDA (CAS)</h4>                  
      <div class="form-row"> 
           <div class="form-group col-md-6">
                 ...
                 <div class="d-flex">
                     <asp:UpdatePanel ID="UPTODOS" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
                        <ContentTemplate>
                              ...
                              <asp:CheckBox ID="ChkTodos" runat="server"  Text="  Autorizar Todos"  OnCheckedChanged="ChkTodos_CheckedChanged"    AutoPostBack="True" />
                     ...
                     <ContentTemplate>
                     <asp:Button ID="BtnGrabar" runat="server" class="btn btn-primary"  Text="PROCEDER CON LA AUTORIZACIÓN (CAS)"  OnClick="BtnGrabar_Click" />      
                        </ContentTemplate> 
                        <Triggers>
	...
	<%-- <h4 class="mb">DETALLE DE LA CARGA CFS</h4> --%>
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server"  >  
       <ContentTemplate>
             ...
             <h3>DETALLE DE AUTORIZACIÓN DE SALIDA (CAS)</h3>
