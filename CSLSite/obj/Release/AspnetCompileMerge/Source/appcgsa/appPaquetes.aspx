<%@ Page Title="Paquetes" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="appPaquetes.aspx.cs" Inherits="CSLSite.appPaquetes" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">MANTENIMIENTO DE PAQUETES</li>
          </ol>
        </nav>
      </div>
       ...
       <asp:UpdatePanel ID="UPCARGA" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
        ...
        <div class="form-row">
                <div class="form-group col-md-12">
                        <label for="inputZip">PAQUETE<span style="color: #FF0000; font-weight: bold;"> &nbsp;*</span></label>
                 ...
                 <div class="form-group col-md-6">
                     <label for="inputEmail4">EVENTO N4:</label>
                     <div class="d-flex">
                           <asp:TextBox ID="TxtEvento" runat="server"  MaxLength="150"  class="form-control"   disabled ></asp:TextBox>  
                            <a class="btn btn-outline-primary mr-4" target="popup" onclick="window.open('../appcgsa/appListEventos.aspx','name','width=1024,height=800')"  id="buscar_eventos" runat="server" >
                             <span class='fa fa-search' style='font-size:24px' id="BtnBuscarEvento" clientidmode="Static"></span> </a>   
                         <asp:HiddenField ID="IdEvento" runat="server" ClientIDMode="Static"/> 
                     </div>    
                </div>   
                <div class="form-group col-md-6"></div>   
                <div class="form-group col-md-6">   
                    <asp:TextBox ID="TxtDescEvento" runat="server"  MaxLength="150"  class="form-control"   disabled ></asp:TextBox>  
                  ...
                  <div class="form-group col-md-12">
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="hidden-table-info">
                           ...
                           <tr >
                            ...
                            <th class="center hidden-phone">Evento N4</th>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("EventoN4")%>' ID="LblEventoN4" runat="server"  /></td>
...
<script type="text/javascript">
    ...
    function popupCallback_Eventos(lookup_get_evento)
    {
            if (lookup_get_evento.sel_g_id != null)
            {
                this.document.getElementById('<%= TxtEvento.ClientID %>').value = lookup_get_evento.sel_g_id;
                 this.document.getElementById('<%= TxtDescEvento.ClientID %>').value = lookup_get_evento.sel_g_nombre;
                this.document.getElementById('IdEvento').value = lookup_get_evento.sel_g_id;

            }
            else
            {

                this.document.getElementById('<%= IdEvento.ClientID %>').value = "";
                this.document.getElementById('<%= TxtEvento.ClientID %>').value = "";
                 this.document.getElementById('<%= TxtDescEvento.ClientID %>').value = "";
            }
