<%@ Page Title="Usuarios" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="consultausuario.aspx.cs" Inherits="CSLSite.admin.consultausuario" %>
  ...
  <%--              <div class="col-md-12 d-flex justify-content-center">
                                ...
                                <div id="xfinder" runat="server" visible="false">
                                    <div class="findresult">
                                        <div class="booking">
                                            ...
                                            <div class="form-group   col-md-2"> 
                                                <div class="form-title" >Listado de Opciones:</div>
                                            </div>
                                                ...
                                                <asp:Repeater ID="tablePagination" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="point"  id="trUsuario">
                                                            ...
                                                            <td>
                                                                <div class="tcomand">
                                                                    <input type="button" class="btn btn-primary" id="btVerUsusario" value="Modificar" tooltip="Carga la información del usuario para modificarla"
                                                             ...
                                                             <td>
                                                                <div class="tcomand">
                                                                    <input type="button" class="btn btn-primary" id="btOpcionesUsusario" value="Opciones" tooltip="Carga la información de opciones asignadas al usuario"
                                                                        onclick="setUserOp('<%#Eval("idUsuario")%>')" />
                                                                </div>
                                                            </td>

                                                            <td>
                                                                <div class="tcomand">
                                                                    <input type="button" id="btRestablecer" class="btn btn-outline-primary mr-4" value="Reestablecer Clave"
    ...
    <script type="text/javascript">
        ...
        function setUser(user) {
            ...
            location.href = "../admin/datosusuario.aspx";
        }

        //Esta funcion cargara los datos del servicio seleccionado para modificar
        function setUserOp(user) {

            $("#<%=hdfIdUsuario.ClientID%>").val(user); //set value
            $("#<%=btSetearId.ClientID%>").click(); //set value
            location.href = "../admin/usuario_permisos.aspx";
        }
