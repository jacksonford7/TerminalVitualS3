<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="menu_backup.aspx.cs" Inherits="CSLSite.cuenta.menu_backup" %>
 ...
 <table width="724" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <!-- Modal -->
    ...
    <asp:Panel ID="Panelleydatos" runat="server" CssClass="modalPolitica" align="center" Style="display: none"  TabIndex="-1"  >
         <div>
  ...
  <strong>Actualizaci&oacute;n de la pol&iacute;tica</strong><strong> </strong><br />
      ...
      <p align="justify">Declaro:&nbsp; que he le&iacute;do la Pol&iacute;tica de Protecci&oacute;n y  Tratamiento de Datos personales de Contecon Guayaquil S.A., por lo que acepto  su contenido y alcance, por estar acorde con la LOPDP.</p>      <div>
        <div> </div>
        <div> </div>
      </div></td>
  </tr>
