<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_naves.aspx.cs" Inherits="CSLSite.autorizaciones.lookup_naves"  Title="Buscar Referencias" %>
         ...
         <div class="form-group col-md-12"> 
             ...
             <div id="xfinder" runat="server" visible="false" >
                 ...
                 <tr class="point" onclick="setGrupos(this);">
                  <td scope="row"><%#Eval("number")%></td>
                  <td scope="row"><%#Eval("codigo")%></td>
                  <td scope="row"><%#Eval("descripcion")%></td>
                  <td scope="row"><%#Eval("rol")%></td>
   ...
   <script type="text/javascript" >
       ...
       function setGrupos(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_naves = {
                  sel_g_id_numero: celColect[0].textContent,
                  sel_g_nave: celColect[1].textContent,
                  sel_g_descripcion: celColect[2].textContent      
              };
           if (window.opener != null) {

               window.opener.popupCallback_Naves(lookup_get_naves);
           }
