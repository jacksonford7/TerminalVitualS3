<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_linea_naviera.aspx.cs" Inherits="CSLSite.autorizaciones.lookup_linea_naviera"  Title="Buscar Líneas Navieras" %>
   ...
   <div class="dashboard-container p-4" id="cuerpo" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-12"> 
              <label for="inputEmail4">Nombre de la línea naviera:</label>
             <div class="d-flex">
    ...
    <script type="text/javascript" >
       ...
       function setGrupos(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_linea = {
                  sel_g_id_linea: celColect[0].textContent,
                  sel_g_nombre_linea: celColect[1].textContent,
                 
           };

           if (window.opener != null) {

               window.opener.popupCallback_Lineas(lookup_get_linea);
           }
