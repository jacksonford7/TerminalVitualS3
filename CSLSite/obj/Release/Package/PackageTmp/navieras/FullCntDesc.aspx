<%@ Page Title="Descarga de Contenedor" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
    CodeBehind="FullCntDesc.aspx.cs" Inherits="CSLSite.fcont_desc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="606" />
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Mis Naves</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Full Containers Discharge Report</li>
            </ol>
        </nav>
    </div>
                                        ...
                                        <div class="booking">
                                            <table>
                                                 <tr>
                                                     ...
                                                     <td>
                                                        <input class="btn btn-primary" clientidmode="Static" id="dataexport" onclick="getTable('reportDescFul');" type="button" value="Exportar" runat="server" />
                                                     </td>
                                                 </tr>
                                             </table>
                                            <br />
