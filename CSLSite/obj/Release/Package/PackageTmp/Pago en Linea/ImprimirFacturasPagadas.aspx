<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/Pago en Linea/ImprimirFacturasPagadas.aspx.cs" Inherits="CSLSite.Pago_en_Linea.ImprimirFacturasPagadas" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Imprimir Facturas Pagadas</title>
...
<div id="hoja">
     ...
     <tr><td style="text-align:center" colspan="2"><h2>FACTURAS PAGADAS POR ANTICIPO</h2></td></tr>
     </table>
     </div>
     <div class="seccion">
     <div class="accion">
     ...
     <tr><td class="bt-top" rowspan="4"><span id="servicio">Liquidación No.</span></td>
     ...
     <div class="accion">
      ...
      <table class="xcontroles" cellspacing="0" cellpadding="0">
        <tr><th class=" bt-top bt-bottom bt-right  bt-left"> Detalle de Facturas</th></tr>
         ...
         <div>
                 ...
                 <HeaderTemplate>
                    ...
                    <thead>
                       <tr><th>Numero Liquidación</th><th>Monto Factura</th><th>Monto Pagado</th></tr>
                    </thead>
                 </HeaderTemplate>
                 <ItemTemplate>
                 <tr class="point" >
                  <td><%#Eval("NUMERO_LIQUIDACION")%></td>
                  <td><%#Eval("MONTO_FACTURA")%></td>
                  <td><%#Eval("MONTO_PAGADO")%></td>
                 </tr>
                  </ItemTemplate>
                 <FooterTemplate>
                 </tbody>
         ...
         <table class="totales" cellpadding="0" cellspacing="0">
                <tr><td  class='filat'>TOTAL</td><td class="estotal" style="width: 800px"><span id='sttal' runat="server" clientidmode="Static" >$0000.00</span></td></tr>
          </table>
          </div>
         </div>
