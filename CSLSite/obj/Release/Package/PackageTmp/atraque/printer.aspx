...
<div id="hoja">
     ...
     <tr><td colspan="2"><h1>SOLICITUD DE ATRAQUE</h1>  </td></tr>
     </table>
     </div>
     <div class="seccion">
     <div class="accion">
     ...
     <td class="bt-top " ><span class="service" runat="server" id="anumber" style=" font-size:2em!important;">CGS20160000</span></td>
        ...
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="4">DATOS DE FECHAS Y OPERACIÓN</th></tr>
         ...
         <td class="bt-bottom bt-right">
          <span id="ope_atd" runat="server" class="labelprint">0000/00/000 00:00</span>
            ...
            <tr>
         <td class="bt-bottom  bt-right bt-left" >Tipo de operación</td>
         <td class="bt-bottom" colspan="1">
          <span id="operacion" runat="server" class="labelprint">..</span>
         </td>
         <td class="bt-bottom  bt-right bt-left">Fecha de embarque de contenedores planificado</td>
         <td class="bt-bottom bt-right">
          <span id="fecembarque" runat="server" class="labelprint">0000/00/000 00:00</span>
         </td>
         </tr>
            <tr>
         <td class="bt-bottom  bt-right bt-left" >Cutoff (BNN)</td>
         <td class="bt-bottom" colspan="1">
          <span id="fecbanano" runat="server" class="labelprint">..</span>
         </td>
         <td class="bt-bottom  bt-right bt-left"></td>
         <td class="bt-bottom bt-right">
          <span id="NEWX" runat="server" class="labelprint"></span>
         </td>
         </tr>
     </table>
     ...
     <div class="informativo bt-left bt-right bt-bottom">
      ...
      <td class="level3">
        ...
        Los datos proporcionados son de entera responsabilidad de quien los consigna, por lo que CONTECON GUAYAQUIL S.A. no se responsabiliza por cualquier error o falsedad que los mismos pudieren tener, siendo de cuenta del cliente todos los gastos y perjuicios que por dicho error se ocasionen a la carga.
          <br />
          Esta solicitud de atraque, no implica la aceptación de la nave o asignación de muelle.<br />
