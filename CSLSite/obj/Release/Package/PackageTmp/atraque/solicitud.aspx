		         ...
		         <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">28.Tipo de operación<span style="color: #FF0000; font-weight: bold;"> *</span></label>
                           <div class="d-flex">
                            <label class="checkbox-container">
                                        <asp:radiobutton ID="RdbNaveContainera" ClientIDMode="Static" runat="server" text="Nave Containera" Checked="true" AutoPostBack="false" GroupName="containera" onclick="ckcupos();" />
                                        <span class="checkmark"></span>
                                    </label>
                                    <label for="inputEmail4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <label class="checkbox-container"> 
                                        <asp:radiobutton ID="RdbMixta" ClientIDMode="Static" runat="server" text="Operación mixta" Checked="false"  AutoPostBack="false" GroupName="containera" onclick="ckcupos();" />
                                        <span class="checkmark"></span>
                                    </label>
                                    <label for="inputEmail4">&nbsp;&nbsp;&nbsp; </label>
                   ...
                   <div class="form-group col-md-6">
                        ...
                        <input type="text" id="fecembarque" maxlength="10" class="datetimepicker form-control"
                            onkeypress="return soloLetras(event,'1234567890/',true)"
                            onblur="valDate(this,true,valfecfum1);"
                            data-toggle="tooltip" data-placement="top"  />
                        <span class="opcional" id="valfecfum1"></span>
                </div>
                  <div class="form-group col-md-6">
                        <label for="inputEmail4">30. Cutoff   (BNN)</label>
                        <input type="text" id="fecbanano" maxlength="10" class="datetimepicker form-control"
                            onkeypress="return soloLetras(event,'1234567890/',true)"
                            onblur="valDate(this,true,valfecfum2);"
                            data-toggle="tooltip" data-placement="top"  />
                        <span class="opcional" id="valfecfum2"></span>
                </div>
    ...
    <script type="text/javascript">
      ...
      function populateObject(objeto, arreglo) {
       ...
       //   alert('P5');
          ...
          objeto.fecembarque = (document.getElementById('fecembarque').value != undefined) ? document.getElementById('fecembarque').value : '';
          objeto.fecbanano = (document.getElementById('fecbanano').value != undefined) ? document.getElementById('fecbanano').value : '';
          objeto.operacion = (document.getElementById('RdbMixta').value != undefined) ? document.getElementById('RdbMixta').checked : '';
      }
        $(document).ready(function () {
