...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <input id="intentos" type="hidden"  runat="server" clientidmode="Static" />
    <input id="horas" type="hidden" runat="server" clientidmode="Static" />
    <input id="estado" type="hidden" runat="server" clientidmode="Static" />
                                                        ...
                                                        <tr class="point" >
                                                            ...
                                                            <div class="tcomand">
                                                              ...
                                                              <td class="center hidden-phone"> 
                                                                ...
                                                                CommandArgument= '<%#Eval("referencia")%>' runat="server" Text="ACTUALIZAR"  class="btn btn-primary" data-toggle="modal" data-target="#exampleModalToggle" ToolTip="ACTUALIZAR SOLICITUD DE ATRAQUE" CommandName="Ver" OnClientClick="handleClick();"/>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
...
<div class="modal fade" id="exampleModalToggle" tabindex="-1" role="dialog" >
    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 1500px">
        ...
        <div class="modal-content"> 
             ...
             <div class="dashboard-container p-4" id="Div1" runat="server" onclick="ckcupos();">   
                           ...
                           <%--        <label for="inputEmail4">24. <strong>ETA:</strong>  Fecha estimada de Atraque muelle CGSA <span style="color: #FF0000; font-weight: bold;"> *</span></label> --%>
                    	     ...
                    	     <div class="form-row">
		                        ...
		                        <div class="form-group col-md-3">
                                 ...
                                 <div class="form-group col-md-3">
                                      <asp:UpdatePanel ID="UPFECHAETS" runat="server"  UpdateMode="Conditional"  >
                                       <ContentTemplate>
                                    <label for="inputEmail4">27.<strong> ETD:</strong>  Fecha estimada de zarpe <span style="color: #FF0000; font-weight: bold;"> *</span></label>
                                    <div class="d-flex">
                                        <asp:TextBox ID="tets" runat="server" CssClass="datetimepicker form-control"  MaxLength="16" ClientIDMode="Static" ReadOnly="true" disabled Visible="false"></asp:TextBox>
                                         <asp:TextBox ID="tetscambio" runat="server" CssClass="datetimepicker form-control"  MaxLength="16" ClientIDMode="Static" ReadOnly="true" disabled></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-6">
                                       ...
                                       <ContentTemplate>
                                    <label for="inputEmail4">28.Tipo de operación<span style="color: #FF0000; font-weight: bold;"> *</span></label>
                                       <div class="d-flex">
                                       
                                                    <asp:radiobutton ID="RdbNaveContainera" ClientIDMode="Static" runat="server" text="Nave Containera" Checked="true" AutoPostBack="false" GroupName="containera"   />
                                                  
                                               
                                                <label for="inputEmail4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                           
                                                    <asp:radiobutton ID="RdbMixta" ClientIDMode="Static" runat="server" text="Operación mixta" Checked="false"  AutoPostBack="false" GroupName="containera"   />
                                 ...
                                 <div class="form-group col-md-6">
                                     <label for="inputEmail4">29. Fecha de embarque de contenedores planificado</label>
                              
                                    <div class="d-flex">
                                        <label for="inputZip" style="width:200px;">Anterior:</label>
                                         <asp:UpdatePanel ID="UPFECHAEMBARQUE" runat="server"  UpdateMode="Conditional"  >
                                       <ContentTemplate>
                                         
                                         <asp:TextBox ID="Txtfecembarque" runat="server" MaxLength="16"  class="form-control" 
                                                        ClientIDMode="Static" disabled Width="200px" >
                                        </asp:TextBox>
                                        </ContentTemplate> 
                                        </asp:UpdatePanel>
                                        ...
                                        <asp:TextBox ID="fecembarque" runat="server" MaxLength="16" 
                                        onkeypress="return soloLetras(event,'1234567890/ ')" 
                                         onblur="valDate(this,true,valfecfum);"
                                        CssClass="datetimepicker form-control"
                                        placeholder="Fecha de embarque (Nuevo)" ClientIDMode="Static">
                                        </asp:TextBox>
                                        <span id="valfecfum" class="opcional"> * </span>
                                             
                                    </div>
                                </div>

                                  <div class="form-group col-md-6">
                                     <label for="inputEmail4">30. Cutoff   (BNN)</label>
                              
                                    <div class="d-flex">
                                        <label for="inputZip" style="width:200px;">Anterior:</label>
                                         <asp:UpdatePanel ID="UPBANANO" runat="server"  UpdateMode="Conditional"  >
                                       <ContentTemplate>
                                         
                                         <asp:TextBox ID="Txtfecbanano" runat="server" MaxLength="16"  class="form-control" 
                                                        ClientIDMode="Static" disabled Width="200px" >
                                        </asp:TextBox>
                                        </ContentTemplate> 
                                        </asp:UpdatePanel>
                                       ...
                                       <asp:TextBox ID="fecbanano" runat="server" MaxLength="16" 
                                        onkeypress="return soloLetras(event,'1234567890/ ')"                                       
                                        CssClass="datetimepicker form-control"
                                        placeholder="Cutoff   (BBK) (Nuevo)" 
                                           ClientIDMode="Static"
                                           >
                                        </asp:TextBox>
                                        <span id="valfecfum2" class="opcional"> * </span>
                                  ...
                                  <div class="nover">
                                  <asp:UpdatePanel ID="UPOCULTOS" runat="server"  UpdateMode="Conditional"  >
                                       <ContentTemplate>

                                        <asp:TextBox ID="Txthoras" runat="server" MaxLength="16"  class="form-control" 
                                                        ClientIDMode="Static" visible="true" >
                                        </asp:TextBox>
                                            <asp:TextBox ID="TxtContador" runat="server" MaxLength="16"  class="form-control" 
                                                        ClientIDMode="Static" visible="true" >
                                        </asp:TextBox>

                                            <asp:TextBox ID="Txtetd" runat="server" MaxLength="16"  class="form-control" 
                                                        ClientIDMode="Static" visible="true" >
                                        </asp:TextBox>
                                       </ContentTemplate> 
 ...
 <script type="text/javascript">
     ...
     function handleClick()
     {
        ...
        document.getElementById('tetb').value = "";
         document.getElementById('teta').value = "";
          document.getElementById('fecembarque').value = "";
         document.getElementById('fecbanano').value = "";
     }
    ...
    var fechae_ant = this.document.getElementById('tetb_ant').value;

    if (choras == '' || isNaN(choras))
    {
        return;
    }
    ...
    var dateString =  dae.getFullYear() + "/" + month + "/" +  day  + " " + hours + ":" + minutes
    this.document.getElementById('tetscambio').value = dateString;
     }
...
<script type="text/javascript">
    ...
    function ckcupos()
    {
       ...
       var cont = document.getElementById('RdbNaveContainera').checked;

       var int = document.getElementById('TxtContador').value;
       var hor = document.getElementById('Txthoras').value;
       ...
       var pestado = document.getElementById('estado').value;
        ...
        {
          //BLOQUEA
            document.getElementById('fecembarque').disabled = false;
            document.getElementById('fecbanano').disabled = false;
        }
        ...
        if (hor == "36")
        {
            ...
            document.getElementById('tetb').disabled = true;
            document.getElementById('teta').disabled = true;
            document.getElementById('thoras').disabled = true;
            document.getElementById('fecembarque').disabled = true;
        }
        if (hor == "0" && int != "2") {
            //document.getElementById('tetb').value = "";
            ...
            //BLOQUEA
            document.getElementById('tetb').disabled = false;
            document.getElementById('teta').disabled = false;
            document.getElementById('thoras').disabled = false;
            document.getElementById('fecembarque').disabled = false;
        }
    ...
    <script type="text/javascript">
         ...
         $(document).ready(function() {
            ...
            setInterval(ejecutarvalidacion, 1000);
         });
