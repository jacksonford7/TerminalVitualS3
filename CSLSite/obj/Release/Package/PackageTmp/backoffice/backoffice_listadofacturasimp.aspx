<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="backoffice_listadofacturasimp.aspx.cs" Inherits="CSLSite.backoffice.backoffice_listadofacturasimp" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE FACTURAS EMITIDAS</li>
          </ol>
        </nav>
      </div>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone">
                                    <a href="../reportes/factura_preview.aspx?id_comprobante=<%#securetext(Eval("IV_ID")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> </button></a>
