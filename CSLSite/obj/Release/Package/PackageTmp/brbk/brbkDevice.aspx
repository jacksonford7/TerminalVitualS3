<%@ Page Title="Configuración de Dispositivos BRBK" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkDevice.aspx.cs" Inherits="CSLSite.brbk.brbkDevice" %>
  ...
  <div id="div_BrowserWindowName" style="visibility:hidden;">
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="Li1" runat="server"><a href="#">Cargas Break Bulk</a></li>
            <li class="breadcrumb-item active" aria-current="page" id="Li2" runat="server">DISPOSITIVOS</li>
          </ol>
        </nav>
      </div>
         ...
         <div class="form-row">
             ...
             <div class="form-group col-md-4"> 
                <label for="inputAddress">Item :<span style="color: #FF0000; font-weight: bold;"></span></label>
                  <div class="d-flex">
                    <asp:TextBox ID="txtImei" runat="server" MaxLength="250" 
                            onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890')" 
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server"  >  
       <ContentTemplate>
           ...
           <section class="wrapper2">
            <h4 class="mb">LISTA DE DISPOSITIVOS</h4>
             <div class="row mb">
             <div class="col-lg-12">
                  ...
                  <div class="adv-table">
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="hidden-table-info">
                          ...
                          <tr style="background-color:#F4F4F4">
                            ...
                            <th class="center hidden-phone">IMEI</th>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone"><%#Eval("imei")%></td>
