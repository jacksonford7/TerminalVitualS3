<%@ Page Title="Descarga" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkDescarga.aspx.cs" Inherits="CSLSite.brbk.brbkDescarga" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">DESCARGA</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
                                    ...
                                    <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnEditar" Height="30px" CommandName="Editar" Text="Ver"  CommandArgument='<%# Bind("idTarjaDet") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal3"  />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="IMDT" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnIMDT" Height="30px" CommandName="IMDT" Text="..."  CommandArgument='<%# Bind("idTarjaDet") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal"  />                                                                                                                           
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="BL.N4" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnN4" Height="30px" CommandName="N4" Text="..."  CommandArgument='<%# Bind("idTarjaDet") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal2"  />                                                                                                                           
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="LIQUIDAR" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnLiquidacion" Height="30px" CommandName="Liquidacion" Text="..."  CommandArgument='<%# Bind("idTarjaDet") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal1"  />                                                                                                                                                                               
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <div class="modal-dialog" role="document" style="max-width: 1000px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">LIQUIDACIÓN</h5>
                                ...
                                <asp:Panel ID="Panel1" runat="server">         
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="d-flex">
                                                <asp:TextBox ID="txtLiqCargaNum"  runat="server" class="form-control"   placeholder=""  Font-Bold="false" disabled></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group   col-md-2"> 
                                            ...
                                            <asp:TextBox ID="txtLiqPeso" runat="server" MaxLength="3" class="form-control" 
                                                onkeypress="return soloLetras(event,'1234567890',true)" 
                                                placeholder="KL"
                                                ></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-group   col-md-2"> 
                                            ...
                                            <asp:TextBox ID="txtLiqCubicaje" runat="server" MaxLength="3" class="form-control" 
                                                onkeypress="return soloLetras(event,'1234567890.',true)" 
                                        ...
                                        <div class="form-group col-md-2">
                                            <span class="help-block">&nbsp;</span>
                                                ...
                                                <asp:UpdatePanel ID="UPFECHA" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                    <ContentTemplate>
                                                        &nbsp;&nbsp;<asp:CheckBox ID="chkSobredimensionado" runat="server" class="list-child" Text="Sobredimensionado"  />
                                                    </ContentTemplate> 
                                                    <Triggers>
                                        ...
                                        <div class="form-group col-md-6"> 
                                            ...
                                            <div class="d-flex">
                                                <asp:TextBox ID="txtLiqConsignatario" runat="server" MaxLength="100" 
                                                    placeholder="CLIENTE"
                                                    disabled
                                                    class="form-control"
                                        ...
                                        <%--<div class="form-group col-md-3"> --%>
                                            ...
                                            <%--<div class="d-flex">--%>
                                                <asp:DropDownList visible="false" ID="cmbLiqUbicacion" class="form-control"  runat="server" Font-Size="Medium" Font-Bold="true">
                                                </asp:DropDownList>
                                            ...
                                            <div class="bokindetalle" style="width:100%; overflow:auto">       
                                                <asp:GridView ID="dgvLiquidacion" runat="server" AutoGenerateColumns="False"  DataKeyNames="idliquidacion"
                                                    ...
                                                    <Columns>     
                                                        ...
                                                        <asp:BoundField DataField="carga"  HeaderText="CARGA" Visible ="false" SortExpression="consignatario" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                        ...
                                                        <asp:TemplateField HeaderText="OVERSIZE" ItemStyle-CssClass="center hidden-phone" >
                                                            <ItemTemplate>
                                                                <asp:UpdatePanel ID="UPOVERSIZED" runat="server" ChildrenAsTriggers="true">
                                                                    <ContentTemplate>
                                                                        <asp:CheckBox ID="CHKOVERSIZED" runat="server" Checked='<%# Bind("sobredimensionado") %>'  CssClass="center hidden-phone" Enabled="false"/>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="Panel2" runat="server">         
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3"> 
                                                    <label for="inputAddress">Condicion :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                ...
                                                <div class="form-group col-md-3"> 
                                                    ...
                                                    <div class="d-flex">
                                                        <asp:DropDownList ID="cmbUbicacion" class="form-control" runat="server" Font-Size="Medium" Font-Bold="true" disabled >
                                                        </asp:DropDownList>
                                                ...
                                                <div class="form-group col-md-12"> 
                                                    ...
                                                    <div class="d-flex"> 
                                                        <asp:TextBox  class="form-control"  ID="txtobservacion" runat="server" disabled MaxLength="100" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890/')"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <section class="wrapper2">
                                            <%--<div class="row mb"> --%>
                                                <div class="content-panel">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 d-flex justify-content-center">
                                                            <asp:Button ID="btnActualizar" runat="server" class="btn btn-primary"  Text="GENERAR DESCARGA DEFINITIVA"  OnClientClick="return mostrarloader('1')" OnClick="btnActualizar_Click"  />
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                             <asp:Button ID="btnGenerarIMDT" runat="server" class="btn btn-default"  Text="SI" OnClick="btnGenerarIMDT_Click"  UseSubmitBehavior="false" data-dismiss="modal" />
        ...
        <asp:UpdatePanel ID="UPMENSAJE2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">  
             <ContentTemplate>
                  ...
                  <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabels">Confirmar Generación</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                          
                        </div>
                        <div class="modal-body">
                            <br/>
                                Si usted da click en SI, se procederá a generar el BL en N4 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <br>
                            </br/>
                        ...
                        <div class="modal-footer">
                             <asp:Button ID="btnGenerarBL" runat="server" class="btn btn-default"  Text="SI" OnClick="btnGenerarBL_Click"  UseSubmitBehavior="false" data-dismiss="modal" />
                          <button type="button" class="btn btn-primary" data-dismiss="modal">NO</button>
                        </div>
                      </div>
                    </div>
            ...
            <Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnGenerarBL" />
            </Triggers>
         </asp:UpdatePanel>   
