<%@ Page Title="Configuración de Productos BRBK" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkProducto.aspx.cs" Inherits="CSLSite.brbk.brbkproducto" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">PRODUCTOS</li>
          </ol>
        </nav>
      </div>
         ...
         <div class="form-row">
             ...
             <div class="form-group col-md-2"> 
                <label for="inputAddress">Item :<span style="color: #FF0000; font-weight: bold;"></span></label>
                  <div class="d-flex">
                        <asp:DropDownList ID="cmbItem" class="form-control" runat="server" Enabled="false" Font-Size="Medium" Font-Bold="true" ></asp:DropDownList>
                        <a class="tooltip" ><span class="classic" >categoría de producto</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
                  </div>
             </div>
              ...
              <div class="form-group col-md-3"> 
                <label for="inputAddress">Maniobra 1:<span style="color: #FF0000; font-weight: bold;"></span></label>
                  <div class="d-flex">
                        <asp:DropDownList ID="cmbManiobra" class="form-control" runat="server" Enabled="false" Font-Size="Medium"  Font-Bold="true" ></asp:DropDownList>
              ...
              <div class="form-group col-md-3"> 
                <label for="inputAddress">Maniobra 2:<span style="color: #FF0000; font-weight: bold;"></span></label>
                  <div class="d-flex">
                        <asp:DropDownList ID="cmbManiobra2" class="form-control" runat="server" Enabled="false" Font-Size="Medium"  Font-Bold="true" ></asp:DropDownList>
                        <a class="tooltip" ><span class="classic" >Maniobras asociado al producto</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
                  </div>
             </div>
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server"  >  
       <ContentTemplate>
           ...
           <section class="wrapper2">
            <h4 class="mb">DETALLE DE PRODUCTOS</h4>
             <div class="row mb">
             <div class="col-lg-12">
                  ...
                  <div class="adv-table">
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="hidden-table-info">
                          ...
                          <tr style="background-color:#F4F4F4">
                            ...
                            <th class="center hidden-phone">MANIOBRA 1</th>
                              <th class="center hidden-phone">MANIOBRA 2</th>
                            <th class="center hidden-phone">CATEGORIA</th>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone"><%#Eval("maniobra2")%></td>
                                <td class="center hidden-phone"><%#Eval("categoria")%></td>
