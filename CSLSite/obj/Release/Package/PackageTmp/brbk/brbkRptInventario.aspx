<%@ Page Title="Reporte de Inventario" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkRptInventario.aspx.cs" Inherits="CSLSite.brbk.brbkRptInventario" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE DE INVENTARIO</li>
            </ol>
        </nav>
    </div>
                                      ...
                                      <asp:Repeater ID="grilla" runat="server"  >
                                       ...
                                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                                          ...
                                          <tr>
                                            ...
                                            <th class="th-sm">INGRESO BODEGA</th>
                                            ...
                                            <th class="th-sm">TARJA INGRESO</th>
                                            ...
                                            <th class="th-sm">PESO UNI</th>
                                            <th class="th-sm">NOVEDAD</th>
                                            <th class="th-sm">SOBREDIMENSIONADA</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr class="gradeC">
                                                <td class="center hidden-phone"> <%#Eval("fechaIngresoBodega")%></td>
                                                ...
                                                <td class="center hidden-phone"> <%#Eval("tarjaIngreso")%></td>
                                                <td class="center hidden-phone"> <%#Eval("categoria")%></td>
                                                <td class="center hidden-phone"> <%#Eval("producto")%></td>
                                                ...
                                                <td class="center hidden-phone"> <%#Eval("pesoUnitario")%></td>
                                                    ...
                                                    <asp:UpdatePanel ID="UPSELECCIONAR" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="checkbox-container">
                                                                <%#Eval("Novedad")%>
                                                                <asp:CheckBox id="Check" runat="server"  Checked='<%#Eval("Novedad")%>'  />
                                                ...
                                                <td class="center hidden-phone"> 
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="checkbox-container">
                                                                <%#Eval("Sobredimensionada")%>
                                                                <asp:CheckBox id="CheckBox1" runat="server"  Checked='<%#Eval("Sobredimensionada")%>'  />
                                                                  <span class="checkmark"></span>
                                                             </label>
                                                        </ContentTemplate>
                                                         <Triggers>
