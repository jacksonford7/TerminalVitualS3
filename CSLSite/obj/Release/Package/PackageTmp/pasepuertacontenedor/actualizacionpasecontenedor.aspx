<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="actualizacionpasecontenedor.aspx.cs" Inherits="CSLSite.actualizacionpasecontenedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">ACTUALIZACIÓN E-PASS CONTENEDOR</li>
          </ol>
        </nav>
      </div>
 ...
 <div class="dashboard-container p-4" id="cuerpo" runat="server">
	  ...
	  <div class="form-row"> 			 
	        <div class="form-group col-md-2">
                ...
                <asp:TextBox ID="TxtContenedorSeleccionado" runat="server" class="form-control"    
                    placeholder=""  Font-Bold="false" disabled ></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
              </div>
              <div class="form-group col-md-2"> 
             ...
             <div class="form-group col-md-2"> 
                  <label for="inputZip">Fecha Horario/Ant.:<span style="color: #FF0000; font-weight: bold;"></span></label>
                  <asp:UpdatePanel ID="UPFECHAANTTURNO" runat="server"  UpdateMode="Conditional" >
                  <ContentTemplate>
                  <asp:TextBox ID="TxtFechaAntTurno" runat="server" class="form-control"    
                    placeholder=""  Font-Bold="false" disabled ></asp:TextBox>
                    </ContentTemplate>
                  </asp:UpdatePanel>
             </div>
            <div class="form-group col-md-2"> 
                  <label for="inputZip">Horario Ant.:<span style="color: #FF0000; font-weight: bold;"></span></label>
                  <asp:UpdatePanel ID="UPHORAANTTURNO" runat="server"  UpdateMode="Conditional" >
                  <ContentTemplate>
                  <asp:TextBox ID="TxtHoraAntturno" runat="server" class="form-control"    
                    placeholder=""  Font-Bold="false" disabled ></asp:TextBox>
                    </ContentTemplate>
                  </asp:UpdatePanel>
             </div>
             ...
             <div class="form-group col-md-2">
                 <label for="inputZip">Cia. Trans:<span style="color: #FF0000; font-weight: bold;">*</span></label>
                    <asp:TextBox ID="Txtempresa"  runat="server" class="form-control"  autocomplete="off" onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz0123456789_')"
                     ...
                     <asp:HiddenField ID="hf_transportista" runat="server" ClientIDMode="Static" />
             </div>
            <div class="form-group col-md-2">
                ...
                <asp:TextBox ID="TxtChofer"  runat="server" class="form-control"   autocomplete="off"  oncopy="return false;" onpaste="return false;"  
                        ...
                        <asp:HiddenField ID="IdTxtChofer" runat="server" ClientIDMode="Static"/>    
                             <asp:HiddenField ID="hf_chofer" runat="server" ClientIDMode="Static" /> 
             </div>
            <div class="form-group col-md-2">
                 <label for="inputZip">Placa: (opcional)<span style="color: #FF0000; font-weight: bold;"></span></label>
                   <asp:TextBox ID="TxtPlaca"  runat="server" class="form-control"   autocomplete="off"  oncopy="return false;" onpaste="return false;"  
                    ...
                    <asp:HiddenField ID="IdTxtPlaca" runat="server" ClientIDMode="Static"/>   
                      <asp:HiddenField ID="hf_placa" runat="server" ClientIDMode="Static" />      
             </div>
            <div class="form-group col-md-2">
    ...
    <h3>DETALLE DE TURNOS A MODIFICAR</h3>
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="hidden-table-info">
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <asp:Button ID="BtnActualizar" CommandArgument= '<%#Eval("CONTENEDOR")%>' runat="server" Text="Actualizar" class="btn btn-primary"  ToolTip="Actualizar Datos" CommandName="Actualizar" />
                           </td> 
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("MOSTRAR_MENSAJE")%>' ID="LblMensaje" runat="server"  />
                                    ...
                                    <br/> 
                                    <asp:Button ID="BtnEvento" CommandArgument= '<%#Eval("CONTENEDOR")%>' runat="server" Text="Facturar" 
                                         OnClientClick="this.disabled=true" UseSubmitBehavior="False"
                                        class="btn btn-primary" ToolTip="Generar Cargos a nueva Factura...Debe ir a la opción de Importaciones/Generar Factura Adiiconal." CommandName="Facturar" />
