...
<script type="text/javascript">
 ...
 function BindFunctions_Buscador()
 {
...
<script type="text/javascript">
 ...
 function BindFunctionsTareas() {
     ...
     $(document).ready(function() {
      ...
      $('#<%= tablePaginationTareas.ClientID %> thead tr').each(function() {
      });

      $('#<%= tablePaginationTareas.ClientID %> tbody tr').each(function() {
      });

 
      var oTable = $('#<%= tablePaginationTareas.ClientID %>').dataTable({
        "aoColumnDefs": [{
          "bSortable": false,
          "aTargets": [0]
        }],
      ...
      $('#<%= tablePaginationTareas.ClientID %> tbody td img').live('click', function() {
        var nTr = $(this).parents('tr')[0];
        if (oTable.fnIsOpen(nTr)) {
          /* This row is already open - close it */
          this.src = "../lib/advanced-datatable/media/images/details_open.png";
        ...
        <div class="form-row"> 
           <div class="form-group col-md-6">
             ...
             <div class="form-group col-md-6">
                  ...
                  <asp:UpdatePanel ID="UpEquipo" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                  <asp:DropDownList runat="server" ID="CboEquipo"     AutoPostBack="true"  class="form-control" OnSelectedIndexChanged="CboEquipo_SelectedIndexChanged"  >
                        </asp:DropDownList>      
                         </ContentTemplate> 
                        <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="CboEquipo" />
                    </Triggers>
                    </asp:UpdatePanel> 
             </div>
    ...
    <div class="form-row">  
        <div class="form-group col-md-12">
            ...
            <ContentTemplate>
                 ...
                 <div class="form-row">
                  <div class="form-group col-md-12">
                  <h3 id="LabelTotalTareas" runat="server">DETALLE DE TAREAS</h3>
                    <asp:Repeater ID="tablePaginationTareas" runat="server" onitemcommand="tablePaginationTareas_ItemCommand" onitemdatabound="tablePaginationTareas_ItemDataBound">
                       <HeaderTemplate>
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="tablePaginationTareas">
                           <thead>
                          <tr>
                            
                            <th class="center hidden-phone">#</th>
                            <th class="center hidden-phone">TAREA</th>
                            <th class="center hidden-phone">CUMPLIO</th>
                            <th class="center hidden-phone">NOVEDAD</th>
                            <th class="center hidden-phone">MOTIVO</th>
                        ...
                        <ItemTemplate>
                           <tr class="gradeC"> 
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("SECUENCIA")%>' ID="LblCarga" runat="server"  /></td>
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("TAREA")%>' ID="LblConsecutivo" runat="server"  /></td>
                                <td class="center hidden-phone">
                                     ...
                                     <asp:UpdatePanel ID="UPSELECCIONAR" runat="server" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                            ...
                                            <asp:CheckBox id="chkMarcar" runat="server"  Checked='<%#Eval("SELECCION")%>' AutoPostBack="True" OnCheckedChanged="chkMarcar_CheckedChanged" />
                                ...
                                <td class="center hidden-phone">
                                     ...
                                     <div class="d-flex">
                                         <asp:TextBox ID="TxtCodNovedad" runat="server" Text='<%#Eval("NOVEDAD")%>' MaxLength="200"  class="form-control"   disabled ></asp:TextBox>  
                                        ...
                                        <ContentTemplate>
                                           ...
                                           <asp:Button ID="BtnDetalle"
                                                CommandArgument= '<%#Eval("ID_TAREA")%>' runat="server" Text=".."  class="btn btn-outline-primary" data-toggle="modal" 
                                               data-target="#exampleModalToggle" ToolTip="VER NOVEDAD" CommandName="Ver" />
                                         </ContentTemplate>
                                              <Triggers>
                                ...
                                <td class="center hidden-phone">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                     <asp:TextBox ID="Txtcomentario" runat="server" Text='<%#Eval("COMENTARIO")%>' MaxLength="200"  class="form-control" AutoPostBack="true" OnTextChanged="TxtNewCantidad_TextChanged"    ></asp:TextBox>    </ContentTemplate>
                                              <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="Txtcomentario" />
                                            </Triggers>
                                        </asp:UpdatePanel>
         ...
         <div class="modal-content">
              <div class="dashboard-container p-4" id="Div1" runat="server">  
                   <div class="modal-header">
                       ...
                       <ContentTemplate>
                                    <h5 class="modal-title" id="Titulo" runat="server">Buscar Novedades</h5>
                           </ContentTemplate>
                        </asp:UpdatePanel>
                   ...
                   <div class="modal-body">
                        ...
                        <ContentTemplate>
                              <script type="text/javascript">
                                  Sys.Application.add_load(BindFunctions_Buscador);
                                   Sys.Application.add_load(BindFunctionsBuscar); 
                            </script>
                             <div class="form-row">
                                  <div class="form-group col-md-12">
                                 ...
                                 <div class="form-group col-md-12">
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="tablePaginationBuscador">
                                       <thead>
                                      <tr>
                                        <th class="center hidden-phone">ID NOVEDAD</th>                          
                                        <th class="center hidden-phone">NOVEDAD</th>
                                        <th class="center hidden-phone">TIPO EQUIPO</th>
                                        <th >SELECCIONAR</th>
                                      </tr>
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeC"> 
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("ID_NOVEDAD")%>' ID="LblId" runat="server"  /></td>
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("NOVEDAD")%>' ID="LblNovedad" runat="server"  /> </td>
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("DESCRIPCION")%>' ID="LblEquipo" runat="server"  /></td>
                                           
                                             <td> 
                                                 <asp:Button ID="BtnModificar"
                                                CommandArgument= '<%#Eval("ID_NOVEDAD")%>' runat="server" Text="SELECCIONAR" 
                                                      OnClientClick="CierraPopup();"
                                                     class="btn btn-primary" ToolTip="SELECCIONAR NOVEDAD" CommandName="Ver"  />
                                            </td>
                   ...
                   <asp:UpdatePanel ID="UPBOTONESNOVEDAD" runat="server" UpdateMode="Conditional" >  
                         <ContentTemplate>
