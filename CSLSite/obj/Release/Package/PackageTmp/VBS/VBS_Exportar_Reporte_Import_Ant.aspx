<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_Exportar_Reporte_Import_Ant.aspx.cs" Inherits="CSLSite.VBS_Exportar_Reporte_Import_Ant" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <script type="text/javascript">
        function exportarImport() {
            ...
            xhr.send(JSON.stringify({ fechaDesde: fechaDesde, cboBloqueId: cboBloqueId}));
        }
