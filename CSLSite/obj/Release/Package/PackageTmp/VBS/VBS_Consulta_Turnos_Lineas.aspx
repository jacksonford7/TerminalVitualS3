<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_Consulta_Turnos_Lineas.aspx.cs" Inherits="CSLSite.VBS_Consulta_Turnos_Lineas" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CONSULTAR TURNOS</li>
          </ol>
        </nav>
      </div>
     ...
     <div class="form-row">
          <div class="form-group col-md-6"> 
              <label for="inputAddress">LINEA:<span style="color: #FF0000; font-weight: bold;"></span></label>
                <asp:TextBox ID="TxtLinea" runat="server" class="form-control"  size="25" 
       ...
       <ContentTemplate>
             <script type="text/javascript">
              ...
              <div class="form-title">
                ...
                <ItemTemplate>
                    <tr class="gradeC">
                        <td class="center hidden-phone"> <%#Eval("IdLinea")%></td>
                        <td class="center hidden-phone"> <%#Eval("VigenciaInicial")%></td>
                        <td class="center hidden-phone"> <%#Eval("Horario")%></td>
                        <td class="center hidden-phone"> <%#Eval("Cantidad")%></td>
                        <td class="center hidden-phone"> <%#Eval("Asignados")%></td>
