<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_Duplicar_Turnos_Import.aspx.cs" Inherits="CSLSite.VBS_Duplicar_Turnos_Import" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Copiar Turnos de Importación</a></li>
    ...
    <script type="text/javascript">
        ...
        function InactivarHoras() {
            ...
            const mensaje = `¿Deseas Copiar las horas del día ${fechaDesdeFormat} Hasta: ${fechaHastaFormat} Para el Tipo De Bloque: ${cboBloqueTexto}?`;
            ...
            mostrarConfirmacion(mensaje,
                function () {
                    ...
                    $.ajax({
                        url: "VBS_Duplicar_Turnos_Import.aspx/DuplicarHorasImport",
