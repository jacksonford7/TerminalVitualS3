<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VBS_Cancelacion_Turnos_Import.aspx.cs" Inherits="CSLSite.VBS_Cancelacion_Turnos_Import" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InactivarHoras() {
            ...
            const mensaje = `¿Deseas Inactivar las horas del día ${fechaDesdeFormat} Hasta: ${fechaHastaFormat} Para el Tipo De Bloque: ${cboBloqueTexto}?`;
            ...
            mostrarConfirmacion(mensaje,
                function () {
                    ...
                    $.ajax({
                        url: "VBS_Cancelacion_Turnos_Import.aspx/InactivarHorasImport",
