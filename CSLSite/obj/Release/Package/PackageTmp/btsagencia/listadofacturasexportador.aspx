<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="listadofacturasexportador.aspx.cs" Inherits="CSLSite.listadofacturasexportador" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE FACTURAS - EXPORTADORES</li>
          </ol>
        </nav>
      </div>
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
       <ContentTemplate>
             <script type="text/javascript">
              ...
              <div class="form-title">
                    DETALLE DE FACTURAS - EXPORTADOR
              </div>
                ...
                <ItemTemplate>
                    <tr class="gradeC">
                        ...
                        <td class="center hidden-phone"> <%#Eval("EXPORTADOR")%></td>
                        ...
                        <td class="center hidden-phone">
                            <a href="../btsagencia/facturacionexportador_print.aspx?id_comprobante=<%#(Eval("FACTURA")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</button></a>
