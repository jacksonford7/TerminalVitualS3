<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="confirmarcajasagencia.aspx.cs" Inherits="CSLSite.confirmarcajasagencia" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CONFIRMACIÓN DE CAJAS MUELLE</li>
          </ol>
        </nav>
      </div>
     ...
     <asp:UpdatePanel ID="UPMUELLE" runat="server" UpdateMode="Conditional" >  
       <ContentTemplate>
          ...
          <%--  <asp:GridView ID="tableMuelle" runat="server" AutoGenerateColumns="False"  DataKeyNames="Fila" OnPageIndexChanging="tableMuelle_PageIndexChanging" OnPreRender="tableMuelle_PreRender"   OnRowDataBound="tableMuelle_RowDataBound" 
                    ...
                    <asp:BoundField DataField="cajas" HeaderText="CAJAS" DataFormatString="{0:N}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                   </Columns>
            </asp:GridView>--%>
                  
               <asp:Repeater ID="tableMuelle" runat="server" onitemcommand="tableMuelle_ItemCommand" onitemdatabound="tableMuelle_ItemDataBound">
                       <HeaderTemplate>
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="tableMuelle">
                           <thead>
                          <tr>
                            ...
                            <th class="center hidden-phone">CAJAS GRANEL</th>
                            <th class="center hidden-phone">CAJAS PALETIZADO</th>
                          </tr>
                        </thead>
                        <tbody>
                        </HeaderTemplate>
                        <ItemTemplate>
                           <tr class="gradeC"> 
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("codLine")%>' ID="LblcodLine" runat="server"  /></td>
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("cajas")%>' ID="LblCajas" runat="server"  /></td>
                                <td class="center hidden-phone">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                     <asp:TextBox ID="TxtCantidad" runat="server" Text='<%#Eval("cajas_confirmar")%>'  onkeypress="return soloLetras(event,'1234567890.')"
                                         MaxLength="10"  class="form-control" AutoPostBack="true" OnTextChanged="TxtNewCantidad_TextChanged"    ></asp:TextBox>    </ContentTemplate>
                                              <Triggers>
                             ...
                             <td class="center hidden-phone">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                     <asp:TextBox ID="TxtPaletizado" runat="server" Text='<%#Eval("cajas_paletizado")%>'  onkeypress="return soloLetras(event,'1234567890.')"
                                         MaxLength="10"  class="form-control" AutoPostBack="true" OnTextChanged="TxtPaletizado_TextChanged"    ></asp:TextBox>    </ContentTemplate>
                                              <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="TxtPaletizado" />
                                            </Triggers>
                                        </asp:UpdatePanel>
    ...
    <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            ...
            <br/>
             ...
             <div class="col-md-12 d-flex justify-content-center">
                   ...
                   <asp:Button ID="BtnFacturar" runat="server" class="btn btn-primary" Text="ACTUALIZAR CAJAS"  OnClientClick="return confirmacion();"  OnClick="BtnFacturar_Click" />
               </div> 
             </div>
            </ContentTemplate>
             </asp:UpdatePanel>   
...
<script type="text/javascript">
    ...
    {
        var mensaje;
        var opcion = confirm("Esta seguro que desea actualizar las cantidad de cajas ?");
        if (opcion == true)
        {
            mostrarloader('2');
            return true;
