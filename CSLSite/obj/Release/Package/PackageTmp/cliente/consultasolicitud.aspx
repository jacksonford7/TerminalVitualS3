    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Actualizar datos de Empresa</li>
          </ol>
        </nav>
      </div>
                   ...
                   <div class="cataresult" >
                    ...
                    <div class="informativo" style=" height:100%; overflow:auto">
                             ...
                             <tr class="point" >
                              ...
                              <td ><asp:Label ID="lempresa"  style="text-transform :uppercase" runat="server" Text='<%# Eval("EMPRESA") %>'></asp:Label></td>
                              <td ><%#Eval("TIPOEMPRESA")%></td>
                              <td ><%#Eval("TIPOSOLICITUD")%></td>
                              <td ><%#Eval("USUARIOING")%></td>
                              <td ><%#Eval("USUARIOMOD")%></td>
                              <td ><%#Eval("FECHAING")%></td>
                              <td ><%#Eval("ESTADO")%></td>
                              <td>
                                <a id="adjDoc" class="btn btn-outline-primary mr-4" onclick="redirectsol('<%# Eval("ENCRYPTNUMSOLICITUD") %>', '<%# Eval("TIPO") %>');">
 ...
 <script src="../Scripts/pages.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function redirectsol(val, tipo) {
            ...
            window.open('../cliente/actualizasolicitudempresa.aspx?sid=' + caja)
        }
    </script>
