<%@ Page  Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" Title="Consulta de Colaboradores"
         CodeBehind="consultadatoscolaborador.aspx.cs" Inherits="CSLSite.consultadatoscolaborador" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Consulta de Colaboradores</li>
          </ol>
        </nav>
      </div>
 ...
 <div class="dashboard-container p-4" id="cuerpo" runat="server">
       ...
       <tr>
        ...
        <td class="bt-bottom bt-right">
             <asp:TextBox ID="txtCedula" runat="server" Width="120px" MaxLength="10"
             ...
             <div class="form-group col-md-12">
                 <label for="inputAddress">Cedula o Cedulas separadas por coma(,):<%--<span style="color: #FF0000; font-weight: bold;"> *</span>--%></label>
                           <asp:TextBox ID="txtCedula" runat="server" class="form-control" placeholder="Ejemplo: 0123456789,9876543210"
             style="text-align: center" onblur="cajaControl(this);"
             onkeypress="return soloLetras(event,'01234567890-,',true)"></asp:TextBox>
             ...
             <%--<div class="form-group col-md-6"> </div>--%>
             <div class="form-group col-md-12">
                 <label for="inputAddress">Todos los colaboradores.<span style="color: #FF0000; font-weight: bold;"> </span></label>
       ...
       <div class="cataresult" >
        ...
        <div class="informativo" style=" height:100%; overflow:auto">
                 <div class="separator">Colaboradores disponibles:</div>
                 ...
                 <tr class="point" >
                  <td><%#Eval("EMPE_NOM")%></td>
                  <td><%#Eval("COLABORADOR")%></td>
                  <td><%#Eval("FECHA_CADUCIDAD")%></td>
                  <td><%#Eval("ESTADO")%></td>
                  <td><%#Eval("NOVEDAD")%></td>
                 </tr>
                 </ItemTemplate>
...
//            function fValida() {
//                if (document.getElementById('<%=chkTodos.ClientID %>').checked) {
//                    document.getElementById('<%=txtCedula.ClientID %>').value = "";
//                }
