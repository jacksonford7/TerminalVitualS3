...
CodeBehind="consultasolicitudvehiculo_new.aspx.cs" Inherits="CSLSite.cliente.consultasolicitudvehiculo_new" %>
   ...
   <script type="text/javascript" >
       ...
       function Quit()
       {
        ...
        function redirectsol(val, val2, val3) {
            ...
            window.open('../cliente/consultasolicitudvehiculodocumentos_new.aspx?numsolicitud=' + caja + '&idsolveh=' + caja2 + '&placa=' + caja3)
        }
   </script>
</body>
</html>
