...
CodeBehind="consultasolicitudcolaboradordocumentos_new.aspx.cs" Inherits="CSLSite.cliente.consultasolicitudcolaboradordocumentos_new" %>
       ...
       <div class="findresult" >
        ...
        <div class="informativo" style=" width:100%;  overflow:auto">
         <table id="tablerp" cellpadding="1" cellspacing="0">
            ...
            <td style=" width:70px"><asp:CheckBox runat="server" ForeColor="Red" id="chkRevisado" Enabled="FALSE" Checked='<%#Eval("ESTADOCOL")%>'/></td>
            <td><asp:TextBox ID="tcomentario" Enabled="false" Text='<%#Eval("COMENTARIO")%>' ForeColor="Red" ToolTip='<%#Eval("COMENTARIO")%>' runat="server" Width="250px" onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
                 <td>
                    <asp:TextBox ID="txtfecha" runat="server" Text='<%#Eval("FECHA_DOCUMENTO")%>'
                      onkeypress="return soloLetras(event,'0123456789-')"  Enabled="false"  class="datetimepicker form-control"></asp:TextBox>
                </td>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
        ...
        <asp:Button ID="btnSalir" runat="server" Text="Regresar"  Visible="true"
