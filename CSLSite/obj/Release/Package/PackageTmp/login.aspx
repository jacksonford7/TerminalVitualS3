 ...
 <h1 class="text-white my-2">Terminal Virtual</h1>
   <div class="container-login">
    ...
    <form id="FrmLogin" class="form-signin" runat="server" autocomplete="off" accept-charset="UTF-8">
          ...
          <input id="puser" type="hidden" value="" runat="server" clientidmode="Static" />
         ...
         <br/>
            ...
            <asp:button class="btn btn-lg btn-primary btn-block"  ID="btstart" runat="server" Text="Ingresar" onclick="btstart_Click"  />
		    ...
		    <div id='borde_ventana_popup' style=" font-size:1.4em!important; height:370px;" > 
             ...
             <tr>
              ...
              <td><span id="monto_fac" runat="server" clientidmode="Static">$0.00</span></td>
               ...
               Favor proceder con el pago de las facturas detalladas y compensar las mismas. En caso de requerir revisión con el departamento de Cobranzas, contactar a <br /> (<a href="mailto:tesoreria@cgsa.com.ec?Subject=Aviso falta de pago" >tesoreria@cgsa.com.ec</a>)
