<%@ Page  Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" Title="Consulta de Colaboradores"
         CodeBehind="consultasolicitudcolaborador.aspx.cs" Inherits="CSLSite.consultasolicitudcolaborador" %>
 ...
 <div class="dashboard-container p-4" id="cuerpo" runat="server">
       ...
       <tr>
        ...
        <td class="bt-bottom bt-right">
             ...
             <div class="form-group col-md-6">
                 <label for="inputAddress">Cédula:<span style="color: #FF0000; font-weight: bold;"> </span></label>
                           <asp:TextBox ID="txtCedula" runat="server" class="form-control"
             style="text-align: center" onblur="cajaControl(this);"
             onkeypress="return soloLetras(event,'01234567890',true)"></asp:TextBox>
       ...
       <div class="cataresult" >
        ...
        <div class="informativo" style=" height:100%; overflow:auto">
                 ...
                 <tr class="point" >
                  ...
                  <td><%#Eval("CEDULA")%></td>
                  <td style=" width:250px"><%#Eval("NOMBRE")%></td>
