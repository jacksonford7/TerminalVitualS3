                        ...
                        <div id="xfinder" runat="server" visible="false" >
                            ...
                            <%--<div class="booking" >--%>
                                <div class="informativo" style=" height:100%;">
                                            ...
                                            <a id="adjDoc" class="btn btn-outline-primary mr-4" onclick="redirectsol('<%#Eval("NUMSOLICITUD")%>', '<%#Eval("TIPO")%>', '<%#Eval("TIPOSOLICITUD")%>', '<%#Eval("RUCCIPAS")%>', '<%#Eval("EMPRESA")%>',  '<%#Eval("ESTADO")%>', '<%#Eval("CODIGO_TIPO_SOLICITUD")%>')">
 ...
 <script src="../Scripts/credenciales.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
       $(document).ready(function () {
        ...
        function redirectsol(val, tipo, tiposol, rucempresa, razonsocial, estado, codigo_documento) {
            ...
            else if (tipo == 'COLABORADOR')
            {
                ...
                else
                {
                    ...
                    {
                        if (codigo_documento == 'ATE')
                        {
                            window.open('../credenciales/revisasolicitudcolaborador_new.aspx?numsolicitud=' + caja + '&ruc=' + rucempresa + '&razonsocial=' + razonsocial)
                        }
                        else
                        {
            ...
            else if (tipo == 'VEHICULO' && codigo_documento != 'ATV')
            {
             ...
             else if (tipo == 'VEHICULO' && codigo_documento == 'ATV')
            {
                ...
                window.open('../credenciales/revisasolicitudvehiculo_new.aspx?numsolicitud=' + caja + '&ruc=' + rucempresa + '&razonsocial=' + razonsocial)
            }
