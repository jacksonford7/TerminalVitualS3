...
<body>
    ...
    <asp:ToolkitScriptManager ID="tkscata" runat="server"></asp:ToolkitScriptManager>
         <div class="dashboard-container p-4" id="cuerpo" runat="server">
		   ...
		   <div class="form-group col-md-10"> 
		   	  <label for="inputAddress">Nombre de la ciudad destino<span style="color: #FF0000; font-weight: bold;"></span></label>
   ...
   <div class="form-row">
    ...
    Confirme que los datos ingresados sean correctos.  En caso de error, por favor notifíquelo a las casilla ec.sac@contecon.com.ec o comuníquese a los teléfonos (04) 6006300 – 3901700 opción 4	 
                  ...
                  <div class=" form-title">Puertos encontrados</div>
   ...
   <script type="text/javascript" >
       function setBooking(row) {
           ...
           if (window.opener != null) {
               if (valor != 1 && valor != 2) {
                   window.opener.popupCallback2(puerto, 'puerto');
               }
               else {
