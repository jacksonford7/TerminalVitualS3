<%@ Page Title="Cancelación, Actualización o Reimpresion e-Pass CFS " Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="cancelacion_actualizacion_pasepuerta_cfs.aspx.cs" Inherits="CSLSite.facturacion.cancelacion_actualizacion_pasepuerta_cfs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div>
    <i class="ico-titulo-2"></i><h1>Actualización, Reimpresion e-Pass CFS</h1>
        <br />
    </div>
    ...
    <div class="seccion">
       <div class="accion">
         ...
         <tr>
            <th class="bt-right  bt-left bt-top" colspan="3">DATOS DE CONSULTA PARA Actualización, Reimpresion e-Pass CFS:</th>
         </tr>
         </table>
         <table class="xcontroles" cellspacing="0" cellpadding="1">
         <tr>
             ...
             <div class="booking" >
                 ...
                 <thead>
                  <div class=" bt-top">
                     ...
                     <th style=" width:150px">Pase</th>
                     <th style=" display:none" >SubSecuencias</th>
                     <th style=" width:50px">Información</th>
                     <th style=" width:50px">Facturado hasta</th>
                     <th style=" width:75px">Turno</th>
                 ...
                 <td style=" width:60px"><asp:LinkButton ID="lnkImprimir" runat="server" Text = "" CssClass="button-link"></asp:LinkButton></td>
                  ...
                  <td ><%#Eval("NUMERO_PASE_N4")%></td> 
                  <td style=" display:none" ><%#Eval("SUB_SECUENCIA")%></td>
                  <td style=" width:50px"><asp:Label Text='<%#Eval("INFORMACION")%>' ID="lblCntr" runat="server" /></td>
                  <td style=" width:50px">
                  ...
                  <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="true">
                    ...
                    <asp:CalendarExtender ID="CAGTFECHAFASA" CssClass="cal_Theme1" runat="server" Enabled="True"
                        Format="dd/MM/yyyy" TargetControlID="lblFecAutPPWeb">
                  ...
                  <td style=" width:75px"><asp:Label Text='<%#Eval("D_TURNO")%>' Width="75px" ID="lbldturno" runat="server" /></td>
    ...
    <script type="text/javascript">
        ...
        function searchCiaTrans(idval) {
            $(idval).autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "cancelacion_actualizacion_pasepuerta_cfs.aspx/GetEmpresaList",
        ...
        function searchChofer(idval) {
            $(idval).autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "cancelacion_actualizacion_pasepuerta_cfs.aspx/GetChoferList",
                        data: "{ 'prefix': '" + idval.value + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
        ...
        function fConsultaListaChoferes(idval) {
            ...
            $.ajax({
                type: "POST",
                url: "cancelacion_actualizacion_pasepuerta_cfs.aspx/GetFilterChoferList",
                data: "{ 'prefix': '" + idval.value + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function openPop(opcion) {
            window.open('../facturacion/impresion-pase-de-puerta-carga-suelta-cfs?' + opcion + '&opcion=PasePuerta', 'name', 'width=700,height=700');
