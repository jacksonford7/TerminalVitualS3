...
<%@ Page Title="Capacidad por Hora" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_CapacidadHoraBodega.aspx.cs" Inherits="CSLSite.VBS_BAN_CapacidadHoraBodega" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CONFIGURACIÓN DE CAPACIDAD POR HORA</li>
            </ol>
        </nav>
    </div>
            ...
            <ContentTemplate>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="d-flex"> 
                            <asp:DropDownList  ID="cmbBodega" class="form-control"  runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbBodega_SelectedIndexChanged" Font-Size="Medium" Font-Bold="true">
                            </asp:DropDownList>
                        </div>
		            </div>
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <div class="d-flex"> 
                            <asp:DropDownList  ID="cmbBloque" class="form-control" runat="server" Font-Size="Medium" Font-Bold="true">
                            </asp:DropDownList>
                        </div>
		            </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="d-flex"> 
                            <asp:TextBox ID="txtBoxIngresado" runat="server" MaxLength="9" class="form-control" onkeypress="return soloLetras(event,'1234567890',true)"  placeholder="CANTIDAD"></asp:TextBox>
                        </div>
		            </div>
                    ...
                    <div class="nover">
                        ...
                        <label for="inputZip">Box Extra</label>
                        <div class="d-flex"> 
                            <asp:TextBox ID="txtBoxExtra" runat="server" MaxLength="9" class="form-control" onkeypress="return soloLetras(event,'1234567890',true)"  placeholder="BOX EXTRA"></asp:TextBox>
                        </div>
		            </div>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-center">
                        ...
                        <span id="imagen"></span>
                         &nbsp;
                        <asp:Button ID="btnDisponiblidad" runat="server"  Text="Disponibilidad" OnClick="btnDisponiblidad_Click"  class="btn btn-outline-primary mr-2"  data-toggle="modal" data-target="#myModal1"  />
                    </div>
                </div>
                        ...
                        <div class="findresult" >
                            <div class="booking" >
                                ...
                                <div class="form-group col-md-12"> 
                                    <div class="form-title">DETALLE DE CONFIGURACIÓN POR TURNOS</div>
                                </div>
                                  <%--
                                <div class="form-row">
                                  <div class="form-group col-md-2">
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    ...
                                    <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Bodega"  HeaderText="BODEGA" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            ...
                                            <asp:TemplateField HeaderText="BOXES" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtBoxes" runat="server" MaxLength="9" class="form-control" AutoPostBack="true"
                                                        onkeypress="return soloLetras(event,'1234567890',true)" 
                                                        placeholder="CANTIDAD"
                                                        OnTextChanged="txtBoxes_TextChanged"
                                                        onkeydown="moverFoco(event, '<%= tablePagination.ClientID %>');"
                                                        onfocus="seleccionarTextoYCursorAlFinal(this);"
                                                        ></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="BOX EXTRA" Visible="false" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtBoxExtra" runat="server" MaxLength="9" class="form-control" AutoPostBack="true"
                                                        onkeypress="return soloLetras(event,'1234567890',true)" 
                                                        placeholder="CANTIDAD EXTRA"
                                                        OnTextChanged="txtBoxExtra_TextChanged"
                                                        onkeydown="moverFoco(event, '<%= tablePagination.ClientID %>');"
                                                        onfocus="seleccionarTextoYCursorAlFinal(this);"
                                                        ></asp:TextBox>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="ESTADO" ItemStyle-CssClass="center hidden-phone" >
                                                <ItemTemplate>
                                                    <asp:UpdatePanel ID="UPPRO" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="CHKPRO" AutoPostBack="true" runat="server" Checked="false" CssClass="center hidden-phone" OnCheckedChanged="CHKPRO_CheckedChanged" />
                                                        </ContentTemplate>
                                                        <%-- <Triggers>
                                          ...
                                          <%--  <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnEditar" Height="30px" CommandName="Editar" Text="Editar"  CommandArgument='<%# Bind("id") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal3"  />                                                                       
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
        ...
        <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            <ContentTemplate>  
                ...
                <div class="form-group col-md-12"> 
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            <asp:Button ID="btnGrabar" runat="server" class="btn btn-primary" Text="GRABAR" disabled OnClientClick="return mostrarloader('2')" OnClick="btnGrabar_Click"   />
                        </div>
            ...
            <div class="modal-dialog" role="document" style="max-width: 1000px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">CONFIGURACIÓN DE DISPONIBILIDAD DE TURNOS</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <asp:UpdatePanel ID="UPDISPONIBILIDAD" runat="server" UpdateMode="Conditional" >  
                            <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex justify-content-center">
                                        <asp:Button ID="btnAgregarFecha" runat="server" class="btn btn-primary"  Text="Agregar"  OnClientClick="return mostrarloader('1')" OnClick="btnAgregarFecha_Click"  />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex justify-content-center">
                                        <div class="alert alert-warning" id="msjErrorDisp" runat="server" clientidmode="Static"><b>Error!</b> >......</div>
                                    </div>
                                </div>
                                ...
                                <section class="wrapper2">
                                    <%--<div class="row mb"> --%>
                                        <div class="content-panel">
                                            <div class="bokindetalle" style="width:100%; overflow:auto">       
                                                <asp:GridView ID="dgvDisponibilidad" runat="server" AutoGenerateColumns="False"  DataKeyNames="id"
                                                                        GridLines="None" 
                                                                        PageSize="20"
                                                                        AllowPaging="false"
                                                    ...
                                                    <Columns>     
                                                        ...
                                                        <asp:BoundField DataField="id" HeaderText="id"  Visible ="false" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                        <asp:BoundField DataField="nave" HeaderText="NAVE"  Visible ="true" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                        <asp:BoundField DataField="fecha" HeaderText="FECHA"  Visible ="true" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                        <asp:BoundField DataField="horaInicio"  HeaderText="INICIO" Visible ="true" SortExpression="aisv" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                        <asp:BoundField DataField="horaFin" HeaderText="FIN"  HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                        <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                            <ItemTemplate>
                                                                <asp:Button runat="server" ID="btnEliminar" Height="30px" CommandName="Eliminar" Text="Eliminar"  CommandArgument='<%# Bind("id") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal3"  />                                                                       
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
...
<script type="text/javascript">
    function moverFoco(event, gridId) {
        if (event.key === "Enter") {
            ...
            var rowIndex = target.parentElement.parentElement.rowIndex;
             //alert(rowIndex );
            var grid = document.getElementById('<%= tablePagination.ClientID %>');
    ...
    function seleccionarTextoYCursorAlFinal(elemento) {
        elemento.select();
        // Colocar el cursor al final después de seleccionar el texto
