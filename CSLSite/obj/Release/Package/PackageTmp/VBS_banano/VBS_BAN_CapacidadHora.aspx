...
<%@ Page Title="Capacidad por Hora" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_CapacidadHora.aspx.cs" Inherits="CSLSite.VBS_BAN_CapacidadHora" %>
                        ...
                        <div class="findresult" >
                            <div class="booking" >
                                ...
                                <div class="form-group col-md-12"> 
                                    <div class="form-title">DETALLE DE CONFIGURACIÓN POR HOLD</div>
                                </div>
                                  <%--
                                <div class="form-row">
                                  <div class="form-group col-md-2">
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    ...
                                    <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="idHold" HeaderText="HOLD_ID" Visible="false"  SortExpression="idHold" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                            <asp:BoundField DataField="Hold" HeaderText="HOLD"  SortExpression="Hold" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
        ...
        <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            <ContentTemplate>  
                ...
                <div class="form-group col-md-12"> 
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            <asp:Button ID="btnGrabar" runat="server" class="btn btn-primary" Text="GRABAR" OnClientClick="return mostrarloader('2')" OnClick="btnGrabar_Click"   />
                        </div>
