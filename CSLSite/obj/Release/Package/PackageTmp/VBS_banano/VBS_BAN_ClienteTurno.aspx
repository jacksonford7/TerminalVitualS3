...
<%@ Page Title="Asignación de turnos" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_ClienteTurno.aspx.cs" Inherits="CSLSite.VBS_BAN_ClienteTurno" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">ASIGNACIÓN DE TURNOS</li>
            </ol>
        </nav>
    </div>
                        ...
                        <div class="findresult" >
                            <div class="booking" >
                                ...
                                <div class="form-group col-md-12"> 
                                    <div class="form-title">DETALLE DE TURNOS DISPONIBLES</div>
                                </div>
 <%--
                                <div class="form-row">
                                   <div class="form-group col-md-2">
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    ...
                                    <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IdTurno" HeaderText="ID" Visible="false"  HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            <asp:BoundField DataField="IdTurnoCab" HeaderText="CODIGO" Visible="false"  HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            ...
                                            <asp:BoundField DataField="HoraFinal" HeaderText="HORA FINAL" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>--%>
                                            <asp:BoundField DataField="Horario" HeaderText="HORARIO" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            <asp:BoundField DataField="Cantidad" HeaderText="CANTIDAD" SortExpression="Cantidad" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                            ...
                                            <asp:BoundField DataField="Asignados" HeaderText="ASIGNADOS"  SortExpression="Asignados" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                            <asp:BoundField DataField="LineaNaviera" HeaderText="LINEA"  SortExpression="LineaNaviera" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                            ...
                                            <asp:TemplateField HeaderText="EDICIÓN INACTIVA" ItemStyle-CssClass="center hidden-phone" >
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnEditar" Height="30px" CommandName="Editar" Text="Editar"  CommandArgument='<%# Bind("IdTurno") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal3"  />                                                                       
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <div class="modal-dialog" role="document" style="max-width: 1000px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">DATOS DEL TURNO</h5>
                    ...
                    <div class="modal-body">
                                        ...
                                        <asp:Panel ID="Panel2" runat="server">         
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="d-flex">
                                                        <asp:TextBox ID="txtLineaDet" disabled  runat="server" class="form-control" Font-Bold="false" ></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="inputAddress">Fecha Desde/Hasta <span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                        <asp:TextBox ID="txtVigenciaInicialdet"  runat="server" class="form-control" Font-Bold="false" disabled></asp:TextBox>
                                                        &nbsp;
                                                        <asp:TextBox ID="txtVigenciaFinalDet"  runat="server" class="form-control" Font-Bold="false" disabled></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label for="inputAddress">Horario Desde/Hasta <span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                        <asp:TextBox ID="txtHorarioInicioDet"  runat="server" class="form-control" Font-Bold="false" disabled></asp:TextBox>
                                                        &nbsp;
                                                        <asp:TextBox ID="txtHorarioFinDet"  runat="server" class="form-control" Font-Bold="false" disabled></asp:TextBox>
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group col-md-2">
                                                    <label for="inputAddress">Horario Asignado<span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                        <asp:TextBox ID="txtHorarioDet"  runat="server" class="form-control" Font-Bold="false" disabled></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="form-group   col-md-2"> 
                                                    <label for="inputAddress">Cantidad<span style="color: #FF0000; font-weight: bold;" disabled></span></label>
                                                    <asp:TextBox ID="txtCantidadDet" runat="server" MaxLength="9" class="form-control"
                                                ...
                                                <div class="form-group   col-md-2"> 
                                                    <label for="inputAddress">Disponible<span style="color: #FF0000; font-weight: bold;" disabled></span></label>
                                                    <asp:TextBox ID="txtDisponibledet" runat="server" MaxLength="9" class="form-control"
                                                        onkeypress="return soloLetras(event,'1234567890',true)" 
                                                        placeholder="CANTIDAD"
                                                        ></asp:TextBox>
                                                </div>
                                                ...
                                                <div class="form-group   col-md-2"> 
                                                    <label for="inputAddress">Asignados<span style="color: #FF0000; font-weight: bold;" disabled></span></label>
                                                    <asp:TextBox ID="txtAsignadosDet" runat="server" MaxLength="9" class="form-control"
                                                        onkeypress="return soloLetras(event,'1234567890',true)" 
                                                        placeholder="CANTIDAD"
                                                        ></asp:TextBox>
                                                </div>
                        ...
                        <asp:UpdatePanel ID="UPEDIT_DET" runat="server"  UpdateMode="Conditional"  >  
                            <ContentTemplate>
        
                                <section class="wrapper2">
                
                                    <div id="xfinderEdit" runat="server" visible="true" >
                                        <div class="findresult" >
                                            <div class="booking" >

                                                <div class="form-group col-md-12"> 
                                                    <div class="form-title">DETALLE DE TURNOS ASIGNADOS</div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputZip">CANTIDAD<span style="color: #FF0000; font-weight: bold;">*</span></label>
                                                        <div class="d-flex"> 
                                                            <asp:TextBox ID="txtCantidadAsignada" runat="server" class="form-control"  MaxLength="16"  onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')" placeholder="CANTIDAD"></asp:TextBox>
                                                            &nbsp;
                                                ...
                                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                                    ...
                                                    <asp:GridView ID="tablePaginationEdit" runat="server" AutoGenerateColumns="False"  
                                                        DataKeyNames="secuencia"
                                                        GridLines="None" 
                                                        OnPageIndexChanging="tablePaginationEdit_PageIndexChanging" 
                                                        OnPreRender="tablePaginationEdit_PreRender"     
                                                        OnRowCommand="tablePaginationEdit_RowCommand"   
                                                        OnRowDataBound="tablePaginationEdit_RowDataBound"
                                                        PageSize="100"
                                                        AllowPaging="True"
                                                        CssClass="display table table-bordered invoice">
                                                        <PagerStyle HorizontalAlign = "Right" CssClass="display table table-bordered invoice"  />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="secuencia" HeaderText="ID" Visible="false"  HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                            <asp:BoundField DataField="idTurnoDet" HeaderText="CODIGO" Visible="false"  HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                            <asp:BoundField DataField="idcliente" HeaderText="HORA INICIO" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                            <asp:BoundField DataField="cliente" HeaderText="HORA FINAL" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                            <%--<asp:BoundField DataField="Horario" HeaderText="HORARIO" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>--%>
                                                            <asp:BoundField DataField="Cantidad" HeaderText="CANTIDAD" SortExpression="Cantidad" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                                            <%--<asp:BoundField DataField="Disponible" HeaderText="DISPONIBLE" SortExpression="Disponible" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                                                       
                                                            <asp:BoundField DataField="Asignados" HeaderText="ASIGNADOS"  SortExpression="Asignados" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                                            ...
                                                            <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                                <ItemTemplate>
                                                                    <asp:Button runat="server" ID="btnQuitar" Height="30px" CommandName="Quitar" Text="Quitar"  CommandArgument='<%# Bind("secuencia") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal3"  />                                                                       
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                     ...
                                     <div id="sinresultadoEdit" runat="server" class="alert alert-info">
                                        No se encontraron resultados, 
                                        asegurese que ha escrito correctamente el MRN y la NAVE
                                        buscada 
                                    </div>
