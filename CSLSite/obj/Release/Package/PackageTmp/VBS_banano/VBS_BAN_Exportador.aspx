<%@ Page Title="Configuración de Exportador" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_Exportador.aspx.cs" Inherits="CSLSite.VBS_BAN_Exportador" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="placebody" runat="server" >
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="Li2" runat="server">EXPORTADOR [SHIPPER]</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="Div1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server"  >  
            <ContentTemplate>
                ...
                <h4 class="mb">LISTA DE EXPORTADORES</h4>
                    <div class="row mb">
                    <div class="col-lg-12">
