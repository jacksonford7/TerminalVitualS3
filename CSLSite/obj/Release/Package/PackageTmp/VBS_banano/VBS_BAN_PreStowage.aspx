...
<%@ Page Title="Pre Stowage" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="VBS_BAN_PreStowage.aspx.cs" Inherits="CSLSite.VBS_BAN_PreStowage" %>
            ...
            <ContentTemplate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group   col-md-2"> 
                        ...
                        <div class="d-flex">
                            <asp:TextBox ID="txtFechaProceso" AutoPostBack="true" runat="server"  class="datetimepickerAlt form-control"  MaxLength="10"  placeholder="MM/dd/yyyy" OnTextChanged="txtFechaProceso_TextChanged" onkeypress="return soloLetras(event,'1234567890/:')"></asp:TextBox>
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-1">
                        ...
                        <div class="d-flex"> 
                            ...
                            <asp:TextBox class="form-control"  ID="txtPiso" placeholder="DECK" runat="server" MaxLength="50" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890/')"></asp:TextBox>
                ...
                <div class="form-group col-md-12"> 
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            ...
                            &nbsp;
                           <div class="d-flex">
                            <asp:DropDownList ID="cmbTipoBodega" class="form-control"  runat="server" Font-Size="Medium" AutoPostBack="true" Font-Bold="true" OnSelectedIndexChanged="cmbTipoBodega_SelectedIndexChanged">
                            </asp:DropDownList>
                            <a class="tooltip" ><span class="classic" >Tipo de Bodega</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
                        </div>
                        </div>
                                    ...
                                    <asp:Repeater ID="tablePagination" runat="server" onitemcommand ="tablePagination_ItemCommand" OnItemDataBound="tablePagination_ItemDataBound">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="tablePagination" width="100%">
                                            <thead style="background: #B4B4B4; color: white">
                                                <tr>
                                                    ...
                                                    <th class="th-sm">UBICACIÓN ASIGNADA</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("bodega")%>' ID="lblAisv" runat="server"  /></td>   
                                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("estado")%>' ID="Label1" runat="server"  /></td>   
