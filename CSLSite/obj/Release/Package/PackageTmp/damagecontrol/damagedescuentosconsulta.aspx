<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="damagedescuentosconsulta.aspx.cs" Inherits="CSLSite.damagedescuentosconsulta" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE POLÍTICAS DE DESCUENTOS</li>
          </ol>
        </nav>
      </div>
     ...
     <div class="form-title">
       ...
       <div class="form-row"> 
            ...
            <div class="form-group col-md-5">
                    ...
                    <asp:DropDownList runat="server" ID="CboEstadoConsulta"    AutoPostBack="false"  class="form-control"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%" >
                        <thead>
                          <tr >
                            ...
                            <th class="center hidden-phone">LÍNEAS</th>
                            <th class="center hidden-phone">ESTADO</th>
                            <th class="center hidden-phone">CREADO</th>
                            <th class="center hidden-phone">APROBADO</th>
                            <th class="center hidden-phone">RECHAZADO</th>
                        ...
                        <ItemTemplate>
                            <tr >
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("LINEAS")%>' ID="LINEAS" runat="server"  style="text-align:center"  /></td> 
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("DESC_ESTADO")%>' ID="DESC_ESTADO" runat="server"  style="text-align:center"  /></td> 
                                 ...
                                 <td class="center hidden-phone"><asp:Label Text='<%#Eval("DESC_USER_ANIVEL2")%>' ID="DESC_USER_ANIVEL2" runat="server"  style="text-align:center"  /></td> 
                                 <td class="center hidden-phone"><asp:Label Text='<%#Eval("DESC_USER_RECHAZA")%>' ID="DESC_USER_RECHAZA" runat="server"  style="text-align:center"  /></td> 
  ...
  <div class="modal-dialog modal-dialog-scrollable" style="max-width: 1200px">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <asp:Button ID="BtnAprobar" runat="server"  class="btn btn-primary"  Text="APROBAR"  Visible="false" />    
