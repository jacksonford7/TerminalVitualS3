<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="contenedorexportacionreefer.aspx.cs" Inherits="CSLSite.contenedorexpo.contenedorexportacionreefer" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">FACTURACIÓN DE CONTENEDORES DE EXPORTACIÓN REEFER</li>
            </ol>
        </nav>
    </div>
            ...
            <ContentTemplate>
                <asp:Panel ID="PanelCualquiera" runat="server" DefaultButton ="BtnBuscar">
                      <%--  <div class="form-group">
                        <asp:TextBox ID="TXTNAVE" runat="server" class="form-control" MaxLength="16" Width="180px" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')"  
        ...
        <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
                    <ContentTemplate>
                     ...
                     <%--                   <div class="form-inline"> 
                                    ...
                                    <div class="form-group">
                                            <asp:TextBox ID="txtFiltro" runat="server" class="form-control" MaxLength="16" Width="180px" onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')"  
                                                placeholder="FILTRO"></asp:TextBox>
						            </div>
                        
                                    <div class="form-group">
                                        
                                        <asp:LinkButton runat="server" ID="btn_Filtrar" Text="<span class='fa fa-search' style='font-size:24px'></span>"  OnClientClick="return mostrarloader('2')"  OnClick="BtnFiltrar_Click" CssClass="btn btn-theme" />
                                    </div>
                        ...
                        <div class="bokindetalle" style=" width:100%; overflow:auto">
                            <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  DataKeyNames="CNTR_BKNG_BOOKING"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField DataField="CNTR_CONTAINERS"  HeaderText="CONTENEDOR"  HeaderStyle-CssClass="gradeC center hidden-phone"  HeaderStyle-HorizontalAlign="Center" ItemStyle-Width ="150px" HeaderStyle-Width ="150px" />--%>
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    <asp:GridView ID="GrillaDetalle" runat="server" AutoGenerateColumns="False"  DataKeyNames="CNTR_CONTAINER"
                                        ...
                                        <Columns>                              
                                            ...
                                            <asp:BoundField DataField="CNTR_HOURS" HeaderText="HORAS RF"   HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                        </Columns>
                                    </asp:GridView>
                                </div>
            ...
            $('a#popup').live('click', function (e) {
                ...
                var $dialog = $('<div></div>')
                    ...
                    .dialog({
                        ...
                        height: 850,
                        width: 870,
                        title: "DETALLE DE CONTENEDORES",
                        buttons: {
                            "Close": function () { $dialog.dialog('close'); }
                        },
                        close: function (event, ui) {

                            __doPostBack('<%= BtnFacturar.ClientID %>', '');  // To refresh gridview when user close dialog
                        }
                    });
                $dialog.dialog('open');
                e.preventDefault();
