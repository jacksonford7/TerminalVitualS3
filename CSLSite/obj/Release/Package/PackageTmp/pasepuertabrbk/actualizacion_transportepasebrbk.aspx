<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="actualizacion_transportepasebrbk.aspx.cs" Inherits="CSLSite.actualizacion_transportepasebrbk" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">ACTUALIZACIÓN DE EMPRESA DE TRANSPORTE E-PASS CARGA BREAK BULK (BRBK)</li>
          </ol>
        </nav>
      </div>
...
<div class="dashboard-container p-4" id="cuerpo" runat="server"> 
    ...
    <div class="form-row"> 
         ...
         <div class="form-group col-md-2">
             <label for="inputZip">Reservados:<span style="color: #FF0000; font-weight: bold;"></span></label>
