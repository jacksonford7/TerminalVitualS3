<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="rpt_listadosolicitudes.aspx.cs" Inherits="CSLSite.rpt_listadosolicitudes" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE SOLICITUDES</li>
          </ol>
        </nav>
      </div>
<div class="dashboard-container p-4" id="cuerpo" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
              <label for="inputEmail4">ESTADO SOLICITUD:</label>
             <asp:DropDownList id="CboTipo"
