<%@ Page Title="Aprobación de Nota de Crédito" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" 
    CodeBehind="frm_aprobar_nota_credito.aspx.cs" Inherits="CSLSite.frm_aprobar_nota_credito" %>
  ...
  <div class="seccion">
        ...
        <ContentTemplate>   
          ...
          <span id="imagen2" ></span>
            ...
            <span clientidmode="Static" onclick="GolinkArchivo();" runat="server" id="BtnAgregar" visible="true"  class="caja cajafull" style="cursor:pointer;color:black;width:100px;"  >Subir Archivo</span>
              &nbsp;<asp:Button ID="BtnProcesar" runat="server" Text="Procesar"   onclick="btnprocesar_Click"  OnClientClick="return confirm('Esta seguro de que desea Aprobar/Anular la nota de crédito?');"  />
         </div>
         </ContentTemplate>
          <Triggers>
              <asp:AsyncPostBackTrigger ControlID="BtnProcesar" />
             ...
             <div class="booking" >
                ...
                <th class="nover">Nivel</th>
                 ...
                 <tr class="point" >
                  ...
                  <td><%#Eval("description")%> <br><a href="../nota_credito/lookup_download_archivo.aspx?nc_id=<%#securetext(Eval("nc_id")) %>"  target="_blank" >Descargar Archivos</a>
                  </td>
                  ...
                  <td> 
                     <%-- <asp:Button ID="BtnAprobar"   OnClientClick="return confirm('Esta seguro de que desea aprobar la nota de crédito?');"  
                      CommandArgument= '<%#Eval("nc_id")%>' runat="server" Text="Aprobar" 
                       ...
                       <asp:Button ID="BtnAprobar"    CommandArgument= '<%#Eval("nc_id")%>' runat="server" Text="Aprobar" 
                       CssClass="Anular" ToolTip="Permite aprobar una nota de crédito" CommandName="Aprobar"  />
                  </td>
    ...
    <script type="text/javascript">
        ...
        function GolinkArchivo() {
             ...
             window.open('../nota_credito/lookup_subir_archivo.aspx', 'name', 'width=850,height=480,menubar=NO,scrollbars=NO,resizable=NO,toolbars=NO,Titlebar=NO,status=no,help=no,minimize=no,unadorned=on,maximize=no');
