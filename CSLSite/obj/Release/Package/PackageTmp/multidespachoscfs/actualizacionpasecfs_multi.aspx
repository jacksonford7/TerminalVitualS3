<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="actualizacionpasecfs_multi.aspx.cs" Inherits="CSLSite.actualizacionpasecfs_multi" %>
     ...
     $(function () {
        $('[id*=Txtempresa]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("actualizacionpasecfs_multi.aspx/GetEmpresas") %>',
                    data: "{ 'prefix': '" + request + "'}",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
     ...
     $(function () {
        $('[id*=TxtChofer]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("actualizacionpasecfs_multi.aspx/GetChofer") %>',
     ...
     $(function () {
        $('[id*=TxtPlaca]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("actualizacionpasecfs_multi.aspx/GetPlaca") %>',
                    data: "{ 'prefix': '" + request + "', 'idempresa' : '" + $("#IdTxtempresa").val() + "' }",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
