<%@ Page Title="FREIGHT FORWARDER" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="p2d_imprimirpase_freightforwarder.aspx.cs" Inherits="CSLSite.p2d_imprimirpase_freightforwarder" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REIMPRIMIR E-PASS CARGA SUELTA (CFS)</li>
          </ol>
        </nav>
   </div>
    ...
    <div class="form-title">
     ...
     <asp:UpdatePanel ID="UPCARGA" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
		...
		<div class="form-row">
                ...
                <label for="inputZip"># DESPACHO:<span style="color: #FF0000; font-weight: bold;">*</span></label>
                <asp:TextBox ID="TXTMRN" runat="server" class="form-control" MaxLength="20"  onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz0123456789-_')"  
                                    placeholder="# DESPACHO"></asp:TextBox>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                    <div class="alert alert-warning" id="banmsg" runat="server" clientidmode="Static"><b>Error!</b> >Debe ingresar el número de despacho......</div>
            </div>
            </div>
   ...
   <div class="form-row">
              ...
              <div class="bokindetalle" style=" width:100%; overflow:auto">               
                    <asp:UpdatePanel ID="UPDETALLE" runat="server"  >  
                            <ContentTemplate>        
                                ...
                                <ItemTemplate>
                                    <tr >
                                        <td class="center hidden-phone"><asp:Label Text='<%#Eval("NUMERO_PASE_N4")%>' ID="LblContenedor" runat="server"  /></td>
          ...
          <div class="col-sm-8">
              <br/>
               <div class="form-title">
                             ...
                             <ContentTemplate>       
                               Pase a Imprimir  &nbsp;&nbsp;&nbsp;&nbsp;       <asp:Button ID="BtnResumen" runat="server" class="btn btn-primary"  Text="IMPRIMIR RESUMEN"   OnClick="BtnResumen_Click"  disabled /> 
                            </ContentTemplate>
                           </asp:UpdatePanel>
               </div>
     ...
     <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
      <ContentTemplate>
           ...
           <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                                 <div class="alert alert-warning" id="banmsg_det" runat="server" clientidmode="Static"><b>Error!</b> >Debe ingresar el número de despacho......</div>
                          </div>
                     </div>
