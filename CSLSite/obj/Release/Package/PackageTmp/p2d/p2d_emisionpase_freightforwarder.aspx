<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="p2d_emisionpase_freightforwarder.aspx.cs" Inherits="CSLSite.p2d_emisionpase_freightforwarder" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
    ...
    <cc1:ToolkitScriptManager ID="tkscata" runat="server"></cc1:ToolkitScriptManager>
    ...
    <asp:HiddenField ID="hf_BrowserWindowName" runat="server" />
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">P2D (FREIGHT FORWARDER)</a></li>
...
<div class="dashboard-container p-4" id="cuerpo" runat="server"> 
        ...
        <ContentTemplate>
            <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputZip">FACTURA (FREIGHT FORWARDER)<span style="color: #FF0000; font-weight: bold;">*</span></label>
                    <asp:UpdatePanel ID="UPCOMBO"  UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                    <asp:TextBox ID="txtCustomer" runat="server"  class="form-control" placeholder="Seleccione la factura a generar pases" MaxLength="0" ReadOnly="true" />
                    <asp:HiddenField ID="hfCustomerId" runat="server" />
                    <cc1:DropDownExtender runat="server" DropDownControlID="pnlComboDropDownList" TargetControlID="txtCustomer"  HighlightBackColor="WhiteSmoke" HighlightBorderColor="WhiteSmoke"   />
                    <asp:Panel runat="server" ID="pnlComboDropDownList" Style="display: none; visibility: hidden;">
                    <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" DataKeyNames="IV_ID"
                       ...
                       <alternatingrowstyle  BackColor="#FFFFFF" />
                        <HeaderStyle ForeColor="White" Font-Bold="True" 
                            BackColor="#E23B1B"></HeaderStyle>     
                        <Columns>
                            <asp:BoundField DataField="IV_ID" HeaderText="Id" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="IV_FACTURA" HeaderText="FACTURA" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                            <asp:BoundField DataField="IV_FECHA" HeaderText="FECHA" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                             <asp:BoundField DataField="IV_TOTAL" DataFormatString="{0:C}" HeaderText="TOTAL" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                             <asp:BoundField DataField="IV_NUMERO_CARGA" HeaderText="CARGAS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        </Columns>
                    </asp:GridView>
                     </asp:Panel>
                        </ContentTemplate>
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                   <h3 id="H1" runat="server">DETALLE DE CARGAS: </h3>

                     <asp:UpdatePanel ID="UPDETALLEFACTURAS" UpdateMode="Conditional" runat="server"  >  
                     <ContentTemplate>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%" >
                                    <thead>
                                      <tr >
                                        ...
                                        <th class="center hidden-phone">FECHA SALIDA</th>
                                        <th class="center hidden-phone">DESCRIPCION</th>
                                        <th class="left hidden-phone" >BULTOS</th>
                                        <th class="center hidden-phone">PAGADO</th>
                                        <th class="center hidden-phone">UBICACION</th>
                                        <th class="center hidden-phone">CIUDAD</th>
                                        <th class="center hidden-phone">DIRECCION</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr >
                                           <td class="center hidden-phone"  style="width:240px"><asp:Label Text='<%#Eval("CARGA")%>' ID="CARGA" runat="server"  style="align-content:center"/> </td>
                                           <td class="center hidden-phone"><asp:Label Text='<%#Eval("CONTENEDOR")%>' ID="CONTENEDOR" runat="server"  style="align-content:center"   /></td>
                                           <td class="center hidden-phone"><asp:Label Text='<%#DataBinder.Eval(Container.DataItem, "FECHA_SALIDA_PASE", "{0:yyyy/MM/dd HH:mm}")%>' ID="FECHA_SALIDA_PASE" runat="server"  style="text-align:center"  /></td>
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("MARCA")%>' ID="MARCA" runat="server"  style="align-content:center"   /></td>
                                            <td class="left hidden-phone"><asp:Label Text='<%#Eval("CANTIDAD")%>' ID="CANTIDAD" runat="server"  style="text-align:left"  /></td>
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("ESTADO_PAGO")%>' ID="ESTADO_PAGO" runat="server"  style="text-align:center"  /></td> 
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("UBICACION")%>' ID="UBICACION" runat="server"  style="text-align:center"  /></td> 
                                             <td class="center hidden-phone"><asp:Label Text='<%#Eval("CIUDAD")%>' ID="CIUDAD" runat="server"  style="text-align:center"  /></td> 
                                             <td class="center hidden-phone"><asp:Label Text='<%#Eval("DIRECCION")%>' ID="DIRECCION" runat="server"  style="text-align:center"  /></td> 
     ...
     <div class="form-row"> 
         <div class="form-group col-md-3">
                 <label for="inputZip">Cia. Trans:<span style="color: #FF0000; font-weight: bold;">*</span></label>
                     <asp:UpdatePanel ID="UPTRANSPORTE" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true" >
                     <ContentTemplate>
                           <asp:TextBox ID="Txtempresa"  runat="server" class="form-control"  autocomplete="off" onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz0123456789_')" disabled
                            ></asp:TextBox>                      
        ...
        <h4 class="mb">DETALLE DEL HORARIO</h4>
         ...
         <div class="form-row">
             <div class="form-group col-md-2">
             <label for="inputZip">Fecha Tope:<span style="color: #FF0000; font-weight: bold;"></span></label>
  ...
  <cc1:ModalPopupExtender ID="mpeLoading" runat="server" BehaviorID="idmpeLoading"
     ...
     $(function () {
        $('[id*=Txtempresa]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("p2d_emisionpase_freightforwarder.aspx/GetEmpresas") %>',
                    data: "{ 'prefix': '" + request + "'}",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
     ...
     $(function () {
        $('[id*=TxtChofer]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("p2d_emisionpase_freightforwarder.aspx/GetChofer") %>',
     ...
     $(function () {
        $('[id*=TxtPlaca]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("p2d_emisionpase_freightforwarder.aspx/GetPlaca") %>',
                    data: "{ 'prefix': '" + request + "', 'idempresa' : '" + $("#IdTxtempresa").val() + "' }",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
