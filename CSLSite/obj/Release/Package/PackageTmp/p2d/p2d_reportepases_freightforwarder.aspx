<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="p2d_reportepases_freightforwarder.aspx.cs" Inherits="CSLSite.p2d_reportepases_freightforwarder" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE E-PASS/FACTURAS CARGA SUELTA CFS</li>
          </ol>
        </nav>
      </div>
                          ...
                          <div class="col-md-12 d-flex justify-content-center">
                            <div class="d-flex">
                              ...
                              <%--  <label class="checkbox-container">
                                    <asp:CheckBox ID="ChkTodos" runat="server"  Text="Seleccionar Todos"  OnCheckedChanged="ChkTodos_CheckedChanged"    AutoPostBack="True" vi />
                  ...
                  <div class="adv-table">
                      <asp:Repeater ID="grilla" runat="server" OnItemDataBound="grilla_ItemDataBound"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("ORDEN")%>' ID="LblGkey" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("FACTURA")%>' ID="Label1" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("CARGA")%>' ID="Label2" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("AGENTE")%>' ID="Label3" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("IMPORTADOR")%>' ID="Label4" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("FACTURADO")%>' ID="Label5" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("TOTAL")%>' ID="Label6" runat="server" /> </td>
                                   <td class="center hidden-phone"><asp:Label Text='<%#Eval("ID_PASE_WEB")%>' ID="Label7" runat="server" /> </td>
                                   ...
                                   <td class="center hidden-phone"> <asp:Label Text='<%#Eval("DIRECCION")%>' ID="Label8" runat="server"  /> </td>
                                   <td class="center hidden-phone"> <asp:Label Text='<%#Eval("DIRECCION_CLIENTE")%>' ID="Label9" runat="server"  /> </td>
                                   <td class="center hidden-phone"> <asp:Label Text='<%#Eval("TRANSPORTISTA_DESC")%>' ID="Label10" runat="server"  /> </td>             
