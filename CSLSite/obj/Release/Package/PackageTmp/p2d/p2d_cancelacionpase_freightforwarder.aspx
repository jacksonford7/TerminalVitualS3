<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="p2d_cancelacionpase_freightforwarder.aspx.cs" Inherits="CSLSite.p2d_cancelacionpase_freightforwarder" %>
                        ...
                        <ContentTemplate>
						 <div class="form-row">
                          ...
                          <br/>
                            ...
                            <div class="alert alert-danger" id="banmsg" runat="server" clientidmode="Static"><b>Error!</b> >Debe ingresar el número de despacho......</div>
                            </div>
                            </div>
       ...
       <ContentTemplate>
             ...
             <div class="form-group col-md-12">
                  <div class="bokindetalle" style=" width:100%; overflow:auto">  
                    <asp:Repeater ID="tablePagination" runat="server"  onitemcommand="tablePagination_ItemCommand" onitemdatabound="tablePagination_ItemDataBound">
                       <HeaderTemplate>
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="hidden-table-info"  width="100%">
                           <thead>
                          <tr>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC"> 
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("DIRECCION")%>' ID="LblDireccion" runat="server"  />  </td> 
        ...
        <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
             <ContentTemplate>
                 ...
                 <div class="row">
                    <div class="col-md-12 d-flex justify-content-center">
                             <div class="alert alert-danger" id="banmsg_det" runat="server" clientidmode="Static"><b>Error!</b>Debe ingresar el número de despacho......</div>
                    </div>
                </div>
                 ...
                 <div class="row">
                  <div class="col-md-12 d-flex justify-content-center">                        
                        <asp:Button ID="BtnGrabar" runat="server" class="btn btn-primary"   Text="Procesar Cancelación e-Pass" 
                            OnClick="BtnGrabar_Click"   OnClientClick="return confirm('Estimado cliente, está seguro que desea Proceder Con La Cancelación de los e-Pass ?');" />
                  </div>
                </div>
            </ContentTemplate>
             </asp:UpdatePanel>   
