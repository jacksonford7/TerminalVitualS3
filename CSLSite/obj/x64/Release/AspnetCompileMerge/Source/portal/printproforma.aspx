<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printproforma.aspx.cs" Inherits="CSLSite.printproforma" %>
...
<div id="hoja" runat="server" clientidmode="Static">
     ...
     <tr><td colspan="2"><h2>  <span id='pro_li' runat="server" clientidmode="Static">PROFORMA POR SERVICIOS DE EXPORTACION</span>  </h2></td></tr>
     </table>
     </div>
     <div class="seccion">
     <div class="accion">
     ...
     <tr><td class="bt-top" rowspan="4"><span id="servicio" runat="server">Proforma #</span></td>
      ...
      <div class="accion">
       ...
       <table class="xcontroles" cellspacing="0" cellpadding="0">
        ...
        <tr>
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >Fecha de Ingreso (ESTIMADA):</td>
         <td class="bt-bottom ">
           <span id="sfecha_cliente" class="labelprint" runat="server">dd/MM/yyy HH:mm </span>
         </td>
         <td class="bt-bottom  bt-right bt-left">Fecha de Zarpe (ESTIMADA):</td>
         <td class="bt-bottom bt-right">
           <span id="sfecha_zarpe" runat="server" class="labelprint">dd/MM/yyy HH:mm</span>
         </td>
         </tr>
      ...
      <table class="xcontroles" cellspacing="0" cellpadding="0">
        <tr><th class=" bt-top bt-bottom bt-right  bt-left"> Detalle de lOS SERVICIOS</th></tr>
         ...
         <table class="totales" cellpadding="0" cellspacing="0">
                ...
                <tr><td  class='filat'> <span style="color:blue;" runat="server" clientidmode="Static" id="etiIva">IVA %(+)</span> </td><td class="estotal"><span style="color:blue;" id='siva' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>


                <tr><td  class='filat'> <span style="color:red;" runat="server" clientidmode="Static" id="pcRetFte">Ret.Fte %(-)</span> </td><td class="estotal"><span style="color:red;" id='valretfte' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>

                <tr><td  class='filat'> <span style="color:red;" runat="server" clientidmode="Static" id="pcRetIva">Ret.IVA %(-)</span> </td><td class="estotal"><span style="color:red;" id='valretiva' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
     ...
     <div class="informativo bt-left bt-right bt-bottom">
      ...
      <td class="level2 resaltar">
         ...
         Considerar que los Valores de Conexión y Energía son valores estimados; los valores definitivos serán reflejados en la factura final.
         </p>
