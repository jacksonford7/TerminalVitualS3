<%@ Page Title="Proformas" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="proforma_cn.aspx.cs" Inherits="CSLSite.proforma_cn" %>
    ...
    <br /> Asegúrese que toda la información que agregue a este documento es correcta antes de proceder a su respectiva generación, si desea confirmar alguna información antes de proceder comuníquese con nuestro departamento de Expo Navios email: ExpoNavios@cgsa.com.ec.
       ...
       <div class="form-row">
	        <div class="form-group col-md-8"> 
              <label for="inputAddress">Booking<span style="color: #FF0000; font-weight: bold;"></span></label>
                <span id="numbook" runat="server" clientidmode="Static" class=" form-control col-md-12" onclick="quitar();" >...</span>

	       </div>
              <div class="form-group col-md-3"> 
                <label for="inputAddress">Reserva<span style="color: #FF0000; font-weight: bold;"></span></label>
                                     <span id="nbqty" class=" form-control col-md-12"  runat="server" clientidmode="Static"  >...</span>
       ...
       <div class="form-row">
              ...
              <label for="inputAddress">Cantidad<span style="color: #FF0000; font-weight: bold;"></span></label>
                  ...
                  <div class="d-flex">
                          <asp:TextBox ID="txtqty" runat="server"  MaxLength="3" CssClass=" form-control"
             ...
             ></asp:TextBox>
                       <span id="val_qty" class="validacion" > * </span>
                          ...
                          <div class="form-group col-md-3"> 
              <label for="inputAddress">Fecha Ingreso (EST)<span style="color: #FF0000; font-weight: bold;"></span></label>

    <div class="d-flex">
               <asp:TextBox ID="txdate" runat="server"  MaxLength="3" CssClass="datepicker form-control"
             ...
             <span id="esfecha" class="validacion" >*  </span>
                          ...
                          <div class="form-group col-md-3"> 
              <label for="inputAddress">Retención FTE (%)<span style="color: #FF0000; font-weight: bold;"></span></label>
    <div class="d-flex">
      ...
      <div class="d-flex">
       ...
       <div class="form-row">
	        <div class="form-group col-md-12 d-flex justify-content-center"> 
                   <asp:Button ID="btbuscar" runat="server" Text="Generar proforma"  CssClass="btn btn-primary"
       ...
       <asp:UpdatePanel ID="uptabla" runat="server" ChildrenAsTriggers="true" >
               <ContentTemplate>
                 ...
                 <div class=" form-title">Vista preliminar</div>
           ...
           <div class="form-row">
	        <div class="form-group col-md-12"> 
                 ...
                 <HeaderTemplate>
                    <table id="miProforma" class="table table-bordered table-sm table-contecon"  cellpadding="1" cellspacing="1">
                    <thead>
	        ...
	        <div class="form-group col-md-12 d-flex justify-content-center"> 
                    ...
                    <asp:Button ID="btprint" runat="server" Text="Confirmar e Imprimir" 
                        ...
                        onclick="btprint_Click"  CssClass="btn btn-primary mr-2"  />
