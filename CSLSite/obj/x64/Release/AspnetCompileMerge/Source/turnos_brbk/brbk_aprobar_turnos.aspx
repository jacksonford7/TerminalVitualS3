<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="brbk_aprobar_turnos.aspx.cs" Inherits="CSLSite.brbk_aprobar_turnos" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">APROBACIÓN DE TURNOS</li>
          </ol>
        </nav>
      </div>
             ...
             <script type="text/javascript">
                     Sys.Application.add_load(BindFunctions); 
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%" >
                        <thead>
                          <tr >
                            <th class="center hidden-phone">ID TURNO</th>
                        ...
                        <ItemTemplate>
                            <tr >
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("ID_TURNO")%>' ID="ID_TURNO" runat="server"  style="align-content:center"   /></td>
                                <td class="center hidden-phone"><asp:Label Text='<%#DataBinder.Eval(Container.DataItem, "FECHA_DESDE", "{0:yyyy/MM/dd HH:mm}")%>' ID="FECHA_DESDE" runat="server"  style="text-align:center"  /></td>
                                <td class="center hidden-phone"><asp:Label Text='<%#DataBinder.Eval(Container.DataItem, "FECHA_HASTA", "{0:yyyy/MM/dd HH:mm}")%>' ID="Label1" runat="server"  style="text-align:center"  /></td>
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("CONCEPTO")%>' ID="CONCEPTO" runat="server"  style="text-align:center"  /></td> 
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("ESTADO")%>' ID="ESTADO" runat="server"  style="text-align:center"  /></td> 
                                 <td class="center hidden-phone"> 
                                     <asp:Button ID="BtnDetalle"
                                    CommandArgument= '<%#Eval("ID_TURNO")%>' runat="server" Text="VER DETALLE"  class="btn btn-primary" data-toggle="modal" data-target="#exampleModalToggle" ToolTip="VER DETALLE" CommandName="Ver" />
                                </td>

                                 <td class="center hidden-phone"> 
                                     <asp:Button ID="BtnAprobar"
                                       OnClientClick="return confirm('Esta seguro que desea aprobar el Turno?');" 
                                    CommandArgument= '<%#Eval("ID_TURNO")%>' runat="server" Text="APROBAR" 
                                 ...
                                 <td class="center hidden-phone"> 
                                     <asp:Button ID="BtnCancelar"
                                       OnClientClick="return confirm('Esta seguro que desea cancelar el turno?');" 
                                    CommandArgument= '<%#Eval("ID_TURNO")%>' runat="server" Text="CANCELAR" class="btn btn-primary" ToolTip="CANCELAR" CommandName="Cancelar" />
                                </td>
                             </tr>    
                       </ItemTemplate>
                       <FooterTemplate>
  ...
  <div class="modal-dialog modal-dialog-scrollable" style="max-width: 1200px">
    <div class="modal-content">
       <div class="modal-header">
           ...
           <ContentTemplate>
                        <h5 class="modal-title" id="Titulo" runat="server">TURNO PENDIENTE DE APROBAR</h5>
               ...
               <script type="text/javascript">
                 ...
                 <div class="form-row">
                      ...
                      <div class="form-group col-md-1">
                         ...
                         <div class="form-group col-md-1">
                          <label for="inputZip">FRECUENC.</label>
         ...
         <div class="form-row">
                <div class="col-md-12 d-flex justify-content-center">
                    ...
                    <asp:Button ID="BtnExcel" runat="server"  class="btn btn-primary"  Text="EXPORTAR EXCEL"  OnClick="BtnExcel_Click" />      
                        &nbsp;&nbsp; &nbsp;      
                    <asp:Button ID="BtnGrabar" runat="server"  class="btn btn-primary"  Text="ACTUALIZAR CAPACIDAD"     OnClick="BtnGrabar_Click" />      
              </div>
        </div>
     </ContentTemplate>
        <Triggers>
...
<script type="text/javascript">
    ...
    {
        var mensaje;
        var opcion = confirm("Estimado cliente, está seguro que desea aprobar el Turno. ?");
        if (opcion == true)
        {
            loader();
            return true;
