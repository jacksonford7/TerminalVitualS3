<%@ Page Title="Sellos Por Contenedor" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="SellosFotos.aspx.cs" Inherits="CSLSite.ReceptioSellosFotos" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">SELLOS POR CONTENEDOR</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
                                                ...
                                                <tr class="point"  id="trUsuario">
                                                    ...
                                                    <td class="center hidden-phone">  
                                                        <asp:Button runat="server" 
                                                                    ToolTip="Ver Fotos de recepción"  
                                                                    ID="btnFotoRecepcion" 
                                                                    Height="30px" 
                                                    ...
                                                    <td class="center hidden-phone">  
                                                        <asp:Button runat="server" 
                                                                    ID="btnFotoEmbarque"
                                                                    Height="30px" 
                                                                    CommandName="FotosEmbarque" 
                                                                    Text="Pre-Embarque"  
                                                                    CommandArgument='<%# Eval("GKEY") %>' 
                                                                    class="btn btn-primary"  
       ...
       <div id="myModal1" class="modal fade" tabindex="-1" role="dialog">
            ...
            <div class="modal-dialog" role="document" style="max-width: 820px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">FOTOS DE SELLOS VALIDADOS</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <asp:UpdatePanel ID="UPMODAL2" runat="server" UpdateMode="Conditional" >  
                            <ContentTemplate>
                                            ...
                                            <div class="adv-table">
                                                <div class="bokindetalle" style="width:100%; overflow:auto">    
                                                   ...
                                                   <%-- <script type="text/javascript">
                                                    ...
                                                    <div id="xfinde3" runat="server" visible="false" >
                                                        ...
                                                        <div class="chat-room mt">
                                                            <aside class="mid-side">
                                                                ...
                                                                <div class="catawrap" >
                                                                    <div class="room-desk" id="htmlImagene2" runat="server">
                                                                    </div>
                                                                </div>
                                                            </aside>
                                                                <br />
                                                    ...
                                                    <div id="sinresultadoFotosSellosValidos" runat="server" class="alert  alert-warning" visible ="false" >
                                                        No se encontraron resultados, 
                                                        asegurese que ha exista fotos de esta transacción
                                                    </div>
                                            </div>
