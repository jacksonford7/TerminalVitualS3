<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="listadopasescontenedor.aspx.cs" Inherits="CSLSite.listadopasescontenedor" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE E-PASES CONTENEDORES</li>
          </ol>
        </nav>
      </div>
                  ...
                  <div class="adv-table">
                      <asp:Repeater ID="grilla" runat="server" OnItemDataBound="grilla_ItemDataBound"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0"  class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                           <thead>
                          <tr>
                              <th class="center hidden-phone" id="COL_TO_HIDE" runat="server">GKEY</th>
                              ...
                              <th class="center hidden-phone">CAS</th>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                   <td class="center hidden-phone" id="COL_TO_HIDE" runat="server"> <asp:Label Text='<%#Eval("GKEY")%>' ID="LblGkey" runat="server" /> </td>
                                    <td class="center hidden-phone"> <%#Eval("ID_PASE_WEB")%></td>
                                                ...
                                                <td class="center hidden-phone"> <%#DataBinder.Eval(Container.DataItem, "CAS", "{0:yyyy/MM/dd}")%> </td> 
                                                <td class="center hidden-phone"><%#DataBinder.Eval(Container.DataItem, "FECHA_SALIDA", "{0:yyyy/MM/dd HH:mm}")%> </td> 
                                                <td class="center hidden-phone"> <%#DataBinder.Eval(Container.DataItem, "FECHA_AUT_PPWEB", "{0:yyyy/MM/dd}")%> </td>
   ...
   <script type="text/javascript" src="../js/buttons/1.6.4/dataTables.buttons.min.js"></script>  
    ...
    function ocultarloader(Valor) {
        ...
        function openPop(opcion)
        {
            ...
            window.open('../reportes/pase_puerta_preview.aspx?'+ opcion,target='blank','width='+anchura+',height='+altura+',top='+y+',left='+x+',toolbar=no,location=no,status=no,menubar=no,scrollbars=no,directories=no,resizable=no')
