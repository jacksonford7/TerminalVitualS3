<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_empresas.aspx.cs" Inherits="CSLSite.autorizaciones.lookup_empresas"  Title="Buscar Empresas de Transportes" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Listado de Empresas de Transportes Autorizadas</title>
         ...
         <div class="form-group col-md-12"> 
             ...
             <div id="xfinder" runat="server" visible="false" >
                 ...
                 <tr class="point" onclick="setGrupos(this);">
                  ...
                  <td scope="row"><%#Eval("ID_EMPRESA")%></td>
                  <td scope="row"><%#Eval("RAZON_SOCIAL")%></td>
                  <td scope="row"><%#Eval("LINEA_NAVIERA")%></td>
                  <td scope="row"><%#Eval("USUARIO_CRE")%></td>
   ...
   <script type="text/javascript" >
       ...
       function setGrupos(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_empresa = {
                  sel_g_id_empresa: celColect[0].textContent,
                  sel_g_ruc: celColect[1].textContent,
                  sel_g_nombre: celColect[2].textContent,
                  sel_g_linea: celColect[3].textContent,
                  sel_g_usuario: celColect[4].textContent
              };
           if (window.opener != null) {

               window.opener.popupCallback_Empresa(lookup_get_empresa);
           }
