<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_vehiculos.aspx.cs" Inherits="CSLSite.autorizaciones.lookup_vehiculos"  Title="Buscar Vehículos por Empresa de Transportes" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Listado de Vehículos Por Empresa de Transporte Autorizada</title>
    ...
    <script type="text/javascript" >
       ...
       function setGrupos(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_vehiculo = {
                  sel_g_id_vehiculo: celColect[0].textContent,
                  sel_g_placa: celColect[1].textContent,
                  sel_g_id_empresa: celColect[2].textContent,
                  sel_g_razon_social: celColect[3].textContent,
                  sel_g_mensaje: celColect[4].textContent
              };
           if (window.opener != null) {

               window.opener.popupCallback_Vehiculo(lookup_get_vehiculo);
           }
