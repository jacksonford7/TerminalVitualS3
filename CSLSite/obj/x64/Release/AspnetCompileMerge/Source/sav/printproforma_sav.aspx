<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printproforma_sav.aspx.cs" Inherits="CSLSite.printproforma_sav" %>
...
<div id="hoja" runat="server" clientidmode="Static">
     ...
     <tr><td colspan="2"><h2>  <span id='pro_li' runat="server" clientidmode="Static">PROFORMA POR RESERVA DE TURNO S.A.V.</span>  </h2></td></tr>
     </table>
     </div>
     <div class="seccion">
     <div class="accion">
     ...
     <tr><td class="bt-top" rowspan="4"><span id="servicio" runat="server">Número #</span></td>
      ...
      <div class="accion">
       ...
       <table class="xcontroles" cellspacing="0" cellpadding="0">
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="4"> Datos del <i>Booking</i> 
         ...
         <tr><td class="bt-bottom  bt-right bt-left">Contenedor</td>
         <td class="bt-bottom" colspan="3" >
           <span id="bonom" runat="server" class="labelprint">SMLU7966170</span>
        ...
        <tr>
         ...
         <td class="bt-bottom ">
           <span id="bkres" class="labelprint" runat="server">1 </span>
         </td>
         <td class="bt-bottom  bt-right bt-left">Total de Contenedores:</td>
         <td class="bt-bottom bt-right">
           <span id="bkcntr" runat="server" class="labelprint">1</span>
         </td>
         </tr>
