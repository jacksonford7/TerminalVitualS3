<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="visualizafacturaapertura.aspx.cs" Inherits="CSLSite.visualizafacturaapertura" %>
  ...
  <div id="div_BrowserWindowName" style="visibility:hidden;">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Impo Contenedores - FREIGHT FORWARDER</a></li>
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">PREVISUALIZACIÓN DE FACTURA</li>
          </ol>
        </nav>
    </div>
       ...
       <div class="form-group col-md-12"> <!--col-lg-12 mt-->     
            ...
            <div class="col-lg-12 col-lg-offset-1"> <!--col-lg-10 col-lg-offset-1-->
             ...
             <asp:UpdatePanel ID="UPDETALLE" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="true">
                ...
                <span id="contenedor" runat="server" style="height:auto; width:auto;">.... </span>
                </div>
                <br/>
                      <address>
                      </address>
