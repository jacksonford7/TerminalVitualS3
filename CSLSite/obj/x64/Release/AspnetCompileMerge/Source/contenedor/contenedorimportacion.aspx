          ...
          <div class="form-group col-md-4">
              <label for="inputEmail4"> &nbsp;<span style="color: #FF0000; font-weight: bold;"> &nbsp;</span></label>
                        ...
                        <ContentTemplate>
                            ...
                            <%--<asp:CheckBox ID="ChkAppCgsa" runat="server"  Text="Servicio de Notificaciones de Trazabilidad de Carga mediante aplicación móvil CGSApp y Terminal Virtual"      />--%>
               ...
               <%--  <label class="checkbox-container">
                            <input  id="App" class="form-check-input" type="checkbox"  runat="server" value="1"   disabled />
                            <span class="checkmark"></span> 
