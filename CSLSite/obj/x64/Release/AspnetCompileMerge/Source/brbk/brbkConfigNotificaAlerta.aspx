<%@ Page Title="Configuración de Alertas" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkConfigNotificaAlerta.aspx.cs" Inherits="CSLSite.brbk.brbkConfigNotificaAlerta" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CONFIGURACIÓN DE ALERTAS</li>
            </ol>
        </nav>
    </div>
            ...
            <ContentTemplate>
                <div class="form-row">
                    ...
                    <div class="form-group   col-md-6"> 
                        ...
                        <div class="d-flex">
                            <asp:TextBox ID="txtMail" runat="server" MaxLength="500" 
                                onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890_$@.',true)"  
                                    onblur="maildata(this,'valmailz');"                    
                    ...
                    <div class="form-group col-md-3"> 
                        ...
                        <div class="d-flex">
                            <asp:DropDownList ID="cmbGrupo" class="form-control" runat="server" Enabled="false" Font-Size="Medium"  Font-Bold="true" ></asp:DropDownList>
                            <a class="tooltip" ><span class="classic" >Grupo asociado al las alertas configuradas</span><img alt='' src='../shared/imgs/info.gif' class='datainfo'/></a>
                        </div>
                    </div>
                            ...
                            <div class="content-panel">
                                <div class="adv-table">
                                    <asp:Repeater ID="tablePagination" runat="server"  onitemcommand="tablePagination_ItemCommand">
                                        <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered invoice" id="hidden-table-info">
                                            <thead>
                                            <tr style="background-color:#F4F4F4">
                                            <th class="center hidden-phone">ID</th>
                                            <th class="center hidden-phone">NOMBRE</th>
                                            <th class="center hidden-phone">MANIOBRA</th>
    ...
    function ocultarloader(Valor) {
      ...
      function prepareObjectRuc() {
            try {
                ...
                var vals = document.getElementById('<%=txtMail.ClientID %>').value;
