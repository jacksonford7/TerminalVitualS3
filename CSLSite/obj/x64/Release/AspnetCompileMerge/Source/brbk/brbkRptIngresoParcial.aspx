<%@ Page Title="Reporte de Ingresos Parciales" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkRptIngresoParcial.aspx.cs" Inherits="CSLSite.brbk.brbkRptIngresoParcial" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE DE INGRESO PARCIAL</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-center">
                        <asp:Button ID="btnLimpiar" runat="server" class="btn btn-primary"  Text="Limpiar"  OnClick="btnLimpiar_Click"  />
                         &nbsp;
                        <asp:Button ID="btnBuscar" runat="server" class="btn btn-primary"  Text="Consultar"  OnClientClick="return mostrarloader('1')"  OnClick="btnconsultar_Click" />
                                      ...
                                      <asp:Repeater ID="grilla" runat="server"  >
                                       ...
                                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                                          ...
                                          <tr>
                                            ...
                                            <th class="th-sm">LINEA</th>
                                              <th class="th-sm">ETA</th>
                                            ...
                                            <th class="th-sm">ARRASTRE</th>
                                            <th class="th-sm">PENDIENTE</th>
                                            <th class="th-sm">CONFIRMADO</th>
                                            <th class="th-sm">DESCARGADO</th>
                                            <th class="th-sm">IMDT</th>
                                            <th class="th-sm">BL-N4</th>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeC">
                                                ...
                                                <td class="center hidden-phone"> <%#Eval("naveRef")%></td>
                                                <td class="center hidden-phone"> <%#Eval("lineaNav")%></td>
                                                <td class="center hidden-phone"> <%#Eval("fechaEta")%></td>
                                                <td class="center hidden-phone"> <%#Eval("cliente")%></td>
                                                ...
                                                <td class="center hidden-phone"> <%#Eval("arrastre")%></td> 
                                                <td class="center hidden-phone"> <%#Eval("pendiente")%></td>
                                                <%--<td class="center hidden-phone"> <%#Eval("confirma")%></td>
                                                <td class="center hidden-phone"> <%#Eval("descarga")%></td>
                                                <td class="center hidden-phone"> <%#Eval("imdt")%></td>
                                                <td class="center hidden-phone"> <%#Eval("n4")%></td>--%>
                                                    ...
                                                    <asp:UpdatePanel ID="UPSELECCIONAR" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="checkbox-container">
                                                                <%#Eval("confirma")%>
                                                                <asp:CheckBox id="Check" runat="server"  Checked='<%#Eval("confirma")%>'  />
                                                ...
                                                <td class="center hidden-phone"> 
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="checkbox-container">
                                                                <%#Eval("descarga")%>
                                                                <asp:CheckBox id="CheckBox1" runat="server"  Checked='<%#Eval("descarga")%>'  />
                                                                  <span class="checkmark"></span>
                                                             </label>
                                                        </ContentTemplate>
                                                         <Triggers>
                                                ...
                                                <td class="center hidden-phone"> 
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="checkbox-container">
                                                                <%#Eval("imdt")%>
                                                                <asp:CheckBox id="CheckBox2" runat="server"  Checked='<%#Eval("imdt")%>'  />
                                                                  <span class="checkmark"></span>
                                                             </label>
                                                        </ContentTemplate>
                                                         <Triggers>
                                                ...
                                                <td class="center hidden-phone"> 
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" ChildrenAsTriggers="true">
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="checkbox-container">
                                                                <%#Eval("n4")%>
                                                                <asp:CheckBox id="CheckBox3" runat="server"  Checked='<%#Eval("n4")%>'  />
                                                                  <span class="checkmark"></span>
                                                             </label>
                                                        </ContentTemplate>
                                                         <Triggers>
