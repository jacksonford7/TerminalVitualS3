<%@ Page Title="Reversar transacción" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkReversoTransaccion.aspx.cs" Inherits="CSLSite.brbk.brbkReversoTransaccion" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REVERSO DE TRANSACCIÓN</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="idTarja" Visible="false" HeaderText="CODIGO" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            <asp:BoundField DataField="idAgente" HeaderText="AGENTE" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                        ...
                                        <%--    <asp:TemplateField HeaderText="Pre-Descarga" ItemStyle-CssClass="center hidden-phone" >
                                            ...
                                            <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnGenerar" Height="30px" CommandName="Generar" Text="Generar"  CommandArgument='<%# Bind("idAgente") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal"  />                                                                                                                           
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                             <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnReversar" Height="30px" CommandName="Reversar" Text="Reversar"   CommandArgument='<%# Bind("idAgente") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal1"  />                                                                       
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
        ...
        <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
         ...
         <asp:UpdatePanel ID="UPMENSAJE" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">  
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            Si usted da click en SI, se procederá a generar la transacción  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <br>
                            </br/>
                        </div>
                        <div class="modal-footer">
                             <asp:Button ID="btnGenerarTransaccion" runat="server" class="btn btn-default"  Text="SI"  OnClick="btnGenerarTransaccion_Click" UseSubmitBehavior="false" data-dismiss="modal" />
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="btnGenerarTransaccion" />
            </Triggers>
         </asp:UpdatePanel>  
        ...
        <asp:UpdatePanel ID="UPMENSAJE2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">  
                ...
                <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel1">Confirmar Reverso</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            ...
                            <div class="modal-body">
                                ...
                                Si usted da click en SI, se procederá a generar el reverso de la transacción  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <br>
                                </br/>
                            </div>
                            <div class="modal-footer">
                                    <asp:Button ID="btnReversarTrasaccion"  OnClick="btnReversarTrasaccion_Click" runat="server" class="btn btn-default"  Text="SI"  UseSubmitBehavior="false" data-dismiss="modal" />
                                <button type="button" class="btn btn-primary" data-dismiss="modal">NO</button>
                            </div>
                        </div>
                    </div>
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="btnReversarTrasaccion" />
            </Triggers>
         </asp:UpdatePanel>   
    </div>
