    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Importación</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Consulta Carta de Autorización de Salida</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6"> 
                ...
                <div class="d-flex"> 
                    <asp:TextBox 
                        style="text-align: center" 
                        ID="bl" runat="server" ClientIDMode="Static" MaxLength="15" class="form-control"
                        ...
                        <div id="xfinder" runat="server" visible="false" title="PRUEBA" >
                            ...
                            <div class="findresult" >
                                <div class="booking" >
                                     ...
                                     <div>
                                         <input  class="btn btn-primary" clientidmode="Static" id="dataexport" onclick="getTable('reportCas');" type="button" value="Exportar" runat="server" />
                                     </div>
