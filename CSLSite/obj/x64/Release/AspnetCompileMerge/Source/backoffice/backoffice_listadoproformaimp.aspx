<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="backoffice_listadoproformaimp.aspx.cs" Inherits="CSLSite.backoffice.backoffice_listadoproformaimp" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE PROFORMAS EMITIDAS</li>
          </ol>
        </nav>
      </div>
                 ...
                 <div class="bokindetalle" style=" width:100%; overflow:auto">   
                      <asp:Repeater ID="grilla" runat="server"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%" >
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                <td class="center hidden-phone"> <%#Eval("PF_FECHA")%></td>
                                <td class="center hidden-phone"> <%#Eval("PF_NUMERO")%></td>
                                <td class="center hidden-phone"> <%#Eval("PF_TIPO_CARGA")%></td>
                                <td class="center hidden-phone"> <%#Eval("PF_FECHA_HASTA")%></td>
                                <td class="center hidden-phone"> <%#Eval("PF_DESC_AGENTE")%></td>
                                <td class="center hidden-phone"> <%#Eval("PF_DESC_CLIENTE")%></td> 
                                <td class="center hidden-phone"> <%#Eval("PF_DESC_FACTURADO")%></td> 
                                <td class="center hidden-phone"> <%#Eval("PF_NUMERO_CARGA")%></td>
                                <td class="center hidden-phone"> <%#DataBinder.Eval(Container.DataItem, "TOT_PF_SUBTOTAL", "{0:c}")%></td> 
                                <td class="center hidden-phone"> <%#DataBinder.Eval(Container.DataItem, "TOT_PF_IVA", "{0:c}")%></td> 
                                <td class="center hidden-phone"> <%#DataBinder.Eval(Container.DataItem, "TOT_PF_TOTAL", "{0:c}")%></td> 
                                 <td class="center hidden-phone"> <%#Eval("PF_USUARIO_CREA")%></td>
                                <td class="center hidden-phone">
                                    <a href="../reportes/proforma_preview.aspx?id_comprobante=<%#securetext(Eval("PF_ID")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> </button></a>
