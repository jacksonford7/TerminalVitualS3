<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="backoffice_listadoridtmanual.aspx.cs" Inherits="CSLSite.backoffice_listadoridtmanual" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO RIDT MANUAL REGISTRADOS</li>
          </ol>
        </nav>
      </div>
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
       <ContentTemplate>
            ...
            <section class="wrapper2">
             <h3>DETALLE DE CARGAS REGISTRADAS</h3>
             <div class="row mb"> 
                      ...
                      <asp:Repeater ID="grilla" runat="server" OnItemDataBound="grilla_ItemDataBound"  >
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                          ...
                          <tr>
                            ...
                            <th class="th-sm">IMPORTADOR</th>
                            <th class="th-sm">AGENTE</th>
                            <th class="th-sm"># DECLARACION</th>
                        ...
                        <ItemTemplate>
                            <tr class="gradeC">
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("importador")%>' ID="importador" runat="server"  /></td>
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("agente")%>' ID="agente" runat="server"  /></td>
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("declaracion")%>' ID="declaracion" runat="server"  /></td>
                                 <td class="center hidden-phone"><asp:Label Text='<%#Eval("usuario")%>' ID="usuario" runat="server"  /></td>
                                 <td class="center hidden-phone"><asp:Label Text='<%#Eval("Nombres")%>' ID="Nombres" runat="server"  /></td>
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("comentarios")%>' ID="comentarios" runat="server"  /></td>
