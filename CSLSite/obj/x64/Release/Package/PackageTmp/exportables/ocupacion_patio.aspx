<%@ Page Title="Reporte de Ocupación de Patios" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="ocupacion_patio.aspx.cs" Inherits="CSLSite.exportables.ocupacion_patio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Reportes</a></li>
             <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Ocupación Patio</li>
          </ol>
        </nav>
      </div>
     <div class="dashboard-container p-4" id="cuerpo" runat="server">
           ...
           sobre la ocupación de los patios en la terminal CGSA.
