<%@ Page Language="C#" Title="Salida de Contenedores" AutoEventWireup="true" 
         CodeBehind="RptGateOut.aspx.cs" Inherits="CSLSite.rpt_gate_out" %>
...
<%--   <table class="tabRepeat" style="width:96%; margin:0 auto;">
   ...
   <h1>Reporte de Salida de Garita</h1></td><td rowspan="4">
            ...
            <tr>
                <td colspan="2" class="style1">
                    ...
                    <div class="form-group col-md-12"> 
                        ...
                        <h6>Reporte de Salida de Garita</h6>
                    </div>
             ...
             <div class="booking" >
                ...
                <div class="bokindetalle" style=" width:100%; overflow:auto">
                    <asp:Repeater ID="tablePagination" runat="server">
                     ...
                     <th style="width:80px">Bill Of Lading</th>
