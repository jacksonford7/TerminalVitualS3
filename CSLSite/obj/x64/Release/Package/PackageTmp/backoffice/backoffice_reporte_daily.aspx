<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="backoffice_reporte_daily.aspx.cs" Inherits="CSLSite.backoffice.backoffice_reporte_daily" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE DAILY BILLING</li>
          </ol>
        </nav>
      </div>
...
<div class="dashboard-container p-4" id="cuerpo" runat="server">
    ...
    <div class="form-row">  
        <div class="form-group col-md-6"> 
                       <asp:DropDownList runat="server" Font-Size="Small" ID="CboFactura" class="form-control">
         ...
         <div class="form-group col-md-6"> 
                       <asp:DropDownList runat="server" Font-Size="Small" ID="CboTipo" class="form-control">
                                        <asp:ListItem Value="1" Text="* Factura *" />
                                            <asp:ListItem Value="4" Text="Nota de Credito" />
