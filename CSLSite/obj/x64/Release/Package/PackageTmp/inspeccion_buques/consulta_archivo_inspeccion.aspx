<%@ Page Title="Consulta Certificados" Language="C#" MasterPageFile="~/site.Master" 
    AutoEventWireup="true" CodeBehind="consulta_archivo_inspeccion.aspx.cs" Inherits="CSLSite.consulta_archivo_inspeccion" %>
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Inspección</a></li>
             <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Consultar Archivo Inspección de Buques</li>
          </ol>
        </nav>
      </div>
         ...
         <div class="form-title">Datos del documento buscado</div>
		   ...
		   <div class="col-md-12 d-flex justify-content-center"> 
             ...
             <div class="  alert alert-warning" id="alerta" runat="server" >
                 Agregue las fechas y los parámetros para la búsqueda de los archivos de inspección</div>
