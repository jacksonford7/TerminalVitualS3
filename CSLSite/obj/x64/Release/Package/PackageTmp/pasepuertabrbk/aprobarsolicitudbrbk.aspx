<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="aprobarsolicitudbrbk.aspx.cs" Inherits="CSLSite.aprobarsolicitudbrbk" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">APROBAR SOLICITUD DE TURNOS (BRBK)</li>
          </ol>
        </nav>
      </div>
                          ...
                          <div class="form-row">
                             <div class="form-group col-md-12">
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered invoice" id="hidden-table-info">
                                       <thead>
                                      <tr>
                                        <th class="center hidden-phone">MODIFICAR</th>                          
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeC"> 
                                             <td class="center hidden-phone"> 
                                                ...
                                                CommandArgument= '<%#Eval("LLAVE")%>' runat="server" Text="MODIFICAR"  class="btn btn-primary" ToolTip="MODIFICAR TURNO" CommandName="Ver" />
                                            </td>
                                           ...
                                           <td class="center hidden-phone">  
                                            <asp:Button ID="BtnAprobar" CommandArgument= '<%#Eval("LLAVE")%>' runat="server" Text="PROBAR" class="btn btn-primary" ToolTip="Aprobar Turno" CommandName="Aprobar"
                                              ...
                                              <asp:Button ID="BtnRechazar" CommandArgument= '<%#Eval("LLAVE")%>' runat="server" Text="RECHAZAR" class="btn btn-primary" ToolTip="Rechazar Turno" CommandName="Rechazar" 
                                                  OnClientClick="return confirm('Esta seguro que desea rechazar el Turno?');" 
