<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cancelacionpasebrbk.aspx.cs" Inherits="CSLSite.cancelacionpasebrbk" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">CANCELACIÓN E-PASS CARGA BREAK BULK (BRBK)</li>
          </ol>
        </nav>
      </div>
                                ...
                                <td class="center hidden-phone"><asp:Label Text='<%#Eval("MOSTRAR_MENSAJE")%>' ID="LblMensaje" runat="server"  />
                                    ...
                                    <br/>
                                     <asp:Button ID="BtnEvento" CommandArgument= '<%#Eval("ID_PASE")%>' runat="server" Text="Facturar" 
                                         ...
                                         class="btn btn-primary"  ToolTip="Generar Cargos a nueva Factura...Debe ir a la opción de Carga Break Bulk/Facturación Break Bulk" CommandName="Facturar" />
                                </td> 
