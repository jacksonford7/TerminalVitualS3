	 ...
	 <div class="form-group col-md-12"> 
        ...
        <div class=" alert alert-warning" id="alerta" runat="server" ></div>        
                 ...
                 <tr class="point" >                  
                  ...
                  <td>
                    <a  href="../handler/getFile.ashx?id=<%#Eval("nombreDocumento")%>" class=" btn btn-link" target="_blank" style='<%#Eval("nombreDocumento") == null ? "display:none;": "display:block;"%>'>Imprimir</a>
                  </td>
                 </tr>
                 </ItemTemplate>
                 <FooterTemplate>
