<%@ Page Title="Transferencia de Saldos - Emisión e-Pass ZAL" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="transferencia_zal.aspx.cs" Inherits="CSLSite.zal.transferencia_zal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Depósito de Vacíos</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Transferencia de Valores Emisión de Nuevos e-Pass Zal/CISE/ZEA</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        ...
        <div class="form-title">
           DATOS DE CONSULTA PARA TRANSFERIR VALORES:
        </div>
        ...
        <div >
            ...
            <div class="form-row" >
                ...
                <div class="form-group   col-md-6"> 
                    ...
                    <asp:TextBox runat="server" ID="fecsalida" AutoPostBack="false" MaxLength="10"  OnTextChanged="fecsalida_TextChanged"
            ...
            <div class="row">
                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <asp:Button class="btn btn-primary" Text="Consultar Horarios y Saldos $" OnClientClick="return fchange()" OnClick="btnconsultarturnos_Click" runat="server" id="btnconsultarturnos"/>
                            ...
                            <div class="booking" >
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    ...
                                    <asp:Repeater ID="tablePagination" runat="server" >
                                        ...
                                        <ItemTemplate>
                                        <tr class="point" >
                                        <td ><asp:Label Text='<%#Eval("id_pase")%>' ID="lbl_id_pase" runat="server"  /></td>
                                        <td ><asp:Label Text='<%#Eval("fecha_salida")%>' ID="lbl_fecha_salida" runat="server" /></td>
                                        <td ><asp:Label Text='<%#Eval("turno")%>' ID="lbl_turno" runat="server" /></td>
                                        <td ><asp:Label Text='<%#Eval("booking")%>' ID="lbl_booking" runat="server" /></td>
                                        <td ><asp:Label Text='<%#Eval("referencia")%>' ID="lbl_referencia" runat="server" /></td>
                                    ...
                                    <tr><td  class='filat'><strong>SALDO A FAVOR:</strong></td><td class="estotal"><span id='tot_saldo' runat="server" clientidmode="Static" ><strong>$0000.00</strong></span></td></tr>
                                    </table>
                                </div>
                            </div>
                            </div>
                                       ...
                                       <div class="bokindetalle" style=" width:100%; overflow:auto">
                                            <asp:Repeater ID="tableDetTurnos" runat="server" >
                                                <HeaderTemplate>
                                                    ...
                                                    <thead>
                                                    <div class=" bt-top">
                                                        <th style=" width:80px; font-size:small">Horario</th>
                                                        <th style="font-size:small">Chofer</th>
                                                        <th style=" width:80px; font-size:small">Placa</th>
                                                    </div>
                                                    </thead> 
                                                    <tbody>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <tr class="point">
                                                    <td style=" width:80px; font-size:small"><%#Eval("Inicio")%></td>
                                                    <td>
                                                        <asp:Label Text='<%#Eval("CHOFER")%>' Font-Size="Small" ID="lblchof" Width="585px" runat="server" /> </td>
                                                    <td style=" width:80px; font-size:small"><%#Eval("PLACA")%></td>
                                                    </tr>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    </tbody>
                                        ...
                                        <fieldset>
                                            <asp:Repeater ID="tablaNueva" runat="server" >
                                                <HeaderTemplate>
                                                    ...
                                                    <thead>
                                                        <tr><th>Código</th><th>Descripcion</th><th>Cant.</th><th>Total</th></tr>
                                                    </thead>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                <tr class="point" >
                                            ...
                                            <%--<table class="totales" cellpadding="0" cellspacing="0">
                                                <tr><td  class='filat'>Subtotal:</td><td class="estotal"><span id='sttsubtotal' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
                                                <tr><td  class='filat'> <span runat="server" clientidmode="Static" id="st_saldo_anterior">Saldo Anterior:</span> </td><td class="estotal"><span id='sttsaldo_anterior' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
                                                <tr><td  class='filat'> <span runat="server" clientidmode="Static" id="st_saldo_actual">Saldo Actual:</span> </td><td class="estotal"><span id='sttsaldo_actual' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
                                                <tr><td colspan="3"></td></tr>
                                            ...
                                            <table class="table table-bordered invoice" cellpadding="0" cellspacing="0">
                                                <tfoot>
                                                    <tr><td  class='border-none text-right font-weight-bold'>Subtotal:</td><td class=""><span id='sttsubtotal' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
                                                    <tr><td  class='border-none text-right text-success font-weight-bold'> <span runat="server" clientidmode="Static" id="st_saldo_anterior">Saldo Anterior:</span> </td><td class="estotal"><span id='sttsaldo_anterior' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
                                                    <tr><td  class='border-none text-right text-danger font-weight-bold'> <span runat="server" clientidmode="Static" id="st_saldo_actual">Saldo Actual:</span> </td><td class="estotal"><span id='sttsaldo_actual' runat="server" clientidmode="Static"  >$0000.00</span></td></tr>
                                                     
                                                    <tr><td  class='border-none text-right font-weight-bold'><strong>A PAGAR:</strong> </td><td class=""><span id='sttal' runat="server" clientidmode="Static" >$0000.00</span></td></tr>
                                                </tfoot>
                                            </table>
                                        </fieldset>
                                    </div>
        ...
        <div class="col-md-12 d-flex justify-content-center" runat="server" id="div3">
            <span id="imagen"></span>
                ...
                <asp:Button ID="btnAsumirBook" class="btn btn-primary" runat="server" Text="Generar Pases"  OnClientClick="return prepareObject('¿Estimado Cliente, está seguro de generar el(los) pase(s).?')"
                ToolTip="Agrega los horarios seleccionados a la tabla para luego poderlos reservar." OnClick="btnAsumirBook_Click"/>
        </div>

         <div class="bokindetalle" style=" overflow:scroll;  height:120px; display:none">
