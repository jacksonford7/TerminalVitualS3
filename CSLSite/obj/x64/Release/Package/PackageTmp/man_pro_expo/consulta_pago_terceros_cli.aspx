<%@ Page Title="Consulta Pago a Terceros" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="consulta_pago_terceros_cli.aspx.cs" Inherits="CSLSite.consulta_pago_terceros_cli" %>
    ...
    <script type="text/javascript">
        ...
        function prepareObject() {
            ...
            try {
                ...
                var vals = document.getElementById('<%=txtReferencia.ClientID %>');
