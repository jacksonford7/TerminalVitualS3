<%@ Page Title="Sellos Validación en Patio" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="SellosFotosValidaSealPatioExpo.aspx.cs" Inherits="CSLSite.SellosFotosValidaSealPatioExpo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">VALIDACIÓN DE SELLOS EN PATIO</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        ...
        <div class="form-title">
              CONSULTA DE SELLOS VALIDADOS EN PATIO POR NÚMERO DE CONTENEDOR
        </div>
