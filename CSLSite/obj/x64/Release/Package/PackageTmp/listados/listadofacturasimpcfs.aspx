<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="listadofacturasimpcfs.aspx.cs" Inherits="CSLSite.listadofacturasimpcfs" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO DE FACTURAS EMITIDAS CARGA SUELTA</li>
          </ol>
        </nav>
      </div>
              ...
              <div class="form-title">
                ...
                <ItemTemplate>
                    <tr class="gradeC">
                        ...
                        <td class="center hidden-phone"> <%#Eval("IV_FECHA_HASTA")%></td>
                        ...
                        <td class="center hidden-phone">
                            <a href="../reportes/factura_preview.aspx?id_comprobante=<%#securetext(Eval("IV_ID")) %>"  target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</button></a>
