<%@ Page Title="Reporte de Personas en Terminal" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
 CodeBehind="externoscgsa.aspx.cs" Inherits="CSLSite.externoscgsa" %>
...
<input id="zonaid" type="hidden" value="1104" />
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
    <div>
   <i class="ico-titulo-1"></i><h2>Seguridad Industrial </h2>  <br /> 
   <i class="ico-titulo-2"></i><h1>Reporte de Empleados de Contecon en Edificios Externos </h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
