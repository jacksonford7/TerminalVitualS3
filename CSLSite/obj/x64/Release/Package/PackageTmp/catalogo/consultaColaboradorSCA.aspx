<%@ Page Language="C#" Title="Lista de Colaboradores" AutoEventWireup="true" CodeBehind="consultaColaboradorSCA.aspx.cs" Inherits="CSLSite.colaboradorsca" %>
        ...
        <div class="dashboard-container p-4" id="cuerpo" runat="server">
		  ...
		  <div class="form-row">
		   <div class="form-group col-md-12"> 
	             <div class="alert alert-warning" style=" display:none" id="alerta" runat="server"></div>
