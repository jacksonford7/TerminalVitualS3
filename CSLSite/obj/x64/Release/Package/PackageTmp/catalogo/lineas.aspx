<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lineas.aspx.cs" Inherits="CSLSite.lineas" %>
  ...
  <div class="dashboard-container p-4" id="cuerpo" runat="server">
		  <div class="form-row">
		   ...
		   <div class="form-group col-md-12"> 
		   	  <label for="inputAddress">Nombre de la línea naviera:<span style="color: #FF0000; font-weight: bold;"></span></label>
       ...
       function setBooking(row) {
            var celColect = row.getElementsByTagName('td');
             ...
             if (window.opener != null) {
                 window.opener.document.getElementById('linea').textContent = linea.descripcion;
                 window.opener.popupCallback(linea.codigo, 'lineaCI');
            }
            self.close();
      }
