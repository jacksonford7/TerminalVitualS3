<%@ Page Language="C#" Title="Lista Cia. Transporte" AutoEventWireup="true" CodeBehind="ciatransporte.aspx.cs" Inherits="CSLSite.ciatransporte" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lista Cia. Transporte</title>
   ...
   <div class="dashboard-container p-4" id="cuerpo" runat="server">
		  <div class="form-row">
		   ...
		   <div class="form-group col-md-12"> 
		   	  <label for="inputAddress">Compañia de Transporte<span style="color: #FF0000; font-weight: bold;"></span></label>
			     <div class="d-flex">
                      <asp:TextBox ID="txtname" runat="server"  CssClass=" form-control"
                       placeholder="ESCRIBA EL RUC O LA RAZON SOCIAL" 
                 onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890')" 
                 MaxLength="50" ></asp:TextBox>  
                   <asp:Button ID="find" runat="server" Text="Buscar" onclick="find_Click"  CssClass="btn btn-primary" OnClientClick="return initFinder();"/>
             <span id="imagen"></span>
			     </div>
          ...
          <div class="form-row">
		   <div class="col-md-12 d-flex justify-content-center"> 
                        <p class=" alert alert-light">Escriba una o varias caracteres del RUC o Razón Social y pulse buscar</p>
             ...
             <div class=" alert alert-warning" runat="server" id="alerta" >Confirme que los datos sean correctos.</div>
             <div class="booking" >
                  <div class="form-title">Compañias de Transporte</div>
              ...
              asegurese que ha escrito correctamente el RUC o Razón Social de la Compañia de Transporte.
              </div>
             </ContentTemplate>
             <Triggers>
   ...
   <script type="text/javascript" >
      ...
      function initFinder() {
          ...
          if (document.getElementById('txtname').value.trim().length > 0 && document.getElementById('txtname').value.trim().length < 3) {
            alertify.alert('Escriba al menos 3 caracteres que sean parte del Ruc o Razón Social');
              return false;
          }
