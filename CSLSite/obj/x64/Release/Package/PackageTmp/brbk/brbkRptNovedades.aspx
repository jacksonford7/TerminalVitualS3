<%@ Page Title="Reporte de Novedades" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkRptNovedades.aspx.cs" Inherits="CSLSite.brbk.brbkRptNovedades" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE DE REGISTRO DE NOVEDADES</li>
            </ol>
        </nav>
    </div>
            ...
            <ContentTemplate>
                ...
                <div class="bokindetalle" style=" width:100%; overflow:auto">  
                    <rsweb:reportviewer runat="server" Width="100%" ID="ReportViewer1" Font-Names="Verdana" 
                        ...
                        <LocalReport ReportPath="brbk\rptNovedades.rdlc">
                            <DataSources>
                    ...
                    <asp:ObjectDataSource runat="server" id="odsReportsBreakBulk" 
                        ...
                        TypeName="CSLSite.brbk.dsReportsBreakBulkTableAdapters.rptNovedadesTableAdapter">
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="00" Name="i_idNave" 
                            SessionField="i_idNave" Type="String" />
