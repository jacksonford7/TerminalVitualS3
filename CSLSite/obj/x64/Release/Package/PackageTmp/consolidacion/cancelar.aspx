<%@ Page Title="Consultar, Imprimir y cancelar turnos" Language="C#" MasterPageFile="~/site.Master" 
         AutoEventWireup="true" CodeBehind="cancelar.aspx.cs" Inherits="CSLSite.turno_cancela_consolidacion" %>
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Exportación</a></li>
             <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Consulta / Cancelación de horarios</li>
          </ol>
        </nav>
      </div>
     ...
     <div class="dashboard-container p-4" id="cuerpo" runat="server">
		   ...
		   <div class="form-group col-md-6"> 
			  ...
			  <div class="d-flex">
                   ...
                   <input id="nbrboo" type="hidden" value="" runat="server" clientidmode="Static" />
                           <a  class="btn btn-outline-primary mr-4" target="popup" onclick="window.open('../catalogo/bookinListConsolidacion.aspx','name','width=1260,height=880')" >
         ...
         <div class="form-row">
		   ...
		   <div class="form-group col-md-6"> 
             ...
             ID="tfecha" runat="server" ClientIDMode="Static" MaxLength="15" CssClass="datetimepicker  form-control"
         ...
         <div class="form-row">
		   ...
		   <div class="form-group col-md-6"> 
			  ...
			  <div class="d-flex">
                ...
                type='text' id='tmail' 
                name='tmail'  runat="server"   class="form-control"
                 ...
                 <tr class="point" >
                  ...
                  <td>
                   <div class="tcomand">
                       ...
                       CommandArgument= '<%#Eval("id_horario_det")%>' runat="server" Text="Actualizar" 
                           CssClass="  btn btn-secondary" ToolTip="Permite modificar este documento" />
                   </div>
                  </td>
                  <td>
                   <div class="tcomand">
                       ...
                       CommandName ='Anula'
                       CommandArgument= '<%#Eval("id_horario_det")%>' runat="server" Text="Cancelar" 
