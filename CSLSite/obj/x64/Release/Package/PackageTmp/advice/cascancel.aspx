<%@ Page Title="Desmarcar retornos" Language="C#" MasterPageFile="~/site.Master" 
AutoEventWireup="true" CodeBehind="cascancel.aspx.cs" Inherits="CSLSite.cascancel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
   ...
   <i class="ico-titulo-2"></i><h1>Desmarcar contenedores para retorno (preaviso automático)</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="4"> Datos PARA EL 
            PROCESAMIENTO</th></tr>
         <tr>
         <td  class="bt-bottom bt-left bt-right" >Paso 1: Linea /Cliente </td>
         <td class="bt-bottom" colspan="2" >
             <span id="nomexpo" class="caja cajafull" runat="server" clientidmode="Static" enableviewstate="true">...</span>
          </td>
