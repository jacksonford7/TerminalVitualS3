<%@ Page  Language="C#"  AutoEventWireup="true" Title="Consultar Factura"  CodeBehind="consultafacturacolaborador.aspx.cs" Inherits="CSLSite.cliente.consultafacturacolaborador" %>
    ...
    <div class="form-row" style=" display:none"> 
      ...
      <div class="row" style=" display:none">
           <div class="col-md-12 d-flex justify-content-center">
              <img alt="loading.." src="../shared/imgs/loader.gif" id="loader" class="nover"  />  <br/>
                 <asp:Button ID="btbuscar" runat="server" Text="Iniciar la búsqueda" 
                   onclick="btbuscar_Click" class="btn btn-primary"  />
            </div>
       </div>
     

       <div class="form-title">
        2) Datos Generales del Colaborador(es).
     </div>
          ...
          <div class="form-group col-md-12">   
             <asp:Repeater ID="rpDetalle" runat="server">
                 ...
                 <tr class="point" >
                  ...
                  <td ><asp:CheckBox runat="server" ForeColor="Red" Enabled="false" id="chkRevisado" Checked='<%#Eval("ESTADOCOL")%>'/></td>
                  <td >
                  <asp:TextBox ID="tcomentario" runat="server" ForeColor="Red" Enabled="false"  ToolTip='<%#Eval("COMENTARIO")%>' Text='<%#Eval("COMENTARIO")%>' onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox>
                  </td>
                  <td ><%#Eval("TIPO")%></td>
                  <td >
                    <a  id="adjDoc" class="btn btn-outline-primary"  onclick="redirectsol('<%# Eval("NUMSOLICITUD") %>', '<%# Eval("IDSOLCOL") %>', '<%#Eval("CIPAS")%>');">
                          ...
                          <div class="form-group col-md-12">        
                            <%-- <table id="table1" class="controles" cellpadding="1" cellspacing="0">--%>
                             ...
                             <tr class="point" >
                              ...
                              <td >
                              <a href='<%#Eval("RUTADOCUMENTO") %>' class="btn btn-outline-primary"  target="_blank">
                                <i class="fa fa-search"></i> Ver Comprobante </a>
                             </td>
                             </tr>
                             </ItemTemplate>
                             <FooterTemplate>
   ...
   <script src="../../Scripts/pages.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function redirectsol(val, val2, val3) {
            ...
            var caja2 = val2;
            var caja3 = val3;
            window.open('../consultasolicitudcolaboradordocumentos.aspx?numsolicitud=' + caja + '&idsolcol=' + caja2 + '&cedula=' + caja3)
        }
