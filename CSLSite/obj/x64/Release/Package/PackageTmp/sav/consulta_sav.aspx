                                    ...
                                    <div class="bokindetalle" style=" width:100%; overflow:auto">
                                        <asp:Repeater ID="tablePagination" runat="server" 
                                                ...
                                                <div class="tcomand">
                                                    ...
                                                    CommandArgument=   '<%# jsarguments( Eval("turno_id"),Eval("unidad_id") )%>' CommandName="eliminar" runat="server" Text="Anular" CssClass="Anular" ToolTip="Permite anular este documento" />
                                                    </div>
                                                </div>
                                                </td>
                                                <td id="imprimir_prof_det" runat="server" style=" width:90px">
                                                    ...
                                                    <br></br>
                                                    <asp:ImageButton 
                                                        CommandArgument='<%# jsarguments( Eval("turno_id"), Eval("documento_id") )%>'
