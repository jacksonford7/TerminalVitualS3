<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="cotizacioncfs.aspx.cs" Inherits="CSLSite.cotizacioncfs" %>
     ...
     <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            ...
            <br/>
             ...
             <div class="col-md-12 d-flex justify-content-center">
                        ...
                        <asp:Button ID="BtnCotizar" runat="server" class="btn btn-primary"  Text="GENERAR PROFORMA" OnClientClick="return mostrarloader('2')" OnClick="BtnCotizar_Click"/>
