<%@ Page Title="Usuarios" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="appPaquetesClientesAgente.aspx.cs" Inherits="CSLSite.appPaquetesClientesAgente" %>
            ...
            <div class="mt-4">         
                <nav class="mt-4" aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">App CGSA</a></li>
                        <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">PAQUETES/AGENTES</li>
                    </ol>
                </nav>
            </div>
