<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appListPaquetes.aspx.cs" Inherits="CSLSite.appListPaquetes"  Title="Buscar Paquetes" %>
   ...
   <div class="dashboard-container p-4" id="cuerpo" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-12"> 
              <label for="inputEmail4">Nombre del Paquete:</label>
             <div class="d-flex">
      ...
      <div class="row">
         <div class="form-group col-md-12"> 
             ...
             <div id="xfinder" runat="server" visible="false" >
                 ...
                 <ItemTemplate>
                 <tr class="point" onclick="setPaquetes(this);">
                  <td scope="row"><%#Eval("id")%></td>
                  <td scope="row"><%#Eval("name")%></td>
                  <td scope="row"><%#Eval("EventoN4")%></td>
    ...
    <script type="text/javascript" >
       ...
       function setPaquetes(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_paquete = {
           ...
           if (window.opener != null) {
               ...
               window.opener.popupCallback_Paquetes(lookup_get_paquete);
           }
