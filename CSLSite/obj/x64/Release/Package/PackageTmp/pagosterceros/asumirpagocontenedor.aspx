<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="asumirpagocontenedor.aspx.cs" Inherits="CSLSite.pagosterceros.asumirpagocontenedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
  ...
  <div id="div_BrowserWindowName" style="visibility:hidden;">
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">ASUMIR PAGO (Importación)</li>
          </ol>
        </nav>
      </div>
    ...
    <h4 class="mb">ASUMIR LA SIGUIENTE CARGA</h4>   
