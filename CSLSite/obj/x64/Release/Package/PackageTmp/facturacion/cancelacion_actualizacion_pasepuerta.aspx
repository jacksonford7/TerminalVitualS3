<%@ Page Title="Cancelación, Actualización o Reimpresion e-Pass" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="cancelacion_actualizacion_pasepuerta.aspx.cs" Inherits="CSLSite.facturacion.cancelacion_actualizacion_pasepuerta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div>
    <i class="ico-titulo-2"></i><h1>Actualización, Reimpresion e-Pass</h1>
        <br />
    </div>
    ...
    <div class="seccion">
       <div class="accion">
         ...
         <tr>
            <th class="bt-right  bt-left bt-top" colspan="3">DATOS DE CONSULTA PARA Actualización, Reimpresion e-Pass:</th>
         </tr>
         </table>
         <table class="xcontroles" cellspacing="0" cellpadding="1">
         <tr>
         ...
         <div class="cataresult" >
            ...
            <ContentTemplate>
             ...
             <div class="booking" >
                 ...
                 <td style=" width:50px"><asp:Label Text='<%#Eval("NOTA")%>' ID="lblNota" runat="server" /></td>
                  ...
                  <td style=" width:70px"><asp:Label Text='<%#Eval("D_TURNO")%>' Width="50px" ID="lbldturno" runat="server" /></td>
    ...
    <script type="text/javascript">
        ...
        function searchCiaTrans(idval) {
            $(idval).autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "cancelacion_actualizacion_pasepuerta.aspx/GetEmpresaList",
        ...
        function searchChofer(idval) {
            $(idval).autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "cancelacion_actualizacion_pasepuerta.aspx/GetChoferList",
                        data: "{ 'prefix': '" + idval.value + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
        ...
        function fConsultaListaChoferes(idval) {
            ...
            $.ajax({
                type: "POST",
                url: "cancelacion_actualizacion_pasepuerta.aspx/GetFilterChoferList",
                data: "{ 'prefix': '" + idval.value + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
