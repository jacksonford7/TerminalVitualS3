<%@ Page Title="Consulta Certificados" Language="C#" MasterPageFile="~/site.Master" 
    AutoEventWireup="true" CodeBehind="consulta_certificado_scan.aspx.cs" Inherits="CSLSite.consulta_certificado_scan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Escaner</a></li>
   ...
   <asp:TextBox ID="aisvn" runat="server" CssClass="form-control" MaxLength="10" 
    ...
    <script type="text/javascript">
        ...
        function descarga(id, secuencia) {
            var lz = "E";
            var url = '../handler/certificadoScan.ashx?sid=';
        ...
        function mostrar(id, secuencia) {
            var lz = "E";
            var url = '../escaner/certificado.aspx?sid=';
            var cc = document.getElementById(secuencia);
            if (cc) {
                if (cc.value) {
                    lz = cc.value;
