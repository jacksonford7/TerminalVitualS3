<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="damagedescuentosnivel2.aspx.cs" Inherits="CSLSite.damagedescuentosnivel2" %>
     ...
     <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">APROBACIÓN DE POLÍTICAS DE DESCUENTOS (NIVEL 2)</li>
          </ol>
        </nav>
      </div>
