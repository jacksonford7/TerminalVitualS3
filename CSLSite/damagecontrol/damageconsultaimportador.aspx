...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="col-md-12 d-flex justify-content-center">
                                        ...
                                        <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="CONTENEDOR" HeaderText="CONTENEDOR" Visible="true" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"></asp:BoundField>
                                                <asp:BoundField DataField="FECHA_REGISTRO" HeaderText="FECHA" Visible="true" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"></asp:BoundField>
                                                        ...
                                                        <asp:Repeater ID="rptImagenes" runat="server">
                                                            <ItemTemplate>
                                                                <asp:Image ID="imgPicture" runat="server"
                                                                    ImageUrl='<%# Eval("Url") %>'
                                                                    class="thumbnail imagenContenedor"
                                                                    data-large='<%# Eval("Url_Large") %>'
                                                                    onclick='<%# "mostrarImagenGrande(\"" + Eval("Url_Large") + "\")" %>' />
                                                            </ItemTemplate>
                                                        </asp:Repeater>
    ...
    <script type="text/javascript">
        function mostrarImagenGrande(rutaSeleccionada) {
            // Buscar por clase en lugar de ID dinámico
            const imagenes = Array.from(document.querySelectorAll('.imagenContenedor'))
            ...
            imagenes.forEach((ruta, i) => {
                const isActive = ruta === rutaSeleccionada ? 'active' : '';
                slides += `
            <div class="carousel-item ${isActive}">
                <img src="${ruta}" class="d-block w-100" style="max-height:700px; object-fit:contain;" alt="Imagen grande">
            </div>
        `;
            });
    ...
    `;
        ...
        function cerrarModal() {
            ...
            modal.innerHTML = ''; // Limpia para próxima apertura
        }
        ...
        function cerrarModal() {
            ...
            document.getElementById("myModal").innerHTML = ""; // Limpia el contenido dinámico
        }
