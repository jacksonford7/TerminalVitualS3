            ...
            if (Response.IsClientConnected)
            {
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        {
                            this.pro_li.InnerText = "LIQUIDACIÓN POR SERVICIOS DE EXPORTACIÓN";
                            this.servicio.InnerText = "Liquidacion #:";
                        }
                        ...
                        this.sfecha_cliente.InnerText = fila.IsfechClienteNull() ? "-" : fila.fechCliente.ToString("dd/MM/yyyy HH:mm");
                        ...
                        this.etiIva.InnerText = string.Format("IVA {0}%(+)", fila.IsIvaMasNull() ? 0 : (int)fila.IvaMas);
