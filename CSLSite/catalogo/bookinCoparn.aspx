<%@ Page Language="C#" Title="Lista de Bookings" AutoEventWireup="true" CodeBehind="bookinCoparn.aspx.cs" Inherits="CSLSite.bookinCoparn" %>
        ...
        <div class="cataresult" >
             ...
             <div class="  alert alert-warning" runat="server" id="alerta" >
                 ...
                 <tr class="point" onclick="setObject(this);">
                  ...
                  <td><%#Eval("lineOperator")%></td>
                  <td><%#Eval("vesselVisit")%></td>
                  <td><%#Eval("portOfLoad")%></td>
                  <td><%#Eval("portOfDischarge")%></td>
                  <td><%#Eval("estado")%></td>
                  <td>
   ...
   <script type="text/javascript" >
       function setObject(row) {
           ...
           if (window.opener != null) {
               ...
               window.opener.popupCallback2(bookin, 'coparn');
           }
           self.close();
       }
       function initFinder() {
