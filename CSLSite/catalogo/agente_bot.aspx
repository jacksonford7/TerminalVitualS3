<%@ Page Language="C#" Title="Catálogo de agentes" AutoEventWireup="true" 
    CodeBehind="agente_bot.aspx.cs" Inherits="CSLSite.agente_bot" %>
         ...
         <div class="form-title">Datos del Agente</div>
		  ...
		  <div class="form-row">
		   ...
		   <div class="form-group col-md-12"> 
		   	 <p class=" alert-secondary">Escriba una o varias letras del nombre y/o documento pulse buscar</p>
		   </div>
		  </div>
           ...
           <div class="row">
            ...
            <div class="cataresult" >
             ...
             <div class="alert-info" id="alerta" >
              ...
              <div id="sinresultado" runat="server" class="alert-success" >
