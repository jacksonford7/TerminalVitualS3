...
namespace CSLSite
{
    public partial class bookingmas : System.Web.UI.Page
    {
        ...
        {
            var tabla = new Catalogos.bookingmasDataTable();
            var ta = new CatalogosTableAdapters.bookingmasTableAdapter();
            ...
            try
            {
                ...
                if (Response.IsClientConnected)
                {
                    ...
                    if (!filatop.IsshiperidNull() && u != null && filatop.shiperid != u.ruc)
                    {
                        ...
                        AjaxControlToolkit.ToolkitScriptManager.RegisterClientScriptBlock(this, this.GetType(), "key_alert", "alertify.alert('Usted no es el reservante de este booking');", true);
                    }
                }
              }
            catch (Exception ex)
