...
namespace CSLSite
{
    public partial class agente_bot : System.Web.UI.Page
    {
            ...
            if (Response.IsClientConnected)
            {
             ...
             u = this.getUserBySesion();
                ...
                try
                {
                    ...
                    string filtro = "SHIPPER";
                    //aca buscar a personas naturales, EN CSL
                    if (!cknatural.Checked)
                    {
                        filtro = "AGENT";
                    }
                    ta.Fill(table, filtro, this.txtname.Text.Trim().Length > 0 ? txtname.Text.Trim() : null, txtci.Text.Trim().Length > 0 ? txtci.Text.Trim() : null);
