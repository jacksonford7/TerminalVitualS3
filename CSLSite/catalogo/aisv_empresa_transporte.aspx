<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aisv_empresa_transporte.aspx.cs" Inherits="CSLSite.aisv_empresa_transporte" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Catálogo de Empresas de Transporte CGSA</title>
...
<body>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
		  <div class="form-row">
		   ...
		   <div class="form-group col-md-12"> 
		   	          <p class="  alert alert-light" id="valintro">Escriba una o varias letras de la razón social</p>
		   </div>
		  </div>
         ...
         <div class="cataresult" >
             ...
             <div class="booking" >
                  <div class="form-title">Empresas encontradas</div>
            ...
            No se encontraron resultados, asegúrese que haya escrito correctamente el nombre, si no aparece en la lista comuníquese con nuestro departamento de servicio al cliente
            o intente con otra descripción.
              </div>
             </ContentTemplate>
             <Triggers>
       ...
       function setBooking(row) {
           ...
           var celColect = row.getElementsByTagName('td');
              ...
              if (window.opener != null) {
                  window.opener.ciaCallback(puerto);
            }
            self.close();
      }
      function msgfinder(control, expresa) {
          if (control.value.trim().length <= 0) {
              this.document.getElementById(expresa).textContent = 'Escriba una o varias letras de la empresa y pulse buscar';
              return;
          }
