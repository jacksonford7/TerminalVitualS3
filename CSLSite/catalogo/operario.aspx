<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operario.aspx.cs" 
    Inherits="CSLSite.operario"  Title="Buscar Operario" %>
...
<body>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
		   ...
		   <div class="form-group col-md-6">
		   	  <label for="inputAddress">Apellidos o Cédula<span style="color: #FF0000; font-weight: bold;"></span></label>
		   ...
		   <div class="col-md-12 d-flex justify-content-center"> 
                        <p class=" alert alert-light" id="valintro">Escriba una o varias letras del nombre o el número de cédula y presione buscar</p>
     ...
     Confirme que los datos ingresados sean correctos.  En caso de error, por favor notifíquelo a las casilla ec.sac@contecon.com.ec o comuníquese a los teléfonos (04) 6006300 – 3901700 opción 4	
                  ...
                  <div class="form-title">Operarios</div>
                 ...
                 <ItemTemplate>
                 <tr class="point" onclick="setOperator(this);">
                  <td><%#Eval("Identificacion")%></td>
                  <td><%#Eval("Nombre")%></td>
                  <td><%#Eval("Apellidos")%></td>
                   <td><%#Eval("OPC_Nombre")%></td>
                  <td>
   ...
   <script type="text/javascript" >
       function setOperator(row) {
            var celColect = row.getElementsByTagName('td');
              var operario = {
                  identificacion: celColect[0].textContent,
                  nombre: celColect[2].textContent,
                  apellidos: celColect[1].textContent
              };
           if (window.opener != null) {
               
                 window.opener.popupCallback(operario);
            }
            self.close();
      }
