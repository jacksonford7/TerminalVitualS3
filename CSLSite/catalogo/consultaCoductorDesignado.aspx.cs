...
namespace CSLSite
{
    public partial class conductor : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                var ruc = Session["rucempresadatossolicitudvehiculopda"].ToString();
                ...
                var t = credenciales.GetConsultaConductoresXEmpresaMda(ruc, cedula, nombres, apellidos);
                try
                {
                    if (t.Rows.Count > 0)
                    {   
                        ...
                        this.alerta.InnerHtml = "Listado de Conductor(es) Desginados:"; //"Estimado cliente, si la fecha requerida para su reserva no aparece en esta lista. <br />" +
