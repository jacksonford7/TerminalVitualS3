...
namespace CSLSite
{
    public partial class bklistAut : System.Web.UI.Page
    {
...
#endif
                var t = turno.GetBookingsAut(txtname.Text.Trim(), u.ruc);
                try
                {
                    if (t != null && t.Count > 0)
                    {
                        ...
                        this.alerta.InnerHtml = "Estimado cliente, si el número de booking que esta buscando no aparece en esta lista. <br />" +
                                       "Favor comunicarse con el Area de Vacíos de CGSA <br />" +
                                                  "Pbx: +593 (04) 6006300, 3901700 ext. 4055, 4059. <br />" +
                                                  "Email: <a href='mailto:CoordinadoresVaciosPTI@cgsa.com.ec'>CoordinadoresVaciosPTI@cgsa.com.ec</a>;";
