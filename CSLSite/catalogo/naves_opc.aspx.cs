...
namespace CSLSite
{
    public partial class naves_opc : System.Web.UI.Page
    {
        ...
        {
            var table = new Catalogos.pc_vessel_catalogDataTable();
            var ta = new CatalogosTableAdapters.pc_vessel_catalogTableAdapter();
