    ...
    <div id="cardsRow" class="row mt-2">
                ...
                <div class="card-body">
                    ...
                    <p class="small-text">
                        ...
                        <span id="lblweight" runat="server" clientidmode="Static"
                            title="Descargar Certificado de Peso" ></span>
                    </p>
                    ...
                    <div class="mb-2 d-flex justify-content-between align-items-center">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-outline-primary btn-sm" OnClick="btnSellos_Click">Ver</asp:LinkButton>
                    </div>

                    <div class="mb-4 d-flex justify-content-between align-items-center">
                        <strong>Certificado de Peso VGM:</strong>
        ...
        <div class="col-md-6">
            ...
            <asp:UpdatePanel ID="UPWUSR" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="gvSellos" runat="server" AutoGenerateColumns="False"
