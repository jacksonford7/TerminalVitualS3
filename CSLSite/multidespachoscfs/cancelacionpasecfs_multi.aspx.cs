...
namespace CSLSite
{
    ...
    public partial class cancelacionpasecfs_multi : System.Web.UI.Page
    {
                ...
                try
                {
                    ...
                    **********************************************************************************************************************************************/
                    ...
                    foreach (var Det in LinqQuery)
                    {
                        ...
                        var Resultado = pase.Cancelar_Multidespacho(ClsUsuario.loginname);
                        ...
                        else
                        {
                           ...
                           * crear caso salesforce
                           ***********************************************************************************************************************************/
                            MensajesErrores = string.Format("Se presentaron los siguientes problemas:no se pudo cancelar el pase de puerta MULTIDESPACHO para la carga: {0}, Total bultos: {1} Existen los siguientes problemas: {2}, {3}", Det.CARGA, Det.CANTIDAD_CARGA, Resultado.MensajeInformacion, Resultado.MensajeProblema);

                            this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación CFS - MULTIDESPACHO", "Error al cancelar pase CFS MULTIDESPACHO", MensajesErrores.Trim(), string.Format("{0}-{1}-{2}", Det.MRN, Det.MSN, Det.HSN),
                            ...
                            **************************************************************************************************************************************/
                            ...
                            this.Mostrar_Mensaje(2, string.Format("<b>Error! Se presentaron los siguientes problemas, no se pudo cancelar el pase de puerta MULTIDESPACHO para la carga: {0}, Total bultos: {1} Existen los siguientes problemas: {2} </b>", Det.CARGA,Det.CANTIDAD_CARGA , MensajeCasos));
                            return;
                        }
