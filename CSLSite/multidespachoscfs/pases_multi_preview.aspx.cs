...
{
    public partial class pases_multi_preview : System.Web.UI.Page
    {
            ...
            if (Response.IsClientConnected)
            {
                ...
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        List<cfs_imprimir_pase_multidespacho> ListPase = cfs_imprimir_pase_multidespacho.Datos_Pase(id_comp, ClsUsuario.ruc, System.DateTime.Now, out cMensaje);
