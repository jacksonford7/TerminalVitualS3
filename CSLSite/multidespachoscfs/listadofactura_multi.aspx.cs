...
namespace CSLSite
{
    public partial class listadofactura_multi : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaFactura = cfs_imprimir_multidespacho.Listado_Facturas(fechadesde, fechahasta, out cMensajes);
