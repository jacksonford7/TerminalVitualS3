<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="emisionpasecfs_multi.aspx.cs" Inherits="CSLSite.emisionpasecfs_multi" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            <div class="form-row">
                <div class="form-group col-md-6">
                   <label for="inputZip">FACTURA MULTIDESPACHO<span style="color: #FF0000; font-weight: bold;">*</span></label>
     ...
     $(function () {
        $('[id*=Txtempresa]').typeahead({
            ...
            source: function (request, response) {
                $.ajax({
                    url: '<%=ResolveUrl("emisionpasecfs_multi.aspx/GetEmpresas") %>',
                    data: "{ 'prefix': '" + request + "'}",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
     ...
     $(function () {
        $('[id*=TxtChofer]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("emisionpasecfs_multi.aspx/GetChofer") %>',
     ...
     $(function () {
        $('[id*=TxtPlaca]').typeahead({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("emisionpasecfs_multi.aspx/GetPlaca") %>',
                    data: "{ 'prefix': '" + request + "', 'idempresa' : '" + $("#IdTxtempresa").val() + "' }",
                    dataType: "json",
                    type: "POST",
                    maxJsonLength: 1,
