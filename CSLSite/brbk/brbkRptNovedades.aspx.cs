...
{
    public partial class brbkRptNovedades : System.Web.UI.Page
    {
        usuario ClsUsuario;
                ...
                try
                {
                    if (string.IsNullOrEmpty(this.txtNave.Text))
                    {
                        ...
                        return;
                         ...
                         ReportParameter ReportParameter_filtro_ = new ReportParameter("ReportParameter_filtro", ClsUsuario.loginname);
