...
{
    public partial class brbkRptTarja : System.Web.UI.Page
    {
        usuario ClsUsuario;
        ...
        private void populate( string login)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    {
                        this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Por favor ingresar MSN"));
                        this.txtMSN.Focus();
                        return;
                    }
                    ...
                    {
                        this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Por favor ingresar HSN"));
                        this.txtHSN.Focus();
                        return;
                    }

                    //var Resultado = tarjaDet.rptConsultaTarjaBodega(TXTMRN.Text, out OError);
                    ...
                    Session["i_mrn"] = TXTMRN.Text+ txtMSN.Text+ txtHSN.Text;
        ...
        //{
        //    Session["i_mrn"] = TXTMRN.Text;
        //    e.DataSources.Add(new ReportDataSource("dsReportsBreakBulk", "odsReportsBreakBulk"));
        //}
