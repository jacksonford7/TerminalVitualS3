<%@ Page Title="Pre Descarga" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkPreDescarga.aspx.cs" Inherits="CSLSite.brbk.brbkPreDescarga" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">PRE-DESCARGA</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
                            ...
                            <div class="booking" >
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <label for="inputZip"><span class="help-block">&nbsp;</span></label>
                                        <div class="d-flex"> 
                                            <%--<asp:Button ID="btnNuevoBL" runat="server" class="btn btn-primary"  Text="Nuevo BL"  OnClick="btnFiltar_Click"  />--%>

                                            <asp:Button runat="server" ID="btnNuevoBL"  CommandName="Nuevo" Text="Nuevo BL" class="btn btn-primary"  data-toggle="modal" data-target="#myModal3" OnClick="btnNuevoBL_Click"  />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bokindetalle" style=" width:100%; overflow:auto">
                                    <asp:GridView ID="tablePagination" runat="server" AutoGenerateColumns="False"  
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="carga" HeaderText="# CARGA" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            <%--<asp:BoundField DataField="mrn" HeaderText="MRN" Visible="false" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            ...
                                            <asp:BoundField DataField="Agente" HeaderText="AGENTE"  SortExpression="Agente" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>                                                                
                                            ...
                                            <asp:BoundField DataField="consigna" HeaderText="CONSIGNATARIO"  SortExpression="Consignatario" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            ...
                                            <asp:BoundField DataField="pendiente" HeaderText="PENDIENTE" SortExpression="pendiente" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                            ...
                                            <asp:TemplateField HeaderText="Pre-Descarga" ItemStyle-CssClass="center hidden-phone" >
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                             ...
                                             <asp:TemplateField HeaderText="" ItemStyle-CssClass="center hidden-phone">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnRecepcion" Height="30px" CommandName="Ver" Text="Recepción"   CommandArgument='<%# Bind("idTarjaDet") %>' class="btn btn-primary"  data-toggle="modal" data-target="#myModal2"  />                                                                       
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
        ...
        <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            <ContentTemplate>  
                ...
                <div class="form-group col-md-12"> 
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            <asp:Button ID="btnGrabar" runat="server" Visible="false" class="btn btn-primary" Text="GENERAR TRANSACCIÓN" OnClientClick="return mostrarloader('1')"    />
                        </div>
            ...
            <div class="modal-dialog" role="document" style="max-width: 1000px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">DATOS DE RECEPCIÓN</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <asp:UpdatePanel ID="UPREC" runat="server" UpdateMode="Conditional" >  
                            <ContentTemplate>
                                <asp:Panel ID="Panel1" runat="server">         
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="d-flex">
                                                <asp:TextBox ID="txtBLRecepcion"  runat="server" class="form-control"   placeholder="" size="16"  Width="300px" Font-Bold="false" disabled ></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-9">
                                            ...
                                            <div class="d-flex">
                                                <asp:TextBox ID="txtMRNRecepcion"  runat="server" class="form-control"   placeholder="" size="16"  Width="300px" Font-Bold="false" disabled></asp:TextBox>
                                                &nbsp;
                                                <asp:TextBox ID="txtMSNRecepcion"  runat="server" class="form-control"   placeholder="" size="16"  Width="300px" Font-Bold="false" disabled></asp:TextBox>
                                                &nbsp;
                                                <asp:TextBox ID="txtHSNRecepcion"  runat="server" class="form-control"   placeholder="" size="16"  Width="300px" Font-Bold="false" disabled></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bokindetalle" style="width:100%; overflow:auto">       
                                            <asp:GridView ID="dgvRecepcion" runat="server" AutoGenerateColumns="False"  DataKeyNames="idRecepcion"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="consignatario"  HeaderText="CONSIGNATARIO" SortExpression="consignatario" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                    <asp:BoundField DataField="producto" HeaderText="PRODUCTO"  HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                    ...
                                                    <asp:BoundField DataField="cantidades" HeaderText="CANT" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
                                                    ...
                                                    <asp:BoundField DataField="estados" HeaderText="ESTADO" ItemStyle-Font-Size="12px" HeaderStyle-CssClass="center hidden-phone" ItemStyle-CssClass="gradeC center hidden-phone"/>
        ...
        <div id="myModal3" class="modal fade" tabindex="-1" role="dialog">
            ...
            <div class="modal-dialog" role="document" style="max-width: 1180px"> <!-- Este tag style controla el ancho del modal -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">EDICIÓN DE DATOS DEL BL Y PLANIFICACIÓN</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                                        ...
                                        <asp:Panel ID="Panel2" runat="server">         
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-9">
                                                    <label for="inputAddress">No Carga :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                        <asp:TextBox ID="txtmrnDet"  runat="server" class="form-control"   placeholder="MRN" Font-Bold="false" ></asp:TextBox>
                                                        &nbsp;
                                                        <asp:TextBox ID="txtmsnDet"  runat="server" class="form-control"   placeholder="MSN" Font-Bold="false" ></asp:TextBox>
                                                        &nbsp;
                                                        <asp:TextBox ID="txthsnDet"  runat="server" class="form-control"   placeholder="HSN" Font-Bold="false" ></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group   col-md-4"> 
                                                    ...
                                                    <div class="d-flex">
                                                        <asp:TextBox ID="txtRucConsignatario" runat="server" MaxLength="100" 
                                                            placeholder="Ruc"
                                                            class="form-control"
                                             ...
                                             <div class="form-group   col-md-8"> 
                                                ...
                                                <div class="form-group col-md-2"> 
                                                    <label for="inputAddress">Maniobra 1 :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                ...
                                                <div class="form-group col-md-2"> 
                                                    <label for="inputAddress">Maniobra 2 :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                                    <div class="d-flex">
                                                        <asp:DropDownList ID="cmbManiobra2" class="form-control" runat="server" Font-Size="Medium" disabled  Font-Bold="true" ></asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group   col-md-3"> 
                                                    ...
                                                    <asp:TextBox ID="txtTonelaje" runat="server" MaxLength="9" class="form-control"
                                                        onkeypress="return soloLetras(event,'1234567890.',true)" 
                                            ...
                                            <%--<div class="row mb"> --%>
                                                <div class="content-panel">
                                                    <div class="form-row">
                                                       ...
                                                       <div class="form-group col-md-6"> 
                                                            <label for="inputAddress">Ubicacion Planificada :<span style="color: #FF0000; font-weight: bold;"></span></label>
                                                            <div class="d-flex">
