...
<%@ Page Title="Reporte de Liquidación de Buque" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="brbkRptLiquidacionBuque.aspx.cs" Inherits="CSLSite.brbk.brbkRptLiquidacionBuque" %>
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE DE LIQUIDACIÓN DE BUQUE</li>
            </ol>
        </nav>
    </div>
                                      ...
                                      <asp:Repeater ID="grilla" runat="server"  >
                                       ...
                                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="grilla" width="100%">
                                          ...
                                          <tr>
                                            ...
                                            <th class="th-sm">SERVICIO ADICIONAL</th>
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeC">
                                                ...
                                                <td class="center hidden-phone"> <%#Eval("ServicioAdicional")%></td>
