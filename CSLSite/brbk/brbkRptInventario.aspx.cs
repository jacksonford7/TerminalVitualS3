...
{
    public partial class brbkRptInventario : System.Web.UI.Page
    {
        usuario ClsUsuario;
        ...
        private void populate(string ruc, string login)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var Resultado = tarjaDet.rptConsultaInventario(txtNave.Text,cmbUbicacion.SelectedValue, out OError);
