...
namespace CSLSite
{
    public partial class facturaimportacion : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
        ...
        private void Poblar_Servicios()
        {
            ...
            else
            {
                ...
                if (objFactura.DetalleServicios.Count != 0)
                {
                    ...
                    var LinqContenedores = (from p in objFactura.Detalle.Where(x => x.IV_CAS == null)
                                              select p.IV_CONTENEDOR).ToList();

                    if (LinqContenedores.Count != 0)
                    {
                        string Contenedores = string.Join(", ", LinqContenedores);

                       /* string MsgInfo = "<b>Informativo! </b>Existen contenedores que no tienen asignado una fecha de CAS, el sistema le permitirá emitir la factura, " +
                            "tener en consideración este mensaje para la emisión de los pases a puerta, ya que se " +
                            "validará la fecha de la CAS en la emisión de pase puerta: " + Contenedores.ToString().Trim() + " ";*/

                        this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Existen contenedores que no tienen asignado una fecha de CAS, el sistema le permitirá emitir la factura, " +
                        "tener en consideración este mensaje para la emisión de los pases a puerta, ya que se " +
                        "validará la fecha de la CAS en la emisión de pase puerta: {0} ", Contenedores.ToString().Trim()));
                        
                        //this.Mostrar_Mensaje(string.Format(MsgInfo));
                    }
                        ...
                        if (LinqFechasContainer.Count != 0)
                        {
                            ...
                            if (Finalizar != null)
                            {
                                if (Finalizar.status_id.Equals("OK"))
                                {
                                   ...
                                   // this.ImgCarga.Attributes["visible"] = "false";
                                    ...
                                    var nProceso = objProcesar.SaveTransaction_New(out cMensajes);
                                    ...
                                    if (!nProceso.HasValue || nProceso.Value <= 0)
                                    {
                                        ...
                                        this.Mostrar_Mensaje(string.Format("<b>Error! No se pudo grabar datos de la factura..{0}</b>", cMensajes));
                                        ...
                                        * **********************************************************************************************************************************/
                                        ...
                                        this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación Contenedor", "Error al grabar", cMensajes, out MensajeCasos);
                                    ...
                                    else
                                    {
                                        ...
                                        //this.BtnNuevo.Attributes.Remove("disabled");
                                    ...
                                    ///*grabar transaccion de factura*/
                                    //var nIdRegistro = objFactura.SaveTransaction(out cMensajes);
                                    //if (!nIdRegistro.HasValue || nIdRegistro.Value <= 0)
                                    //{
                                    //    this.Id_Factura_Generada = string.Empty;
                                    //    this.hf_idfacturagenerada.Value = string.Empty;
                                    ...
                                    //    objFactura.DetalleServicios.Clear();
                                    //    Session["Invoice" + this.hf_BrowserWindowName.Value] = objFactura;
                                    //    this.Id_Factura_Generada = nIdRegistro.Value.ToString();
                                    //    this.hf_idfacturagenerada.Value = nIdRegistro.Value.ToString();
                                    //    this.OcultarLoading();
                                    //    this.Actualiza_Paneles();
                                    //}
                                }
                                else
                                {
                                    ...
                                    * **********************************************************************************************************************************/
                                    ...
                                    this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación Contenedor", "Error al grabar", Finalizar.messages.ToString(), out MensajeCasos);
                            ...
                            else
                            {
                                ...
                                * **********************************************************************************************************************************/
                                ...
                                this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación Contenedor", "Error al grabar", string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Problemas al finalizar el DRAFT # {0}", draftNumber), out MensajeCasos);
