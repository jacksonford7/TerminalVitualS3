<%@ Page Title="Despacho Vehiculos" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="despachovehiculos.aspx.cs" Inherits="CSLSite.despachovehiculos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <div class="container mt-4">
        ...
        <table class="table table-bordered" id="tablaDespacho">
            <thead>
                <tr>
                    <th>#</th>
                    <th>FA</th>
