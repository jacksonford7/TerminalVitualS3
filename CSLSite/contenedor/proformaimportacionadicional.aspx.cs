...
namespace CSLSite
{
    public partial class proformaimportacionadicional : System.Web.UI.Page
    {
        usuario ClsUsuario;
        ...
        protected void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/contenedor/contenedorimportacionadicional.aspx?ID_CARGA=" + securetext(ID_CARGA), false);
        }
