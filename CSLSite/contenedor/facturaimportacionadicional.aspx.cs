...
namespace CSLSite
{
    public partial class facturaimportacionadicional : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
                    ...
                    else
                    {
                        ...
                        **********************************************************************************************************************************************/
                        ...
                        if (LinqFechasContainer.Count != 0)
                        {
                            ...
                            if (objFactura.DetalleServicios.Count == 0)
                            {
                                this.Mostrar_Mensaje(string.Format("<b>Error! </b>No existe servicios para facturar..error en generación del DRAFT"));
                                return;
                            }
                           ...
                           new System.Xml.Linq.XElement("FACT_CONTENEDOR", from p in objFactura.Detalle.AsEnumerable().AsParallel()
                            ...
                            if (Finalizar != null)
                            {
                                if (Finalizar.status_id.Equals("OK"))
                                {
                                    ...
                                    this.BtnFacturar.Attributes["disabled"] = "disabled";
                                    this.Mostrar_Mensaje(string.Format("<b>Se procedió a generar la factura # {0}  {1} ", FacturaFinal, ",Puede proceder a imprimir su comprobante"));
