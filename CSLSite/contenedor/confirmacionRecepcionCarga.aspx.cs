...
namespace CSLSite
{
    public partial class confirmacionRecepcionCarga : System.Web.UI.Page
    {
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ListaContenedores = Contenedor.CargaporReferencia(ClsUsuario.loginname, this.TXTMRN.Text.ToString());

                 

                    //INFORMACION DE BOOKING YA PROCESADOS(ya almacenados en base de datos)
                    RN_Bill_InvoiceContainerExpo _obj = new RN_Bill_InvoiceContainerExpo();
                    var ListaBookingProcesado = _obj.consultaEntidad(this.TXTMRN.Text.ToString(), out _ERROR);

                    //INFORMACION DE VALIDACIONES DE CONTENEDORES YA PROCESADOS(ya almacenados en base de datos)
                    RN_Bill_InvoiceContainerExpo _objValidacion = new RN_Bill_InvoiceContainerExpo();
                    objValidacionesDet = _objValidacion.consultaSubDetalle(null,null, TXTMRN.Text, out _ERROR);
