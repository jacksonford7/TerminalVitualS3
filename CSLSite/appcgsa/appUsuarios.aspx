<%@ Page Title="Usuarios" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="appUsuarios.aspx.cs" Inherits="CSLSite.appUsuarios" %>
        ...
        <ContentTemplate>
            ...
            <div class="mt-4">         
                <nav class="mt-4" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">App CGSA Usuarios Con Paquetes Adquiridos</a></li>
                ...
                <div class="form-group col-md-12"> 
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-center">
                                ...
                                <asp:Button ID="Button1" class="btn btn-primary" Text="Crear Usuario" runat="server" OnClick="Button1_Click" visible="false" />
                                &nbsp;
  ...
  <%--              <div class="col-md-12 d-flex justify-content-center">
    ...
    <script type="text/javascript">
        ...
        function setUserOp(user) {
            ...
            $("#<%=hdfIdUsuario.ClientID%>").val(user); //set value
            $("#<%=btSetearId.ClientID%>").click(); //set value
            location.href = "../appcgsa/appAccesoUsuarios.aspx";
        }
