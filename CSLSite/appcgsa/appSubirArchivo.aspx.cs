...
namespace CSLSite
{
    public partial class appSubirArchivo : System.Web.UI.Page
    {
        private usuario u;
        ...
        private void New_ExportFileUpload()
        {
            ...
            if (fsuploadarchivo.HasFile)
            {
                ...
                var p = CSLSite.app_start.CredencialesHelper.UploadFile_AppCgsa(Server.MapPath(fsuploadarchivo.FileName), fsuploadarchivo.PostedFile.InputStream, out finalname);
                if (!p)
                {
