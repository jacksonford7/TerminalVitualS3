<%@ Page Title="Usuarios" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="appRptPaquetesClientesAgente.aspx.cs" Inherits="CSLSite.appRptPaquetesClientesAgente" %>
    ...
    <asp:UpdatePanel ID="updConsultaUsuarios" runat="server">
        <ContentTemplate>
            ...
            <div class="mt-4">         
                <nav class="mt-4" aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">App CGSA</a></li>
                        <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">REPORTE PAQUETES/AGENTES</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="dashboard-container p-4" id="cuerpo" runat="server">
                ...
                <div Style="display: none;"  class="form-title">
                            ...
                            <div class='accordion' id='accordionExample2'>
                                <div class='card'> 
                                    <div class='card-header' id='heading-busq'>
                                       <h2 class='mb-0'>
                                           <button type = 'button' class='btn btn-link font-weight-bold text-red' data-toggle='collapse' data-target='#collapse_busq'><i class='fa fa-chevron-right'></i> CRITERIOS DE BÚSQUEDAS DE AGENTES</button>
                                       </h2>
                                    </div>
