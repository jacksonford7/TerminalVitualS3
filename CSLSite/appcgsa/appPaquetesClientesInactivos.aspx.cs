...
namespace CSLSite
{
    public partial class appPaquetesClientesInactivos : System.Web.UI.Page
    {
        ...
        private void Carga_Paquetes_Clientes()
        {
            try
            {
                ...
                List<MantenimientoPaqueteCliente> Listado = MantenimientoPaqueteCliente.Listado_Paquetes_Clientes_Inactivos(pdesde, phasta, criterio,out OError);
                if (Listado != null)
                {
