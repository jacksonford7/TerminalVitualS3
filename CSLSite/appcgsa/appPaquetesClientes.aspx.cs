...
namespace CSLSite
{
    public partial class appPaquetesClientes : System.Web.UI.Page
    {
        ...
        private void Carga_Paquetes_Clientes()
        {
            try
            {
                ...
                List<MantenimientoPaqueteCliente> Listado = MantenimientoPaqueteCliente.Listado_Paquetes_Clientes_filtro(pdesde, phasta, criterio,out OError);
                if (Listado != null)
                {
