...
namespace CSLSite
{
    public partial class listadofacturasimp : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaFactura = _obj.Entidad_Listado_Facturas_Impo(fechadesde, fechahasta, ClsUsuario.loginname, ClsUsuario.ruc, out cMensajes);
