...
namespace CSLSite
{
    public partial class listadoproformaimpo : System.Web.UI.Page
    {
        #region "Clases"
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var TablaProforma = _obj.Entidad_Listado_Proforma_Impo(fechadesde, fechahasta, ClsUsuario.loginname, ClsUsuario.ruc, out cMensajes);

                   // var TablaProforma = Cls_Bil_Proforma_Listado.Listado_Proformas(fechadesde, fechahasta, ClsUsuario.Usuario, ClsUsuario.Ruc, out cMensajes);
