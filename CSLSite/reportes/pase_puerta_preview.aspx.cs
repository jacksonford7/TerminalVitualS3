...
namespace CSLSite
{
    public partial class pase_puerta_preview : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
        ...
        {
            List<Int64> ListaImprimir = new List<Int64>();
            ...
            else
            {
                ...
                var DsReporte = PasePuerta.Pase_Container.ImprimirPasesContenedor(ListaImprimir, ClsUsuario.ruc);
