...
namespace CSLSite
{
    public partial class pase_puerta_brbk_preview : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
        ...
        private void Poblar_PasePuerta()
        {
            ...
            else
            {
                ...
                var DsReporte = PasePuerta.Pase_BRBK.ImprimirPasesBreakBulk(ListaImprimir, ClsUsuario.ruc);
