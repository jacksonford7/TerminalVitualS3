<%@ Page Title="Reporte Truck Time" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="trucktime.aspx.cs" Inherits="CSLSite.exportables.trucktime" %>
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Reportes</a></li>
             <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Truck Time</li>
          </ol>
        </nav>
      </div>
