<%@ Page Title="Reporte Inventario cedi" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="inventario_cedi.aspx.cs" Inherits="CSLSite.exportables.inventario_cedi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Reporte Inventario cedi</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        <div class="alert alert-warning">
            Este archivo exportable contiene la información del inventario cedi.
        </div>
            ...
            <div class="form-group col-md-12">
                <asp:UpdatePanel ID="upresult" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="botonera">
                            <asp:Button ID="btbuscar" runat="server" Text="Exportar Reporte Inventario cedi"
