<%@ Page Title="Asignar turnos" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" 
    CodeBehind="turnos.aspx.cs" Inherits="CSLSite.turnos_consolidacion" %>
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Exportación</a></li>
             <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Asignación de Horarios</li>
          </ol>
        </nav>
      </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
			  ...
			  <div class="d-flex">
                   <span id="numbook" class="caja" onclick="clear();">...</span>
                          <a  class="btn btn-outline-primary mr-4"  target="popup" 
                              onclick="window.open('../catalogo/bookinListConsolidacion.aspx','name','width=1260,height=880')" >
         <span class='fa fa-search' style='font-size:24px'></span> 
		   ...
		   <div class="form-group col-md-6"> 
			  ...
			  <div class="d-flex">
                   <span id="txtfecha" class="  form-control col-md-12"  >...</span>
                                   <a  class="btn btn-outline-primary mr-4" 
                 target="popup" onclick="openPop();" >
            <span class='fa fa-search' style='font-size:24px'></span> 
          ...
          <div class="form-row">
		   ...
		   <div class="form-group col-md-12"> 
			  ...
			  <div class="d-flex">
                         <input 
               placeholder="Para enviar a varios mails separelos con punto y coma."
               type='text' id='tmail' name='tmail'  runat="server" 
		   ...
		   <div class="col-md-12 d-flex justify-content-center"> 
             ...
             <asp:Button ID="btbuscar" runat="server" Text="Consultar disponibilidad"   
                 ...
                 OnClientClick="return checkDate('xfecha');"
                  />
                <span id="imagen"></span>
		   </div> 
		   </div>
           <div class="cataresult" >
             ...
             <div class="booking" >
                 ...
                 <tr class="point" >
                  ...
                  <td><%#Eval("HASTA")%></td>
                  <td><%#Eval("CANT_BBK")%></td>
                  <td><%#Eval("RESERVADO_BBK")%></td>
                  <td><%#Eval("DISPONIBLE_BBK")%></td>
                  ...
                  <td>
                      ...
                      Text="0" ID="caja" CssClass="form-control" xval='<%#Eval("DISPONIBLE")%>' onblur="cajaControl(this);" runat="server" MaxLength="4" onkeypress="return soloLetras(event,'01234567890',true)" ></asp:TextBox>
                   </td>
                 </tr>
                  </ItemTemplate>
                 <FooterTemplate>
...
<div class="form-row">
           <div class="col-md-12 d-flex justify-content-center" runat="server" id="btnera">
              ...
              <input id="btsalvar" class="btn btn-primary" type="button" value="Proceder y Asignar"  onclick="prepareObject();encerar();" /> &nbsp;
           </div>
    </div>
             </div>
             </div>
    ...
    <script type="text/javascript">
        ...
        function pasavalores() {
            ...
            var fe = document.getElementById('xfecha').value;
            document.getElementById('numbook').textContent = bo;
            document.getElementById('txtfecha').textContent = fe;
        }
                ...
                for (var f = 0; f < tbl.rows.length; f++) {
                    ...
                    if (celColect != undefined && celColect != null && celColect.length > 0) {
                        ...
                        var tdetalle = {
                            ...
                            desde: celColect[0].textContent,
                            hasta: celColect[1].textContent,
        ...
        function encerar() {
            ...
            for (var f = 0; f < tbl.rows.length; f++) {
                var celColect = tbl.rows[f].getElementsByTagName('td');
                if (celColect != undefined && celColect != null && celColect.length > 0) {
                    celColect[8].getElementsByTagName('input')[0].value = 0;
                }
            }
            document.getElementById('ttd').textContent = 'Total reservado: 0';
        }
    </script>
