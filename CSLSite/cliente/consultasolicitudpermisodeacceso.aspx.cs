...
namespace CSLSite
{
    public partial class consultasolicitudpermisodeacceso : System.Web.UI.Page
    {
        ...
        {
            get { return (DataTable)Session["dtDocumentosconsultasolicitudpermisodeacceso"]; }
            set { Session["dtDocumentosconsultasolicitudpermisodeacceso"] = value; }
        }
        public String numsolicitudempresa
        {
            get { return (String)Session["numsolicitudconsultasolicitudpermisodeacceso"]; }
            set { Session["numsolicitudconsultasolicitudpermisodeacceso"] = value; }
        }
        public string rucempresa
        {
            get { return (string)Session["rucempresaconsultasolicitudpermisodeacceso"]; }
            set { Session["rucempresaconsultasolicitudpermisodeacceso"] = value; }
        }
        public string useremail
        {
            get { return (string)Session["useremailconsultasolicitudpermisodeacceso"]; }
            set { Session["useremailconsultasolicitudpermisodeacceso"] = value; }
        }
        public string mensajefac
        {
            get { return (string)Session["mensajefacconsultasolicitudpermisodeacceso"]; }
            set { Session["mensajefacconsultasolicitudpermisodeacceso"] = value; }
        }
        public string mensajeok
        {
            get { return (string)Session["mensajeokconsultasolicitudpermisodeacceso"]; }
            set { Session["mensajeokconsultasolicitudpermisodeacceso"] = value; }
        }
