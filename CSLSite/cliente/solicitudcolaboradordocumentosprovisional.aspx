...
CodeBehind="solicitudcolaboradordocumentosprovisional.aspx.cs" Inherits="CSLSite.cliente.solicitudcolaboradordocumentosprovisional" %>
      ...
      <asp:Repeater ID="tablePaginationDocumentos" runat="server">
            ...
            <td>
                ...
                <asp:FileUpload extension='<%#Eval("EXTENSION")%>' id="fsupload"  title="Escoja el archivo con formato indicado en la siguiente columna."
                       onchange="validaextension(this)" style=" font-size:small;" runat="server" class="btn btn-outline-primary mr-4"/>
                       </td>
            </td>
            <td>
                <a onclick="abrirVentana('<%#Eval("RUTADOCUMENTO") %>')" class="btn btn-outline-primary mr-4" target="_blank">
