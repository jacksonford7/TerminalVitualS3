...
{
    public partial class consultasolicitudvehiculo_new : System.Web.UI.Page
    {
        public String numsolicitudempresa
        {
            get { return (String)Session["numsolicitudconsultasolicitudvehiculo"]; }
            set { Session["numsolicitudconsultasolicitudvehiculo"] = value; }
        }
        public string rucempresa
        {
            get { return (string)Session["rucempresaconsultasolicitudvehiculo"]; }
            set { Session["rucempresaconsultasolicitudvehiculo"] = value; }
        }
        public string useremail
        {
            get { return (string)Session["useremailconsultasolicitudvehiculo"]; }
            set { Session["useremailconsultasolicitudvehiculo"] = value; }
        }
        ...
        private void ConsultaInfoSolicitud()
        {
            try
            {
                ...
                var tablixVehiculo = credenciales.GetSolicitudVehiculoCliente(numsolicitudempresa);
