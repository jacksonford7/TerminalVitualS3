...
namespace CSLSite
{
    public partial class solicitudCredencialesActivasOPCConsulta : System.Web.UI.Page
    {
        ...
        {
            get { return (DataTable)Session["dtDocumentosrevisasolicitudpermisoOPC"]; }
            set { Session["dtDocumentosrevisasolicitudpermisoOPC"] = value; }
        }
        ...
        protected void btsalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtAC_R_PERMISO_TEMPORAL.Rows.Add("", empresa, txtarea.Text, "", cedulareplegal, nombresreplegal, txtactper.Text, fechaing.ToString("yyyy-MM-dd"), fechacad.ToString("yyyy-MM-dd"));
                ...
                //{
                //    ConsultaInfoSolicitud();
                //    Response.Write("<script language='JavaScript'>var r=alert('Solicitud " + mensajeok + " exitosamente, en unos minutos recibirá una notificación via mail.');if(r==true){window.close()}else{window.close()};</script>");
                //}
            }
            catch (Exception ex)
            {
