...
{
    public partial class consultafacturacolaborador : System.Web.UI.Page
    {
        ...
        private void New_ExportFileUpload()
        {
            ...
            foreach (RepeaterItem item in tablePagination.Items)
            {
                ...
                if (fsupload.HasFile)
                {
                    ...
                    dtDocumentos.Rows.Add(Convert.ToInt32(lblIdSolicitud.Text), finalname);
                }
            }
        ...
        private void ExportFileUpload()
        {
            ...
            foreach (RepeaterItem item in tablePagination.Items)
            {
                ...
                if (fuAdjuntarFactura.HasFile)
                {
                    ...
                    string substring = ConfigurationManager.AppSettings["rutaconfaccol"].ToString() + "\\";
