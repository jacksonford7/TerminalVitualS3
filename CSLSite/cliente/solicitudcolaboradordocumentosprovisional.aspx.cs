...
{
    public partial class solicitudcolaboradordocumentosprovisional : System.Web.UI.Page
    {
        ...
        {
            get { return (DataTable)Session["dtDocumentosSolColPro"]; }
            set { Session["dtDocumentosSolColPro"] = value; }
        }
        private String xmlDocumentos;
        public String rucci
        {
            get { return (String)Session["ruccisolcoldocpro"]; }
            set { Session["ruccisolcoldocpro"] = value; }
        }
            ...
            if (Response.IsClientConnected && !IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (true/*Session["tipodocsol"].ToString() != "0"*/)
                    {
                        ...
                        var tablix3 = credenciales.GetDocumentosColaboradorPaseProvisional(Session["srucempresacolpro"].ToString(), Request.QueryString["tipodoc"].ToString());
                        ...
                        {
                            rucci = Request.QueryString["CIPAS"];
                        }

                        DataTable dt = new DataTable();
                        dt = Session["dtDocumentosColaboradoresSolicitudPro"] as DataTable;
                        ...
                        tablePaginationDocumentos.DataSource = tablix3;
                        tablePaginationDocumentos.DataBind();
                        Session["dtDocumentosSolColPro"] = new DataTable();
        ...
        private void ExportFileUpload()
        {
            ...
            foreach (RepeaterItem item in tablePaginationDocumentos.Items)
            {
                ...
                if (fsupload.HasFile)
                {
                    ...
                    foreach (var itemlistaDoc in llistaDoc)
                    {
                        ...
                        dtDocumentos.Rows.Add(rucci, itemlistaDoc.iddocemp, itemlistaDoc.idtipemp, rutafile, finalname, extensionfile);
                    }
            ...
            DataTable dtPadre = Session["dtDocumentosColaboradoresSolicitudPro"] as DataTable;
            ...
            Session["dtDocumentosSolColPro"] = new DataTable();
            Session["dtDocumentosColaboradoresSolicitudPro"] = dtHijo;
            Session["dtDocumentosSolColPro"] = dtHijo;
