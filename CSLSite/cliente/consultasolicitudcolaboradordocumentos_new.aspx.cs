...
{
    public partial class consultasolicitudcolaboradordocumentos_new : System.Web.UI.Page
    {
        ...
        private void ConsultaInfoSolicitud()
        {
            ...
            DataTable dtDocumentos = credenciales.GetDocumentosColaboradorXNumSolicitudCliente_New(numsolicitudempresa, idsolcol);
