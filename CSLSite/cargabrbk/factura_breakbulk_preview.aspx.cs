...
namespace CSLSite
{
    public partial class factura_breakbulk_preview : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
        ...
        private void Poblar_Servicios()
        {
            ...
            else
            {
                ...
                var nIdRegistro_Traza = objFactura.SaveTransaction_Traza_brbk(out cMensajes);
                if (!nIdRegistro_Traza.HasValue || nIdRegistro_Traza.Value <= 0)
                {
                    this.Mostrar_Mensaje(string.Format("<b>Error! No se pudo grabar traza de la factura de break bulk..{0}</b>", cMensajes));
                }
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.Mostrar_Mensaje( string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible..no existen datos para facturar carga break bulk"));
                    Response.Redirect("~/facturacionbrbk.aspx", false);
                    return;
                }
        ...
        protected void BtnVisualizar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                ...
                if (objFactura == null)
                {
                    this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Aún no ha generado la factura de carga break bulk, para poder imprimirla"));
                    return;
                }
        ...
        protected void BtnFacturar_Click(object sender, EventArgs e)
        {
            ...
            this.Mostrar_Mensaje(string.Format("<b>GENERANDO FACTURA CARGA BREAK BULK! </b>....POR FAVOR ESPERE, SE ESTA GENERANDO LA FACTURA......."));
            ...
            if (Response.IsClientConnected)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (objFactura.DetalleServicios.Count == 0)
                        {
                            this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>No existe servicios pendientes para facturar carga break bulk: {0}", objFactura.IV_NUMERO_CARGA));
                            return;
                        }
                        ...
                        **********************************************************************************************************************************************/
                        ...
                        if (Cliente.Exitoso)
                        {
                            ...
                            {
                                this.Mostrar_Mensaje(string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible..no existen datos de cliente para facturar carga break bulk: {0}", objFactura.IV_NUMERO_CARGA));
                                return;
                            }
                        }
                        else
                        ...
                        **********************************************************************************************************************************************/
                        ...
                        if (SinServicios)
                        {
                            ...
                            //                this.Mostrar_Mensaje(string.Format("<b>Error! No se pudo actualizar datos días libres, para la carga break bulk {0}, {1}</b>", objFactura.IV_NUMERO_CARGA, cMensajes));
                            //                return;
                            //            }
                            //            else
                            //            {
                            ...
                            this.Mostrar_Mensaje(string.Format("<i class='fa fa-warning'></i><b> Informativo! No existen servicios pendientes para facturar carga break bulk.</br> {0} ", cMensajeActualizados));
                            return;
                        ...
                        * 27-04-2020
                        * *********************************************************************************************************************************/                          
                        List<Cls_Bil_Configuraciones> ValidaFactura = Cls_Bil_Configuraciones.Get_Validacion("VALIDA_FACT_BRBK", out cMensajes);
                        ...
                        if (Finalizar != null)
                        {
                            if (Finalizar.status_id.Equals("OK"))
                            {
                                ...
                                this.Mostrar_Mensaje(string.Format("<b>Se procedió a generar la factura de carga break bulk # {0}  {1} ...{2} ", FacturaFinal, ",Puede proceder a imprimir su comprobante.", cMensajeActualizados));
                                ...
                                var nProceso = objProcesar.SaveTransaction_break_bulk(out cMensajes);
                                ...
                                if (!nProceso.HasValue || nProceso.Value <= 0)
                                {
                                    ...
                                    this.Mostrar_Mensaje(string.Format("<b>Error! No se pudo grabar datos de la factura de carga break bulk..{0}</b>", cMensajes));
                                    ...
                                    * **********************************************************************************************************************************/
                                    ...
                                    this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación BREAK BULK", "Error al grabar", cMensajes, out MensajeCasos);
                            ...
                            else
                            {
                                ...
                                * **********************************************************************************************************************************/
                                ...
                                this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación BREAK BULK", "Error al grabar", Finalizar.messages.ToString(), out MensajeCasos);
                        ...
                        else
                        {
                            ...
                            * **********************************************************************************************************************************/
                            ...
                            this.Enviar_Caso_Salesforce(ClsUsuario.loginname, ClsUsuario.ruc, "Facturación BREAK BULK", "Error al grabar", string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Problemas al finalizar el DRAFT # {0}", draftNumber), out MensajeCasos);
                ...
                catch (Exception ex)
                {
                    ...
                    lm = SqlConexion.Cls_Conexion.LogEvent<Exception>(Page.User.Identity.Name, nameof(BtnFacturar_Click), "Facturar BREAK BULK", false, null, null, ex.StackTrace, ex);
