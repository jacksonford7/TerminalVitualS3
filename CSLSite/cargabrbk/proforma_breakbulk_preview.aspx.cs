...
namespace CSLSite
{
    public partial class proforma_breakbulk_preview : System.Web.UI.Page
    {
        usuario ClsUsuario;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.Mostrar_Mensaje(string.Format("<b>Error! </b>Lo sentimos, algo salió mal. Estamos trabajando para solucionarlo lo más pronto posible..no existen datos para proformar carga break bulk"));
        ...
        protected void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/cargabrbk/facturacionbrbk.aspx?ID_CARGA=" + securetext(ID_CARGA), false);
        }
