...
<div class="dashboard-container p-4" id="cuerpo" runat="server">
 ...
 <table width="724" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="692" height="76" valign="top"><div align="justify">Estimado Cliente, suscríbase a CGSApp y reciba notificaciones en tiempo real de la trazabilidad de su carga.<br/>
  ...
  <tr>
    <td height="228" valign="top"><div align="left"><strong>¿Qué información recibirá?</strong><br/>
        - Status de ingreso y despacho de carga - incluye registro fotográfico.<br/>
        - Revisión de E-pass (turnos generados), incluye status de turno - incluye visualización y descarga de pases generados.<br/>
        - Liberación Aduanera.<br/>
        - Status de carga almacenada - inventario en sitio.<br/>
        - Facturas emitidas -  incluye visualización y descarga de documentos generados.<br/>
  ...
  <tr>
    <td height="38" valign="top"><div align="center"><strong>¡Fácil! ¡Rápido! ¡Seguro!</strong><br/>
        <strong>
    Precio del servicio USD 7.00+IVA por movimiento de carga, hasta culminar el contenido de la importación/exportación.</strong></div></td>
  </tr>
  <tr>
