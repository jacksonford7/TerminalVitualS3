                    ...
                    <span id="numexpo" class="nover" type="hidden" runat="server" clientidmode="Static" enableviewstate="true">...</span>
                        ...
                        <div class="form-row">
                             <div class="form-group col-md-4"> 
                                ...
                                <asp:DropDownList ID="cmbDeposito" class="form-control" runat="server" Enabled="false" Font-Size="Medium"  AutoPostBack="true" Font-Bold="true"
                                                   ...
                                                   <div class="bokindetalle" style=" width:100%; overflow:auto">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource_Detalle" runat="server" ConnectionString="<%$ ConnectionStrings:midle %>" SelectCommand="SP_MOVIMIENTOS_PROFORMAS_ZAL" SelectCommandType="StoredProcedure">        
                                                            <SelectParameters>  
                                                                ...
                                                                <asp:SessionParameter DbType="Int64" Name="depot" SessionField="depot" DefaultValue="0" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        function popupCallback(objeto, catalogo)
        {
            ...
            if (catalogo == 'bk')
            {
                ...
                //document.getElementById('txtsolicitud').textContent = objeto.nbr;
                this.document.getElementById('<%= txtsolicitud.ClientID %>').value = objeto.nbr;
                return;
            }
            ...
            if (catalogo == 'numexport') {
                ...
                this.document.getElementById('<%= TxtExportador.ClientID %>').value = document.getElementById('nomexpo').textContent;
                return;
            }
