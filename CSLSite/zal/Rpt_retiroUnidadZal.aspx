<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rpt_retiroUnidadZal.aspx.cs" Inherits="CSLSite.Rpt_retiroUnidadZal" %>
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">RETIROS DE UNIDADES</li>
            </ol>
        </nav>
    </div>
    ...
    <script type="text/javascript">
        ...
        function exportar() {
           ...
           <%-- var cboTipoCarga = document.getElementById("<%= cboTipoCarga.ClientID %>");
            ...
            xhr.open('POST', 'Rpt_retiroUnidadZal.aspx/ExportarExcel', true);
