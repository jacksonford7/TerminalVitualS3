<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rpt_recepcionVaciosZal.aspx.cs" Inherits="CSLSite.Rpt_recepcionVaciosZal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div class="mt-4">
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">RTV</a></li>
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">RECEPCIÓN DE VACÍOS</li>
            </ol>
        </nav>
    </div>
    ...
    <script type="text/javascript">
        ...
        function exportar() {
           ...
           <%-- var cboTipoCarga = document.getElementById("<%= cboTipoCarga.ClientID %>");
            ...
            xhr.open('POST', 'Rpt_recepcionVaciosZal.aspx/ExportarExcel', true);
