<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="facturacion_zal_listado.aspx.cs" Inherits="CSLSite.facturacion_zal_listado" %>
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">LISTADO GENERAL DE FACTURAS EMITIDAS</li>
          </ol>
        </nav>
      </div>
    ...
    <div class="form-row">  
     ...
     <asp:UpdatePanel ID="UPDETALLE" runat="server" UpdateMode="Conditional" >  
       <ContentTemplate>
           ...
           <h4 id="LabelTotal" runat="server" class="mb">PASE PUERTA ZAL</h4>
    ...
    <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            ...
            <br/>
             ...
             <div class="col-md-12 d-flex justify-content-center">
                    ...
                    <asp:Button ID="BtnExcel" runat="server" class="btn btn-primary" Text="EXPORTAR EXCEL"   OnClientClick="exportar();" />
...
<script type="text/javascript">
    ...
    function exportar()
    {
        ...
        console.log(json);
            ...
            xhr.open('POST', 'facturacion_zal_listado.aspx/ExportarExcel', true);
