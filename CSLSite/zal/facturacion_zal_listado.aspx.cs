...
namespace CSLSite
{
    ...
    public partial class facturacion_zal_listado : System.Web.UI.Page
    {
        ...
        private void Cargar_PasesPendientes()
        {
            try
            {
                ...
                if (Response.IsClientConnected)
                {
                    ...
                    this.LabelTotal.InnerText = string.Format("DETALLE DE PASE DE PUERTAS ZAL FACTURADOS");
                    ...
                    List<ZAL_Detalle_Factura> ListPases = ZAL_Detalle_Factura.Detalle_Pases_Facturados_Por_Cgsa(fechadesde, fechahasta,  out cMensajes);
