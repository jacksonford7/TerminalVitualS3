...
namespace CSLSite
{
    public partial class Rpt_retiroUnidadZal : System.Web.UI.Page
    {
        #region "Clases"
        ...
        public static byte[] CreateExcelBytesFromStoredProcedure(string fechaDesde, string fechaHasta)
        {
            ...
            string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["midle"].ConnectionString;
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("ZAL_C_RetiroUnidad", connection))
                {
