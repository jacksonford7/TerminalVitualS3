<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="facturacion_zal.aspx.cs" Inherits="CSLSite.facturacion_zal" %>
...
<script type="text/javascript">
  ...
  $(document).ready(function ()
    ...
    $(document).ready(function() {    
    $('#<%=PaginationBuscador.ClientID%>').DataTable({        
        language: {
    ...
    <asp:HiddenField ID="manualHide" runat="server" />
      ...
      <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">RETIRO DE CONTENEDORES (ZAL)</a></li>
            <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">FACTURACIÓN EMITIDA POR (CGSA)</li>
          </ol>
        </nav>
      </div>
       ...
       <div class="form-group col-md-4"> 
            <label for="inputAddress">DEPÓSITO:<span style="color: #FF0000; font-weight: bold;"></span></label>
                    <asp:UpdatePanel ID="UPDEPOSITO" runat="server"  UpdateMode="Conditional">
                        <ContentTemplate>
                    <asp:DropDownList ClientIDMode="Static" ID="cmbDeposito" AutoPostBack="true" class="form-control" runat="server" 
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="tablePagination">
                        ...
                        <ItemTemplate>
                           <tr class="gradeC"> 
                                ...
                                <td class="center hidden-phone"><span class="ruc_facturar"><asp:Label Text='<%#Eval("ruc_facturar")%>' ID="Lblruc" runat="server"  /></span></td>                                
                                <td class="center hidden-phone"><span class="cliente_facturar"><asp:Label Text='<%#Eval("cliente_facturar")%>' ID="LblExportador" runat="server"  /></span></td>

                                <td class="center hidden-phone">
                                    <span class="asume_ruc_facturar">
                                     <div class="d-flex">
                                       
                                        <asp:TextBox ID="TxtRucExportador" runat="server" Text='<%#Eval("asume_ruc_facturar")%>' MaxLength="20"  class="form-control"   disabled ></asp:TextBox>  
                                        ...
                                        <ContentTemplate>
                                           ...
                                           <asp:Button ID="BtnBuscador"
                                               ...
                                               data-target="#exampleModalToggle" ToolTip="BUSCAR" CommandName="Ver" />
                                                ...
                                                <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="BtnBuscador" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                      </div> 
                                  </span>
                                </td>
                                <td class="center hidden-phone"><span class="asume_cliente_facturar"><asp:Label Text='<%#Eval("asume_cliente_facturar")%>' ID="LblExportadorAsumen" runat="server"  /></span></td>
                               ...
                               <td class="nover"><span class="asume_ruc_facturar_dos"><asp:Label Text='<%#Eval("asume_ruc_facturar")%>' ID="Label1" runat="server"  /></span></td>
                           </tr>    
    ...
    <asp:UpdatePanel ID="UPBOTONES" runat="server" UpdateMode="Conditional" >  
            ...
            <br/>
             ...
             <div class="col-md-12 d-flex justify-content-center">
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="BtnFacturaAgrupada" runat="server" class="btn btn-primary" Text="FACTURAS AGRUPADAS"  OnClientClick="return confirmacion_grupo();"  OnClick="BtnFacturaAgrupada_Click" Visible="false" />
                        ...
                        <ContentTemplate>
                          ...
                          <script type="text/javascript">
                             ...
                             <div class="form-row">
                                 ...
                                 <div class="form-group col-md-12">
                                   <asp:Repeater ID="PaginationBuscador" runat="server" onitemcommand="PaginationBuscador_ItemCommand" >
                                   <HeaderTemplate>
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-sm table-contecon" id="PaginationBuscador">
                                       <thead>
                                      <tr>
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeC"> 
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("gkey")%>' ID="LblId" runat="server"  /></td>
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("CLNT_CUSTOMER")%>' ID="LblRucExp" runat="server"  /> </td>
                                            <td class="center hidden-phone"><asp:Label Text='<%#Eval("CLNT_NAME")%>' ID="LblNombreExp" runat="server"  /></td>
                                           <td class="center hidden-phone"><asp:Label Text='<%#Eval("CLNT_CITY")%>' ID="LblLineaExp" runat="server"  /></td>
                                             <td  class="center hidden-phone"> 
                                                 <asp:Button ID="BtnModificar"
                                                CommandArgument= '<%#Eval("gkey")%>' runat="server" Text="SELECCIONAR" 
...
<script type="text/javascript">
    ...
    function exportar()
    {
        ...
        rows.forEach(row => {
            ...
            const ruc_facturar = row.querySelector(".ruc_facturar").innerText;
            const cliente_facturar = row.querySelector(".cliente_facturar").innerText;
            const asume_ruc_facturar = row.querySelector(".asume_ruc_facturar_dos").innerText;
            ...
            const rowData = {
                ...
                ruc_facturar: ruc_facturar,
                cliente_facturar: cliente_facturar,
        ...
        console.log(json);
            ...
            xhr.open('POST', 'facturacion_sav.aspx/ExportarExcel', true);
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
           ...
           function Imprimir(btn)
           {
               ...
               var link = "../zal/facturacion_zal_print.aspx?id_comprobante=" + factura;
