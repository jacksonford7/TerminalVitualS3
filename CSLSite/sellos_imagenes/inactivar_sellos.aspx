<%@ Page Title="Inactivar Carbo Neutro" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="inactivar_sellos.aspx.cs" Inherits="CSLSite.inactivar_sellos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="mt-4">         
                <nav class="mt-4" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">CERTIFICADO DE SELLOS</a></li>
                        <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">DESACTIVAR SERVICIO</li>
                    </ol>
                </nav>
            </div>
               ...
               <%-- <div class="form-group col-md-12"> 
                   ...
                   <div class="form-row"> 
                      ...
                      <%--  <div class="form-group col-md-6">   
                        ...
                        <div class="form-group col-md-6" > 
                          <label for="inputEmail4">ARCHIVO PDF DE AUTORIZACIÓN (DESACTIVAR):</label>
                          <div class="d-flex">
                                                ...
                                                <asp:Repeater ID="tablePagination" runat="server" onitemcommand="tablePagination_ItemCommand" onitemdatabound="tablePagination_ItemDataBound"  >
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="point"  id="trUsuario">
                                                            ...
                                                            <td>
                                                                <asp:Label Text='<%#Eval("Client")%>' ID="LblClientId" runat="server"  />
                                                            ...
                                                            <td>
                                                                <div class="tcomand">
                                                                      <asp:Button ID="BtnEvento" CommandArgument= '<%#Eval("Id")%>' runat="server" Text="Eliminar" 
                                                                            OnClientClick="return confirm('Está seguro de inactivar el servicio?');"
                                      
                                                                            class="btn btn-primary" ToolTip="Inactivar certificado sellos" CommandName="Eliminar"
                                                                              />
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
            ...
            {
               try {
                   var w = window.open('../sellos_imagenes/archivo_sellos.aspx', 'Archivos', 'width=850,height=400');
                     w.focus();     
               }
               catch (e) {
