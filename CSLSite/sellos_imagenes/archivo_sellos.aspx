<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="archivo_sellos.aspx.cs" Inherits="CSLSite.archivo_sellos"  Title="Buscar Archivo PDF a Cargar" %>
...
<body >
  ...
  <asp:ToolkitScriptManager ID="tkscata" runat="server"></asp:ToolkitScriptManager>
     <div class="dashboard-container p-4" id="cuerpo" runat="server">
       ...
       <div class="form-title">Cargar archivos (Autorización de Desactivación Certificado de Sellos)</div>
