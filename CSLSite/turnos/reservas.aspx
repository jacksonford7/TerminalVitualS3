...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
        ...
        <nav class="mt-4" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item" id="opcion_principal" runat="server"><a href="#">Exportación</a></li>
             <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">Reporte de Reservas(CFS)</li>
          </ol>
        </nav>
      </div>
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
         ...
         <div class="form-title">Filtros para el reporte</div>
		  <div class="form-row">
		   <div class="form-group col-md-6"> 
			  ...
			  <div class="d-flex">
                               <asp:TextBox
             ID="tbooking" CssClass="form-control" runat="server" ClientIDMode="Static"  MaxLength="15"
         ...
         <asp:TextBox 
             ...
             ID="tfechaini" runat="server" ClientIDMode="Static"  MaxLength="15"
		  ...
		  <div class="form-row">
		   <div class="col-md-12 d-flex justify-content-center">
               <span id="imagen"></span>
             <asp:Button ID="btbuscar" runat="server" Text="Consultar reservas" CssClass="btn btn-primary"   
