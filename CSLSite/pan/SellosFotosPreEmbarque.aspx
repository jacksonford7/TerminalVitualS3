<%@ Page Title="Sellos Pre-Embarque" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="SellosFotosPreEmbarque.aspx.cs" Inherits="CSLSite.SellosFotosPreEmbarque" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server" >
    ...
    <div class="mt-4">         
        <nav class="mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" id="sub_opcion" runat="server">SELLOS PRE-EMBARQUE POR CONTENEDOR</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dashboard-container p-4" id="cuerpo" runat="server">
        ...
        <div class="form-title">
              CONSULTA DE SELLOS PRE-EMBARQUE POR NÚMERO DE CONTENEDOR
        </div>
