    ...
    public partial class actualizacionpasecfs : System.Web.UI.Page
    {
        ...
        public static string[] GetEmpresas(string prefix)
        {
            ...
            { 
                ...
                var Transportista = N4.Entidades.CompaniaTransporte.ObtenerCompanias(ClsUsuario.Usuario, prefix);
        ...
        public static string[] GetChofer(string idempresa, string prefix)
        {
            ...
            {
                var ClsUsuario = HttpContext.Current.Session["control"] as Cls_Usuario;
                var Chofer = N4.Entidades.Chofer.ObtenerChoferes(ClsUsuario.Usuario, String.Empty, idempresa);
                if (Chofer.Exitoso)
                {
        ...
        public static string[] GetPlaca(string idempresa, string prefix)
        {
            ...
            {
                var ClsUsuario = HttpContext.Current.Session["control"] as Cls_Usuario;
                var Camion = N4.Entidades.Camion.ObtenerCamiones(ClsUsuario.Usuario, prefix, idempresa);
                if (Camion.Exitoso)
                {
        ...
        public static string securetext(object number)
        {
            ...
            return Cls_QuerySegura.EncryptQueryString(number.ToString());
        }
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(Txtempresa.Text))
                    {
                        ...
                        if (EmpresaSelect.Split('-').ToList().Count > 1)
                        {
                            ...
                            var EmpresaTransporte = N4.Entidades.CompaniaTransporte.ObtenerCompania(ClsUsuario.Usuario, IdEmpresa);
                    ...
                    if (!string.IsNullOrEmpty(TxtChofer.Text))
                    {
                        ...
                        if (ChoferSelect.Split('-').ToList().Count > 1)
                        {
                            ...
                            var ChoferTransporte = N4.Entidades.Chofer.ObtenerChofer(ClsUsuario.Usuario, IdChofer);
                    ...
                    if (!string.IsNullOrEmpty(TxtPlaca.Text))
                    {
                        ...
                        if (PlacaSelect.Split('-').ToList().Count > 1)
                        {
                            ...
                            var PlacaTransporte = N4.Entidades.Camion.ObtenerCamion(ClsUsuario.Usuario, IdPlaca);
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var ClsUsuario = HttpContext.Current.Session["control"] as Cls_Usuario;
                    var Carga = PasePuerta.Pase_CFS.ObtenerListaEditable(this.TXTMRN.Text.Trim(), this.TXTMSN.Text.Trim(), this.TXTHSN.Text.Trim(), ClsUsuario.Ruc, ClsUsuario.Usuario, null);
                    if (Carga.Exitoso)
                    {
                        ...
                        var EstadoPases = N4.Importacion.container_cfs.ValidarEstadoTransaccion(Lista, ClsUsuario.Usuario.Trim());
                        ...
                        if (LinqQuery != null)
                        {
                            ...
                            objPaseCFS.IV_USUARIO_CREA = ClsUsuario.Usuario;
                            ...
                            if (!string.IsNullOrEmpty(TxtFechaHasta.Text))
                            {
                                ...
                                else
                                {
                                    ...
                                    var Turnos = PasePuerta.TurnoCFS.ObtenerTurnos(ClsUsuario.Ruc, FechaActualSalida, ListaItems);
                                    if (Turnos.Exitoso)
                                    {
                                        //turno por defecto
                                        List_Turnos.Add(new Cls_Bil_Turnos { IdPlan = string.Format("{0}-{1}-{2}-{3}-{4}", "0", "0", "", "", "0"), Turno = "* Seleccione *" });
                ...
                try
                {
                    ...
                    **********************************************************************************************************************************************/
                    ...
                    foreach (var Det in LinqQuery)
                    {
                        ...
                        pase.USUARIO_REGISTRO = ClsUsuario.Usuario;
                        pase.TIPO_CARGA = "CFS";
                     
                        
                        pase.PPW = Det.ID_PPWEB;

                        var Resultado = pase.Actualizar(ClsUsuario.Usuario,Det.TURNO, Det.SUB_SECUENCIA,Det.MRN, Det.MSN, Det.HSN);
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    if (e.CommandName == "Facturar")
                    {
                        ...
                        if (proceso_ok)
                        {
                            var Resultado = Pase_CFS.Marcar_Servicio(ClsUsuario.Usuario, ID_UNIDAD, Lista_Gkeys);
                            if (!Resultado.Exitoso)
                            {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ClsUsuario = Cls_Token.Tracker(this.Page);
            if (ClsUsuario != null)
            {
                if (!Page.IsPostBack)
                {
