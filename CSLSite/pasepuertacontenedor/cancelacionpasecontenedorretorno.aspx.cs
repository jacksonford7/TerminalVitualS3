...
namespace CSLSite
{
    ...
    public partial class cancelacionpasecontenedorretorno : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                **********************************************************************************************************************************************/
                ...
                foreach (var Det in LinqQuery)
                {
                    ...
                    pase.MOTIVO_CANCELACION = "RETORNO POR PESO/SELLO";

                    var Resultado = pase.Cancelar_PorRetorno(ClsUsuario.loginname, pase.MOTIVO_CANCELACION);
