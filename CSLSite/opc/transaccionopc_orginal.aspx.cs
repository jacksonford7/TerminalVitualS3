...
namespace CSLSite
{
    public partial class transaccionopc_orginal : System.Web.UI.Page
    {
        //
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                   ...
                   /* if (HttpContext.Current.Request.Cookies["token"] == null)
                    ...
                    //elimina turnos relacinados a la grua
                    objVesselV.Turns.RemoveAll(p => p.crane_id == idGrua);
        ...
        protected void BtnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //genera turnos
                List<Crane_Turn> Lista = Crane_Turn.GenerateTurns(IdGrua, dfechaDesde, Int32.Parse(this.TxtHorasTrabajo.Text));

                foreach (Crane_Turn Lista2 in Lista)
                {
                    objVesselTurno = new Crane_Turn(); 
                    objVesselTurno.id = Lista2.id;
                    objVesselTurno.turno_number = Lista2.turno_number;
                    objVesselTurno.crane_id = Lista2.crane_id;
                    objVesselTurno.turn_time_start = Lista2.turn_time_start;
                    objVesselTurno.turn_time_end = Lista2.turn_time_end;
                    objVesselTurno.turn_time_meet = Lista2.turn_time_start;
                    objVesselTurno.crane_name = NombreGrua;
        ...
        protected void BtnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                if (objVesselV != null)
                {
                    ...
                    {
                        this.MessageBox("Aún no ha agregado el detalle de los turnos", this);
                        return;
                    }
