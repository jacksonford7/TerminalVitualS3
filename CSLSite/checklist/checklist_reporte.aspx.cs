...
namespace CSLSite
{
    public partial class checklist_reporte : System.Web.UI.Page
    {
        #region "Clases"
        ...
        private void Carga_Turnos()
        {
            try
            {
                ...
                List<Cls_Turnos> Listado = Cls_Turnos.Lista_Turnos_Todos(out cMensajes);
            ...
            {
                this.Mostrar_Mensaje(string.Format("<i class='fa fa-warning'></i><b> Error! </b>{0}", ex.Message));
        ...
        private void Carga_TipoEquipo()
        {
            try
            {
                ...
                List<Cls_TipoEquipos> Listado = Cls_TipoEquipos.Lista_TipoEquipos_Todos(out cMensajes);
        ...
        private void Carga_Equipos()
        {
            try
            {
                if (CboTipoEquipo.SelectedIndex != -1)
                {
                    ...
                    List<Cls_Equipos> Listado = Cls_Equipos.Lista_Equipos_Todos(ID_TIPO_EQUIPO, out cMensajes);
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    if (!Int64.TryParse(this.CboEquipo.SelectedValue.ToString(), out ID_EQUIPO))
                    {
                        ID_EQUIPO = 0;
                    }
                    ...
                    //if (ID_EQUIPO==0)
                    //{
                    //    this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Por favor seleccione un equipo a consultar"));
                    ...
                    if (!Int64.TryParse(this.CboTurno.SelectedValue.ToString(), out ID_TURNO))
                    {
                        ID_TURNO = 0;
                    }
                    ...
                    //if (ID_TURNO == 0)
                    //{
                    //    this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Por favor seleccione un turno a consultar"));
                    //    this.CboTurno.Focus();
                    //    return;
                    //}
                    ...
                    {
                        this.Mostrar_Mensaje(string.Format("<b>Informativo! </b>Solo puede consultar los movimientos de hasta un año."));
                        return;
                    }

                    var ExistenRegistros = Cls_CheckList_Reporte.Reporte_Checklist(fechadesde,
                                                  fechahasta,
                                                  ID_EQUIPO,
                                                  ID_TURNO,
                                                  ID_TIPO_EQUIPO,
                    ...
                    else
                    {
                        ...
                        //DataTable dt;
                        string v_nameTable = "Reporte_checklist";
