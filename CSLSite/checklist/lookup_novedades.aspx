<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lookup_novedades.aspx.cs" Inherits="CSLSite.lookup_novedades"  Title="Buscar Novedades" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Buscar Líneas Navieras</title>
   ...
   <div class="dashboard-container p-4" id="cuerpo" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-12"> 
              <label for="inputEmail4">Descripción Motivo:</label>
             <div class="d-flex">
      ...
      <div class="row">
         <div class="form-group col-md-12"> 
            ...
            No se encontraron resultados, asegúrese que haya escrito correctamente el nombre del motivo
              </div>
             </ContentTemplate>
             <Triggers>
    ...
    <script type="text/javascript" >
       ...
       function setGrupos(row)
       {
            var celColect = row.getElementsByTagName('td');
              var lookup_get_novedad = {
                  sel_g_id_novedad: celColect[0].textContent,
                  sel_g_nombre_novedad: celColect[1].textContent,
                 
           };

           if (window.opener != null) {

               window.opener.popupCallback_Novedades(lookup_get_novedad);
           }
