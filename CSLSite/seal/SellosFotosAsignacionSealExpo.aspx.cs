...
namespace CSLSite
{
    ...
    public partial class SellosFotosAsignacionSealExpo : System.Web.UI.Page
    {
        #region "Clases"
        usuario ClsUsuario;
        ...
        private void ConsultarData(DateTime? _desde, DateTime? _hasta, string _container)
        {
            try
            {
                var oDet = SelloAsignaSealExpo.ListSellos(_desde, _hasta, _container);
        ...
        protected void tablePagination_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    if (e.CommandName == "FotosAsignacion")
                    {
                        ...
                        var eSello = SelloAsignaSealExpo.Sello(v_ID, out OError);
                        ...
                        foreach(SelloAsignaSealExpoFoto oFoto in oImagenes)//for (int i = 0; i < 4; i++)
                        {
