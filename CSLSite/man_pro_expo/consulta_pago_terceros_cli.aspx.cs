...
namespace CSLSite
{
    public partial class consulta_pago_terceros_cli : System.Web.UI.Page
    {
        public string rucempresa
        {
            get { return (string)Session["rucempcli"]; }
            set { Session["rucempcli"] = value; }
        }
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                var number = log_csl.save_log<Exception>(ex, "consulta_pago_terceros_cli", "btbuscar_Click()", DateTime.Now.ToShortDateString(), Page.User.Identity.Name);
