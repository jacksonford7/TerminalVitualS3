...
namespace CSLSite
{
    public partial class revisasolicitudcolaboradordocumentos_new : System.Web.UI.Page
    {
        private GetFile.Service getFile = new GetFile.Service();
        public DataTable dtDocumentos
        {
            get { return (DataTable)Session["dtDocumentosrevisasolicitudcolaboradordocumentos"]; }
            set { Session["dtDocumentosrevisasolicitudcolaboradordocumentos"] = value; }
        }
        private String xmlDocumentos;
        public String cedula
        {
            get { return (String)Session["cedularevisasolicitudcolaboradordocumentos"]; }
            set { Session["cedularevisasolicitudcolaboradordocumentos"] = value; }
        }
        public String numsolicitudempresa
        {
            get { return (String)Session["numsolicitudrevisasolicitudcolaboradordocumentos"]; }
            set { Session["numsolicitudrevisasolicitudcolaboradordocumentos"] = value; }
        }
        public String idsolcol
        {
            get { return (String)Session["idsolcoldocrevisasolicitudcolaboradordocumentos"]; }
            set { Session["idsolcoldocrevisasolicitudcolaboradordocumentos"] = value; }
        }
        ...
        private void ConsultaInfoSolicitud()
        {
            ...
            dtDocumentos = credenciales.GetDocumentosColaboradorXNumSolicitud_New(numsolicitudempresa, idsolcol);
            ...
            try
            {
                dtPadre = Session["dtDocumentosrevisasolicitudcolaboradorPermanente"] as DataTable;
            }
            catch
            {
                dtPadre = null;
        ...
        private void ExportFileUpload()
        {
            ...
            foreach (RepeaterItem item in tablePaginationDocumentos.Items)
            {
                ...
                dtDocumentos.Rows[item.ItemIndex][15] = cedula;

                //actualiza fecha
                if (!credenciales.ActualizarSolicitudColaborador(
                        numsolicitudempresa,
                        idsolcol,
            ...
            DataTable dtPadre = Session["dtDocumentosrevisasolicitudcolaboradorPermanente"] as DataTable;
            ...
            Session["dtDocumentosrevisasolicitudcolaboradorPermanente"] = dtHijo;
