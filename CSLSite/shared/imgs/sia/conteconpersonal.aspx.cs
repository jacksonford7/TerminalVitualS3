...
namespace CSLSite
{
    public partial class conteconpersonal : System.Web.UI.Page
    {
        //AntiXRCFG
        ...
        private void populate()
       {
           ...
           var table = new Catalogos.GENERA_EMPLEADODataTable();
           var ta = new CatalogosTableAdapters.GENERA_EMPLEADOTableAdapter();
           try
           {
               ...
               ta.Fill(table,tcedula.Text.Trim(), txapellidos.Text.Trim());
               if (table.Rows.Count <= 0)
               {
                   xfinder.Visible = false;
                   sinresultado.Attributes["class"] = string.Empty;
                   sinresultado.Attributes["class"] = "msg-info";
                   this.sinresultado.InnerText = "No se encontraron resultados,verifique cédula o apellidos";
                   sinresultado.Visible = true;
                   return;
               }
