      ...
      //  private static SqlConnection sql = null;
        ...
        public static DataOperacion<List<T>> ComandoSelectALista<T>(string conn, string pc_name, Dictionary<string, object> parameters, int timeout = 6000) where T : class, new()
        {
            ...
            using (sql)
            {
                ...
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoSelectALista), pc_name, -2, clase, parameters, e.GetType().Name, e);
                ...
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoSelectALista), pc_name, -2, clase, parameters, e.GetType().Name, e);
        ...
        public static DataOperacion<T> ComandoSelectAEntidad<T>(string conn, string pc_name, Dictionary<string, object> parameters, int timeout = 6000) where T : class, new()
        {
            ...
            using (sql)
            {
                ...
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoSelectAEntidad), pc_name, -2, clase, parameters, e.GetType().Name, e);
                ...
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoSelectAEntidad), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<T>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
        ...
        public static DataOperacion<DataTable> ComadoSelectADatatable(string conn, string pc_name, Dictionary<string, object> parameters = null, int timeout = 6000)
        {
                ...
                using (sql)
                {
                    using (var cmd = sql.CreateCommand())
                    {
                        ...
                        if (table == null || table.Rows.Count <= 0)
                        {
                            ...
                            lm = BDTraza.LogEvent<WarningException>("SQL", nameof(ComandoSelectAEntidad), pc_name, -2, clase, parameters, wa.GetType().Name, wa);
            ...
            {
                lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComadoSelectADatatable), pc_name, -2, clase, parameters, e.GetType().Name, e);
            ...
            {
                lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComadoSelectADatatable), pc_name, -2, clase, parameters, e.GetType().Name, e);
                return DataOperacion<DataTable>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
            }
        }
        public static DataOperacion<T> ComandoSelectEscalar<T>(string conn, string pc_name, Dictionary<string, object> parameters, int timeout = 6000) where T : struct
        {
            ...
            using (sql)
            {
                ...
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoSelectEscalar), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<T>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
                }
                catch (InvalidCastException e)
                {
                    lm = BDTraza.LogEvent<InvalidCastException>("SQL", nameof(ComandoSelectEscalar), pc_name, 0, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<T>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
                }
                catch (Exception e)
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoInsertUpdateDeleteID), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<T>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
                }
                finally
                {
        ...
        public static DataOperacion<Int32> ComandoInsertUpdateDeleteFila(string conn, string pc_name, Dictionary<string, object> parameters, int timeout = 6000)
        {
            ...
            using (sql)
            {
                ...
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoInsertUpdateDeleteFila), pc_name, -2, clase, parameters, e.GetType().Name, e);
                ...
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoInsertUpdateDeleteFila), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<Int32>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
                }
                finally
                {
            ...
            using (sql)
            {
                try
                {
                    ...
                    if (!ti.HasValue)
                    {
                        ...
                        lm = BDTraza.LogEvent<ApplicationException>("SQL", nameof(ComandoInsertUpdateDeleteID), pc_name, 0, clase, parameters, et.GetType().Name, et);
                ...
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoInsertUpdateDeleteID), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<Int64?>.CrearFalla(string.Format("Excepcion no.{0}", lm), string.Format("Reporte el número el siguiente ticket de servicio:{0}", lm.HasValue ? lm : -2));
                }
                catch (Exception e)
                {
        ...
        public static DataOperacion<string> ComandoTransaccionString(string conn, string pc_name, Dictionary<string, object> parameters, int timeout = 6000)
        {
            init();
            SqlCommand sp_com = new SqlCommand();
            SqlConnection sql = null;
            ...
            using (sql)
            {
                ...
                {
                    sql.Open();
                    var result = sp_com.ExecuteScalar() as string;
                    if (result == null)
                    {
                        var et = new ApplicationException("Ejecución no retorna valor de cadena");
                        lm = BDTraza.LogEvent<ApplicationException>("SQL", nameof(ComandoTransaccionString), pc_name, 0, clase, parameters, et.GetType().Name, et);
                        return DataOperacion<string>.CrearFalla(string.Format("Excepción no.{0}", lm), string.Format("Reporte el número del siguiente ticket de servicio: {0}", lm.HasValue ? lm : -2));
                    }
                    return DataOperacion<string>.CrearResultadoExitoso(result, "Correcto");
                }
                catch (SqlException e)
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoTransaccionString), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<string>.CrearFalla(string.Format("Excepción no.{0}", lm), string.Format("Reporte el número del siguiente ticket de servicio: {0}", lm.HasValue ? lm : -2));
                }
                catch (Exception e)
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoTransaccionString), pc_name, -2, clase, parameters, e.GetType().Name, e);
                    return DataOperacion<string>.CrearFalla(string.Format("Excepción no.{0}", lm), string.Format("Reporte el número del siguiente ticket de servicio: {0}", lm.HasValue ? lm : -2));
                }
                finally
                {
        ...
        public static DataOperacion<Int32> ComandoInsertMasivo(string conn, string sqltable, DataTable bulkdata, int timeout = 6000)
        {
            ...
            using (SqlBulkCopy bulkCopy = new SqlBulkCopy(conn))
            {
                ...
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoSelectEscalar), "SQL_BULK", -1, clase, null, e.GetType().Name, e);
                    return DataOperacion<Int32>.CrearFalla(string.Format("Ocurrio una excepcion SQL {0}",lm));
                }
                catch (InvalidCastException e)
                {
                    lm = BDTraza.LogEvent<InvalidCastException>("SQL", nameof(ComandoSelectEscalar), "SQL_BULK", -2, clase, null, e.GetType().Name, e);
                    return DataOperacion<Int32>.CrearFalla(string.Format("Ocurrio una excepcion CONVERSION {0}", lm));
                }
                catch (Exception e)
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoInsertUpdateDeleteID), "SQL_BULK", -3, clase, null, e.GetType().Name, e);
        ...
        public static T ComandoScalar<T>(string conn, string sqlQuery, Dictionary<string, object> parameters = null, int timeout = 6000) where T : struct
        {
            init();
            SqlCommand sp_com = new SqlCommand();
            SqlConnection sql = null;
            ...
            using (sql)
            {
                ...
                {
                    sql.Open();
                    var ti = sp_com.ExecuteScalar();
                    if (ti != null && ti != DBNull.Value)
                    {
                        return (T)Convert.ChangeType(ti, typeof(T));
                    }
                    else
                    {
                        // Manejo si el resultado es nulo o DBNull
                        return default(T);
                    }
                }
                catch (SqlException e)
                {
                    lm = BDTraza.LogEvent<SqlException>("SQL", nameof(ComandoScalar), sqlQuery, -2, clase, parameters, e.GetType().Name, e);
                    // Manejo de excepciones SQL
                    throw new Exception(string.Format("Excepcion no.{0}. Reporte el número del siguiente ticket de servicio: {1}", lm, lm.HasValue ? lm.ToString() : "-2"), e);
                }
                catch (Exception e)
                {
                    lm = BDTraza.LogEvent<Exception>("SQL", nameof(ComandoScalar), sqlQuery, -2, clase, parameters, e.GetType().Name, e);
