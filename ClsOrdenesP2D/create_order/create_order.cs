...
{
    public class create_order : ToStringBase
    {
        [JsonProperty]
        ...
        public create_order(string _token, string _uop)
        {
            this.UrlOp = _uop;
            this.token = _token;
        }
        ...
        private messages_order runWriteOperation()
        {
            try
            {
                ...
                using (var client = new HttpClient(handler, false))
                {
                    ...
                    HttpResponseMessage result = client.PostAsync(this.UrlOp, content).Result;
