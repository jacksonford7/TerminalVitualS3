...
namespace ClsProformas
{
    public class Servicios : Base
    {
        ...
        public Servicios()
        {
            ...
            this.Detalle = new List<Servicios>();
        }

        public Servicios( string _codigo,string _descripcion,decimal _cantidad, decimal _costo,bool _opcional,bool _aplica, string _nota,
        ...
        /*carga los servicios*/
        public static List<Servicios> List_Servicios(out string OnError)
        {
            OnInit();

            return sql_pointer.ExecuteSelectControl<Servicios>(v_conexion, 2000, "SP_OBTIENE_SERVICIO_PROFORMA", null, out OnError);

        }

        public static List<Servicios> List_Servicios_Repcontver(Int64 ID_DEPOT, Int64 ID_LINEA,  out string OnError)
        {
            OnInit();
            parametros.Clear();
            parametros.Add("ID_DEPOT", ID_DEPOT);
            parametros.Add("ID_LINEA", ID_LINEA);
            return sql_pointer.ExecuteSelectControl<Servicios>(v_conexion, 6000, "SP_OBTIENE_SERVICIO_PROFORMA_REPCONTVER", parametros, out OnError);

        }

        public List<Servicios> Detalle { get; set; }
