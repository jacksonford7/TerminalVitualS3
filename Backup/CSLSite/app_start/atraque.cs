	...
	@usr_alias varchar(20),
        ...
        public static bool ValidateSolicitudData(jSolicitud solicitud, out string validacionError)
        {
           ...
           //puertos
            ...
            {
                validacionError = "Solicitud:\nDatos de puertos incompletos (17)";
                return false;
            }
            ...
            {
                validacionError = "Solicitud:\nDatos de manifiesto de importación incompletos (19)";
                return false;
            }
            if (IsMrnExist(solicitud.imrn))
            {
                validacionError = string.Format("Solicitud:\nDatos de manifiesto de importación {0} ya se encuentran en otra referencia comuníquese con planificación (19)",solicitud.imrn); ;
                return false;
            ...
            {
                validacionError = "Solicitud:\nInformación de APG incompleta | incorrecta (21)";
                return false;
            }
            ...
            {
                validacionError = "Solicitud:\nInformación de APG incompleta (22)";
                return false;
            }
            ...
            {
                validacionError = "*Solicitud*\nLa fecha de ETA no tiene el formato correcto (23)";
                return false;
            }
            ...
            {
                validacionError = "*Solicitud*\nLa fecha de ETB no tiene el formato correcto (24)";
                return false;
            }
            ...
            {
                validacionError = "Solicitud:\nUso de muelle incompleto | incorrecto (25)";
                return false;
            }
            ...
            DateTime ets = etb.AddHours(horas);
            //ETS vs ETB
            if (ets <= etb)
            {
                validacionError = "Solicitud:\nFecha ETS debe ser mayor que ETB (26)";
                return false;
            ...
            if (ets <= eta)
            {
                validacionError = "Solicitud:\nFecha ETS debe ser mayor que ETA (24)";
                return false;
            }
