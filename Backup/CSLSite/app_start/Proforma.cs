    ...
    public class Proforma
    {
        ...
        public string Guardar(out string error)
        {
            ...
            using (var con = new SqlConnection())
            {
                ...
                comandoCabecera.CommandText = "pc_proforma_insertar";
                ...
                using (var tx = con.BeginTransaction())
                {
                    try
                    {
                        ...
                        email.AppendFormat("<p>Fecha de estimada de retiro:{0}</p>",FechaCliente.ToString("dd/MM/yyyy HH:mm"));
                        ...
                        email.AppendFormat("<tr><td colspan='4' style='text-aling:right;'><strong>Subtotal</strong></td><td>{0}</td></tr>",  this.SubTotal.ToString("C"));
                        email.AppendFormat("<tr><td colspan='4' style='text-aling:right;'><strong>IVA 14%</strong></td><td>{0}</td></tr>",IVA.ToString("C"));
                        email.AppendFormat("<tr><td colspan='4' style='text-aling:right;'><strong>A PAGAR</strong></td><td>{0}</td></tr>", Total.ToString("C"));
                        email.Append("</table>");
                        email.AppendFormat("<br/>Atentamente,<br/><strong>Servicio de Notificaciones Automáticas</strong><br/>CENTRO DE SERVICIOS EN LINEA<br/>Contecon Guayaquil S.A. CGSA<br/>An ICTSI Group Company.");
