//valida que tenga seleccionado tráfico antes de permitir seleccionar contenedor
...
//valida que tenga seleccionado tráfico y un contenedor uno escojido antes de permitir seleccionar contenedor dos
function linkcontenedor2(ctrafico, contenedor1, tipo) {
    try {
       ...
       window.open('../catalogo/contenedores.aspx?trafico=' + traficoTexto + '&contenido=' + tipo, '', 'width=850,height=480');
...
function linkconsultacontenedor(usuario) {
    try {
        ...
        window.open('../catalogo/consultaContenedores.aspx?usuario=' + userC, '', 'width=850,height=480');
...
function linkconsultadetalle(idSolicitud, codigoServicio) {
    try {
        ...
        if (codigoServicio == 'CIE') {
          window.open('../catalogo/consultaSolicitudDetalleExportacion.aspx?idSolicitud=' + idSol, '', 'width=850,height=480');
        }
        else {
           window.open('../catalogo/consultaSolicitudDetalle.aspx?idSolicitud=' + idSol, '', 'width=850,height=480');
        }
    } catch (e) {
        alert(e.Message);
    }
...
function linkconsultacontenedorOperario() {
    try {
       window.open('../catalogo/consultaContenedores.aspx', 'Contenedores', 'width=850,height=480');
...
function linkContenedoresBySolicitud(idSolicitud) {
    try {
        ...
        window.open('../catalogo/consultaContenedoresAnalista.aspx?idSolicitud=' + idSol, '' + idSolicitud, 'width=900,height=520');
        } catch (e) {
            alert(e.Message);
        }
    }
    ...
    function linkBuque() {
        try {
           ...
           window.open('../catalogo/referenciaBuque.aspx', 'Booking', 'width=850,height=480');
            ...
            switch (tipoS.trim()) {
                ...
                case 'SEL': //Verificación de Sellos
                    if (tipoT == null || tipoT == undefined || tipoT == 0 || tipoT == '') {
                        ...
                        if (tipoT === "IMPRT") {
                            //$('[id*=dptipocarga]').html("<option value='CA'>Carga Suelta</option>");
...
function linkcontenedorCorrecionDAEExportacion(ctrafico, tipo, ccorreccion, aisv, idUsuario) {
    try {
       ...
       window.open('../catalogo/contenedoresExportacion.aspx?trafico=' + trafico + '&contenido=' + tipo + '&aisv=' + aisvTexto + '&usuario=' + idUsuario + '&correccion=' + correccion, '', 'width=850,height=480');
...
function linkReferencia() {
    try {
       window.open('../catalogo/referenciaBuque.aspx', ' ', 'width=850,height=480');
