        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var tablix = turno.GetRptReservas(fechaini, fechafin, this.tbooking.Text, this.agencia.Value);
        ...
        public static string ValidateJSON(turno objeto)
        {
            try
            {
               ...
               // var user_email = sUser.email;
                ...
                turno.addMail(out error, sUser.email, 
                    "Se genero una reserva de turnos para consolidación, *Booking " + objeto.booking, 
                    mail, destinatarios, objeto.usuario, objeto.idlinea, objeto.linea);
                ...
                return CslHelper.JsonNewResponse(true, true, "window.location='../csl/menu'", "Proceso exitoso en unos minutos recibirá el mail");
            }
            catch (Exception ex)
            {
