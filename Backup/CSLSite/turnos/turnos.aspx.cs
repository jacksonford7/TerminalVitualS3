    ...
    public partial class turnos : System.Web.UI.Page
    {
        ...
        public static string ValidateJSON(turno objeto)
        {
            try
            {
                ...
                mail = string.Concat(mail, string.Format("Estimado/a {0} {1}:<br/>Este es un mensaje del Sistema de Solicitud de Servicios de Contecon S.A, para comunicarle lo siguiente.<br/>A continuación el detalle de su reserva:<br/>", sUser.nombres, sUser.apellidos));
