     ...
     <div class="accion" id="ADU">
      <table class="controles" cellspacing="0" cellpadding="1" id="CNTR">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos del contenedor</th></tr>
         ...
         <td class="bt-bottom bt-right validacion "><span id="valsimo" class="validacion"> </span></td>
                ...
                <tr><td class="bt-bottom  bt-right bt-left">24. Consignatario:</td>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="refrigeracion">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos sobre refrigeración del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >25. Tipo de refrigeración:</td>
            <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">26. Temperatura [°C]:</td>
         <td class="bt-bottom">
         <a class="tooltip" ><span class="classic">
        ...
        <td class="bt-bottom bt-right validacion "><span id='valtemp' class="validacion" > * obligatorio</span></td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">27. Humedad &nbsp;[CBM]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">28. Ventilación&nbsp;[%]:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle de los sellos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >29. Sello de agencia:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >30. Sello de ventilación [Reefer]:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" ><span id="msc_sello">31. Sello adicional 1:</span></td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >32. Sello adicional 2:</td>
         <td class="bt-bottom">
         ...
         <span class="opcional" > * opcional</span>
                           ...
                           <tr>
         <td class="bt-bottom  bt-right bt-left" >33. Responsable del sellado:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">34. Documento de identidad:</td>
         <td class="bt-bottom" >
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="TRSP">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="4"> Datos del transporte</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" rowspan="2" >35. Ubicación del área de consolidación:</td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">36. Fecha y hora de salida del área de 
             consolidación:</td>
         <td class="bt-bottom" colspan="2">
          <asp:TextBox ID="txtSalida" runat="server" MaxLength="16" Width="250px" CssClass="datetimepicker"
            ...
            <tr><td class="bt-bottom  bt-right bt-left">37. Tiempo estimado de viaje [Hrs]:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">38. Nombre del conductor:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <td class="bt-bottom bt-right validacion "><span class="validacion" id="valnombre" ></span></td>
         	         ...
         	         <tr><td class="bt-bottom  bt-right bt-left">39. Documento de identidad:</td>
         <td class="bt-bottom" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">40. Placa del vehículo:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">41. Certificado de Cabezal:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">42. Certificado de Chasis:</td>
         <td class="bt-bottom" colspan="2">
         <a class="tooltip" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">43. Certificado especial:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <span class="opcional" > * opcional</span>
                  ...
                  <tr><td class="bt-bottom  bt-right bt-left">44. Compañía de Transporte:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">45. RUC:</td>
         <td class="bt-bottom" colspan="2">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos para notificación</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >46. Correo(s) para notificación: 
       ...
       <div id="describir" class="accion">
        ...
        <tr>
        <td class="bt-bottom  bt-right bt-left">47. Documento de Aduana No:</td>
         <td class="bt-bottom" colspan="2">
        ...
        <tr>
         <td class="bt-left bt-bottom bt-right"  >48. Cantidad de unidades:</td>
         <td class="bt-bottom" colspan="2" >
               <a class="tooltip" >
        ...
        <tr>
        <td class="bt-bottom  bt-right bt-left">49. Peso total de las unidades&nbsp;[KG]:</td>
         <td class="bt-bottom" colspan="2">
        ...
        <tr>
        <td class="bt-bottom  bt-right bt-left">50. Tipo de embalaje:</td>
         <td class="bt-bottom" colspan="2">
