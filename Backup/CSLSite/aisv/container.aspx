...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="205" />
     ...
     <div>
         ...
         <i class="ico-titulo-2"></i><h1>Nuevo AISV para Exportación de Contenedores Llenos</h1><br />
    </div>
    ...
    Aceptado el registro no se realizaran modificaciones, ni correcciones. 
     ...
     <div class="seccion">
      ...
      <tr><td class="level2">
         Confirme que los datos sean correctos. En caso de error, favor comuníquese con el Departamento de Planificación a los teléfonos: +593 (04) 6006300, 3901700 ext.  ext. 4039, 4040, 4060, 4040, 4039.
      </td></tr>
      </table>
     </div>
    <div class="colapser colapsa"></div>
        ...
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="2"> Datos del <i>Booking</i> </th></tr>
         ...
         <td class="bt-bottom  bt-right">
             ...
             <input id="over" type="checkbox"  onclick="radio(this,ckdimen);"/>
                ...
                <span>Arribo tardío</span>
               <input id="cklate" type="checkbox" />   
             <a class="tooltip" >
			<span class="classic">Late Arrival, indica si la unidad llega después del Cutoff de la Nave</span>
     ...
     <div class="accion" id="ADU">
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="5"> Datos de Aduana (Senae) </th></tr>
         <tr>
        ...
        <td class="bt-bottom bt-right validacion "><span class="opcional" id="valexpor" > * opcional</span></td>
         ...
         <td class="bt-bottom" colspan="3">
             <select id="dpdoc" onchange="adudoc(this,'txtdae1','txtdae2','txtdae3','xxxms');" style='width:60px'>
              ...
              <input id="txtdae1" placeholder="00" type="text" maxlength="3" value='028'  onkeypress="return soloLetras(event,'1234567890',false)"  style='width:30px'/>
              <input id="txtdae2" placeholder="0000" type="text" maxlength="4"  onkeypress="return soloLetras(event,'1234567890',false)"  style='width:40px'/>
                <input id="txtdae3" type="text" maxlength="21" value='40'  
                onkeypress="return soloLetras(event,'ps1234567890',false)"  
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="CNTR">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >22. Número del contenedor:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">23. Tara del contenedor [TON]:</td>
         <td class="bt-bottom">
                <span id="tara" class="caja cajafull">00.00</span>
             </td>
         <td class="bt-bottom bt-right  "></td>
         </tr>
         <tr><td class="bt-bottom  bt-right bt-left">24. Max.&nbsp;<i>Payload</i>&nbsp;contenedor [TON]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">25. Peso bruto de la carga&nbsp;[TON]:</td>
         <td class="bt-bottom">
         ...
         <td class="bt-bottom bt-right validacion "><span id="valpes" class="validacion"> * obligatorio</span></td>
         </tr>
         <tr><td class="bt-bottom  bt-right bt-left">26. Origen del contenedor <i>(Depot)</i></td>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="refrigeracion">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos sobre refrigeración del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >27. Tipo de refrigeración:</td>
         <td class="bt-bottom">
               <asp:DropDownList ID="dprefrigera" runat="server" Width="80%" onchange="valdpmeref(this,0,valrefri,tipor,1)"
                ClientIDMode="Static"
               >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">28. Temperatura [°C]:</td>
         <td class="bt-bottom">
         <a class="tooltip" ><span class="classic">
        ...
        <td class="bt-bottom bt-right validacion "><span id='valtemp' class="validacion" > * obligatorio</span></td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">29. Humedad &nbsp;[CBM]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">30. Ventilación&nbsp;[%]:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle de los sellos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >31. Sello de agencia:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >32. Sello de ventilación [Reefer]:</td>
         <td class="bt-bottom">
             <asp:TextBox ID="tseal2" runat="server" CssClass="mayusc" ClientIDMode="Static"
                 onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890',true)" 
                 MaxLength="14" Width="200px" Enabled="False" onpaste="return false;" 
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" > <span id="msc_sello">33. Sello adicional 1:</span> </td>
         <td class="bt-bottom">
             <asp:TextBox ID="tseal3" runat="server" CssClass="mayusc"
                 onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890',true)" 
                 MaxLength="14" Width="200px" onpaste="return false;" 
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >34. Sello adicional 2:</td>
         <td class="bt-bottom">
             <asp:TextBox ID="tseal4" runat="server" CssClass="mayusc"
                 onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890',true)" 
                 MaxLength="14" Width="200px"
                 placeholder="Sello opcional" onpaste="return false;" 
             ></asp:TextBox>
             </td>
         <td class="bt-bottom bt-right ">
         <span class="opcional" id="sel_cau" > * opcional</span>
         </td>
         </tr>

                  <tr>
         <td class="bt-bottom  bt-right bt-left" >35. Responsable del sellado:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="TRSP">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="4"> Datos del transporte</th></tr>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">44. Fecha y hora de salida de planta/finca:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">52. Compañia de Transporte:</td>
         <td class="bt-bottom" colspan="2">
             ...
             ></asp:TextBox>
                  <a class="tooltip" ><span class="classic" >Nombre de la compañía transportista que realiza la entrega de la unidad de carga en CGSA.</span>
                        <img alt='' src='../shared/imgs/info.gif' class='datainfo'/>
              </a>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">53. RUC:</td>
         <td class="bt-bottom" colspan="2">
             ...
             ></asp:TextBox>
                        <a class="tooltip" ><span class="classic" >Número del Registro Único de Contribuyente de la compañia transportista registrada anteriormente.</span>
                        <img alt='' src='../shared/imgs/info.gif' class='datainfo'/>
              </a>
             </td>
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos para notificación</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >54. Correo(s) para notificación: 
