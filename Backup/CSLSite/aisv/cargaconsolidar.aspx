...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="201" />
  <noscript><meta http-equiv="refresh" content="0; url=sinsoporte.htm" /> </noscript>
            <div>
         <i class="ico-titulo-1"></i><h2>Autorización de Ingreso y Salida de Vehículos </h2>  <br /> 
         <i class="ico-titulo-2"></i><h1>Nuevo AISV para Exportación de Carga para Consolidación</h1><br />
    </div>
        <div class="msg-alerta">
     <span id="dtlo" runat="server">Estimado usuario:</span> 
    <br /> 
   Para este tipo de AISV, en el campo “Documento de Aduana” debe registrar una <strong>  DAE de carga contenerizada</strong>.  
        ...
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="4"> Búsqueda del Booking</th></tr>
         ...
         <td class="bt-bottom">
          <span id="numbook" class="caja">...</span>
              ...
              <td class="bt-bottom finder">
            <a class="topopup" target="popup" onclick="linkbokin('lineaCI','numexport','LCL');" >
          <i class="ico-find" ></i> Buscar   </a>
         </td>
    ...
    <div class="colapser colapsa"></div>
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">19. Documento de Aduana No:</td>
           ...
           <td class="bt-bottom" colspan="3">
             <select id="dpdoc" onchange="adudoc(this,'txtdae1','txtdae2','txtdae3','xxxms');" style='width:60px'>
              ...
              <input id="txtdae1" type="text" maxlength="3" placeholder="000" value='028'  onkeypress="return soloLetras(event,'1234567890',false)"  style='width:30px'/>
              <input id="txtdae2" type="text" maxlength="4" placeholder="0000" onkeypress="return soloLetras(event,'1234567890',false)"  style='width:40px'/>
                ...
                style='width:180px' placeholder="Documento" />
        ...
        <td class="bt-bottom bt-right validacion "><span class="validacion" id="valadu"  > * obligatorio</span></td>
         ...
         <td class="bt-bottom bt-right" colspan="4">
          <a class="tooltip" ><span class="classic">Indicar si la carga declarada, se controla bajo cupos por ejemplo, banano.</span>
           <input id="ckcupo" type="checkbox" onclick="ckcupos(this);" />
                  
           </a>
           <div id="rules" class="disable">
              &nbsp;
               <asp:DropDownList ID="dpins" runat="server"  Width="100px" Enabled="False" 
     ...
     <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos de la carga 
            para consolidación</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >22. Cantidad de unidades:</td>
         <td class="bt-bottom">
               <a class="tooltip" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">23. Peso unitario&nbsp;[KG]:</td>
         <td class="bt-bottom">
        ...
        <tr><td class="bt-bottom  bt-right bt-left">24. Tipo de embalaje:</td>
         <td class="bt-bottom">
        ...
        <tr><td class="bt-bottom  bt-right bt-left">25. Código de peligrosidad (IMO):</td>
         <td class="bt-bottom">
   ...
   <div id="opcional" class="colapser-option  colapsa">Clic aquí para añadir información del contenedor (Opcional)</div>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="CNTR">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >26. Número del contenedor:</td>
         <td class="bt-bottom">
             ...
             onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890')"
              ...
              EnableViewState="False" placeholder="Contenedor"
             ></asp:TextBox>
             </td>
         <td class="bt-bottom bt-right validacion "><span id="valcont" class="validacion"> * obligatorio</span></td>
         </tr>
         <tr><td class="bt-bottom  bt-right bt-left">27. Tara del contenedor [TON]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">28. Max.&nbsp;<i>Payload</i>&nbsp;contenedor[TON]:</td>
         <td class="bt-bottom">
             <asp:TextBox ID="txtpay" runat="server" Width="200px" placeholder="MaxPayLoad Ton."
                 MaxLength="5" 
                onBlur="valrange(this,tara.textContent,60,'valpayload',false);"
         ...
         <td class="bt-bottom bt-right validacion "><span id="valpayload" class="validacion" > * obligatorio</span></td>
           ...
           <tr><td class="bt-bottom  bt-right bt-left">29. Origen del contenedor <i>(Depot)</i></td>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" >
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos sobre refrigeración del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >30. Tipo de refrigeración:</td>
           <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">31. Temperatura [°C]:</td>
         <td class="bt-bottom">
        ...
        <td class="bt-bottom bt-right validacion "><span id='valtemp' class="opcional" > * opcional</span></td>
          ...
          <tr><td class="bt-bottom  bt-right bt-left">32. Humedad &nbsp;[CBM]:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left">33. Ventilación&nbsp;[%]:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle de los sellos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >34. Sello de agencia:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >35. Sello de ventilación [Reefer]:</td>
         <td class="bt-bottom">
             <asp:TextBox ID="tseal2" runat="server" CssClass="mayusc"
                 onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890',true)" 
                 placeholder="Sello refrigeracion"
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >36. Sello adicional 1:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >37. Sello adicional 2:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle del exceso de 
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >38. Excede dimesiones nominales:</td>
         <td class="bt-bottom">
          <a class="tooltip" ><span class="classic">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">39. Excesos izquierda [cm]:
          <i class="ileft"></i>
         </td>
         <td class="bt-bottom">
             <asp:TextBox ID="txtexizq" runat="server" MaxLength="4" Width="200px" placeholder="Izquierda"
              onkeypress="return soloLetras(event,'1234567890.')"
         ...
         <tr><td class="bt-bottom  bt-right bt-left">40. Excesos derecha [cm]:&nbsp;&nbsp;
          <i class="iright"></i>
         </td>
         <td class="bt-bottom">
             <asp:TextBox ID="txtexder" runat="server" MaxLength="4" Width="200px" placeholder="Derecha"
              onkeypress="return soloLetras(event,'1234567890.')"  
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left">41. Excesos frontal&nbsp;[cm]: 
         &nbsp;&nbsp;&nbsp;  <i class="ifront"></i>
         </td>
         <td class="bt-bottom">
             <asp:TextBox ID="txtexfro" runat="server" MaxLength="4" Width="200px" placeholder="Frontal"
              onkeypress="return soloLetras(event,'1234567890.')"
         ...
         <tr><td class="bt-bottom  bt-right bt-left">42. Excesos atrás&nbsp;[cm]:&nbsp;&nbsp;
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ibotom"></i></td>
          
         <td class="bt-bottom">
             <asp:TextBox ID="txtexatra" runat="server" MaxLength="4" Width="200px" placeholder="Posterior"
              onkeypress="return soloLetras(event,'1234567890.')"  
         ...
         <tr><td class="bt-bottom  bt-right bt-left">43. Excesos superior&nbsp;[cm]:
         &nbsp;
          <i class="itop"></i></td>
         <td class="bt-bottom">
             <asp:TextBox ID="txtexenc" runat="server" MaxLength="4" Width="200px" placeholder="Superior"
              onkeypress="return soloLetras(event,'1234567890.')"  
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="TRSP">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="4"> Datos del transporte</th></tr>
           <tr>
         <td class="bt-bottom  bt-right bt-left" >44. Ubicación de la planta:</td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">45. Fecha y hora de salida de planta:</td>
         <td class="bt-bottom" colspan="2">
           ...
           placeholder="dd/mm/aaaa hh:mm"
            ...
            <tr><td class="bt-bottom  bt-right bt-left">46. Tiempo estimado de viaje [Hrs]:</td>
             <td class="bt-bottom" colspan="2">
             <asp:TextBox ID="txthoras" runat="server" MaxLength="3" Width="250px" placeholder="Horas viaje"
         ...
         <td class="bt-bottom bt-right validacion "><span class="validacion" id="valestima" > * obligatorio</span></td>
          ...
          <tr><td class="bt-bottom  bt-right bt-left">47. Nombre del conductor:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <td class="bt-bottom bt-right validacion "><span class="validacion" id="valnombre" ></span></td>
         		         ...
         		         <tr><td class="bt-bottom  bt-right bt-left">48. Documento de identidad:</td>
         <td class="bt-bottom" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">49. Placa del vehículo:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">50. Certificado de Cabezal:</td>
               <td class="bt-bottom" colspan="2">
          <a class="tooltip" ><span class="classic">Si no agrega esta información, la misma será solicitada en la garita de ingreso</span>
            ...
            placeholder="Certificado"
              ></asp:TextBox> </a>
              Expira el:
              <input type="text" id="txtcerCab"  maxlength="16" style="width:120px" class="datepicker"
               onkeypress="return soloLetras(event,'1234567890/:')"
               onblur="valDate(this,false,fechacab);" placeholder="dd/mm/aaaa"
             />

             </td>
         <td class="bt-bottom bt-right validacion "><span class="opcional" id="fechacab" > * opcional</span></td>
         </tr>
         <tr><td class="bt-bottom  bt-right bt-left">51. Certificado de Chasis:</td>
               <td class="bt-bottom" colspan="2">
         <a class="tooltip" >
            ...
            Expira el:
              <input type="text" id="txtcerCha" style="width:120px" 
               maxlength="16" class="datepicker"
               onkeypress="return soloLetras(event,'1234567890/:')"
         ...
         <tr><td class="bt-bottom  bt-right bt-left">52. Certificado especial:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <span class="opcional" > * opcional</span>
                  ...
                  <tr><td class="bt-bottom  bt-right bt-left">53. Compañía de Transporte:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">54. RUC:</td>
         <td class="bt-bottom" colspan="2">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos para notificación</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >55. Correo(s) para notificación: 
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            $(document).ready(function () {
                ...
                $("#opcional").toggle(function () { $(this).text('Clic aquí para añadir información del contenedor (Opcional)'); $(this).removeClass("colapsa").addClass("expande"); $(this).next().hide(); }
                                  , function () { $(this).text('Clic aquí para añadir ocultar información del contenedor (Opcional)'); $(this).removeClass("expande").addClass("colapsa"); $(this).next().show(); });
