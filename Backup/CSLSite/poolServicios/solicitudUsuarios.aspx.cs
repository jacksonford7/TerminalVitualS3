...
namespace CSLSite
{
    public partial class solicitudUsuarios : System.Web.UI.Page
    {
        ...
        public void envioCorreoSolicitud(int idSolicitud, usuario sUser, string descripcionServicio, string codigoSolicitud)
        {
            ...
            var correoBackUp = ConfigurationManager.AppSettings["correoBackUp"];

            switch (descripcionServicio)
            {
                case "Repesaje":
                    mail = getBodyRepesaje(solicitudUsuario, sUser);
                    destinatarios = correoBackUp;
                    break;
                case "Verificación de Sellos":
                    mail = getBodyVerificacion(solicitudUsuario, sUser);
                    destinatarios = string.Format("yardplanners@cgsa.com.ec;{0}", correoBackUp != null ? correoBackUp : "contecon.s3@gmail.com");
                    break;
                case "Etiquetado - Desetiquetado Unidades":
                ...
                case "Revisión Técnica Refrigerada":
                    ...
                    destinatarios = string.Format("yardplanners@cgsa.com.ec;reefers@cgsa.com.ec;{0}", correoBackUp != null ? correoBackUp : "contecon.s3@gmail.com");
                    break;
            }
