    ...
    public partial class mantenimientoOperario : System.Web.UI.Page
    {
        ...
        #region Funciones para enviar correos y crear sus cuerpos
            ...
            public string getBodyReestiba(List<consultaCabeceraUsuario> solicitudUsuario, usuario sUser)
            {
                ...
                mail = string.Concat(mail, "<br/><br/>Es un placer servirle, <br/><br/> Atentamente, <br/> <b>S3 - Sistema de Solicitud de Servicios</b> <br/> Contecon Guayaquil S.A. CGSA <br/> An ICTSI Group Company <br/><br/> <b>El contenido de este mensaje es informativo, por favor no responda este correo.</b>");
            ...
            public string getBodyRepesaje(List<consultaCabeceraUsuario> solicitudUsuario, usuario sUser)
            {
                ...
                mail = string.Concat(mail, "<br/><br/>Es un placer servirle, <br/> Atentamente, <br/> <b>S3 - Sistema de Solicitud de Servicios</b> <br/> Contecon Guayaquil S.A. CGSA <br/> An ICTSI Group Company <br/><br/> <b>El contenido de este mensaje es informativo, por favor no responda este correo.</b>");
            ...
            public string getBodyEtiquetadoDes(List<consultaCabeceraUsuario> solicitudUsuario, usuario sUser)
            {
                ...
                mail = string.Concat(mail, "<br><br/>Es un placer servirle, <br><br/><br><br/> Atentamente, <br><br/> <b>S3 - Sistema de Solicitud de Servicios/b> <br><br/> Contecon Guayaquil S.A. CGSA <br><br/> An ICTSI Group Company <br><br/><br><br/> <b>El contenido de este mensaje es informativo, por favor no responda este correo.</b>");
