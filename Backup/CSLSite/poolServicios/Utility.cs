...
namespace CSLSite
{
    public static class Utility
    {
        ...
        public  const string firma = "<p>Usted recibirá el estado de su solicitud en el transcurso de 24 a 48 horas.</p><p>Es un placer servirle,</p><p>Atentamente,<br/><strong>S3 - Sistema de Solicitud de Servicios</strong><br/>Contecon Guayaquil S.A. CGSA<br/>An ICTSI Group Company.</p><p><i>El contenido de este mensaje es informativo, por favor no responda este correo.</i></p>";
        public const string firmaNo = "<p>Es un placer servirle,</p><p>Atentamente,<br/><strong>S3 - Sistema de Solicitud de Servicios</strong><br/>Contecon Guayaquil S.A. CGSA<br/>An ICTSI Group Company.</p><p><i>El contenido de este mensaje es informativo, por favor no responda este correo.</i></p>";
        ...
        public static string correccion_iie_msg_ingreso(string contenedor, string aisv, string tipocor, string daeE, string daeB, string cii, string iie)
        {
            ...
            xmensaje.Append("<p>Cualquier consulta adicional, envíe un correo a las casillas customerservice@cgsa.com.ec; gates-helpdesk@cgsa.com.ec</p>");
            xmensaje.Append(Utility.firmaNo);
            return xmensaje.ToString();
        }
        ...
        public static string repesaje_msg_proceso(List<string> contenedores, string trafico, string estado, string boking, string nocarga , string observaciones)
        {
            ...
            {
                xmensaje.Append("<p>Cualquier consulta adicional envíe un correo a la casilla: customerservice@cgsa.com.ec.</p>");
            }
        ...
        {
            StringBuilder xmensaje = new StringBuilder();
            xmensaje.Append("<h4>Estimado Cliente:<br/><br/>Este es un mensaje de Contecon Guayaquil S.A., a continuación se detalla la información con la cual podrá acceder a nuestro Sistema de Solicitud de Servicios, en el portal [ https://www.cgsa.com.ec ].</h4>");
            xmensaje.Append("<table cellpadding='1' cellspacing='1' border='0'>");
            ...
            xmensaje.Append("</table>");
            xmensaje.Append("<p><strong>Nota:</strong>El sistema automáticamente le pedirá que cambie su contraseña. De existir alguna consulta adicional, contáctenos a la casilla cgsa-customerservice@cgsa.com.ec</p>");
            xmensaje.Append(Utility.firmaNo);
            return xmensaje.ToString();
        ...
        public static string recupera_clave(string usuario, string clave, string fecha)
        {
            ...
            xmensaje.AppendFormat("<p>La contraseña que deberá utilizar para acceder a nuestro Sistema de Solicitud de Servicios es:  {0}</p>", clave);
