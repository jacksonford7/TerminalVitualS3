...
<body>
    ...
    <asp:ToolkitScriptManager ID="tkscata" runat="server"></asp:ToolkitScriptManager>
     ...
     <div class="catawrap" >
      ...
      <table class="controles" style=" font-size:small" cellspacing="0" cellpadding="1">
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtactividadcomercial" runat="server" Width="99%" MaxLength="500" 
             style="text-align: center" 
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890 ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtdireccion" runat="server" Width="99%" MaxLength="500" 
             style="text-align: center" 
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txttelofi" runat="server" Width="99%" MaxLength="9" 
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
           <asp:TextBox ID="txtcontacto" runat="server" Width="99%" MaxLength="500" 
             style="text-align: center" 
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890 ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txttelcelcon" runat="server" Width="99%" MaxLength="10" 
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
             <asp:TextBox runat="server" id="tmailinfocli" Width="99%" ></asp:TextBox>
          </td>
         </tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:155px;" >11. Mail EBilling:</td>
         <td class="bt-bottom bt-right">
             <asp:TextBox runat="server" id="tmailebilling" Width="99%" ></asp:TextBox>
          </td>
         </tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:155px" >12. Certificaciones:</td>
         <td class="bt-bottom bt-right">
           <asp:TextBox ID="txtcertificaciones" runat="server" Width="99%" MaxLength="500" 
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtafigremios" runat="server" Width="99%" MaxLength="1000" 
             style="text-align: center"
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890;./-_ ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtrefcom" runat="server" Width="99%" MaxLength="500" 
             style="text-align: center" 
    ...
    <div class="colapser colapsa"></div>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" style=" font-size:small" >
         ...
         <td class="bt-bottom bt-right">
             <asp:TextBox runat="server" id="tmailRepLegal" Width="99%" />
          </td>
         </tr>
      </table>
     </div>
       ...
       <tr>
         <td class="bt-bottom bt-left bt-right">
           <asp:TextBox ID="txtmotivorechazo" runat="server" Width="99%" MaxLength="500"
       ...
       <%--<div class="separator">Revisar los documentos solicitados:</div>--%>
        <div class="bokindetalle" style=" overflow:auto; height:100%; font-size:inherit">
       ...
       <span id="imagen"></span>
       <asp:Button ID="btsalvar" runat="server" Text="Actualizar" Width="125px"
               OnClientClick="return prepareObject('¿Esta seguro de actualizar la solicitud?');" onclick="btsalvar_Click" 
               ToolTip="Actualiza la solicitud."/>
        </div>
      </div>
      </div>
    </form>
