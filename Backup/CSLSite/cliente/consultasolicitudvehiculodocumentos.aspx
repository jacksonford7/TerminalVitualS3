       ...
       <%--<div class="separator">Revisar los documentos solicitados:</div>--%>
        <div class="informativo" style=" width:100%; height:100%; overflow:auto">
         <table id="tablerp" cellpadding="1" cellspacing="0">
            ...
            <td style=" width:70px"><asp:CheckBox Enabled="false" Checked='<%#Eval("ESTADOCOL")%>' ForeColor="Red" runat="server" id="chkRevisado"/></td>
            <td><asp:TextBox ID="tcomentario" Enabled="false" Text='<%#Eval("COMENTARIO")%>' ForeColor="Red" runat="server" Width="250px" onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
            </tbody>
