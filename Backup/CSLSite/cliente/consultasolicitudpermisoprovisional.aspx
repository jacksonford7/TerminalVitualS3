...
CodeBehind="consultasolicitudpermisoprovisional.aspx.cs" Inherits="CSLSite.consultasolicitudpermisoprovisional" %>
     ...
     <div class="seccion">
       ...
       <div class="accion">
         ...
         <td class="bt-bottom bt-right">
             ...
             onkeypress="return soloLetras(event,'0123456789/')"  Enabled="false"
             ></asp:TextBox>
         </td>
         </tr>
     ...
     <div class="accion">
      ...
      <asp:Repeater ID="tablePagination" runat="server"  >
                 ...
                 <tr class="point" >
                  ...
                  <td style=" width:60px"><asp:CheckBox runat="server" id="chkRevisado"/></td>
...
//          return;
      ...
      function redirectsol(val, val2, val3) {
          ...
          var caja2 = val2;
          var caja3 = val3;
          window.open('../consulta/consulta-documentos-permiso-provisional/?numsolicitud=' + caja + '&idsolcol=' + caja3 + '&cedula=' + caja2)
      }
   </script>
    <script src="../Scripts/jquery-1.7.1.min.js" type="text/javascript"></script>
    <script src="../Scripts/pages.js" type="text/javascript"></script>
