...
<%--                 </thead> --%>
                <tr style="position:static">
                 ...
                 <tr >
                  ...
                  <td style=" width:70px"><%#Eval("PLACA")%></td>
                  ...
                  <td style=" width:50px"><asp:CheckBox runat="server" Width="50px" Checked='<%#Eval("ESTADO")%>' id="chkRevisado" Enabled="False" ForeColor="Red"/></td>
                  <td style=" width:200px"><asp:TextBox ID="tcomentario" Enabled="False" ForeColor="Red" runat="server" Width="200px" Text='<%#Eval("COMENTARIO")%>' onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
                 </tr>
                 </ItemTemplate>
                 <FooterTemplate>
                 <%--</tbody>--%>
