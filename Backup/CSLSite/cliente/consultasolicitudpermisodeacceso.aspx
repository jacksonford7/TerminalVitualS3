...
<%--                 </thead> --%>
                <tr style="position:static">
                 ...
                 <tr >
                  ...
                  <td style=" width:80px"><asp:Label Text='<%#Eval("CEDULA")%>' runat="server" id="lblcipas"/></td>
                  ...
                  <td style=" width:50px; display:none"><asp:CheckBox runat="server"  Width="50px" id="chkPermiso" onchange="valPermiso()"/></td>
                  ...
                  <td style=" width:80px; display:none">
                                    <asp:TextBox Style="text-align: center" ID="txtfecing" runat="server" Width="80px"
                                    MaxLength="15" CssClass="datetimepicker" ClientIDMode="Static" onkeypress="return soloLetras(event,'0123456789/')"
                                    ></asp:TextBox>
                  </td>
                  <td style=" width:80px; display:none">
                                <asp:TextBox Style="text-align: center" ID="txtfecsal" runat="server" Width="80px"
                                    MaxLength="15" CssClass="datetimepicker" ClientIDMode="Static" onkeypress="return soloLetras(event,'0123456789/')"
                                ></asp:TextBox>
                  </td>
                  <td style=" width:120px; display:none"><asp:DropDownList runat="server" Width="120px" ID="ddlTurnoOnlyControl"></asp:DropDownList></td>
                  ...
                  <td style=" width:50px;"><asp:CheckBox runat="server" id="chkRevisado" Checked='<%#Eval("ESTADOSPA")%>' Enabled="False" ForeColor="Red" onchange="valRechazado()"/></td>
                  <td style=" width:300px;"><asp:TextBox ID="tcomentario" Width="300px" runat="server" Text='<%#Eval("COMENTARIO")%>' Enabled="False" ToolTip='<%#Eval("COMENTARIO")%>' ForeColor="Red" onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
                  <td style=" width:80px">
