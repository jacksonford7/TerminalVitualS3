...
namespace CSLSite
{
    public partial class consultasolicitudpermisodeaccesovehiculo : System.Web.UI.Page
    {
        ...
        {
            get { return (DataTable)Session["dtDocumentosconsultasolicitudpermisodeaccesoveh"]; }
            set { Session["dtDocumentosconsultasolicitudpermisodeaccesoveh"] = value; }
        }
        public String numsolicitudempresa
        {
            get { return (String)Session["numsolicitudconsultasolicitudpermisodeaccesoveh"]; }
            set { Session["numsolicitudconsultasolicitudpermisodeaccesoveh"] = value; }
        }
        public string rucempresa
        {
            get { return (string)Session["rucempresaconsultasolicitudpermisodeaccesoveh"]; }
            set { Session["rucempresaconsultasolicitudpermisodeaccesoveh"] = value; }
        }
        public string useremail
        {
            get { return (string)Session["useremailconsultasolicitudpermisodeaccesoveh"]; }
            set { Session["useremailconsultasolicitudpermisodeaccesoveh"] = value; }
        }
        public string mensajefac
        {
            get { return (string)Session["mensajefacconsultasolicitudpermisodeaccesoveh"]; }
            set { Session["mensajefacconsultasolicitudpermisodeaccesoveh"] = value; }
        }
        public string mensajeok
        {
            get { return (string)Session["mensajeokconsultasolicitudpermisodeaccesoveh"]; }
            set { Session["mensajeokconsultasolicitudpermisodeaccesoveh"] = value; }
        }
