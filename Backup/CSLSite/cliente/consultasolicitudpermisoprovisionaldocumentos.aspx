       ...
       <%--<div class="separator">Revisar los documentos solicitados:</div>--%>
        <div class="informativo">
         <table id="tablerp" cellpadding="1" cellspacing="0">
            ...
            <td style=" width:70px"><asp:CheckBox runat="server" id="chkRevisado"/></td>
            <td><asp:TextBox ID="tcomentario" runat="server" Width="200px" onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
            </tbody>
