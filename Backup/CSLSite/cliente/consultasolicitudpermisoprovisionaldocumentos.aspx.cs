...
namespace CSLSite
{
    public partial class consultasolicitudpermisoprovisionaldocumentos : System.Web.UI.Page
    {
        ...
        private void ConsultaInfoSolicitud()
        {
            ...
            if (dtPadre != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        dtDocumentos.Rows[i][10] = dt.Rows[i][10];
                        dtDocumentos.Rows[i][11] = dt.Rows[i][11];
                    }
                    foreach (RepeaterItem item in tablePaginationDocumentos.Items)
                    {
                        ...
                        chkRevisado.Checked = Convert.ToBoolean(dtDocumentos.Rows[item.ItemIndex][10]);
                        ...
                        {
                            tcomentario.Text = dtDocumentos.Rows[item.ItemIndex][11].ToString();
                        }
                    }
                }
            }
        ...
        private void ExportFileUpload()
        {
            ...
            foreach (RepeaterItem item in tablePaginationDocumentos.Items)
            {
                ...
                dtDocumentos.Rows[item.ItemIndex][10] = chkRevisado.Checked;
                dtDocumentos.Rows[item.ItemIndex][11] = tcomentario.Text;
                dtDocumentos.Rows[item.ItemIndex][12] = cedula;
            }
