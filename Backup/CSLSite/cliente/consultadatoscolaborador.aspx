...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
 ...
 <i class="ico-titulo-1"></i><h2>MCA - Módulo de Control de Acceso</h2><h2>&nbsp;</h2>
     <br />
 <i class="ico-titulo-2"></i><h1>Consulta de Colaboradores</h1><br />
 </div>
 <div class="seccion">
       <div class="accion">
       ...
       <tr><th class="bt-bottom bt-right bt-left bt-top" colspan="4"> Criterios de consulta:</th></tr>
       <tr>
        <td class="bt-bottom bt-right bt-left" style=" width:245px">Cedula o Cedulas separados por coma(,):</td>
        <td class="bt-bottom bt-right">
             <asp:TextBox ID="txtCedula" runat="server" Width="435px" placeholder="Ejemplo: 0123456789,9876543210"
             style="text-align: center" onblur="cajaControl(this);"
             onkeypress="return soloLetras(event,'01234567890-,',true)"></asp:TextBox>
        </td>
       </tr>
       ...
       <tr>
         <td class="bt-bottom bt-right bt-left">Todas los colaboradores.</td>
         <td class="bt-bottom bt-right">
