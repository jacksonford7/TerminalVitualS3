        ...
        <div id="wall-panel">
            <div class="xlogin">
                <div class="wraper-line">
                    ...
                    <asp:ImageButton ID="closebt" runat="server" ImageUrl="~/shared/imgs/btn-salir.png"
                        CausesValidation="False" OnClick="btexit_Click" />
                </div>
            </div>
            <div id="wraper-panel">
                <div id="logoCGSA">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="seccion" id="PERSONAL">
                                ...
                                <div class="accion">
                                    <table class="controles" cellspacing="0" cellpadding="1">
                                        ...
                                        <tr>
                                            ...
                                            <td class="bt-bottom">
                                                <asp:TextBox ID="txtPasswordAnterior" runat="server" CssClass="mayusc" onpaste="return false;"
                                                    MaxLength="30" placeholder="CONTRASEÑA ANTERIOR" Width="200px" TextMode="Password"
                                        ...
                                        <tr>
                                            ...
                                            <td class="bt-bottom">
                                                <asp:TextBox ID="txtNuevoPassword" runat="server" CssClass="mayusc" onpaste="return false;"
                                                    MaxLength="30" placeholder="NUEVA CONTRASEÑA" Width="200px" TextMode="Password"
                                                    onblur="cadenareqerida(this,1,30,'valNuePas');"></asp:TextBox>
                                            </td>
                                            <td class="bt-bottom bt-right validacion">
                                                <span class="validacion" id="valNuePas">* obligatorio</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="bt-bottom  bt-right bt-left">
                                            ...
                                            <td class="bt-bottom">
                                                <asp:TextBox ID="txtPasswordConfirmado" runat="server" CssClass="mayusc" onpaste="return false;"
                                                    placeholder="CONFIRMAR CONTRASEÑA" MaxLength="30" Width="200px" TextMode="Password"
                                                    onblur="cadenareqerida(this,1,30,'valConfPas');"></asp:TextBox>
                                            </td>
                                            <td class="bt-bottom bt-right validacion">
                                                <span class="validacion" id="valConfPas">* obligatorio</span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="botonera">
                                    ...
                                    <asp:Button ID="btbuscar" Text="Cambiar Contraseña" runat="server" OnClick="btbuscar_Click" />
                                    &nbsp;
                                </div>
