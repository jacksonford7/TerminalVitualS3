...
namespace CSLSite.cuenta
{
    public partial class cambiarpassword : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Código que se ejecutar al iniciar la página
        /// </summary>
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                csl_log.log_csl.save_log<ApplicationException>(new ApplicationException("No autenticado"), "cambiarPassword", "Page_Init", "No autenticado", "No disponible");
        ...
        /// <summary>
        /// Código que llama al método de cambio de contraseña
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (resultado == "ok")
                {
                    ...
                    string destinatarios = sUser.email;
                     ...
                     mail =  Utility.cambio_clave(sUser.email,DateTime.Now.ToString("dd/MM/yyyy HH:mm"));
                    ...
                    CLSDataSeguridad.addMail(out errorMail, user_email, "S3 - Cambio de contraseña", mail, destinatarios, sUser.loginname, "", "");
                    ...
                    else
                    {
                        ...
                        this.Session.Clear();
                        Utils.mostrarMensajeRedireccionando(this.Page, "Cambio de contraseña exitoso.", "../csl/login");
                    }
                }
                else
                {
