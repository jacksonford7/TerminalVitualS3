    ...
    public partial class consultasolicitudrechazoempresa : System.Web.UI.Page
    {
        ...
        protected void btsalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(numsolicitudempresa))
                {
                    Response.Write("<script language='JavaScript'>var r=alert('Ocurrió un problema al cargar la pagina, la URL ha cambiado.');if(r==true){window.location='http://www.cgsa.com.ec/inicio.aspx';}else{window.location='http://www.cgsa.com.ec/inicio.aspx';}else{window.location='http://www.cgsa.com.ec/inicio.aspx';}else{window.location='http://www.cgsa.com.ec/inicio.aspx';};</script>");
                }
                else
                {
                    numsolicitudempresa = QuerySegura.DecryptQueryString(Request.QueryString["sid"]).Replace("\0", string.Empty).Trim();
                ...
                {
                    Response.Write("<script language='JavaScript'>var r=alert('Solicitud reenviada exitosamente.');if(r==true){window.location='http://www.cgsa.com.ec/inicio.aspx';}else{window.location='http://www.cgsa.com.ec/inicio.aspx';}</script>");
                }
            }
            catch (Exception ex)
            {
