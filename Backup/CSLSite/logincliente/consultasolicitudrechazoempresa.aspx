<%@ Page Language="C#" AutoEventWireup="true" Title="Consulta Solicitud Registro de Empresa"
CodeBehind="consultasolicitudrechazoempresa.aspx.cs" Inherits="CSLSite.logincliente.consultasolicitudrechazoempresa" %>
    ...
    <asp:ToolkitScriptManager ID="tkscata" runat="server"></asp:ToolkitScriptManager>
     ...
     <div class="catawrap" >
      ...
      <table class="controles" style=" font-size:small" cellspacing="0" cellpadding="1">
         ...
         <td class="bt-bottom bt-right">
           <asp:TextBox ID="txtrazonsocial" runat="server" Width="99%" MaxLength="500" Enabled="true"
             style="text-align: center;" 
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890 ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtruccipas" runat="server" Width="99%" MaxLength="25" Enabled="true"
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtactividadcomercial" runat="server" Width="99%" MaxLength="500" Enabled="true"
             style="text-align: center" 
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890 ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtdireccion" runat="server" Width="99%" MaxLength="500" Enabled="true"
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txttelofi" runat="server" Width="99%" MaxLength="9" Enabled="true"
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
           <asp:TextBox ID="txtcontacto" runat="server" Width="99%" MaxLength="500" Enabled="true"
             style="text-align: center" 
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890 ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txttelcelcon" runat="server" Width="99%" MaxLength="10" Enabled="true"
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
             <asp:TextBox runat="server" id="txtmailinfocli" Width="99%" Enabled="true"></asp:TextBox>
          </td>
         </tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:155px;" >11. Mail EBilling:</td>
         <td class="bt-bottom bt-right">
             <asp:TextBox runat="server" id="txtmailebilling" Width="99%" Enabled="true"></asp:TextBox>
          </td>
         </tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:155px" >12. Certificaciones:</td>
         <td class="bt-bottom bt-right">
           <asp:TextBox ID="txtcertificaciones" runat="server" Width="99%" MaxLength="500" Enabled="true"
             style="text-align: center"
         ...
         <td class="bt-bottom bt-right">
             <asp:TextBox
              ...
              enableviewstate="false" clientidmode="Static" Enabled="true"
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtafigremios" runat="server" Width="99%" MaxLength="1000" Enabled="true"
             style="text-align: center"
             onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890;./-_ ',true)"></asp:TextBox>
         </td>
         </tr>
         ...
         <td class="bt-bottom bt-right">
            <asp:TextBox ID="txtrefcom" runat="server" Width="99%" MaxLength="500" Enabled="true"
             style="text-align: center" 
    ...
    <div class="colapser colapsa"></div>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" style=" font-size:small" >
         ...
         <td class="bt-bottom bt-right">
           <asp:TextBox ID="txtreplegal" runat="server" Width="99%" MaxLength="500"
             style="text-align: center" Enabled="true"
         ...
         <td class="bt-bottom bt-right">
             <asp:TextBox runat="server" id="tmailRepLegal" Width="99%" Enabled="true"/>
          </td>
         </tr>
      </table>
     </div>
       ...
       <tr>
         ...
         <td class="bt-bottom bt-left bt-right">
           <asp:TextBox ID="txtmotivorechazo" runat="server" Width="99%" MaxLength="500" Enabled="FALSE" ForeColor="Red"
       ...
       <%--<div class="separator">Revisar los documentos solicitados:</div>--%>
        <div class="bokindetalle" style=" overflow:auto; height:100%; width:100%; font-size:inherit">
         <div class="bokindetalle">
            ...
            <td style=" width:70px"><asp:CheckBox runat="server" ToolTip="Documento rechazado" Checked='<%#Eval("ESTADOCOL")%>' Enabled="false" id="chkRevisado"/></td>
            ...
            <td>
            <asp:FileUpload extension='<%#Eval("EXTENSION")%>' class="uploader" id="fsupload"  width="200px"
      ...
      <div class="accion">
       ...
       <div class="botonera" runat="server" id="salir"  >
        <%--<asp:Button ID="btnSalir" runat="server" Text="Salir" Width="125px" visible="false"
                onclick="btnSalir_Click" 
                ToolTip="Cierra la ventana."/>--%>
        <span id="imagen"></span>
        <asp:Button ID="btsalvar" runat="server" Text="Reenviar" Width="125px"
