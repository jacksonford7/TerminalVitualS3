<%@ Page Title="Reporte de carga suelta IMO" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
 CodeBehind="bbkimo.aspx.cs" Inherits="CSLSite.bbkimo" %>
...
<input id="zonaid" type="hidden" value="1101" />
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
    <div>
   <i class="ico-titulo-1"></i><h2>Seguridad Industrial </h2>  <br /> 
   <i class="ico-titulo-2"></i><h1>Reporte de Carga Suelta Peligrosa en la Terminal 
            </h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="5"> Datos para el corte</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left">Creados desde:</td>
         <td class="bt-bottom">
            <asp:TextBox ID="desded" runat="server" Width="120px" MaxLength="10" 
             Enabled="false"    
          ...
          <td class="bt-bottom " >
             <asp:TextBox ID="hastad" runat="server" ClientIDMode="Static" Width="120px" MaxLength="15"
               Enabled="false"
                  ></asp:TextBox>
         ...
         <div class="botonera">
          <span id="imagen"></span>
             ...
             <div class="booking" >
                 ...
                 <tr class="point" >
                  <td><%#Eval("ID")%></td>
                  <td><%#Eval("BL_BOOKING")%></td>
                  <td><%#Eval("CATEGORIA")%></td>
                  <td><%#Eval("CANTIDAD")%></td>
                  <td>
                    <a class="xinfo" >
                    <span class="xclass">
                     <h3>Comodity:</h3><%#Eval("COMODITY")%>
                     </span>
                        <%#Eval("IMO")%>
                    </a>
                  </td>
