...
namespace CSLSite
{
    public partial class bbkimo : System.Web.UI.Page
    {
        //AntiXRCFG
        ...
        private void populate()
       {
           ...
           var table = new Catalogos.BULK_IMODataTable();
           var ta = new CatalogosTableAdapters.BULK_IMOTableAdapter();
           try
           {
               DateTime desde;
               DateTime hasta;
              ...
              ta.Fill(table,desde, hasta);
               if (table.Rows.Count <= 0)
               {
                   xfinder.Visible = false;
                   sinresultado.Attributes["class"] = string.Empty;
                   sinresultado.Attributes["class"] = "msg-info";
                   this.sinresultado.InnerText = "No se encontraron resultados, revise las fechas o ponga desde 04-02-2014";
                   sinresultado.Visible = true;
                   return;
               }
