...
namespace CSLSite.aisv
{
    public partial class vacios : System.Web.UI.Page
    {
        ...
        protected string getOklist(List<unidadAdvice> listado, ref List<unidadAdvice> listaok, int cuantos)
        {
            ...
            var i = 0;
            t.Append("<p>Unidades que serán preavisadas <a href='#' class='topopup' onclick=\"SelectContent('divok');\"  >Seleccionar</a></p><div id='divok'><table id=\"tablaok\" cellpadding=\"1\" cellspacing=\"0\"><thead><tr><th>Container</th></tr></thead><tbody>");
            ...
            if (Response.IsClientConnected)
            {
                ...
                try
                {
                   ...
                   str = Regex.Replace(str, @"'|!|<|>|-|_|""|#|", string.Empty);
                    ...
                    sinresultado.InnerHtml = string.Format("<span><strong>Contenedores para poner en preaviso:</strong> [{0}]</span><br/><span><strong>Contenedores con errores:</strong> [{1}]</span><br/><span><strong>Total de contenedores en archivo:</strong> [{2}]</span>", ok, xresultado.Count - ok, xresultado.Count);
