...
<input id="zonaid" type="hidden" value="401" />
   ...
   <i class="ico-titulo-2"></i><h1>Consulta / Cancelación de turnos</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="6"> Datos del documento buscado</th></tr>
         ...
         <td class="bt-bottom bt-right " >
               <input 
                ...
                type='text' id='tmail' 
                name='tmail'  runat="server" style= 'width:400px; text-align: left; font-size:smaller' class="date"
                 ...
                 <tr class="point" >
                  ...
                  <td>
                   <div class="tcomand">
                       ...
                       CommandArgument= '<%#Eval("id_horario_det")%>' runat="server" Text="Actualizar" CssClass="Anular" ToolTip="Permite modificar este documento" />
                   </div>
                  </td>
                  <td>
                   <div class="tcomand">
                       ...
                       CommandName ='Anula'
                       CommandArgument= '<%#Eval("id_horario_det")%>' runat="server" Text="Cancelar" CssClass="Anular" ToolTip="Permite anular este documento" />
                   </div>
                  </td>
                 </tr>
                  </ItemTemplate>
