...
namespace CSLSite
{
    public partial class rptreservas_consolidacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var t = turnoConsolidacion.GetRptReservasFull(arrglo[2], arrglo[3], arrglo[0], arrglo[1], true, Convert.ToBoolean(Session["DetalleReserva"]));
