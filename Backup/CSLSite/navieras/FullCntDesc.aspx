...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div>
        ...
        <h1>
            Full Containers Discharge Report</h1>
        <br />
    </div>
    <div class="seccion">
        <div class="accion">
            ...
            <div class="cataresult">
                <asp:UpdatePanel ID="upresult" runat="server" ChildrenAsTriggers="true">
                 ...
                 <td>
             <input clientidmode="Static" id="dataexport" onclick="getTable('reportDescFul');" type="button" value="Exportar" runat="server" />
             </td>
             </tr>
             </table>
                                    <br />
                                    <div class="separator">
                                        Full Container Discharge</div>
