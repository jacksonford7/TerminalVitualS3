<%@ Page Title="Carga de Vacíos" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
    CodeBehind="EmptyCntLoad.aspx.cs" Inherits="CSLSite.econt_load" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="605" />
    ...
    <div>
        ...
        <h1>
            Empty Containers Load Report</h1>
        <br />
    </div>
    <div class="seccion">
        <div class="accion">
            ...
            <table class="xcontroles" cellspacing="0" cellpadding="1">
                ...
                <tr>
                    <td class="bt-bottom bt-left bt-right" style="width: 100px">
                        Referencia de Nave :
                    </td>
                ...
                <%--    <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:150px">Ver detalle reserva.</td>
         <td class="bt-bottom bt-right " >
             <asp:CheckBox Text="" ID="chkDetalle" runat="server" />
         </td>
         </tr>--%>
            </table>
            <div class="botonera">
            ...
            <div class="cataresult">
                <asp:UpdatePanel ID="upresult" runat="server" ChildrenAsTriggers="true">
                 ...
                 <td>
             <input clientidmode="Static" id="dataexport" onclick="getTable('reportCargEmp');" type="button" value="Exportar" runat="server" />
             </td>
             </tr>
             </table>
                                    <br />
                                    <div class="separator">
                                        Empty Container Load</div>
