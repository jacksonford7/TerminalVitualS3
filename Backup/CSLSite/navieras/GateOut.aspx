...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div>
   <i class="ico-titulo-2"></i><h1>Gate Out Report</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
         ...
         <div class="botonera">
          <span id="imagen"></span>
             ...
             <div class="booking" >
                 ...
                 <td>
             <input clientidmode="Static" id="dataexport" onclick="getTable('reportGateOut');" type="button" value="Exportar" runat="server" />
             </td>
             </tr>
             </table>
                 <br />
                 <div class="separator">Gate Out</div>
