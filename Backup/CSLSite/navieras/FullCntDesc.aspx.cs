...
namespace CSLSite
{
    public partial class fcont_desc : System.Web.UI.Page
    {
        ...
        protected void btbuscar_Click(object sender, EventArgs e)
        {
            if (Response.IsClientConnected)
            {
                try
                {
                    ...
                    var tablix = repNavieras.GetRptFullCntDesc(this.agencia.Value, this.tbooking.Text, "FCL");
                    tablePagination.DataSource = tablix;
                    tablePagination.DataBind();
                    Session["reportDescFul"] = tablix;
                    xfinder.Visible = true;
                    ...
                    this.aprint.HRef = string.Format("RptFullCntDesc.aspx?sid={0}", sid);
                }
                catch (Exception ex)
                {
