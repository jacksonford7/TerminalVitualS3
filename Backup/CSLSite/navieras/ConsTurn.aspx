<%@ Page Title="Turnos" Language="C#" MasterPageFile="~/site.Master" 
         AutoEventWireup="true" CodeBehind="ConsTurn.aspx.cs" Inherits="CSLSite.cons_turn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="603" />
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
    <div>
   
   <i class="ico-titulo-2"></i><h1>Consulta Turnos para Despacho de Contenedores</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="3">Filtros para el reporte</th></tr>
         ...
         <table>
             ...
             onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890')" ></asp:TextBox>
              ...
              <td>
             <span id="valcont" class="validacion" > * obligatorio</span>
             </td>
              </tr>
              </table>
          </td>
          ...
          <tr>
         <td class="bt-bottom  bt-right bt-left" style=" width:100px">Fecha:</td>
          <td class="bt-bottom bt-right " >
          <table>
                            <tr>
                                <td>
         ...
         <div class="botonera">
          <span id="imagen"></span>
             ...
             <br>
             <div>
             <input clientidmode="Static" id="dataexport" onclick="getTable('reportTurn');" type="button" value="Exportar" runat="server" />
             </div>
             </br>
                 <br />
                 <div style="width:200px" class="separator">Resultado</div>
                 <div class="bokindetalle">
                 <div style=" width : 200px; overflow : auto ; height : 200px">
                 <asp:Repeater ID="tablePagination" runat="server"  >
                 <HeaderTemplate>
                 <table id="tabla" cellspacing="1" cellpadding="1" class="tabRepeat">
                 <thead>
                 <tr>
                 <th style="width:140px">De</th>
