...
<body>
     ...
     <div class="catawrap" >
      ...
      <table class="controles" style=" font-size:small" cellspacing="0" cellpadding="1">
         ...
         <td style=" background:white; padding:0">
            <asp:TextBox ID="txtrazonsocial" runat="server" Width="770px" MaxLength="500" Enabled="false"
             style="text-align: center;" 
    ...
    <div class="colapser colapsa"></div>
       ...
       <%--<div class="separator">Revisar los documentos solicitados:</div>--%>
        <div class="bokindetalle" style=" overflow:auto; height:100%; font-size:inherit">
         <div class="bokindetalle">
            ...
            <td style=" width:70px"><asp:CheckBox runat="server" Checked='<%#Eval("ESTADODOC")%>' id="chkRevisado"/></td>
            <td><asp:TextBox ID="tcomentario" runat="server" ForeColor="Red" Width="200px" Text='<%#Eval("COMENTARIO")%>' onkeypress="return soloLetras(event,'abcdefghijklnmñopqrstuvwxyz01234567890-_/ ',true)"></asp:TextBox></td>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
            </tbody>
      ...
      <div class="accion">
       ...
       <asp:Button ID="btsalvar" runat="server" Text="Finalizar" Width="125px"
               OnClientClick="return prepareObject('¿Esta seguro de Finalizar la solicitud?');" onclick="btsalvar_Click" 
               ToolTip="Finaliza la solicitud."/>
        </div>
      </div>
      </div>
