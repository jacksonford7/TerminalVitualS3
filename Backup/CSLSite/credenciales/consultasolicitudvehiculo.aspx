...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
 ...
 <i class="ico-titulo-1"></i><h2>MCA - Módulo de Control de Acceso</h2><h2>&nbsp;</h2>
     <br />
 <i class="ico-titulo-2"></i><h1>Consulta de Vehiculos</h1><br />
 </div>
 <div class="seccion">
       <div class="accion">
       ...
       <tr>
        <td class="bt-bottom bt-right bt-left" >Placa:</td>
        <td class="bt-bottom bt-right">
             <asp:TextBox ID="txtPlaca" runat="server" Width="120px" MaxLength="11"
       ...
       <div class="cataresult" >
        ...
        <div class="informativo" style=" height:100%; overflow:auto">
                 ...
                 <tr class="point" >
                  ...
                  <td>
                    <a style=" width:90px" id="adjDoc" class="topopup" onclick="redirectsol('<%# Eval("NUMSOLICITUD") %>', '<%# Eval("IDSOLVEH") %>', '<%#Eval("PLACA")%>');">
