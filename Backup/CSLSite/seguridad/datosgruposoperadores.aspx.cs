...
namespace CSLSite
{
    public partial class datosgruposoperadores : System.Web.UI.Page
    {
        public static usuario sUser = null;
        public static UsuarioSeguridad us;
        public static string identificacionEmpresa;
        ...
        /// <summary>
        /// Código que se ejecuta el iniciar la página (verifica que el usuario este autenticado)
        /// </summary>
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                csl_log.log_csl.save_log<ApplicationException>(new ApplicationException("No autenticado"), "datosgruposoperadores", "Page_Init", "No autenticado", "No disponible");
        ...
        /// <summary>
        /// Código que inicializa los controles, carga combos
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (us.tipoUsuario == ConfigurationManager.AppSettings["tipoAdministradorEmpresa"].ToString())
                {
                ...
                {
                    if (Session["idUsuarioPadre"] != null)
                    {
                        int idUsuarioPadre = int.Parse(Session["idUsuarioPadre"].ToString());
                        UsuarioSeguridad usPadre = s.consultarUsuarioPorId(idUsuarioPadre);
                        if (usPadre != null)
                        {
                            identificacionEmpresa = usPadre.codigoEmpresa;
                            idUsuario = usPadre.idUsuario;
        ...
        /// <summary>
        /// Código que carga el grid con el resultado de la búsqueda de las asignaciones
        /// </summary>
        ...
        /// <param name="nombreEmpresa">Nombre de la empresa relacionada al usuario a buscar</param>
        /// <param name="estado">Estado de usuario a buscar</param>
        ...
        private void cargarResultados(string usuario, string nombreUsuario, string identificacionUsuario, string nombreEmpresa, string estado, string tipoUsuario)
        {
            ...
            try
            {
                ...
                usuarios = seguridad.consultarUsuariosRolesOperador(usuario, nombreUsuario, identificacionUsuario, nombreEmpresa, estado, tipoUsuario, identificacionEmpresa, int.Parse(ddlGrupo.SelectedValue));
                if (usuarios != null)
                {
                    if (usuarios.Count > 0)
                    {
        ...
        /// <summary>
        /// Código que llama al método de guardado de las asignaciones
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void cargarGrupos()
        {
            ...
            Seguridad s = new Seguridad();
            grupos = s.consultarGrupoPorIdentificacion(identificacionEmpresa, idUsuario);
        ...
        /// <summary>
        /// Código que llama al método de guardado de asignaciones de grupos - operadores
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            Seguridad seguridad = new Seguridad();
            string resultado = seguridad.GuardarModificarRolesUsuarioOperador(idGrupo, dtUsuario, sUser.id, sUser.loginname);
            alerta.Visible = false;
            alerta.InnerText = "";
            if (resultado == "ok")
            {
                
                    Utils.mostrarMensajeRedireccionando(this.Page, "Datos de roles - usuarios guardados correctamente.", "../seguridad/grupooperador");
        ...
        /// <summary>
        /// Código que regresa a la pantalla de consulta de usuarios administradores
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnRegresar_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/seguridad/consultaadministrador", false);
        }
    }
}