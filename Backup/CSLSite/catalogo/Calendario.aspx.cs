    ...
    public partial class calendario : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Response.IsClientConnected && !IsPostBack)
            {
                ...
                var t = turno.GetProxHorario(DateTime.Now.Date, u.ruc, r);
                try
                {
                    if (t != null && t.Count > 0)
                    {
                        ...
                        this.alerta.InnerHtml = "Estimado cliente, si la fecha requerida para su reserva no aparece en esta lista. <br />" +
