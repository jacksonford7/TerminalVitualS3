        ...
        public void envioCorreo(int idSolicitud, usuario sUser)
        {
            ...
            switch (descripcionServicio)
            {
                case "Reestiba":
                    ...
                    destinatarios = string.Format("{0};{1}", correoBackUp.config_value, cfg != null ? cfg.config_value : "customerservice@cgsa.com.ec");
                    ...
                    else
                    {
                        ...
                        destinatarios = correoBackUp != null ? correoBackUp.config_value : "customerservice@cgsa.com.ec";
                    }
                    break;
                case "Repesaje":
