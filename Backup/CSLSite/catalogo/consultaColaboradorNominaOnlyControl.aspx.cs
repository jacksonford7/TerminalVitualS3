...
namespace CSLSite
{
    public partial class colaboradoroc : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                var ruc = Session["rucempresadatossolicitudcolaborador"].ToString();
                sinresultado.Visible = false;
                var u = this.getUserBySesion();
                string error = string.Empty;
                var t = Session["dtNominaOnyControlsolicitudpermisodeacceso"] as DataTable;//credenciales.GetNominaOnlyControl(ruc, out error);
                try
                {
