...
namespace ServicesEntities
{
    public class SerializacionHelper
    {
        ...
        public string XmlSerializeEntity<T>(T obj, Action<Exception,T> OnError=null)
        {
        ...
        public T XmlDeserializeEntity<T>(string data, Action<Exception,string> OnError = null) where T :class
        {
