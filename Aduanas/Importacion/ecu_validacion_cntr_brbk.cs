...
{
    [Serializable]
    [XmlRoot(ElementName = "ecu_validacion_cntr_brbk")]
    public class ecu_validacion_cntr_brbk : ModuloBase
    {
        ...
        public ecu_validacion_cntr_brbk() : base()
        {

        }

        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>>CargaPorManifiestoImpo(string usuario, string mrn, string msn, string hsn )
        {
            ...
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(pv);
            }
            //fin inicializa
            ...
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(mrn)));
            }
            if (string.IsNullOrEmpty(msn))
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(msn)));
            }
            if (string.IsNullOrEmpty(hsn))
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(hsn)));
            }
            if (string.IsNullOrEmpty(usuario))
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(usuario)));
            }
            ...
            var rp = BDOpe.ComandoSelectALista<ecu_validacion_cntr_brbk>(bcon, "[Bill].[validacion_cntr_cfs_impo_mrn]", this.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(rp.MensajeProblema);
        }
        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>> CargaPorManifiestoImpoPro(string usuario, string mrn, string msn, string hsn, string ruc)
        {
            this.actualMetodo = MethodBase.GetCurrentMethod().Name;
            //inicializa
            string pv = string.Empty;
            ...
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(ruc)));
            }
            ...
            var rp = BDOpe.ComandoSelectALista<ecu_validacion_cntr_brbk>(bcon, "[Bill].[validacion_cntr_cfs_impo_mrn_ruc_pro]", this.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(rp.MensajeProblema);
        }
        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>> CargaPorManifiestoImpo(string usuario, string mrn, string msn, string hsn, bool validar)
        {
            this.actualMetodo = MethodBase.GetCurrentMethod().Name;
            //inicializa
            string pv = string.Empty;
...
#endif
            var rsql = BDOpe.ComandoSelectALista<ecu_validacion_cntr_brbk>(bcon, "[Bill].[validacion_cntr_bbk_impo_mrn_ruc]", this.Parametros);
            return rsql.Exitoso ? ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearResultadoExitoso(rsql.Resultado, string.Format("Filas {0}", rsql.Resultado.Count)) : ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(rsql.MensajeProblema);

        }
        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>> CargaPorRucImpo(string usuario, string ruc, string codigo )
        {
            //inicializa
            this.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv = string.Empty;
            ...
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(mrn)+'/'+nameof(codigo)));
            }
            if (string.IsNullOrEmpty(usuario))
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(msn)));
            ...
            this.LogEvent(usuario, actualMetodo, string.Format("{0}-{1}-{2}", mrn, msn, hsn));
#endif
            var rsql = BDOpe.ComandoSelectALista<ecu_validacion_cntr_brbk>(bcon, "[Bill].[validacion_cntr_cfs_impo_mrn_ruc]", this.Parametros);
            return rsql.Exitoso ? ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearResultadoExitoso(rsql.Resultado, string.Format("Filas {0}", rsql.Resultado.Count)) : ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(rsql.MensajeProblema);
        }
        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>> CargaPorCodigoImpo(string usuario, string codigo)
        {
            //inicializa
            this.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv = string.Empty;
...
#endif
            var rp = BDOpe.ComandoSelectALista<ecu_validacion_cntr_brbk>(bcon, "[Bill].[validacion_cntr_impo_codigo]", this.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(rp.MensajeProblema);
        }
        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>> CargaPorManifiestoImpo(string usuario, string agente_id, string ruc, string mrn, string msn, string hsn)
        {
            this.actualMetodo = MethodBase.GetCurrentMethod().Name;
            //inicializa
            string pv = string.Empty;
            ...
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(mrn)+'/'+nameof(agente_id)));
            }
            if (string.IsNullOrEmpty(msn))
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(msn)));
...
#endif
            var rp = BDOpe.ComandoSelectALista<ecu_validacion_cntr_brbk>(bcon, "[Bill].[validacion_cntr_bbk_impo_mrn_ruc]", this.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(rp.MensajeProblema);
        }
        public ResultadoOperacion<List<ecu_validacion_cntr_brbk>> CargaPorManifiestoImpo(string usuario, string ruc, string agente_id, string mrn, string msn, string hsn, bool validar)
        {
            this.actualMetodo = MethodBase.GetCurrentMethod().Name;
            //inicializa
            string pv = string.Empty;
            ...
            {
                return Respuesta.ResultadoOperacion<List<ecu_validacion_cntr_brbk>>.CrearFalla(string.Format(tt.Item1, nameof(ruc)+'/'+nameof(agente_id)));
            }
        ...
        public static bool? EsCargaCFS(string mrn, string msn, string hsn)
        {
            ...
            var p = new ecu_validacion_cntr_brbk();
