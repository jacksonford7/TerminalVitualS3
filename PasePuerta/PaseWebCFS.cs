...
{
    public class Pase_WebCFS : ModuloBase
    {
        ...
        public string NUMERO_CERTIFICADO { get; set; } //CERTIFICADO
        ...
        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerCargaPaseCFS(string mrn, string msn, string hsn, string ruc, DateTime? fecha=null)
        {
            ...
            {
                return ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(pv);
            }
            p.Parametros.Clear();
            ...
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[carga_pase_web_cfs]", p.Parametros);

            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);

        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerCargaPaseCFS_MultiDespacho(Int64 IV_ID)
        {
            var p = new Pase_Container();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            p.Parametros.Add("IV_ID", IV_ID);
          
            var bcon = p.Accesorio.ObtenerConfiguracion("N4Middleware")?.valor;

            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "CFS_CARGA_PASE_WEB_MULTIDESPACHO", p.Parametros);

            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);

        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerCargaPaseCFS_MultiDespachoTransporte(Int64 IV_ID)
        {
            var p = new Pase_Container();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "P2D_MULTI_CARGA_PASE_WEB_FFORWARDER", p.Parametros);

            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);

        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerTarjaCFS(string mrn, string msn, string hsn, Int64 ikey)
        {
            var p = new Pase_Container();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            var bcon = p.Accesorio.ObtenerConfiguracion("N4Middleware")?.valor;
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[carga_tarja_cfs]", p.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);
        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerTarjaCFS_CERTIFICADOS(string mrn, string msn, string hsn, Int64 ikey)
        {
            var p = new Pase_Container();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            p.Parametros.Add("key", ikey);
            var bcon = p.Accesorio.ObtenerConfiguracion("N4Middleware")?.valor;
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[carga_tarja_cfs_certificados]", p.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);
        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerTarjaCFS_Ver_Certificado(string mrn, string msn, string hsn)
        {
            var p = new Pase_Container();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            p.Parametros.Add("hsn", hsn);
            var bcon = p.Accesorio.ObtenerConfiguracion("N4Middleware")?.valor;
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[carga_tarja_cfs_ver_certificados]", p.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);
        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerTarjaCFS_Edit(string mrn, string msn, string hsn, Int64 ikey)
        {
            var p = new Pase_Container();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            p.Parametros.Add("key", ikey);
            var bcon = p.Accesorio.ObtenerConfiguracion("N4Middleware")?.valor;
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[carga_tarja_cfs_edit]", p.Parametros);
            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);
        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerListaPase(string mrn, string msn, string hsn, string ruc)
        {
            var p = new Pase_CFS();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[lista_pase_web_cfs]", p.Parametros);

            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);

        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerListaPase_MultiDespacho(string mrn,  string ruc)
        {
            var p = new Pase_CFS();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "[Bill].[lista_pase_web_cfs_multidespacho]", p.Parametros);

            return rp.Exitoso ? ResultadoOperacion<List<Pase_WebCFS>>.CrearResultadoExitoso(rp.Resultado) : ResultadoOperacion<List<Pase_WebCFS>>.CrearFalla(rp.MensajeProblema);

        }

        public static ResultadoOperacion<List<Pase_WebCFS>> ObtenerListaPase_MultiDespachoTransporte(string mrn, string ruc)
        {
            var p = new Pase_CFS();
            p.actualMetodo = MethodBase.GetCurrentMethod().Name;
            string pv;
            ...
            var rp = BDOpe.ComandoSelectALista<Pase_WebCFS>(bcon, "P2D_MULTI_lista_pase_web_cfs", p.Parametros);
