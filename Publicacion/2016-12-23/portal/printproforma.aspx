...
<div id="hoja">
     ...
     <tr><td colspan="2"><h2>PROFORMA POR SERVICIOS DE EXPORTACION</h2></td></tr>
     </table>
     </div>
     <div class="seccion">
     <div class="accion">
     ...
     <tr><td class="bt-top" rowspan="4"><span id="servicio">Proforma #</span></td>
     ...
     <div class="accion">
      ...
      <table class="xcontroles" cellspacing="0" cellpadding="0">
        <tr><th class=" bt-top bt-bottom bt-right  bt-left"> Detalle de la ejecución de servicios</th></tr>
