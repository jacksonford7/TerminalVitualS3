...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
   ...
   <i class="ico-titulo-2"></i><h1>Gate In Report</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="3">Filtros para el reporte</th></tr>
         ...
         <table>
             ...
             onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890/')">
                 <%--ontextchanged="tbooking_TextChanged" >--%>
                 </asp:TextBox>
                 </td>
                 <td>
         ...
         <div class="botonera">
          <span id="imagen"></span>
             ...
             <table>
                 ...
                 <td>
             <input clientidmode="Static" id="dataexport" onclick="getTable('reportGateIn');" type="button" value="Exportar" runat="server" />
             </td>
             </tr>
             </table>
                 <br />
