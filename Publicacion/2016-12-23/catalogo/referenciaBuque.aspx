    ...
    <div class="catabody">
        <div class="catawrap">
            <div class="catabuscar">
                <div class="catacapa">
                    Línea:
                    <asp:TextBox ID="txtLinea" runat="server" Width="20%" MaxLength="3" CssClass="mayusc"
                    ...
                    Año:
                    <asp:TextBox ID="txtAnio" runat="server" Width="20%" MaxLength="4" CssClass="mayusc"
                        onkeypress="return soloLetras(event,'1234567890')" EnableViewState="False" placeholder="Año"></asp:TextBox>
                    Buque:
                    <asp:TextBox ID="txtBuque" runat="server" Width="20%" MaxLength="11" CssClass="mayusc"
                        onkeypress="return soloLetras(event,'abcdefghijklmnñopqrstuvwxyz1234567890')"
