    ...
    <div class="colapser colapsa"></div>
     ...
     <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos de la carga 
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >21. Cantidad de unidades:</td>
         <td class="bt-bottom">
               <a class="tooltip" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">22. Peso unitario&nbsp;[KG]:</td>
         <td class="bt-bottom">
        ...
        <tr><td class="bt-bottom  bt-right bt-left">23. Tipo de embalaje:</td>
         <td class="bt-bottom">
        ...
        <tr><td class="bt-bottom  bt-right bt-left">24. Código de peligrosidad (IMO):</td>
         <td class="bt-bottom">
   ...
   <div id="opcional" class="colapser-option  colapsa">Clic aquí para añadir información del contenedor (Opcional)</div>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="CNTR">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >25. Número del contenedor:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">26. Tara del contenedor [TON]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">27. Max.&nbsp;<i>Payload</i>&nbsp;contenedor[TON]:</td>
         <td class="bt-bottom">
         ...
         <td class="bt-bottom bt-right validacion "><span id="valpayload" class="validacion" > * obligatorio</span></td>
           ...
           <tr><td class="bt-bottom  bt-right bt-left">28. Origen del contenedor <i>(Depot)</i></td>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" >
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos sobre refrigeración del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >29. Tipo de refrigeración:</td>
           <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">30. Temperatura [°C]:</td>
         <td class="bt-bottom">
        ...
        <td class="bt-bottom bt-right validacion "><span id='valtemp' class="opcional" > * opcional</span></td>
          ...
          <tr><td class="bt-bottom  bt-right bt-left">31. Humedad &nbsp;[CBM]:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left">32. Ventilación&nbsp;[%]:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle de los sellos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >33. Sello de agencia:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >34. Sello de ventilación [Reefer]:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >35. Sello adicional 1:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >36. Sello adicional 2:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle del exceso de 
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >37. Excede dimesiones nominales:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">38 Excesos izquierda [cm]:
          <i class="ileft"></i>
         </td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">39. Excesos derecha [cm]:&nbsp;&nbsp;
          <i class="iright"></i>
         </td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left">40. Excesos frontal&nbsp;[cm]: 
         &nbsp;&nbsp;&nbsp;  <i class="ifront"></i>
         </td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">41. Excesos atrás&nbsp;[cm]:&nbsp;&nbsp;
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ibotom"></i></td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">42. Excesos superior&nbsp;[cm]:
         &nbsp;
          <i class="itop"></i></td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="TRSP">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="4"> Datos del transporte</th></tr>
           <tr>
         <td class="bt-bottom  bt-right bt-left" >43. Ubicación de la planta:</td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">44. Fecha y hora de salida de planta:</td>
         <td class="bt-bottom" colspan="2">
           ...
           placeholder="dd/mm/aaaa hh:mm"
            ...
            <tr><td class="bt-bottom  bt-right bt-left">45. Tiempo estimado de viaje [Hrs]:</td>
             <td class="bt-bottom" colspan="2">
         ...
         <td class="bt-bottom bt-right validacion "><span class="validacion" id="valestima" > * obligatorio</span></td>
          ...
          <tr><td class="bt-bottom  bt-right bt-left">46. Nombre del conductor:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <td class="bt-bottom bt-right validacion "><span class="validacion" id="valnombre" ></span></td>
         		         ...
         		         <tr><td class="bt-bottom  bt-right bt-left">47. Documento de identidad:</td>
         <td class="bt-bottom" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">48. Placa del vehículo:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">49. Certificado de Cabezal:</td>
               <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">50. Certificado de Chasis:</td>
               <td class="bt-bottom" colspan="2">
         <a class="tooltip" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">51. Certificado especial:</td>
         <td class="bt-bottom" colspan="2">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos para notificación</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >52. Correo(s) para notificación: 
