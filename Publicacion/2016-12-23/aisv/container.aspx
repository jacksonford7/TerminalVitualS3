        ...
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="2"> Datos del <i>Booking</i> </th></tr>
         ...
         <td class="bt-bottom  bt-right">
             ...
             <input id="over" type="checkbox"  onclick="radio(this,ckdimen);"/>
              <span><strong>Arribo tardío</strong> </span>
     ...
     <div class="accion" id="ADU">
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="CNTR">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >21. Número del contenedor:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">22. Tara del contenedor [TON]:</td>
         <td class="bt-bottom">
                <span id="tara" class="caja cajafull">00.00</span>
             </td>
         <td class="bt-bottom bt-right  "></td>
         </tr>
         <tr><td class="bt-bottom  bt-right bt-left">23. Max.&nbsp;<i>Payload</i>&nbsp;contenedor [TON]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">24. Peso bruto de la carga&nbsp;[TON]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">25. Origen del contenedor <i>(Depot)</i></td>
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="refrigeracion">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos sobre refrigeración del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >26. Tipo de refrigeración:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">27. Temperatura [°C]:</td>
         <td class="bt-bottom">
        ...
        <td class="bt-bottom bt-right validacion "><span id='valtemp' class="validacion" > * obligatorio</span></td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">28. Humedad &nbsp;[CBM]:</td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">29. Ventilación&nbsp;[%]:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle de los sellos del contenedor</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >30. Sello de agencia:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >31. Sello de ventilación [Reefer]:</td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" > <span id="msc_sello">32. Sello adicional 1:</span> </td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >33. Sello adicional 2:</td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Detalle del exceso de 
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left" >36. Excede dimesiones nominales:</td>
         <td class="bt-bottom">
          <a class="tooltip" ><span class="classic">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">37. Excesos izquierda [cm]:
          <i class="ileft"></i>
         </td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">38. Excesos derecha [cm]:&nbsp;&nbsp;
          <i class="iright"></i>
         </td>
         <td class="bt-bottom">
         ...
         <tr>
         <td class="bt-bottom  bt-right bt-left">39. Excesos frontal&nbsp;[cm]: 
         &nbsp;&nbsp;&nbsp;  <i class="ifront"></i>
         </td>
         <td class="bt-bottom">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">40. Excesos atrás&nbsp;[cm]:&nbsp;&nbsp;
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ibotom"></i></td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">41. Excesos superior&nbsp;[cm]:
         &nbsp;
          <i class="itop"></i></td>
         <td class="bt-bottom">
      ...
      <table class="controles" cellspacing="0" cellpadding="1" id="TRSP">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="4"> Datos del transporte</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >42. Ubicación de la planta:</td>
         ...
         <tr><td class="bt-bottom  bt-right bt-left">43. Fecha y hora de salida de planta/finca:</td>
         <td class="bt-bottom" colspan="2">
          <asp:TextBox ID="txtSalida" runat="server" MaxLength="16" Width="250px" CssClass="datetimepicker"
            ...
            <tr><td class="bt-bottom  bt-right bt-left">44. Tiempo estimado de viaje [Hrs]:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">45. Nombre del conductor:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">46. Documento de identidad:</td>
         <td class="bt-bottom" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">47. Placa del vehículo:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">48. Certificado de Cabezal:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">49. Certificado de Chasis:</td>
         <td class="bt-bottom" colspan="2">
         <a class="tooltip" >
         ...
         <tr><td class="bt-bottom  bt-right bt-left">50. Certificado especial:</td>
         <td class="bt-bottom" colspan="2">
         ...
         <tr><td class="bt-bottom  bt-right bt-left">51. Compañia de Transporte:</td>
         <td class="bt-bottom" colspan="2">
      ...
      <table class="controles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left" colspan="3"> Datos para notificación</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left" >53. Correo(s) para notificación: 
