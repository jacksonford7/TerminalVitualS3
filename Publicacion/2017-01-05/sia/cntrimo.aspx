<%@ Page Title="Reporte de contendores IMO" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
 CodeBehind="cntrimo.aspx.cs" Inherits="CSLSite.cntrimo" %>
...
<input id="zonaid" type="hidden" value="1102" />
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
    <div>
   <i class="ico-titulo-1"></i><h2>Seguridad Industrial </h2>  <br /> 
   <i class="ico-titulo-2"></i><h1>Reporte de Contenedores Peligrosos en la Terminal</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="5"> Datos para el corte</th></tr>
         <tr>
         <td class="bt-bottom  bt-right bt-left">Registrados desde:</td>
         <td class="bt-bottom">
          ...
          <span id="imagen"></span>
             ...
             <div class="booking" >
                 ...
                 <tr class="point" >
                  ...
                  <td><%#Eval("POSICION_ACTUAL")%></td>
                  <td>
                    <a class="xinfo" >
                    <span class="xclass">
                    <h3>Línea:</h3><%#Eval("LINEA")%>
                    <h3>Comodity:</h3><%#Eval("COMODITY")%>
                    <h3>Descripción:</h3><%#Eval("IMO_DESCRIPCION")%>
                      </span>
                        <%#Eval("IMDG")%>
                    </a>
                  </td>
