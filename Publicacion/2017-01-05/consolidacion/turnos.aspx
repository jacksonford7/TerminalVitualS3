...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="403" />
       ...
       <div class="accion">
        ...
        <a  class="topopup" target="popup" onclick="window.open('../catalogo/bookcon','name','width=1260,height=480')" >
         ...
         <td class="bt-bottom  bt-right bt-left">Fecha de programación:</td>
          <td class="bt-bottom bt-right " >
                   <span id="txtfecha" class="caja" style=" width:280px!important;" >...</span>
         ...
         <td class="bt-bottom bt-right">
               ...
               type='text' id='tmail' name='tmail'  runat="server" style= 'width:400px; font-size:smaller' class="date"
             ...
             <div class="booking" >
                 ...
                 <tr class="point" >
                  ...
                  <td>
                      ...
                      Text="0" ID="caja" CssClass="suma" xval='<%#Eval("DISPONIBLE")%>' onblur="cajaControl(this);" runat="server" MaxLength="4" onkeypress="return soloLetras(event,'01234567890',true)" ></asp:TextBox>
                   </td>
                 </tr>
                  </ItemTemplate>
                 <FooterTemplate>
