...
<input id="zonaid" type="hidden" value="206" />
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
    <div>
   <i class="ico-titulo-1"></i><h2>Autorización de Ingreso y Salida de Vehículos </h2>  <br /> 
   <i class="ico-titulo-2"></i><h1>Consulta, reimpresión y replicación de AISV (CGSA)</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
            <table class="xcontroles" cellspacing="0" cellpadding="1">
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="5"> Datos del documento AISV buscado</th></tr>
         <tr>
          ...
          <span id="imagen"></span>
             ...
             <div class="booking" >
                 ...
                 <tr class="point" >
                  ...
                  <td>
                   <div class="tcomand">
                       <a href="impresion.aspx?sid=<%# securetext(Eval("aisv")) %>" class="imprimir" target="_blank">Mostrar</a>|
                       <div class='<%# boton( Eval("estado"))%>' >
                       <asp:Button ID="btanula"  
                       OnClientClick="return confirm('Esta seguro que desea replicar este AISV?');" 
                       CommandArgument=   '<%# jsarguments( Eval("aisv"),Eval("referencia"),Eval("cntr"),Eval("tipo"),Eval("movi"),Eval("estado") )%>' runat="server" Text="Replicar" CssClass="Anular" ToolTip="Permite replicar este AISV" />
                       </div>
                   </div>
                  </td>
                 </tr>
             ...
             <div id="pager">
               Registros por página
                 ...
                 <input clientidmode="Static" id="dataexport" onclick="getTable('resultado');" 
