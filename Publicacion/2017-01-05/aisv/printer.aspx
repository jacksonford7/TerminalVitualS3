<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printer.aspx.cs" Inherits="CSLSite.printer" %>
...
<div id="hoja">
     ...
     <table class="xcontroles" cellspacing="0" cellpadding="0">
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="4"> Datos de Aduana (Senae) </th></tr>
         ...
         <td class="bt-bottom bt-right">
          <span id="entrega" runat="server" class="labelprint">0590520149011336544 (R)</span>
         </td>
         </tr>
         <tr>
        ...
        <tr><th class="bt-bottom bt-right  bt-left" colspan="4"> Datos del transporte </th></tr>
         ...
         <tr><td class=" bt-right bt-left bt-bottom">Certificado especial</td>
           ...
           <td class="bt-right" colspan="3">
            <span id="trasnport" runat="server"  class="labelprint">0919176503001 - COCA CODO SINCLAIR</span>
           </td>
         </tr>
     </table>
         ...
         <table class="xcontroles" cellspacing="0" cellpadding="0">
        <tr><th class="bt-bottom bt-right bt-top bt-left" colspan="4"> Datos de la terminal 
            (si aplica) </th></tr>
         <tr>
