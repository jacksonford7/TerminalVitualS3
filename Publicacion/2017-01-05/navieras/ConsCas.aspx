<%@ Page Title="CAS" Language="C#" MasterPageFile="~/site.Master"  AutoEventWireup="true" CodeBehind="ConsCas.aspx.cs" Inherits="CSLSite.cons_cas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    <input id="zonaid" type="hidden" value="601" />
    <asp:ToolkitScriptManager ID="tkcal" EnableScriptGlobalization="true" runat="server"> </asp:ToolkitScriptManager>
    <div>
   
   <i class="ico-titulo-2"></i><h1>Consulta Carta de Autorización de Salida</h1><br />
 </div>
  <div class="seccion">
       <div class="accion">
        ...
        <tr><th class="bt-bottom bt-right  bt-left bt-top" colspan="3">Filtros para el reporte</th></tr>
         ...
         <tr>
         <td class="bt-bottom bt-left bt-right" style=" width:100px" >BL:</td>
         <td class="bt-bottom bt-right" >
         <table>
                            <tr>
                                <td>
             <asp:TextBox
             style="text-align: center" 
             ID="bl" runat="server" ClientIDMode="Static" width="277px" MaxLength="15" CssClass="mayusc" 
             onkeypress="return soloLetras(event,'abcdefghijklmnopqrstuvwxyz01234567890')" ></asp:TextBox>
              </td>
              </tr>
              </table>
         ...
         <div class="botonera">
          <span id="imagen"></span>
             ...
             <br>
             <div>
             <input clientidmode="Static" id="dataexport" onclick="getTable('reportCas');" type="button" value="Exportar" runat="server" />
             </div>
             </br>
                 <div class="separator">Resultado</div>
                 <div class="bokindetalle">
                 <div style=" width : 99%; overflow : auto; height : 140px ">
                 ...
                 <th style="width:60px">CAS Date</th>
                 </tr>
                 </thead> 
                 <tbody>
                 </HeaderTemplate>
