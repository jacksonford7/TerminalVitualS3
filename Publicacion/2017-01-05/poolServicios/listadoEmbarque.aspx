...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
    ...
    <div>
        ...
        <h2>
            Listado de Embarque</h2>
        <br />
        <br />
        <i class="ico-titulo-2"></i>
        <h1>
            Listado de Embarque</h1>
        <br />
    </div>
                ...
                <div class="accion">
                    <table class="xcontroles" cellspacing="0" cellpadding="1">
                        ...
                        <tr>
                            ...
                            <td class="bt-bottom">
                                <asp:TextBox ID="txtReferencia" runat="server" Width="290px" Enabled="false" Style="text-align: center;"></asp:TextBox>
                                <asp:HiddenField ID="hdfReferencia" runat="server" />
                            </td>
                            <td class="bt-bottom  bt-right finder">
                                <a class="topopup" target="popup" onclick="linkReferencia();"><i class="ico-find"></i>
                                    Buscar </a>
                        ...
                        <tr>
                            ...
                            <td class="bt-bottom">
                                <asp:TextBox ID="txtCutOff" runat="server" Width="290px" Enabled="false" Style="text-align: center;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="bt-bottom bt-right" colspan="4">
                                <asp:TextBox ID="txtNave" runat="server" Width="290px" Enabled="false" Style="text-align: center;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="bt-bottom bt-right" colspan="4">
                                <asp:TextBox ID="txtReporte" runat="server" Width="290px" Enabled="false" Style="text-align: center;"></asp:TextBox>
                    ...
                    <div id="xfinder" runat="server" visible="false">
                        ...
                        <table class="xcontroles" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                <td class="bt-bottom bt-right bt-left" style="width: 231px;">
                                    Exportador:
                                </td>
                                <td class="bt-bottom bt-right" colspan="4">
                                    <asp:TextBox ID="txtExportador" runat="server" Width="290px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="bt-bottom bt-right" colspan="4">
                                    <asp:TextBox ID="txtBooking" runat="server" Width="290px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="bt-bottom bt-right" colspan="4">
                                    <asp:TextBox ID="txtContenedor" runat="server" Width="290px"></asp:TextBox>
                                    <asp:HiddenField ID="hdfContenedor" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td class="bt-bottom bt-right bt-left">
                                    Falta de Pago para embarque:
                                </td>
                                <td class="bt-bottom bt-right" colspan="4">
                                    <asp:DropDownList ID="ddlFaltaPago" runat="server" Width="290px" >
                        ...
                        <div class="botonera" runat="server" id="div1">
                            <asp:Button ID="btnBuscarContenedor" runat="server" Text="Buscar" OnClientClick="showGif('placebody_imagenBus')"
                    ...
                    <div class="botonera" runat="server" id="divBotonera">
                        <input clientidmode="Static" id="dataexport" onclick="getTable('resultadoLista');"
                            type="button" value="Exportar" runat="server" />
                        <span id="imagen" runat="server"></span>
                        <asp:Button ID="btgenerar" runat="server" Text="Guardar" OnClientClick="showGif('placebody_imagen')"
    ...
    <script type="text/javascript">
        ...
        function confirmCheck(ctrl, contenedor) {
            ...
            if (ctrl.checked == true) {
                var r = confirm("¿Está seguro que desea asumir/garantizar los costos de embarque (recepción/porteo, roleos y/o late arrival) del contenedor " + contenedor + "?");
                if (r == true) {
                    ctrl.checked = true;
