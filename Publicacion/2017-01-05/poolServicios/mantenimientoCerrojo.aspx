...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
 ...
 <div class="seccion">
       ...
       <tr>
            <td class="bt-bottom bt-right bt-left" >Num. Consulta:</td>
       ...
       <tr class="nover">
            <td class="bt-bottom bt-right bt-left nover">Tipo de Usuario:</td>
            <td class="bt-bottom bt-right nover">
              <%--<a class="tooltip" >
              <span class="classic">Esta informacion contiene los tipos de servicios disponibles.</span>--%>
            ...
            <td class="bt-bottom bt-right validacion nover "></td>
       </tr>       
       <tr>
       ...
       <tr class="nover">
         <td class=" nover bt-bottom bt-right bt-left">Todas las solicitudes.</td>
         <td class=" nover bt-bottom bt-right">
       ...
       <div class="botonera">
            <input clientidmode="Static" id="dataexport" onclick="getTable('tablaAnalistas');"
        ...
        <div class="booking" >
                 ...
                 <tr class="point" >                  
                  ...
                  <td>
                    ...
                    <a href="<%#Eval("nombreDocumento")%>" class="imprimir" target="_blank" style='<%#Eval("nombreDocumento") == null ? "display:none;": "display:block;"%>'>Imprimir</a>
                  </td>
                 </tr>
                 </ItemTemplate>
                 <FooterTemplate>
