...
<asp:Content ID="Content2" ContentPlaceHolderID="placebody" runat="server">
 ...
 <div>
 <i class="ico-titulo-1"></i><h2>Ingreso de Solicitud (Cerrojo Electrónico)</h2>  
     <br />
     <br />
     ...
     <%--  <asp:UpdatePanel ID="updBusquedaExcel" runat="server" ChildrenAsTriggers="true">
       ...
       <tr>
            ...
            <%--<td class="bt-bottom finder">
                <span id="imagen"></span>
                <asp:Button ID="btnSubirArchivoChoferes" runat="server" Text="Subir..." Height="25px" Width="78px" onclick="btnSubirArchivoChoferes_Click" />
            </td> --%>
       </tr>             
    </table>
       <div class="botonera">
