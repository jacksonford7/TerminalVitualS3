...
{
    public class VBS_Plantilla_Det : Cls_Bil_Base
    {
        ...
        private string NOMBRE_CABECERA = string.Empty;
       ...
       public string NOMBRECABECERA { get => NOMBRE_CABECERA; set => NOMBRE_CABECERA = value; }
        ...
        public VBS_Plantilla_Det()
        {
            init();
        }


        public VBS_Plantilla_Det(Int64 _ID_TURNO,
         Int64 _SECUENCIA,
  ...
  string _DESC_BODEGA,
        ...
        public static List<VBS_Plantilla_Det> Generar_Turnos(DateTime FECHA_DESDE, DateTime FECHA_HASTA, Int64 ID_TIPO_PRODUCTO, string ID_BODEGA, Int64 FRECUENCIA, Int64 CAPACIDAD, out string OnError)
        {
            parametros.Clear();
            ...
            return sql_punteroVBS.ExecuteSelectControl<VBS_Plantilla_Det>(sql_punteroVBS.Conexion_LocalVBS, 6000, "[BRBK].[GENERA_TURNOS]", parametros, out OnError);
        }
