...
{
    public class BAN_DetallePlantilla : Cls_Bil_Base
    {
        ...
        private long _ID_DETALLEPLANTILLA;
        ...
        public long SECUENCIA { get => _SECUENCIA; set => _SECUENCIA = value; }
        public long ID_DETALLEPLANTILLA { get => _ID_DETALLEPLANTILLA; set => _ID_DETALLEPLANTILLA = value; }
