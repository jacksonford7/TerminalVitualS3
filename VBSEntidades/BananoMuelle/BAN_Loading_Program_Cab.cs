...
{
    public class BAN_Loading_Program_Cab : Cls_Bil_Base
    {
        #region "Propiedades"
        ...
        public List<BAN_Loading_Program_Det> Detalle { get; set; }
        public List<BAN_Exclusion> Exclusiones { get; set; }
        
        #endregion

        public BAN_Loading_Program_Cab()
        {
            init();
        }
        ...
        public static BAN_Loading_Program_Cab GetLoadingProgramCabEspecifico(long? _id, string idNave,int linea, int fechaDocumento)
        {
            parametros.Clear();
            parametros.Add("i_idLoadingCab", _id);
            parametros.Add("i_idNave", idNave);
            parametros.Add("i_idLinea", linea);
            parametros.Add("i_fechaDocumento", fechaDocumento);
            var obj = sql_puntero.ExecuteSelectOnly<BAN_Loading_Program_Cab>(sql_punteroVBS.Conexion_LocalVBS, 4000, "[BAN_Loading_Program_Cab_Consultar]", parametros);
        ...
        public Int64? Save_Update(out string OnError)
        {
            ...
            var db = sql_puntero.ExecuteInsertUpdateDeleteReturn(sql_punteroVBS.Conexion_LocalVBS, 6000, "[BAN_Loading_Program_Cab_Insertar]", parametros, out OnError);
        ...
        public Int64? Save_Autorizacion(out string OnError)
        {
            ...
            var db = sql_puntero.ExecuteInsertUpdateDeleteReturn(sql_punteroVBS.Conexion_LocalVBS, 6000, "[BAN_Loading_Program_Cab_UpdateDate]", parametros, out OnError);
            if (!db.HasValue || db.Value < 0)
            {
                return null;
            }
