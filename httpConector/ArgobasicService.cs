namespace ConectorN4
{
    ...
    public partial class ArgobasicService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ArgobasicService() {
            if (System.Configuration.ConfigurationManager.AppSettings["N4Service"] == null)
            {
                //sino pusistes la cadena de conexion se apunta a desarrollo
                this.Url = "http://172.16.2.6:9080/apex/services/argobasicservice";
            }
            else
            {
                //sino apunte a la que usted diga
                this.Url = System.Configuration.ConfigurationManager.AppSettings["N4Service"];
            }
