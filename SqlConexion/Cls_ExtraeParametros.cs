...
namespace SqlConexion
{
    class Cls_ExtraeParametros
    {
        ...
        private void initialize()
        {
            ...
            configuraciones = puntero.ExecuteSelectControl<Cls_Parametros>(puntero.Conexion_Local, 2000, "sp_Bil_Extrae_Configuraciones", null, out error);
        }
        ...
        {
            OnInit();
            return configuraciones?.Where(s => s.nombre.Equals(nombre)).FirstOrDefault();
            //si no hay esta nulo
