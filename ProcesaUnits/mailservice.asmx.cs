            ...
            try
            {
                           ...
                           if (!string.IsNullOrEmpty(item.imo) && item.imo !="0" && freigthKind!="MTY")
                           {
                              ...
                              //LE PONE LOS PUESTOS
                               ...
                               if (!pod.Contains("NA") && !pod1.Contains("NA"))
                               {
                                    ...
                                    {
                                        xunit = string.Concat(xunit, string.Format("<routing pol=\"ECGYE\" pod-1=\"{1}\"  pod-2=\"{2}\" group=\"{3}\"><carrier facility=\"GYE\" mode=\"TRUCK\" direction=\"IB\" qualifier=\"DECLARED\" /> <carrier facility=\"GYE\" mode=\"TRUCK\" direction=\"IB\" qualifier=\"ACTUAL\" /><carrier id=\"{0}\" facility=\"GYE\" mode=\"VESSEL\" direction=\"OB\" qualifier=\"DECLARED\" />   <carrier id=\"{0}\" facility=\"GYE\" mode=\"VESSEL\" direction=\"OB\" qualifier=\"ACTUAL\" /></routing >", item.referencia, pod, pod1, item.group));
                                    }
                               }
                               else 
                               {
                                   ...
                                   if (pod != "NA")
                                   {
                                        ...
                                        {
                                            xunit = string.Concat(xunit, string.Format("<routing pol=\"ECGYE\" pod-1=\"{1}\" group=\"{2}\" ><carrier facility=\"GYE\" mode=\"TRUCK\" direction=\"IB\" qualifier=\"DECLARED\" /> <carrier facility=\"GYE\" mode=\"TRUCK\" direction=\"IB\" qualifier=\"ACTUAL\" /><carrier id=\"{0}\" facility=\"GYE\" mode=\"VESSEL\" direction=\"OB\" qualifier=\"DECLARED\" />   <carrier id=\"{0}\" facility=\"GYE\" mode=\"VESSEL\" direction=\"OB\" qualifier=\"ACTUAL\" /></routing >", item.referencia, pod, item.group));
                                        }
                                   ...
                                   else
                                   {
                                        ...
                                        {
                                            xunit = string.Concat(xunit, string.Format("<routing pol=\"ECGYE\" group=\"{1}\" ><carrier facility=\"GYE\" mode=\"TRUCK\" direction=\"IB\" qualifier=\"DECLARED\" /> <carrier facility=\"GYE\" mode=\"TRUCK\" direction=\"IB\" qualifier=\"ACTUAL\" /><carrier id=\"{0}\" facility=\"GYE\" mode=\"VESSEL\" direction=\"OB\" qualifier=\"DECLARED\" />   <carrier id=\"{0}\" facility=\"GYE\" mode=\"VESSEL\" direction=\"OB\" qualifier=\"ACTUAL\" /></routing >", item.referencia, item.group));
                                        }
                ...
                //   jAisvContainer dbo = new jAisvContainer();
                    foreach (var c in containers)
                   {
                       if (c.preadvice)
                       {
                           DataHelper.InsertTurnos(Convert.ToInt32(c.idTurno), usuario, DateTime.Now, c.uniISO, c.unidadID, "", "");
                           xmail.AppendFormat("<tr><td>{0}</td><td>{1}</td></tr>",c.unidadID,c.uniISO,c.idTurno,c.fechaTurno,c.horaTurno);
                           xmlinsert.AppendFormat("<CSL_P_Mant_cslContenedorVacio CnvContenedor=\"{0}\" CnvBooking=\"{1}\" CnvUsuario=\"{2}\" flag=\"I\"  CnvFechaTurno=\"{3}\" CnvHoraTurno=\"{4}\"  CnvIdTurno=\"{5}\"  />", c.unidadID,c.bokingID,usuario,c.fechaTurno,c.horaTurno,c.idTurno);
                           number++;
                           xnumber++;
                       }
                   }
