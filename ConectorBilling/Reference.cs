...
namespace N4 {
    ...
    public partial class ArgoService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ArgoService() {
            ...
            if (System.Configuration.ConfigurationManager.AppSettings["BillingN4Service"] == null)
            {
                //sino pusistes la cadena de conexion se apunta a desarrollo
                this.Url = "http://172.16.2.14:11080/billing/services/argoservice";
            }
            else
            {
                //sino apunte a la que usted diga
                this.Url = System.Configuration.ConfigurationManager.AppSettings["BillingN4Service"];
            }
