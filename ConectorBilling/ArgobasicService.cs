namespace N4
{
    ...
    public partial class ArgobasicService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {

        /// <remarks/>
        public ArgobasicService()
        {
            if (System.Configuration.ConfigurationManager.AppSettings["BillingN4Service2"] == null)
            {
                //sino pusistes la cadena de conexion se apunta a desarrollo
                this.Url = "http://172.16.2.14:11080/billing/services/argobasicservice";
            }
            else
            {
                //sino apunte a la que usted diga
                this.Url = System.Configuration.ConfigurationManager.AppSettings["BillingN4Service2"];
            }
