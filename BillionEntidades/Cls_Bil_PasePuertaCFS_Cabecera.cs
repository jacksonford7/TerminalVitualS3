...
{
    public class Cls_Bil_PasePuertaCFS_Cabecera : Cls_Bil_Base
    {
        ...
        public List<Cls_Bil_PasePuertaCFS_Detalle> Detalle { get; set; }
        public List<Cls_Bil_CasManual> Detalle_Cas { get; set; }
        public List<cfs_detalle_pase_multidespacho> DetallePaseFacturas { get; set; }

        public Cls_Bil_PasePuertaCFS_Cabecera()
        {
            init();
            this.DetalleSubItem = new List<Cls_Bil_PasePuertaCFS_SubItems>();
            this.Detalle = new List<Cls_Bil_PasePuertaCFS_Detalle>();
            this.Detalle_Cas = new List<Cls_Bil_CasManual>();
            this.DetallePaseFacturas = new List<cfs_detalle_pase_multidespacho>();
        }



        public Cls_Bil_PasePuertaCFS_Cabecera(DateTime? _FECHA,string _MRN,string _MSN,string _HSN, string _SESION,string _FACTURA,
