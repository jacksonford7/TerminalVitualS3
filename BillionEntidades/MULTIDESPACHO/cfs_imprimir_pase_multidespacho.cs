...
{
    public class cfs_imprimir_pase_multidespacho : Cls_Bil_Base
    {
        ...
        public cfs_imprimir_pase_multidespacho()
        {
            init();
        ...
        public static List<cfs_imprimir_pase_multidespacho> Datos_Pase(string mrn, string ruc, DateTime? fecha, out string OnError)
        {
            OnInit("N4Middleware");
            ...
            return sql_puntero.ExecuteSelectControl<cfs_imprimir_pase_multidespacho>(nueva_conexion, 6000, "[Bill].[lista_pase_web_cfs_multidespacho]", parametros, out OnError);
