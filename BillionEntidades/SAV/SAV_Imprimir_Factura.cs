...
{
    public class SAV_Imprimir_Factura : Cls_Bil_Base
    {
        ...
        public SAV_Imprimir_Factura()
        {
            init();

        }

        public static List<SAV_Imprimir_Factura> Carga_Factura_Sav(string FACTURA, out string OnError)
        {
            parametros.Clear();
            parametros.Add("FACTURA", FACTURA);
            return sql_puntero.ExecuteSelectControl<SAV_Imprimir_Factura>(sql_puntero.Conexion_Local, 6000, "sav_imprimir_factura", parametros, out OnError);
