...
{
    public class SAV_Asigna_Factura : Cls_Bil_Base
    {
        ...
        private Int64? Actualiza(out string OnError)
        {
            ...
            var db = sql_puntero.ExecuteInsertUpdateDeleteReturn(nueva_conexion, 8000, "sav_asigna_factura", parametros, out OnError);
        ...
        public Int64? SaveTransaction(out string OnError)
        {
            ...
            try
            {
                ...
                if (!id.HasValue)
                {
                    OnError = "*** Error: al actualizar factura de devolución de contenedores ****";
                    return 0;
                }
                ID = id.Value;
