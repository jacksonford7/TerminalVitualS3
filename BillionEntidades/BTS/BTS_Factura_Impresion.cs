...
{
    public class BTS_Factura_Impresion : Cls_Bil_Base
    {
        ...
        public static List<BTS_Factura_Impresion> Datos_Factura(Int64 ID, out string OnError)
        {
            parametros.Clear();
            parametros.Add("ID", ID);
            return sql_puntero.ExecuteSelectControl<BTS_Factura_Impresion>(sql_puntero.Conexion_Local, 4000, "Bts_Rpt_Formato_ImprimirFacturaFinal", parametros, out OnError);
