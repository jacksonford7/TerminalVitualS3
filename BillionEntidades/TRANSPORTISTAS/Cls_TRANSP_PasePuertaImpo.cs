...
{
    public class Cls_TRANSP_PasePuertaImpo : Cls_Bil_Base
    {
        ...
        public List<Cls_TRANSP_PasePuertaImpo_Detalle> Detalle { get; set; }
        public List<Cls_TRANSP_PasePuertaExpo_Detalle> Detalle_Expo { get; set; }
        #endregion


        public Cls_TRANSP_PasePuertaImpo()
        {
            init();

            this.Detalle = new List<Cls_TRANSP_PasePuertaImpo_Detalle>();
            this.Detalle_Expo = new List<Cls_TRANSP_PasePuertaExpo_Detalle>();
        }
        ...
        public static List<Cls_TRANSP_PasePuertaImpo> Listado_Pases_Impo(string ID_EMPRESA,  out string OnError)
        {

            OnInit();
            parametros.Clear();
            parametros.Add("ID_EMPRESA", ID_EMPRESA);
            return sql_puntero.ExecuteSelectControl<Cls_TRANSP_PasePuertaImpo>(nueva_conexion, 5000, "TRANSP_CARGA_PASEPUERTA_IMPO", parametros, out OnError);
