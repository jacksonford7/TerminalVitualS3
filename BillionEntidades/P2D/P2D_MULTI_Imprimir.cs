...
{
    public class P2D_MULTI_Imprimir : Cls_Bil_Base
    {
        ...
        private string _IV_CIUDAD = string.Empty;
        #endregion
        ...
        public string IV_CIUDAD { get => _IV_CIUDAD; set => _IV_CIUDAD = value; }
        #endregion

        public P2D_MULTI_Imprimir()
        {
            init();
        ...
        public static List<P2D_MULTI_Imprimir> Datos_Factura(Int64 IV_ID, out string OnError)
        {
            parametros.Clear();
            parametros.Add("IV_ID", IV_ID);
            return sql_puntero.ExecuteSelectControl<P2D_MULTI_Imprimir>(sql_puntero.Conexion_Local, 4000, "P2D_MULTI_ImprimirFactura", parametros, out OnError);

        }

        public static List<P2D_MULTI_Imprimir> Listado_Facturas(DateTime FECHA_DESDE, DateTime FECHA_HASTA, out string OnError)
        {
         
            parametros.Clear();
            parametros.Add("IV_FECHA_DESDE", FECHA_DESDE);
            parametros.Add("IV_FECHA_HASTA", FECHA_HASTA);
            return sql_puntero.ExecuteSelectControl<P2D_MULTI_Imprimir>(sql_puntero.Conexion_Local, 6000, "P2D_MULTI_RPT_LISTADO_FACTURAS", parametros, out OnError);
