...
{
    public class BTS_Factura_Exportador_Impresion : Cls_Bil_Base
    {
        ...
        public BTS_Factura_Exportador_Impresion()
        {
            init();
        ...
        public static List<BTS_Factura_Exportador_Impresion> Datos_Factura(string FACTURA, out string OnError)
        {
            parametros.Clear();
            parametros.Add("FACTURA", FACTURA);
            return sql_puntero.ExecuteSelectControl<BTS_Factura_Exportador_Impresion>(sql_puntero.Conexion_Local, 6000, "Bts_Rpt_Formato_ImprimirFacturaExportador", parametros, out OnError);

        }

        public static List<BTS_Factura_Exportador_Impresion> Datos_Factura_Otros(string FACTURA, out string OnError)
        {
            parametros.Clear();
            parametros.Add("FACTURA", FACTURA);
            return sql_puntero.ExecuteSelectControl<BTS_Factura_Exportador_Impresion>(sql_puntero.Conexion_Local, 6000, "BTS_ImprimirFacturaExportador_Otros", parametros, out OnError);
