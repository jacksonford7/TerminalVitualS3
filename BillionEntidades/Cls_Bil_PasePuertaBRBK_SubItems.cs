...
{
    public class Cls_Bil_PasePuertaBRBK_SubItems : Cls_Bil_Base
    {
        #region "Variables"
        ...
        public Cls_Bil_PasePuertaBRBK_SubItems()
        {
            init();
        }
        ...
        public Cls_Bil_PasePuertaBRBK_SubItems( string _MRN , string _MSN,string _HSN, string _CARGA, Int64? _CONSECUTIVO,string _CIATRANS,
