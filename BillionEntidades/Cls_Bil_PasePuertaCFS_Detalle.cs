...
{
    public class Cls_Bil_PasePuertaCFS_Detalle : Cls_Bil_Base
    {
        ...
        public Cls_Bil_PasePuertaCFS_Detalle()
        {
            init();
        }

        public Cls_Bil_PasePuertaCFS_Detalle(DateTime? _FECHA, string _MRN, string _MSN, string _HSN, string _SESION, string _FACTURA,
        ...
        string _TRANSPORTISTA_DESC, string _CHOFER_DESC, string _ESTADO_PAGO, string _MOSTRAR_MENSAJE, string _ORDENAMIENTO, string _SUB_SECUENCIA, string _LLAVE, Int64? _ID_UNIDAD,
         bool? _P2D, bool? _ENVIADO_LIFTIF, string _ORDER_ID, string _ORDEN
        )
        ...
        public static List<Cls_Bil_PasePuertaCFS_Detalle> Listado_Pases(DateTime FECHA_DESDE, DateTime FECHA_HASTA, string Agente, int Tipo, out string OnError)
        {
            ...
            return sql_puntero.ExecuteSelectControl<Cls_Bil_PasePuertaCFS_Detalle>(sql_puntero.Conexion_Local, 6000, "sp_Bil_Rpt_Listado_Pases_CargaSuelta", parametros, out OnError);

        }

        public static List<Cls_Bil_PasePuertaCFS_Detalle> Listado_Pases_Freightforwarder(DateTime FECHA_DESDE, DateTime FECHA_HASTA, string Agente,  out string OnError)
        {
            ...
            parametros.Add("FECHA_HASTA", FECHA_HASTA);
            parametros.Add("RUC", Agente);
            return sql_puntero.ExecuteSelectControl<Cls_Bil_PasePuertaCFS_Detalle>(sql_puntero.Conexion_Local, 6000, "P2D_Multi_Listado_Pases_Facturas", parametros, out OnError);
