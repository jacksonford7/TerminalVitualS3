...
{
    public class Cls_Bil_Invoice_Impresion : Cls_Bil_Base
    {
        ...
        public Cls_Bil_Invoice_Impresion()
        {
            init();
        ...
        public static List<Cls_Bil_Invoice_Impresion> Datos_Factura(Int64 IV_ID, out string OnError)
        {
            parametros.Clear();
            parametros.Add("IV_ID", IV_ID);
            return sql_puntero.ExecuteSelectControl<Cls_Bil_Invoice_Impresion>(sql_puntero.Conexion_Local, 4000, "sp_Bil_Rpt_Formato_ImprimirFactura", parametros, out OnError);

        }

        public static List<Cls_Bil_Invoice_Impresion> Datos_FacturaExpo(Int64 _referencia, out string OnError)
        {
            parametros.Clear();
            parametros.Add("IV_ID", _referencia);
            return sql_puntero.ExecuteSelectControl<Cls_Bil_Invoice_Impresion>(sql_puntero.Conexion_Local, 4000, "sp_Bil_Rpt_Formato_ImprimirFacturaExpo", parametros, out OnError);
